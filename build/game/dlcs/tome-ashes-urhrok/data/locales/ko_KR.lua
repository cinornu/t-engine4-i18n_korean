...
t([[Whenever you kill a burning enemy, you will instantly deal a melee attack against a random adjacant enemy at %d%% power. 
		...
		추가로, 이 공격은 언제나 소각의 타격의 효과를 발생시킵니다. 근처에 피격당할 적이 없는 경우, 다음 공격에 적용됩니다. 이렇게 발동하는 소각의 타격은 일반 피해의 %d%% 에 해당하는 피해량을 갖고, 공격당한 적은 기절하게 됩니다. 이 기술은 소각의 타격의 재사용 대기시간을 무시합니다.
