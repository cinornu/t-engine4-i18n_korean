...
t("These massive gauntlets once belonged to a very powerful demon named Ul'Gruth. The behemoth was said to be able to level entire buildings with a single swing of his hands.", "이 거대한 전투장갑은 한때, 울'그루쓰라는 아주 강력한 악마가 소유하고 있었습니다. 그 거수는 손을 한 번 휘저으는 것으로도 수 채의 건물을 무너뜨릴 수 있었다고 합니다.", "_t")
t("Your Obliterating Smash can destroy walls.", "착용자의 소멸의 강타가 벽을 파괴할 수 있게 됩니다.", "_t")
t("Fearfire Mantle", "공포화염 망토", "entity name")
t("cloak shaped flames", "망토 형상의 화염", "_t")
...
t("Grushgore the Destroyer was as famous for his incredible brutality as he was for his childlike intelligence. He wasn't known for his subtlety of naming, but there's no denying the power of his massive sword.", "파괴자 그루쉬고어는 말도 안 되는 폭력성과 어린 아이 같은 지능으로 유명했습니다. 그에게는 이름 짓는 재능은 없었지만, 적어도 이 거대한 검의 강력한 힘은 그 누구도 부정하지 못합니다.", "_t")
t("Increases all damage dealt, and reduces all damage taken, by 1%, stacking up to 10 times. Resets after 10 turns without attacking.", "공격 시 가하는 모든 피해량과, 피격 시 피해 감소량이 1% 증가합니다. 최대 10 번 중첩되며, 공격을 하지 않은 체 10 턴이 지나면 모든 중첩이 사라집니다..", "_t")
t("Quasit's Skull", "콰짓의 해골", "entity name")
t("rocky helm", "바위 투구", "_t")
t("Some enterprising adventurer seems to have noticed the skin of quasits is actually tougher than most metals, and fashioned this helm from one. Shame about the smell.", "몇몇 진취적인 모험가들은 콰짓의 피부가 실제로 대부분의 금속보다 강하다는 사실을 알아차린 것 같습니다. 그들은 콰짓의 가죽으로 이 투구를 만들었습니다. 음 냄새는 똑같군요.", "_t")
t("Revenant", "망자", "entity name")
t("shifting breastplate", "변화하는 흉갑", "_t")
t("The joints of this armor creak ominously, the frame bends and heaves, almost as if breathing. The scratch and crack of metal mutters of suffering, of loss, perseverance and revenge.", "이 갑옷의 연결부는 불길하게 금이 가있고, 뼈대는 휘어있고, 숨만 셔도 덜컥거립니다. 표면에 난 금과 상처들은 고통과 상실, 인내와 복수를 중얼거리는 듯합니다.", "_t")
...
t("The battered remains of a flame imp's hand. It still burns with that unnatural flame.", "화염 임프의 박살 난 손입니다. 아직도 비 자연적인 화염으로 불타고 있습니다.", "_t")
t("Wheel of Fate", "운명의 수레바퀴", "entity name")
t([["This isn't what I wished for!" - Howar Muransk, Cornac demonologist.

This band of gothic obsidian menaces with an embossed image of a grinning skull. It beckons you to tempt fate and put it on. Do you?]], [["내가 원한 건 이딴 게 아니야!" - 하워 머란스크, 코르낙 악마학자.

이 고풍적인 흑요석 반지의 활짝 웃고 있는 해골 조각은 겉보기에도 위협적입니다. 손을 흔들어 운명에게 몸을 맡기라고 유혹합니다. 하시겠습니까?]], "_t")
...
t("Increases all saves by your Shadow Power.", "그림자의 힘에 비례해 모든 내성이 증가합니다.", "_t")
...
t("\"All the better to pierce the heart of the world.\"", "\"세계의 심장을 뚫기에 필요한 모든 것.\"", "_t")
...
t("\"It's a treacherous road to the top of the world.\"", "\"세상의 정점에 오르기까지의 여로는 위험천만하고, 모든 것을 믿을 수 없는 법이다.\"", "_t")
...
t("\"An innocuous bauble. Until you look through the hole.\"", "\"자세히 보기 전까지는 그저 악의 없는 싸구려 보석에 지나지 않는다.\"", "_t")
...
t("\"Wreckage all about you. Is there anything left inside?\"", "\"당신이 파괴한 모든 잔해들. 그 안에 남아있는 게 있기나 하나?\"", "_t")
...
t("A strange orb of demonic origins. It glows with a surreal red light.", "악마적으로 탄생한 기이한 구체. 비현실적인 붉은색으로 빛난다.", "_t")
