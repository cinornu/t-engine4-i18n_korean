...
t("Exploratory Farportal", "탐험용 장거리 관문", nil)
t("FINGER", "FINGER", nil)
...
t("Marus of Elvala", "Marus of Elvala", nil)
...
t("Slavers", "노예", nil)
t("Sorcerers", "주술사", nil)
t("Stire of Derth", "Stire of Derth", nil)
...
t("Undead", "언데드", nil)
t("Ungrol of Last Hope", "Ungrol of Last Hope", nil)
