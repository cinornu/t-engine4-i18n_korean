...
-- This game type pauses the ticking as long as its paused property is true.  
...
-- @classmod engine.GameTurnBased
module(..., package.seeall, class.inherit(engine.GameEnergyBased))

can_pause = true

--- @see engine.GameEnergyBased
-- @param[type=Key] keyhandler
-- @number energy_to_act
-- @number energy_per_tick
