...
--
-- @usage The lang_def parameter is a table that must look like this:
-- {
...
-- }
--
-- The rules field defines how names are generated. Any special character found inside (starting with a $, with an optional number and a character) will be replaced by a random word from one of the lists.<br>
-- $P = syllablesPre<br>
-- $s = syllablesStart<br>
...
--- Generates a name
-- @param rule if not nil this is a generation rule to use instead of a random one
