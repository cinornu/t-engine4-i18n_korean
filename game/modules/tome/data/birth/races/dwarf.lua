...
newBirthDescriptor
{
	...
	cosmetic_options = {
		...
		facial_features = {
			...
			{name=_t"Blond Beard", file="face_beard_blond_01", unlock="cosmetic_race_dwarf_female_beard", only_for={sex="Female"}},
			{name=_t"Redhead Beard", file="beard_redhead_01", unlock="cosmetic_race_dwarf_female_beard", only_for={sex="Female"}},
