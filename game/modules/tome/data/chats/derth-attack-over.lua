...
newChat{ id="welcome",
	text = _t[[#LIGHT_GREEN#*A Halfling comes forth from his hiding place.*#WHITE#
You killed them all? Are we safe now? Oh, please tell me this was a bad dream!]],
	answers = {
		{_t"Be at ease. I have dispatched those monstrosities. Do you know where they came from or what they wanted?", jump="quest"},
	}
}
...
I do not know. I was tending my crop just outside the town when I heard screaming. As I entered the town, I saw the dark cloud over here. Those... those... things were coming from it in blasts of lightning!]],
	answers = {
		{_t"It seems they have stopped coming for now. I will look for somebody who could help dispose of this nefarious cloud.", jump="quest2"},
	}
}

newChat{ id="quest2",
	text = _t[[Thank you! You have saved many people today!
...
There are also those Zigur-something people that claim to fight magic. Why are they not here?!]],
	answers = {
		{_t"You mean the Ziguranth. That would be me.", cond=function(npc, player) return player:isQuestStatus("antimagic", engine.Quest.DONE) end, jump="zigur"},
		{_t"I will not let you down.", action=function(npc, player) player:hasQuest("lightning-overload"):done_derth() end},
	}
}
