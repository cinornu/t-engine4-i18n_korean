...
newChat{ id="welcome",
	text = _t[[#LIGHT_GREEN#*A robed Human is waiting for you when you step out of the portal.*#WHITE#
Well met, @playername@!
...
We have studied his portal research, and if you give me the components I will create the portal for you, here and now!]],
	answers = {
		{_t"Yes, Tannen was not exactly friendly. I thank you for your help. Here are the components. [hand him the diamond and the athame]", action=function(npc, player) player:hasQuest("east-portal"):create_portal(npc, player) end},
	}
}
