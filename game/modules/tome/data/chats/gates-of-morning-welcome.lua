...
newChat{ id="welcome",
	text = _t[[#LIGHT_GREEN#*Before you stands a beautiful woman clad in shining golden armour*#WHITE#
...
newChat{ id="from",
	text = _t[[Maj'Eyal! For many years have we tried to contact your people. We always failed.
In any event, what is your purpose here?]],
	answers = {
		{_t"It seems that I am stranded in these unfamiliar lands. #LIGHT_GREEN#*Tell her about your hunt for orcs and your encounter with Fillarel.*#WHITE#", jump="orcs"},
		{_t"Sun Paladins? What do you mean? We know of no such thing where I come from.", jump="sun-paladins", cond=function() return profile.mod.allow_build.divine_sun_paladin end},
	}
}

newChat{ id="sun-paladins",
	text = _t[[We are the mighty warriors of the Sunwall, channeling the power of the Sun and merging it with martial training.
For hundreds of years, we stood between the Orc Pride and the free people. Our numbers are diminishing, but we will stand firm until our last breath.]],
	answers = {
		{_t"You have a noble spirit, my lady.", jump="from"},
	}
}

newChat{ id="orcs",
	text = _t[[Orcs! Ah! Well then this is your lucky day. This whole continent is swarming with Orcs. They have united as the Orc Pride and, according to rumour, their masters are powerful.
