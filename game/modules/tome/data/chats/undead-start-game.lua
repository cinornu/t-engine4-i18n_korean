...
newChat{ id="welcome",
	text = _t[[#LIGHT_GREEN#*Before you stands a Human clothed in black robes. He seems to be ignoring you.*#WHITE#
...
Oh yes! YES, one more for my collection. My collection, yes. A powerful one indeed!]],
	answers = {
		{_t"[listen]", jump="welcome2"},
	}
}

newChat{ id="welcome2",
	text = _t[[A powerful tool against my enemies. Yes, yes. They all hate me, but I will show them my power!
I will show them! SHOW THEM!]],
	answers = {
		{_t"I am not a tool! RELEASE ME!", jump="welcome3"},
	}
}

newChat{ id="welcome3",
	text = _t[[You cannot talk. You cannot talk! You are a slave, a tool!
