...
newChat{ id="welcome",
	text = _t[[Call forth which ward?]],
	answers = {
		{("Fire [%d]"):tformat(src.wards[DamageType.FIRE] or 0), 
		...
		{("Lightning [%d]"):tformat(src.wards[DamageType.LIGHTNING] or 0),
		...
		{("Cold [%d]"):tformat(src.wards[DamageType.COLD] or 0),
		...
		{("Arcane [%d]"):tformat(src.wards[DamageType.ARCANE] or 0),
		...
		{("Light [%d]"):tformat(src.wards[DamageType.LIGHT] or 0), 
		...
		{("Darkness [%d]"):tformat(src.wards[DamageType.DARKNESS] or 0), 
		...
		{("Temporal [%d]"):tformat(src.wards[DamageType.TEMPORAL] or 0), 
		...
		{("Physical [%d]"):tformat(src.wards[DamageType.PHYSICAL] or 0), 
		...
		{("Nature [%d]"):tformat(src.wards[DamageType.NATURE] or 0), 
		...
		{("Blight [%d]"):tformat(src.wards[DamageType.BLIGHT] or 0), 
		...
		{("Acid [%d]"):tformat(src.wards[DamageType.ACID] or 0), 
		...
		{("Mind [%d]"):tformat(src.wards[DamageType.MIND] or 0), 
