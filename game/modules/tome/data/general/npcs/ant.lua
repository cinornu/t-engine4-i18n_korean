...
newEntity{ base = "BASE_NPC_ANT",
	...
	desc = _t"It's a large white ant.",
...
newEntity{ base = "BASE_NPC_ANT",
	...
	desc = _t"It's a large brown ant.",
	level_range = {1, 15}, exp_worth = 1,
	rarity = 1,
...
newEntity{ base = "BASE_NPC_ANT",
	...
	desc = _t"It's a large black ant with huge mandibles.",
...
newEntity{ base = "BASE_NPC_ANT",
	...
	desc = _t"It's a large green ant.",
...
newEntity{ base = "BASE_NPC_ANT",
	...
	desc = _t"It's a large yellow ant.",
	level_range = {5, nil}, exp_worth = 1,
	rarity = 1,
...
newEntity{ base = "BASE_NPC_ANT",
	...
	desc = _t"It's a large black ant.",
	level_range = {5, nil}, exp_worth = 1,
	rarity = 1,
...
newEntity{ base = "BASE_NPC_ANT",
	...
	desc = _t"It's a large red ant, wreathed in flames.",
...
newEntity{ base = "BASE_NPC_ANT",
	...
	desc = _t"It's a large white ant. The air is frigid around it.",
	level_range = {15, nil}, exp_worth = 1,
	rarity = 1,
	max_life = resolvers.rngavg(20,40),
...
newEntity{ base = "BASE_NPC_ANT",
	...
	desc = _t"It's a large yellow ant with sparks arcing across its body.",
	level_range = {15, nil}, exp_worth = 1,
	rarity = 1,
	max_life = resolvers.rngavg(20,40),
	combat = { damtype=DamageType.LIGHTNING },
...
newEntity{ base = "BASE_NPC_ANT",
	...
	desc = _t"It's a large black ant.  Its porous skin oozes acid.",
	level_range = {15, nil}, exp_worth = 1,
	rarity = 1,
	max_life = resolvers.rngavg(20,40),
	combat = { damtype=DamageType.ACID },
...
newEntity{ base = "BASE_NPC_ANT",
	...
	desc = _t"It's a large ant with a heavy exoskeleton, geared for war.",
