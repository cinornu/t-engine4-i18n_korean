...
newEntity{ base = "BASE_NPC_AQUATIC_CRITTER",
	...
	desc = _t"A snake-like being, moving toward you.",
...
newEntity{ base = "BASE_NPC_AQUATIC_CRITTER",
	...
	desc = _t"A snake-like being, radiating electricity.",
	level_range = {1, nil}, exp_worth = 1,
	rarity = 4,
...
newEntity{ base = "BASE_NPC_AQUATIC_CRITTER",
	...
	desc = _t"A huge, elongated sea-green reptile.",
	level_range = {1, nil}, exp_worth = 1,
	rarity = 5,
	rank = 2,
...
newEntity{ base = "BASE_NPC_AQUATIC_CRITTER",
	...
	desc = _t"A huge, elongated sea-green reptile, it looks old and impenetrable.",
...
newEntity{ base = "BASE_NPC_AQUATIC_CRITTER",
	...
	desc = _t"Darting its many tentacles toward you, it tries to lock you down.",
	level_range = {1, nil}, exp_worth = 1,
	rarity = 1,
...
newEntity{ base = "BASE_NPC_AQUATIC_CRITTER",
	...
	desc = _t"Darting its many tentacles toward you, it tries to blind you with its murky ink.",
	level_range = {1, nil}, exp_worth = 1,
	rarity = 2,
	stats = { mag=30, },
