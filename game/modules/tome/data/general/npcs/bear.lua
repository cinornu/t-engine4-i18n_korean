...
newEntity{ base = "BASE_NPC_BEAR",
	...
	desc = _t[[The weakest of bears, covered in brown shaggy fur.]],
...
newEntity{ base = "BASE_NPC_BEAR",
	...
	desc = _t[[Do you smell like honey? 'Cause this bear wants honey.]],
...
newEntity{ base = "BASE_NPC_BEAR",
	...
	desc = _t[[It has come down from its cave foraging for food. Unfortunately, it found you.]],
...
newEntity{ base = "BASE_NPC_BEAR",
	...
	desc = _t[[Bears with tusks, trained to kill.]],
	level_range = {7, nil}, exp_worth = 1,
	rarity = 3,
...
newEntity{ base = "BASE_NPC_BEAR",
	...
	desc = _t[[A huge, beastly bear, more savage than most of its kind.]],
...
newEntity{ base = "BASE_NPC_BEAR",
	...
	desc = _t[[This huge white bear has wandered south in search of food.]],
