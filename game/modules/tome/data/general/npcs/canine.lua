...
newEntity{ base = "BASE_NPC_CANINE",
	...
	desc = _t[[Lean, mean, and shaggy, it stares at you with hungry eyes.]],
...
newEntity{ base = "BASE_NPC_CANINE",
	...
	desc = _t[[Larger than a normal wolf, it prowls and snaps at you.]],
...
newEntity{ base = "BASE_NPC_CANINE",
	...
	desc = _t[[Easily as big as a horse, this wolf menaces you with its claws and fangs.]],
...
newEntity{ base = "BASE_NPC_CANINE",
	...
	desc = _t[[A large and muscled wolf from the northern wastes. Its breath is cold and icy, and its fur coated in frost.]],
	level_range = {4, nil}, exp_worth = 1,
	rarity = 3,
...
newEntity{ base = "BASE_NPC_CANINE",
	...
	desc = _t[[It is a large wolf with eyes full of cunning.]],
...
newEntity{ base = "BASE_NPC_CANINE",
	...
	desc = _t[[The quick brown fox jumps over the lazy dog.]],
