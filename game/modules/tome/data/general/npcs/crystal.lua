...
newEntity{ name = "wisp",
	...
	desc = _t[[A floating orb of magical energy. It shines with a radiant light. They explode upon contact.]],
...
newEntity{ base = "BASE_NPC_CRYSTAL",
	...
	desc = _t"A formation of red crystal. It emits bright red, scorching light.",
...
newEntity{ base = "BASE_NPC_CRYSTAL",
	...
	desc = _t"A formation of white crystal. It emits bright white, chilling light.",
	level_range = {1, nil}, exp_worth = 1,
	rarity = 1,
...
newEntity{ base = "BASE_NPC_CRYSTAL",
	...
	desc = _t"A formation of black crystal. It absorbs all light around it.",
...
newEntity{ base = "BASE_NPC_CRYSTAL",
	...
	desc = _t"A formation of crimson crystal. It emits a crimson light reminiscent of blood.",
	level_range = {3, nil}, exp_worth = 1,
	rarity = 3,
...
newEntity{ base = "BASE_NPC_CRYSTAL",
	...
	desc = _t"A formation of blue crystal. Its light shines like the ocean's waves.",
	level_range = {3, nil}, exp_worth = 1,
	rarity = 4,
...
newEntity{ base = "BASE_NPC_CRYSTAL",
	...
	shader = "quad_hue",
	desc = _t"A formation of multi-hued crystal. It shines with all the colors of the rainbow.",
...
newEntity{ base = "BASE_NPC_CRYSTAL",
	...
	shader = "quad_hue",
	desc = _t"A formation of shimmering crystal. Orbs of light circle around it.",
	level_range = {10, nil}, exp_worth = 1,
	rarity = 5,
	resists = { [DamageType.LIGHT] = 100 },
