...
newEntity{ base = "BASE_NPC_CAT",
	...
	desc = _t[[A large cat with a grey fur matted with black.]],
...
newEntity{ base = "BASE_NPC_CAT",
	...
	desc = _t[[A large black cat, slender and muscular.]],
...
newEntity{ base = "BASE_NPC_CAT",
	...
	desc = _t[[A truly magnificent beast, with fur striped black and yellow.]],
...
newEntity{ base = "BASE_NPC_CAT",
	...
	desc = _t[[This cat is simply enormous, and has fangs with the size and sharpness of short swords.]],
