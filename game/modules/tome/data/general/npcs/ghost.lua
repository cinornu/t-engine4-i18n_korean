...
newEntity{ base = "BASE_NPC_GHOST",
	...
	desc = _t[[It is an unlife of power almost unequaled. An affront to existence, its very touch abuses and disrupts the flow of life, and its unearthly limbs, of purest black, crumble rock and wither flesh with ease.]],
...
newEntity{ base = "BASE_NPC_GHOST",
	...
	desc = _t[[It is a ghostly woman's form that wails mournfully.]],
...
newEntity{ base = "BASE_NPC_GHOST",
	...
	desc = _t[[A vengeful, screaming soul given form with the breath of Urh'Rok himself. The vapors of the Fearscape seep from its dimension-bending form, withering and searing.]],
