...
newEntity{ base = "BASE_NPC_JELLY",
	...
	desc = _t"A strange green blob on the dungeon floor.",
...
newEntity{ base = "BASE_NPC_JELLY",
	...
	desc = _t"A strange red blob on the dungeon floor.",
	level_range = {1, 25}, exp_worth = 1,
	rarity = 1,
	max_life = resolvers.rngavg(5,9),
...
newEntity{ base = "BASE_NPC_JELLY",
	...
	desc = _t"A strange blue blob on the dungeon floor.",
	level_range = {1, 25}, exp_worth = 1,
	rarity = 1,
	max_life = resolvers.rngavg(5,9),
...
newEntity{ base = "BASE_NPC_JELLY",
	...
	desc = _t"A strange white blob on the dungeon floor.",
	level_range = {1, 25}, exp_worth = 1,
	rarity = 1,
	max_life = resolvers.rngavg(5,9),
...
newEntity{ base = "BASE_NPC_JELLY",
	...
	desc = _t"A strange yellow blob on the dungeon floor.",
	level_range = {1, 25}, exp_worth = 1,
	rarity = 1,
	max_life = resolvers.rngavg(5,9),
...
newEntity{ base = "BASE_NPC_JELLY",
	...
	desc = _t"A strange black blob on the dungeon floor.",
	level_range = {1, 25}, exp_worth = 1,
	rarity = 1,
	max_life = resolvers.rngavg(5,9),
