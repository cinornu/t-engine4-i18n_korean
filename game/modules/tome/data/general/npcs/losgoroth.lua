...
newEntity{
	...
	desc = _t[[Losgoroth are mighty void elementals, native to the void between the stars. They are rarely seen on a planet's surface.]],
...
newEntity{ base = "BASE_NPC_LOSGOROTH",
	...
	desc = _t[[Manaworms are losgoroth which feed on the mana of arcane users. If they ever come in contact with a spellcaster, they latch on and start draining mana away.]],
	rarity = 3,
	max_life = resolvers.rngavg(40,60),
	movement_speed = 0.7,
	combat_armor = 0, combat_def = 20,
