...
newEntity{ base = "BASE_NPC_MAJOR_DEMON",
	...
	desc = _t"A monstrous demon, covered in acidic thorns.",
...
newEntity{ base = "BASE_NPC_MAJOR_DEMON",
	...
	desc = _t[[This demon would look like a minotaur, if a minotaur had a fiery aura surrounding it and horns all over its body.
...
newEntity{ base = "BASE_NPC_MAJOR_DEMON",
	...
	desc = _t[[This terrible demon is covered in blood, which flows *on* its skin in ever-changing patterns that disturb you simply when looking at it.]],
	level_range = {35, nil}, exp_worth = 1,
	rarity = 4,
	rank = 3,
...
newEntity{ base = "BASE_NPC_MAJOR_DEMON",
	...
	desc = _t[[You can only guess at the real shape of this demon. Its body is surrounded by a cloud of fiery darkness.
...
newEntity{ base = "BASE_NPC_MAJOR_DEMON",
	...
	desc = _t[[A burning giant wielding a forge hammer of the underworld in each hand -- weapons imbued by Urh'Rok himself with the power to crush and shape felsteel. Enter their range at your peril.]],
