...
newEntity{
	...
	desc = _t"A strange growth on the dungeon floor.",
	body = { INVEN = 10 },
	autolevel = "warrior",
...
newEntity{ base = "BASE_NPC_MOLD",
	...
	desc = _t"A strange grey growth on the dungeon floor.",
...
newEntity{ base = "BASE_NPC_MOLD",
	...
	desc = _t"A strange brown growth on the dungeon floor.",
...
newEntity{ base = "BASE_NPC_MOLD",
	...
	desc = _t"A strange luminescent growth on the dungeon floor.",
...
newEntity{ base = "BASE_NPC_MOLD",
	...
	desc = _t"A strange sickly green growth on the dungeon floor.",
...
newEntity{ base = "BASE_NPC_MOLD",
	...
	desc = _t[[Steeped in fungal malevolence, this mold refused to die.  How a mold becomes a skeleton, though, is beyond you.  Are those its own bones, or the bones of hapless adventurers?]],
