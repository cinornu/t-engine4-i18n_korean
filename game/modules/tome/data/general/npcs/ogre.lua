...
newEntity{ base = "BASE_NPC_OGRE",
	...
	desc = _t[[A maul-wield ogre. Ready to CRUSH!]],
...
newEntity{ base = "BASE_NPC_OGRE",
	...
	desc = _t[[A master of combat, she is impatient to test her newfound skills.]],
...
newEntity{ base = "BASE_NPC_OGRE",
	...
	desc = _t[[This ogre closes in fast on you, arms open for the hug of death.]],
	resolvers.nice_tile{tall=1},
	level_range = {20, nil}, exp_worth = 1,
	rarity = 3,
	rank = 3,
...
newEntity{ base = "BASE_NPC_OGRE",
	...
	desc = _t[[A towering ogre guard, her skin covered in runes and arcane designs.]],
	female = 1,
	resolvers.nice_tile{tall=1},
