...
newEntity{
	...
	desc = _t"It's colorful and it's oozing.",
...
newEntity{ base = "BASE_NPC_OOZE",
	...
	desc = _t"It's green and it's oozing.",
...
newEntity{ base = "BASE_NPC_OOZE",
	...
	desc = _t"It's red and it's oozing.",
	level_range = {1, 25}, exp_worth = 1,
	rarity = 1,
	max_life = resolvers.rngavg(5,9),
...
newEntity{ base = "BASE_NPC_OOZE",
	...
	desc = _t"It's blue and it's oozing.",
	level_range = {1, 25}, exp_worth = 1,
	rarity = 1,
	max_life = resolvers.rngavg(5,9),
...
newEntity{ base = "BASE_NPC_OOZE",
	...
	desc = _t"It's white and it's oozing.",
	level_range = {1, 25}, exp_worth = 1,
	rarity = 1,
	max_life = resolvers.rngavg(5,9),
...
newEntity{ base = "BASE_NPC_OOZE",
	...
	desc = _t"It's yellow and it's oozing.",
	level_range = {1, 25}, exp_worth = 1,
	rarity = 1,
	max_life = resolvers.rngavg(5,9),
...
newEntity{ base = "BASE_NPC_OOZE",
	...
	desc = _t"It's black and it's oozing.",
	level_range = {1, 25}, exp_worth = 1,
	rarity = 1,
	max_life = resolvers.rngavg(5,9),
...
newEntity{ base = "BASE_NPC_OOZE",
	...
	desc = _t[[It is a strange, vast gelatinous structure that assumes cubic proportions as it lines all four walls of the corridors it patrols.
...
newEntity{ base = "BASE_NPC_OOZE",
	...
	desc = _t"It's reddish and it's oozing.",
...
newEntity{ base = "BASE_NPC_OOZE",
	...
	blood_color = colors.WHITE,
	desc = _t"It's translucent and it's oozing.",
	level_range = {25, nil}, exp_worth = 1,
	rarity = 10,
	rank = 2,
...
newEntity{ base = "BASE_NPC_OOZE",
	...
	blood_color = colors.GREEN,
	desc = _t"It's very slimy and it's oozing.",
	level_range = {25, nil}, exp_worth = 1,
	rarity = 1,
	rank = 2,
	max_life = resolvers.rngavg(80,90), life_rating = 11,
