...
newEntity{
	...
	desc = _t"A not-so-strange growth on the dungeon floor.",
	body = { INVEN = 10 },
	autolevel = "warrior",
...
newEntity{ base = "BASE_NPC_PLANT",
	...
	desc = _t"This flesh-eating plant has grown to enormous proportions and seeks to quell its hunger.",
...
newEntity{ base = "BASE_NPC_PLANT",
	...
	desc = _t"This harmless little plant makes you all itchy.",
...
newEntity{ base = "BASE_NPC_PLANT",
	...
	desc = _t"As you approach it, you hear a high-pitched buzzing sound.",
