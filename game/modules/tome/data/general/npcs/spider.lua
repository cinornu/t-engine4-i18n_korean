...
newEntity{ base = "BASE_NPC_SPIDER",
	...
	desc = _t[[A huge arachnid, it produces even bigger webs.]],
...
newEntity{ base = "BASE_NPC_SPIDER",
	...
	desc = _t[[A huge arachnid, it sprays venom at its prey.]],
...
newEntity{ base = "BASE_NPC_SPIDER",
	...
	desc = _t[[A huge arachnid with a massive exoskeleton.]],
...
newEntity{ base = "BASE_NPC_SPIDER",
	...
	desc = _t[[These cunning spiders terrorize those who enter the ever-growing borders of their lairs.  Those who encounter them rarely return.]],
...
newEntity{ base = "BASE_NPC_SPIDER",
	...
	desc = _t[[The air reeks with noxious fumes and the ground around it decays.]],
	level_range = {27, nil}, exp_worth = 1,
	rarity = 3,
	max_life = 120,
	life_rating = 13,
...
newEntity{ base = "BASE_NPC_SPIDER",
	...
	desc = _t[[This spider seems to command the flow of mana, which pulses freely through its body.]],
	level_range = {27, nil}, exp_worth = 1,
	rarity = 4,
	max_life = 120,
	max_mana = 380,
...
newEntity{ base = "BASE_NPC_SPIDER",
	...
	desc = _t[[Largest of all the spiderkin, its folds of skin seem nearly impenetrable.]],
...
newEntity{ base = "BASE_NPC_SPIDER",
	...
	desc = _t[[The air seems to freeze solid around this frigid spider.]],
	level_range = {27, nil}, exp_worth = 1,
	rarity = 4,
	max_life = 120,
	life_rating = 14,
...
newEntity{ base = "BASE_NPC_SPIDER",
	...
	desc = _t[[A tiny arachnid that phases in and out of reality.]],
	level_range = {7, nil}, exp_worth = 1,
...
newEntity{ base = "BASE_NPC_SPIDER",
	...
	desc = _t[[A large blue arachnid with white markings on its thorax.  It shifts and shimmers as though only partially connected to the timeline.]],
	level_range = {27, nil}, exp_worth = 1,
...
newEntity{ base = "BASE_NPC_SPIDER",
	...
	desc = _t[[A large dark blue arachnid with a shifting yellow and white pattern on its thorax.  It shifts and shimmers as though only partially connected to the timeline.]],
	level_range = {38, nil}, exp_worth = 1,
