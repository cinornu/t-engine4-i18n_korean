...
newEntity{ base = "BASE_NPC_TROLL",
	...
	desc = _t[[A giant troll with scabrous black skin. With a shudder, you notice the belt of dwarf skulls around his massive waist.]],
...
newEntity{ base = "BASE_NPC_TROLL",
	...
	desc = _t[[This huge troll wields a massive spear and has a disturbingly intelligent look in its piggy eyes.]],
...
newEntity{ base = "BASE_NPC_TROLL",
	...
	desc = _t[[A large and athletic troll with an extremely tough and warty hide.]],
...
newEntity{ base = "BASE_NPC_TROLL",
	...
	desc = _t[[A disgusting and mismatched construct of necromantically-enhanced troll bits and shattered weapons. Confused and furious, it rends and shatters its surroundings with impossible strength, moving with speed found nowhere in nature.]],
...
newEntity{ base = "BASE_NPC_TROLL", unique=true,
	...
	resolvers.nice_tile{tall=1},
	desc = _t[[This old-looking troll glares at you with malice. His muscles appear atrophied, but a certain power surrounds him nonetheless.]],
