...
newEntity{
	...
	display = "~",
	desc = _t[[Light up the dark places of the world!]],
...
newEntity{ base = "BASE_LITE",
	...
	desc = _t[[A brass container with a wick emerging from it, protected from draughts by a sheet of greased paper. It can be carried by a handle.]],
	level_range = {1, 20},
	rarity = 7,
	encumber = 2,
	cost = 0.5,
...
newEntity{ base = "BASE_LITE",
	...
	desc = _t[[A normal brass lantern, enhanced by alchemy to make it brighter.]],
	level_range = {20, 35},
	rarity = 10,
	encumber = 1,
	cost = 3,
...
newEntity{ base = "BASE_LITE",
	...
	desc = _t[[Made by the Dwarves, this lantern provides light in the darkest recesses of the earth.]],
	level_range = {35, 50},
	rarity = 12,
	encumber = 1,
	cost = 4,
