...
newLore{
	id = "dreadfell-note-1",
	category = "dreadfell",
	name = _t"note from the Master",
	lore = _t[[MINIONS: Perhaps you feel your Master has been lax or absent? Well, I shall amend that. I have been studying an object of great import. It is of much greater interest than your foolish unlives. But do not think that I will let you get away with things because of this.
...
newLore{
	...
	category = "dreadfell",
	name = _t"note from the Master",
	lore = _t[[MINIONS: Be aware, I your great Master have found an item. It is of extreme power, but not yet complete, at least for my purposes.
...
newLore{
	...
	category = "dreadfell",
	name = _t"note from the Master",
	lore = _t[[MINIONS: To my newest vampire: burn, foolish adventurer, burn! I bet you are sorry for that flame spell now, aren't you? Suffer as I revisit it upon you.
...
newLore{
	...
	category = "dreadfell",
	name = _t"A smudged poem chalked on a dark piece of slate",
	lore = _t[[Master of life, Master of death,
All fall to a word
...
newLore{
	...
	category = "dreadfell",
	name = _t"A poem written in scribbled, child-like writing",
	lore = _t[[Me like Master,
He's a real laster,
He is faster
than a caster,
Can bring disaster,
...
newLore{
	...
	category = "dreadfell",
	name = _t"A poem written in an elegant Gothic script",
	lore = _t[[No staff will save thee
...
newLore{
	...
	category = "dreadfell",
	name = _t"a note about undead poetry from the Master",
	lore = _t[[As an aside, I notice one of my skeletons has amused himself by writing a poem about me. Whilst my first reaction was to have his bones crunched into dust and what remained of his undead soul sent to the darkest depths of the abyss, I do now realise that there is some merit to this. Every great leader needs tales penned of his brilliant conquest. Therefore I now command you all to write more poetry in my honour, praising my amazing powers, unrivalled leadership, unconquerable strength, etc etc. Any that fail to produce works of sufficient standard shall be annihilated.]],
}
...
newLore{
	...
	category = "dreadfell",
	name = _t"a letter to Aletta from the Master",
	lore = _t[[Ah, sweet Aletta! How rich your blood tasted on my lips! I know it's not quite what you were expecting from the next step in our relationship, but aren't surprises the true joy of any romance?
