...
newLore{
	...
	category = "fearscape",
	name = _t"sacrificial altar", always_pop = true,
	image = "kryl_feijan_sacrificial_altar.png",
	lore = _t[[You see a female human lying unconscious on a black altar, twisted sigils scored into her naked flesh.
