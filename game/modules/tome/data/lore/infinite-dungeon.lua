...
newLore{
	...
	name = _t"clue (ruined dungeon)", always_pop = true,
	lore = _t[[There is an inscription here:
...
newLore{
	...
	category = "ruined dungeon",
	name = _t"infinite dungeon (ruined dungeon)", always_pop = true,
	lore = _t[[There is an inscription here:
...
newLore{
	...
	category = "infinite dungeon",
	name = _t"The Hunter and the Hunted chapter 3",
	lore = _t[[Branzir returned to his people, and continued the hunt for the other gods, till but one god remained: Amakthel. Then the last great Godhunt began, as the Sher'Tul fought to overcome their maker and master. And this was no easy feat, for Amakthel was by far the strongest of all the gods, and many Sher'Tul were still loyal to their creator. Much blood was spilled before ever the assault on his throne could begin, and much blood would spill still after.
...
newLore{
	...
	category = "infinite dungeon",
	name = _t"The Hunter and the Hunted chapter 4",
	lore = _t[[Seeing the full powers of the Sher'Tul Ralkur felt paralysed with fear, and thought his quest for vengeance hopeless. But he bided his time still, and his patience was rewarded as he saw dissention begin to arise in the great race. When Caldizar disappeared and the Godslayers separated he felt his time was ripe, and he came upon the forest keep of Branzir under a storm of wrath. He flew down screeching, and spreading his wings he let loose spikes of steel that rained down on the keep, cutting through wood and stone and flesh. All who were in the keep were killed, and the air was filled with Ralkur's cackling laughter as he flew away.
