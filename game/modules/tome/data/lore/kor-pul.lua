...
newLore{
	id = "kor-pul-note-1",
	category = "kor'pul",
	name = _t"journal page (kor'pul)",
	lore = _t[[Damn that Zemekkys! Damn his insane experiments!! Why in the blackest night did I ever agree to take part in them?!
...
newLore{
	...
	category = "kor'pul",
	name = _t"journal page (kor'pul)",
	lore = _t[[Aha, I have found the accursed undead that plague this nefarious dungeon! The skeletal fool was thankfully no match for me! I suppose it helped that he had no arms...
...
newLore{
	...
	category = "kor'pul",
	name = _t"journal page (kor'pul)",
	lore = _t[[This place is infested! I've found a lot of skeletons now, and unfortunately most of them have borne a full set of limbs. However, my holy quest cannot be denied! Plus I got a really great sword off one of the blighters, I can chop anything up easily now!
...
newLore{
	...
	category = "kor'pul",
	name = _t"journal page (kor'pul)",
	lore = _t[[It's quiet down here. And dark... very dark. I suppose I should have brought a lantern. Our motto is to bring light into dark places, but I guess I should have thought about that in practical terms. I've cleared out pretty much all of this area, and there's not much left to explore beyond this last room.
