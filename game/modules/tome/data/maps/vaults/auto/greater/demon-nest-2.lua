...
roomCheck(function(room, zone, level, map)
	return resolvers.current_level >= 25 and zone.npc_list.__loaded_files["/data/general/npcs/minor-demon.lua"] and zone.npc_list.__loaded_files["/data/general/npcs/major-demon.lua"] and zone.npc_list.__loaded_files["/data/general/npcs/horror.lua"]
end)
specialList("terrain", {
