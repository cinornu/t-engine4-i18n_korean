...
name = _t"Serpentine Invaders"
desc = function(self, who)
	local desc = {}
	desc[#desc+1] = _t"Nagas are invading the slazish fens. The Sunwall cannot fight on two fronts; you need to stop the invaders before it is too late.\n Locate and destroy the invaders' portal."
	if self:isCompleted("slazish") then
		desc[#desc+1] = _t"#LIGHT_GREEN#* You have destroyed the naga portal. The invasion is stopped.#WHITE#"
		...
		desc[#desc+1] = _t"#SLATE#* You must stop the nagas.#WHITE#"
	end
