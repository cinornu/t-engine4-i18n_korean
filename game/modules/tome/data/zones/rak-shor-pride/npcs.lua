...
newEntity{ base="BASE_NPC_ORC_RAK_SHOR", define_as = "RAK_SHOR",
	...
	resolvers.talents{
		...
		[Talents.T_NECROTIC_AURA]={base=4, every=5, max=7},
		...
		[Talents.T_DISCARDED_REFUSE]={base=4, every=5, max=7},
		[Talents.T_CORPSE_EXPLOSION]={base=4, every=5, max=7},
		[Talents.T_ASSEMBLE]={base=4, every=5, max=7},
		[Talents.T_PUTRESCENT_LIQUEFACTION]={base=4, every=5, max=7},
...
newEntity{ base = "BASE_NPC_GHOST", define_as = "GLACIAL_LEGION",
	...
	resolvers.talents{
		...
		[Talents.T_BLACK_ICE]={base=5, every=5, max=10},
