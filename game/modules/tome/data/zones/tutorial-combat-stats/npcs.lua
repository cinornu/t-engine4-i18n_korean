...
newEntity{ define_as = "TUT_GUIDE",
	...
	desc = _t[[A pitchfork-wielding human with a welcoming smile.]],
...
newEntity{ base = "BASE_NPC_ORC",
	...
	--desc = _t[[He is a hardy, well-weathered survivor.]],
	level_range = {1, nil}, exp_worth = 1,
	max_life = 100,
--	resolvers.equip{
...
newEntity{ base = "BASE_NPC_ELVEN_CASTER",
	...
	desc = _t[[An elf that looks as though he spends a good amount of his time wiggling his fingers and chanting.]],
	level_range = {1, nil}, exp_worth = 1,
	rarity = 1,
	mana_regen = 20,
	positive_regen = 20,
...
newEntity{ base = "BASE_TUTORIAL_SPIDER",
	...
	desc = _t[[A huge, chittering arachnid.]],
	level_range = {1, nil}, exp_worth = 1,
	rarity = 1,
	max_life = 100,
	life_regen = 50,
