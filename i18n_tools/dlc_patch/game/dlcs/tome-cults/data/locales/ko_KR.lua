...
My first instinct was to lead a charge into the crag and cleanse this terrible place, but I knew this would be a mistake. It will pain all of us deeply to not take action now, but there is no sense in throwing our lives away. For now, we must establish camp and observe this threat.]], [[드워프 산맥의 산기슭 근처에 마법적인 일탈이 있다는 보고가 우리 형제들 사이에 종종 있었다. 오늘날까지는 우리는 그 근원을 추적할 수 없었다. 사령술사나 다른 형태의 비전 마법 사용자들의 악취 나는 거처를 발견할거라고 생각했었는데...우리가 발견한 것은 전에 본 그 어떤 것과도 다른 흉물이었다.
