...
Each swing drips pustulant fluid before it, and each droplet writhes and wriggles in the air before splashing against the ground.]], [[불룩한 형태의 썩은 로브는 솔기가 모두 찢어진 것같다. 이 끔찍한 존재가 움직일 때마다 부풀어오른 벌레 떼들이 몸 여기저기서 쏟아저 나온다. 2 개의 팔 같은, 점액질로 끈적한 구더기의 부속지가 담즘이 흘러나오는 전투 도끼의 손잡이 부분을 꽉 쥐고있다.
무기를 휘두루면, 고름이 뚝뚝 흘러내린다. 그 작은 방울 하나 하나는 땅바닥에 닿기 전에 무수히 많이 꿈틀거린다.]], "_t")
...
t("Caught in a slimy tendril, reducing all damage by %d%%.", "가하는 피해량 -%d%%.", "tformat")
...
t("Caught disgusting worms, reducing all damage by %d%%.", "가하는 피해량 -%d%%.", "tformat")
...
t("Linked to their horror ally gaining %d%% all damage resistance.", "모든 피해 저항 +%d%%.", "tformat")
...
t("Terrified of the horror duo attacking them reducing defense and spell save by %d.", "회피도, 주문 내성 -%d.", "tformat")
...
t("The victim in your stomach seems to still be alive: '#CRIMSON#%s'", "당신 뱃속의 희생양은 아직 살아있는 것 같다: '#CRIMSON#%s'", "logPlayer")
...
t("Blood and gore cover the target, dealing %0.2f darkness damage and %0.2f blight damage per disease.", "질병 하나 당 %0.2f 암흑 피해와 %0.2f 황폐 피해 받음.", "tformat")
...
t("Target briefly saw what True Horror means, deeply scaring it. %d%% chances to fail using a talent.", "%d%% 확률로 기술 사용 실패.", "tformat")
...
t("Empowered by the fear of its foes, darkness and blight damage penetration increased by %d%%.", "암흑, 황폐 저항 관통 +%d%%.", "tformat")
...
t("Half turned to stone, reducing movement speed by %d%% and 35%% chances to shatter on damage, increasing damge taken by %d%%.", "이동 속도 -%d%% / 피격 시 35%% 확률로 부서저내려, %d%% 의 추가 피해를 입음.", "tformat")
...
t("Split", "분열", "_t")
t("Faded from time, reducing damage taken by %d%% and all damage dealt by %d%%.", "받는 피해량 -%d%% 가하는 피해량 -%d%%.", "tformat")
...
t("The target is being driven mad by the void, taking %0.2f darkness damage per turn and reducing all powers by %d.", "매 턴 %0.2f 암흑 피해 받음 / 물리력, 주문력, 사고력 -%d.", "tformat")
...
t("The target is being distracted by a hallucination, reducing all damage dealt to non-hallucinations targets by %d%%.", "환각이 아닌 대상에게 주는 피해 -%d%%.", "tformat")
t("Cacophony", "불협화음", "_t")
t("The target is overwhelmed by voices from the void, giving them a 20%% higher chance to spawn hallucinations from Dark Whispers and causing them to take an additional %d%% temporal damage from Dark Whispers and Hideous Visions.", "어둠의 속삭임으로 인한 환각 생성 확률 +20%% / 어둠의 속삭임과 흉측한 광경으로 주는 피해량에 %d%% 시간 피해 추가.", "tformat")
...
t("The target is wasting away from entropic forces, taking %0.2f damage per turn.", "매 턴 %0.2f 피해를 입음.", "tformat")
...
t("#{bold}##RED#%s loses %d health and is almost overcome by the entropy!#{normal}##LAST##", "#{bold}##RED#%s %d 생명력을 엔트로피 반발로 인해 잃었고, 엔트로피에 삼켜지려한다!#{normal}##LAST##", "logSeen", nil, {"는"})
t("Entropic Gift", "엔트로피의 선물", "_t")
t("The full force of entropy has been brought to bear on the target, inflicting %0.2f darkness and %0.2f temporal damage each turn.", "매 턴 %0.2f 암흑 피해와 %0.2f 시간피해 받음.", "tformat")
...
t("The target is doomed to madness. All talent cooldowns are increased by %d%%.", "모든 기술의 재사용 대기시간 +%d%%.", "tformat")
...
t("The target is doomed to ruin.  On falling below 75%%, 50%% or 25%% life all enemies in radius %d will take %0.2f darkness damage", "생명력이 75%%, 50%%, 25%% 이하로 떨어지면, 반경 %d 칸 내의 적들이 %0.2f 암흑 피해를 입음", "tformat")
t("#Target# is doomed to ruin!", "#Target2# 파멸로 인해 끝장날 것이라는 예언을 들었다!", "_t")
t("+Prophecy of Ruin", "+파멸의 예언", "_t")
t("-Prophecy of Ruin", "-파멸의 예언", "_t")
t("Prophecy of Treason", "배반의 예언", "_t")
t("The target is doomed to treason. Each turn they have a %d%% chance to attack an adjacent creature.  If no creatures are adjacent they will attack themself.", "%d%% 확률로 인접한 적을 공격함. 아무도 없을 경우 자해함.", "tformat")
...
t("When this target is damaged %d%% of the damage will also be done to the source of this effect.", "피격 시 피해량의 %d%% 가 이 지속 효과의 부여자에게도 가해집니다.", "tformat")
...
This effect will fade in 2 turns if the source is not in line of sight.]], [[부정적인 효과들의 지속시간, 이로운 효과의 지속시간을 각각 %d%% 연장, 단축.
...
This effect will fade in 2 turns if the source is not in line of sight.]], [[모든 능력치 -%d
이 효과는 효과 부여자의 시선에서 2 턴 동안 사라지면 즉시 중단됨.]], "tformat")
...
t("-Accelerate", "-가속", "_t")
t("The target is removed from the normal time stream, unable to act but unable to take any damage. Each turn, beneficial effects decrease in duration.", "행동 불가 / 피해 면역 / 매 턴 이로운 효과의 지속시간이 단축됨.", "_t")
t("Suspend", "유보", "_t")
t("The target is removed from the normal time stream, unable to act but unable to take any damage. Each turn, negative effects and cooldowns will decrease in duration.", "행동 불가 / 피해 면역 / 매 턴 부정적인 효과의 지속시간과 재사용 대기시간이 단축됨.", "_t")
...
t("The target is being erased from reality. Each time a magical effect is applied, they will take %0.2f darkness damage and %0.2f temporal damage. If 5 effects are applied, a powerful void horror will appear.", "마법 효과가 적용될 시, %0.2f 암흑 피해와 %0.2f 시간 피해를 입음 / 효과가 5 개 적용되면, 강력한 소멸의 전령이 나타남.", "tformat")
...
t("The target has tied itself to the fate of another. If it dies, it's chosen target will die in it's place and it will be healed by %d for each stack of Fortune and Jinx.", "운명에 묶여있음. 효과 부여자가 죽을 경우, 선택된 희생자가 그 대신 죽게되고, 효과 부여자는 불운과 행운 중첩마다 생명력을 %d 회복함.", "tformat")
...
t("The target is infected by a disease, reducing its speed by %d%% and doing %0.2f blight damage per turn.", "전체 속도 -%d%% / 매 턴 %0.2f 황폐 피해 입음.", "tformat")
...
t("Covered in defiled blood, healing the source for %d%% of all damage done.", "가하는 피해의 %d%% 가 효과 부여자의 생명력을 회복.", "tformat")
...
t("Inside Forbidden Tome: \"Home, Horrific Home\" for %d turns.", "금지된 고서 속: \"집, 끔찍한 집\" for %d turns.", "tformat")
...
t("Your body can not function properly here, it is slowly wasting away. Each turn you take %0.2f void damage and any new debuff on you lasts %d%% longer. Each turn those penalties increase until the effect is removed.", "매 턴 %0.2f 공허 피해 받음 / 새로 받는 부정적인 효과의 지속시간이 %d%% 연장됨. 이 효과가 사라지기 전까지, 이 불이익은 점점 커짐.", "tformat")
...
t("Nasty glass splinters that make you bleed, doing %0.2f arcane damage per turn. Deals %0.2f arcane damage on move. Talents have %d%% chances to fail.", "매 턴 %0.2f 비전 피해 받음 / 이동 시 %0.2f 비전 피해 받음 / %d%% 확률로 기술 사용 실패.", "tformat")
...
t("The target is evolved increasing its global speed by %d%%.", "전체 속도 +%d%%.", "tformat")
...
t("The target is evolved increasing all its stats by %d.", "모든 능력치 +%d.", "tformat")
...
t("The target is evolved increasing its damage by %d%%.", "피해량 +%d%%.", "tformat")
...
t("Stay put, increasing your armour and defense by %d.", "방어력과 회피도 +%d.", "tformat")
t("speed", "속도", "effect subtype")
t("Entropic Feedback", "엔트로피 반발", "_t")
t("The target healing is distorted by entropy for %d%% of the healing done over 8 turns.", "8 턴 동안 %d%% 의 생명력 회복.", "tformat")
