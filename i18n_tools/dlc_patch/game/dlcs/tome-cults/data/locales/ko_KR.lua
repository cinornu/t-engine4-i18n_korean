...
적막이 흐르고. 인간이 나처럼 내심 화를 참으려고 노력하는게 보였다. 그는 곧 일어나서 나갔다. 나도 그러고 싶었지만, 불행하게도 그러지 못 했고. 하플링이 주섬주섬 소지품을 챙겨서 나갈 때 나도 조용히 따라나갔다. 하플링이 알아챘고, 우리는 밖에서 맞닥뜨렸다. 거친 말이 오갔고, 그 다음에 정확히 무슨 일이 있었는지는 잘 기억나지 않지만, 하플링이 내 앞에 쓰러져 있다. 내 손에는 피가 잔뜩 묻어 있던 건 똑똑히 기억한다. 정신 차려서 내가 한 짓을 깨닫고, 정착지에서 도망쳐 나와버렸다.
...
그때까지 샬로레들에게 품었던 분노가 혼란스러움으로 바뀌었다. 어떤 광기가 그들을 죽음으로 내몬 것일까? 오크를 막기 위해 희생이라도 한 것일까? 스스로의 의지로 싸운 게 맞을까? 그럼 샬로레들을 비난하는게 옳은가? 머리에 마구 떠오르는 이런 질문들에 제대로 대답할 거리를 생각해 낼 수가 없었다. 그저 이제 뭘 해야 하는지 고민할 뿐이었다. 그래도 나는 어찌어찌 나아가서 샬로레 시골마을에 도착했다. 무너진 건물 사이로 늑대들이 주민들로 보이는 시신들로 만찬을 즐기는 광경을 보았다. 저 멀리에서 도움을 간청하는 외침도 들렸다.
...
With these things established, we will discuss the gods of Eyal and what influence their actions had, and continue to have, on our world. While I discovered many gods in my studies, it is entirely possible that Eyal had even more gods than what is documented in my findings, but their existence cannot be substantiated by existing scholarly texts.]], [[신들은 에이얄의 역사속에서 자주 언급된 존재들이다. 대부분의 독자들에게는 이질적인 개념으로, 현 시대 대부분의 에이얄인들은 신들을 접해보지 못했기 때문이다. 신이라는 단어는 당신에게 어떤 전능하고 터무니없이 강력한 존재의 인상을 주는데, 이 존재들은 확실히 그러하다. 그러나, 정확히 신이 무엇인지 정의하는데 적절한 학문적 성과물은 거의 없다. 에이얄의 역사를 통틀어 여러 문화권에서 같은 이름으로 자주 등장함에도 불구하고 신에 대한 설명은 모두 제각각이다.
...
t([[Each time an enemy takes damage from Dark Whispers, there is a %d%% chance for one of their visions to manifest in an adjacent tile for %d turns. This vision takes no actions but the victim will deal %d%% reduced damage to all other targets until the vision is slain.
		A target cannot have more than one hallucination at a time.]], [[매 번 적이 어둠의 속삭임으로 피해를 입을 때마다, 적들의 정신을 채운 환각이 %d%% 확률로 인접한 칸에 구현됩니다. 환각은 %d 턴 동안 지속됩니다. 환각은 아무 행동도 취하지 않지만, 희생자는 환각을 없에버리기 전까지 다른 모든 대상으로 한 공격에 %d%% 적은 피해를 입힙니다.
