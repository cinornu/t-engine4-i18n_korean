...
t("The target is reeling from the aftershock of a destroyed possessed body, reducing damage by 60%%, reducing movement speed by 50%%.", "대상의 빙의체가 파괴되어 그 후유증으로 휘청이고 있다. 피해량이 60%% 감소하고, 이동 속도가 50%% 감소했다.", "tformat")
...
t("#Target# suddently feels strange in the brain.", "#Target2# 갑자기 뇌에 이상한 느낌을 받기 시작했다.", "_t")
t("#Target# feels less strange.", "#Target1# 느끼던 이상한 느낌이 줄어들었다.", "_t")
