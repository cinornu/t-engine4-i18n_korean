...
이 약삭빠르고 비열한 <?=_t(player.descriptor.subrace)?>는 지금까지 우리에게 있어 눈엣가시였다. 우리는 <?=player:his_her()?>가 도망칠 수 있게 해줬던 우연한 유성 충돌 등에 대비해 더 잘 지켜낼 수 있도록 보호막을 보강해왔다. 그렇지만 <?=player:he_she()?>가 탈출하면서 크리스탈을 부수고 나갔기에  우리는 그의 위치를 직접 추적 할 수 없게 됐다. 상관 없다. - 우리가 <?=player:him_her()?>에게 새겨왔던 낙인과 표식이 그에게 영향을 미치는 마법 에너지 신호를 감시할 수 있게 해줬다. 점술가들에 따르면 <?=player:him_her()?>를 전이시키는 특정한 패턴이 나타난다고 한다. 아마 쉐르'툴이 그 출처일 것이다. 우리는 <?=player:him_her()?> 가로채기 위해 우리의 신호를 보냈다. 그리고 <?=player:he_she()?>를 안전히 확보할 수 있는 우리 정거장으로 재전송했다. <?=player:he_she()?>에게 불복종 건으로 벌을 주고나면 <?=player:his_her()?> 충성심을 되찾기 위해 다시 한 번 개몽의 판에 접촉시킬 것이다.
...
이 약삭빠르고 비열한 엘프는 지금까지 우리에게 있어 눈엣가시였다. 우리는 <?=player:his_her()?>가 도망칠 수 있게 해줬던 우연한 유성 충돌 등에 대비해 더 잘 지켜낼 수 있도록 보호막을 보강해왔다. 그렇지만 <?=player:he_she()?>가 탈출하면서 크리스탈을 부수고 나갔기에  우리는 그의 위치를 직접 추적 할 수 없게 됐다. 상관 없다. - 우리가 <?=player:him_her()?>에게 새겨왔던 낙인과 표식이 그에게 영향을 미치는 마법 에너지 신호를 감시할 수 있게 해줬다. 점술가들에 따르면 <?=player:him_her()?>를 전이시키는 특정한 패턴이 나타난다고 한다. 아마 쉐르'툴이 그 출처일 것이다. 우리는 <?=player:him_her()?> 가로채기 위해 우리의 신호를 보냈다. 그리고 <?=player:he_she()?>를 안전히 확보할 수 있는 우리 정거장으로 재전송했다. <?=player:he_she()?>에게 불복종 건으로 벌을 주고나면 <?=player:his_her()?> 충성심을 되찾기 위해 다시 한 번 개몽의 판에 접촉시킬 것이다.
