...
그가 말을 이어가면서 말투가 점점 더 심각해졌다. "그리고 그들은 엘발라로 들어와서 똑같은 일을 자행하려 합니다. 아마 장막을 뚫고 이곳으로 들어오면서 그들의 시체를 본 적이 있을 겁니다." 내가 이 모든 이야기를 되새기는 동안 그는 잠시 아무 말도 하지 않았다. 그는 목소리를 가다듬고 다시 말을 이었다. "물론, 이 사태는 내가 사절단을 못 보내게 만드는 수준으로 끝날 일이 아닙니다. 누군가가 외지인들을 선동하고 있습니다. 대체 누가, 어떤 자들이 그런 짓을 하고 있는지는 모르겠지만, 인간들이 몰려들어서 소리치던 것들을 생각하면 심히 두렵습니다." 
...
Soon smiling at me, the messenger began to gesture towards a nearby seat. I wasn't much interested in chatting with him, but thinking perhaps he may be able to inform me a bit of events I decided to accept his offer. I moved to sit down, ordering some food to eat. The messenger began making small talk, noting the devastation wrought from the Spellblaze, viciously attacking 'the mages' within each of his sentences, and lamenting the loss of some of his friends. For a time I let him talk as I ate my food. Oddly enough, the messenger didn't give me his name or ask for my own; perhaps being at least somewhat knowledgeable of Thaloren customs in that regard. I didn't actually notice this when I talked to him initially, only realizing it due to later events that would unfold.]], [[[i]표면적으로 나르골은 전체적으로 잘 통제되고 있는 것처럼 보였으나 실상은 그렇지 않았다. 혼란을 잠재우기 위해서 피난민들이 가지고 있던 마법 물품이란 마법물품은 죄다 찾아내 압수했으며, 마법폭발에 대한 책임을 묻고 암살당할 위험을 우려하여 피난민들의 지도자층은 모두 잠적했다. 군대에 속해 있던 마법사들은 지하로 보내졌다. 이 마법사들은 이로 인해 자신들이 처한 위험을 인지하고 있었으나, 성난 군중들을 더 자극하고 싶지 않았다.[/i]

나는 황량한 산비탈을 천천히 그리고 조심스럽게 내려갔으며 징검다리를 밟으며 강을 건넜다. 불타버린 초목을 건너 도시의 관문으로 향하는 피난민의 행렬에 합류했다. 경비병이 관문을 지나는 마차를 조사하고 지나는 자들에게 몇 가지 질문을 하는 통에 나는 뒤에서 꽤 오래 기다려야 했다. 그럼에도 행렬에서 빠져나와 돌아가는 자는 없었고, 내 차례가 다가왔을 무렵 한 드워프가 고함을 지르기 시작했는데 경비병이 그에게서 뭔가 압수했기 때문이었다. 드워프는 도시로 들어갈 수 있다는 허가를 받은 뒤에도 계속 소리를 질렀으며, 그는 들어가면서도 입에서 터져나오는 욕지거리를 멈추지 않았다.

열 명 남짓한 인원이 통과하고 나서 드디어 내 차례가 됐다. 난 장군에게서 받은 문서를 바로 꺼내들었고, 가까이 있던 경비병이 문서에 찍힌 도장을 알아봤다. 그리고 다른 경비병들에게 손짓하며 그들을 불러모았다. 자기들끼리 문서를 잠시 훑어본 뒤, 낮은 목소리로 밀담을 나누었다. 그리고 경비병 중 한 명이 문서를 들고 주변에 있던 탑으로 급하게 달려갔다. 이내 그 경비병이 다른 하플링을 대동한 채로 돌아왔다. 하플링이 입고 있던 말끔한 갑옷을 보고 나는 그가 경비병들의 상관임을 확신했다.

상관은 내게 천천히 다가온 뒤 나의 됨됨이를 판단하려는 듯 뚫어져라 쳐다봤다. 그는 내 눈을 쳐다보려고 위를 돌려다 봤고 나는 아래를 내려다 보아야 했다. 그러고선 그는 확 뒤돌고 경비병에게 손짓했다. 경비병은 바로 손을 내밀어 보였으며, 그때 그것이 상자를 달라는 것임을 바로 깨닫고 짐 속에서 상자를 꺼내 건네주었다. 상자를 받아든 경비병은 상관에게 고갯짓한 뒤 어딘가로 빠르게 달려갔다. 다른 경비병이 나에게 다가와 정중한 목소리로 말했다. "나르골 왕국에 어서오십시오."

나는 관문을 통과해 들어갔고 경비병들은 다시 내 뒤에 있던 피난민들을 다시 심사하기 시작했다. 주변에는 수많은 천막과 급조된 판잣집이 즐비했다. 도시로 몰려드는 피난민들을 수용하기 위해 지은 것 같았다. 피난민들은 주변에 멍하니 앉아있을 뿐이었다. 몇몇 생기가 다 빠져나간 듯한 눈빛으로 서쪽을 쳐다보고 있었는데, 아마도 그들이 피난해온 정착지 쪽을 보는 것 같았다. 어떤 자들은 멍하니 하늘을 쳐다보며, 마치 마법폭발이 벌어졌을 때처럼 휘몰아치는 죽음을 기다리는 듯했다.

앞에 펼쳐진 참담한 광경에 침통함을 느끼며 나는 다른 곳으로 움직이기로 했다. 난 건물들이 모여 있는 쪽으로 가기로 했다. 거리에는 무너진 건물의 잔해가 즐비했고 지붕과 벽들이 무너져 있었다. 무너진 벽과 돌 사이로 하플링 일가족이 보였다. 거리를 따라 더 걸어가자 술집 간판이 바닥에 나동그라져 있었다. 조금 배고픔을 느끼고 있던 차라 무언가 먹을 것을 살 수 있길 바라며 간판 옆의 건물로 향했다.

안쪽에는 여기 저기에서 하플링, 인간, 드워프들이 섞인 채로 식탁에 모여 앉아 있었다. 바깥의 피난민들 보다는 조금 더 생기가 있었으며, 누군가는 노름을 하기도 하고 누군가는 대화를 나누고 있었다. 내가 술집에 들어서자 한 인간이 갑자기 내게 다가와 말을 걸었다. "이봐, 그때 그 탈로레 아닌가? 아, 맞구만 그래." 그가 미치기라도 했나 생각했다. 나는 그 인간이 누군지 몰랐다. 이런 감상을 눈치챈듯 인간을 재빨리 말을 이었다. "아, 날 기억 못 할 수도 있겠군. 북쪽의 여관에 있었던 그 전령이라네. 거기서 엘도랄의 얼간이 자식이랑 말싸움을 하던 인간으로 기억하겠지."

나는 이빨을 꽉 깨물었다. 심히 곤란한 상황에 빠진 것이 아닌가 걱정했으나, 인간은 또다시 말을 이었다. "걱정 마시게. 당신이 그 하플링에게 한 짓을 가지고 뭐라 하는 사람을 찾을 수 없을 걸. 나도 똑같은 일을 해줄까 생각하고 있었지. 그런 걸 떠들고 다녔다간 결국 두들겨 맞았을 테니까. 누구든지 그 입을 다물게 했을 거야." 전령이 말한 것이 이상하다 느끼며 나는 조심스럽게 대답했다. "그게 무슨 소립니까?" 전령은 눈썹을 치켜올리며 말했다. "뭐? 여기 있는 경비병이 그런 하플링을 지켜주기라도 할 것 같은가? 그런 불상사는 요즘엔 흔한 일이라네."

그는 미소를 지으며 옆 자리로 오라고 손짓했다. 그와 대화를 나누는 것에 큰 흥미가 있었던 것은 아니지만, 최근에 있었던 일들에 대해 알 수 있지 않을까 하여 그의 제안을 받아들이기로 했다. 나는 인간의 옆 자리에 가서 앉았으며 먹을 것을 주문했다. 전령은 마법폭발로 인한 참상에 대해 이야기했으며 내뱉는 문장마다 '마법사들' 대한 폭언을 쏟는 것을 잊지 않았다. 그리고 그가 잃어버린 친구들에 대해서도 말하며 애통해 했다. 잠시 동안 나는 음식을 먹으며 그가 말하도록 두었다. 이상하게도 인간은 내게 이름을 알려주거나 내 이름을 묻지도 않았다. 그런 점에서 보았을 때 그는 탈로레의 관습에 대해서 어느정도 알고 있었던 것 가다. 그와 처음 이야기했을 때 이를 알아채진 않았으나, 이후 내가 겪게 되는 사건 속에서 이를 실감했다.]], "_t")
...
His words made me think for a moment, but I simply got up and left. I remember him calling out that should I change my mind, that I would be 'welcomed as a new initiate for sure'. The sun had begun to set in the sky as I left the building. Figuring I should look for a place to stay for the night I found an inn and purchased a room. I figured that in the morning I would go to the market and buy some food and supplies for my journey home. I slept soundly until early in the morning before the sun had begun to rise when the sounds of screaming filled my ears. Wondering what was going on I looked out the window of my room to see fire and smoke rising from a large building in the distance.]], [[[i]누군가를 알아간다는 건 참 어려운 일이다. 그 전령이 좋은 예라는 것을 곧 깨닫게 된다. 나는 그가 마법폭발 때문에 분개한 인간 정도로 생각하고 있었다. 지금 와서 생각해보면, 그는 단순히 화가 난 인간이 아니라 마법 사냥을 선동한 집단의 구성원이었던 것 같다. 전령과, 그가 나간 뒤따라 나갔던 검은 망토의 인간들이 그 다음 날 일어났던 극악무도한 음모를 수행하다 죽었던 것이 틀림없다. 헌데 그는 자신의 의지로 죽었던 것인가? 그 점이 내가 오늘 날에 이르러서 드는 의문이다.[/i]

식사를 마치고 나서, 전령에게서 이야기를 더 듣기로 했다. 그의 장광설이 끝난 뒤에 물어보았다, "그러면 요즘 이곳은 어떻길래?" 그는 한숨을 쉬며 대답했다, "글쎄, 나르골은 비교적 잘 통제되는 것 같네. 쏟아져 오는 피난민들에게 줄 식량도 어떻게든 비축하고 있고, 드워프들을 위한 술까지 입수해둔 모양이야. 그런데 여기서 드워프들을 보게 될 줄은 몰랐네. 철의 왕좌 말고도 모여 사는 곳이 대륙 어딘가에 또 있는지는 모르겠어. 드워프들은 워낙 입이 무거워서 잘 알 수는 없지만 말이야."

드워프들에 딱히 관심이 있는 건 아니었지만, 그가 마지막으로 말했던 것은 내가 드워프에 관해 알고 있는 바와는 잘 맞아떨어지지 않았다. 내가 아는 한, 그들은 모두 철의 왕좌에서 살며, 끽해 봤자 그 주변을 벗어나지 않는다. 이에 대해 물어보자 곧 대답해주었다. "음, 여기 있는 드워프들은 서쪽의 산악 지대에 너머에서 살던 자들이네. 코르낙은 드워프가 그렇게 가까운 곳에서 산다는 걸 전혀 모르지. 드워프들은 이걸 비밀로 하고 있을 테고. 드워프들에겐 안 된 일이지만, 망할 마법사들이 저들의 터전을 박살내는 바람에 거기서 나와야만 했던 거지."

그 대답이 충분히 설명이 됐다고 생각하며 난 도시를 들어올 때 고함을 지르던 드워프가 기억났다. 전령이 그 일에 대해 무언가 알고 있지 않을까 생각했다. 이에 관해서 말을 꺼냈다, "혹시 드워프가 가지고 다닐만한 물건 중에 관문의 경비병이 압수할 만한 게 뭔지 알고 있나요?" 전령은 어깨를 으쓱하며 대답했다, "아마도 망할 마법사가 옛날에 마법을 부여해놓은 물건을 가지고 있었겠지. 그것 때문에 드워프에 대한 대우가 별로 좋지 않아지고 있어. 드워프들은 물건이 마법에 오염됐는지 아닌지 따위를 거의 신경쓰지 않거든."

그는 머리를 흔들며 곧 떠들어대기 시작했다. "그게 말이지. 나르골은 마법과 관련된 물품들을 죄다 압수하고 있어. 여기에 사는 하플링들을 안심시키려는 거지. 시민들이 들고 다니기엔 너무 위험하다고 말하더군. 내 생각엔 시민이든 뭐든 간에 죄다 위험해. 이걸 압수하는 놈들도 마찬가지야. 그 오만한 놈들은 여기서 사는 하플링 동족들한테서 마법 물품들을 압수하지는 않는다고. 그저 '자발적으로' 반납하기를 기대하더군. 드워프들이랑 비슷하게 도시 바깥에서 온 하플링 피난민들이나 인간들은 자기 소유의 물건을 죄다 빼앗기고 있다고." 말을 다 끝마치고 나서 그는 웃음을 터뜨렸다.

검은 망토를 둘러싼 인간이 그에게 다가오자 전령이내 웃음을 멈췄다. 그 인간은 전령에게 허리를 숙여 무언가 속삭였다. 전령은 그 말을 듣고나서 고개를 끄덕이며 말했다. "금방 따라가지. 준비가 되면 다시 전달해주도록 해." 이에 검은 망토의 인간은 머리를 숙여 인사했다. 그러고선 하플링 무리가 있는 식탁으로 갔다가, 드워프 한 명이 있는 식탁으로도 달려갔다. 그리고 자리를 마무리하고 바깥으로 나갔다. 하플링들과 드워프도 식사를 마치고 조용히 자리를 떠났다. 이 전령이 대체 누구인지 궁금하여 그를 힐끗 쳐다 봤고, 그 또한 나를 살펴보고 있었다. 긴장이 풀린 목소리로 그는 말했다, "저들은 신경쓰지 말게. 꽤 좋은 이야기를 나누고 있었겠지만 남들이 끼어들 건 아닌 것 같으니."

그때서야 나는 이 인간이 내가 생각했던 것 이상으로 꾸미는 것이 있는 인물이라는 것을 깨달았다. 단순히 재담꾼이나 믿을 만한 사람으로 생각하기에는 위험한 구석이 있는 것 같았다. 무모하긴 하지만 이 인간이 뭔가 더 알고 있는지 더 알아보기로 했다. 나는 조용히 말을 꺼냈다, "샬로레에 관해 뭔가 계획이라도 있나요?" 그 즉시 인간은 자세를 바로 잡았고 이어가는 말의 목소리가 달라졌다. "아, 에이알의 대지에서 그 하찮은 촌뜨기들을 쓸어버린다면 더 좋을 게 없지 않겠소? 보아하니 당신도 그들에게 책임이 있다는 걸 알고 그들의 피로 몸을 적시고자 숲에서 나왔을 거 같은데. 분명 다들 그러고 싶을 거요. 머지않아 샬로레는 마즈'에이알에 마법폭발을 일으킨 대가를 톡톡히 치룰 것이오."

조심스레 목소리에 분노를 최대한 담아 물었다. "마법폭발, 그걸 그렇게 부르나보죠?" 그렇다고 말하며 그는 대답했다. "그렇소, 최소한 그렇게 들었지." 그는 꽤나 떠들기 좋아했으니 무언가 더 말하기를 기다렸다. "내 제안 하나 하지. 이 계획에 관해 당신도 우리 무리에 참여하지 않겠나? 자연이 이런 참극에 빠지지 않도록 우리의 계획을 곧 실행에 옮길 거야. 당신은 탈로레니 자연의 고통을 아주 제대로 실감하고 있겠지. 그리고, 샬로레가 가장 큰 책임이 있긴 하지만 다른 종족들이 그 원대한 계획을 아예 모르고 있었던 건 아니라고. 모든 종족이, 아마 드워프를 제외하고는, 마법폭발에 대해 어느 정도 알고 있었을 걸."

그 전령은 분명 샬로레 장군이 두려워 했던 단체의 일원인 것 같았다. 전령은 무엇을 꾸미고 있던 간에 그 계획에 구상에 참여하고 있었으며, 방금 전에 망토를 쓴 자와 함께 한 것을 보면 비밀리에 무언가 구상하고 있었던 것 같다. 이들과 합류하는 것도 고려해보았으나, 그 계획이 뭐든 간에 그런 것에 참여하고 싶지는 않았으며 상당히 위험해 보이기도 했다. "그 제안은 고맙지만, 거절하겠어요." 마침내 나는 대답했다. 그는 눈썹을 치켜올리며 대답했다, "당신 같은 탈로레라면 자연을 더럽힌 자들에게 똑같이 복수하리라고 생각했는데 말이야?"

그가 내던진 말에 조금 고민했지만, 이내 일어나서 그 자리를 떴다. 그 자리를 뒤로 하는 내 모습을 두고 마음을 바뀌면 '새로운 동지로서 환영받을 것'이라고 소리쳤던 것이 기억난다. 그때 건물을 나왔을 때 해가 뉘엿뉘엿 져가고 있었다. 하룻밤을 지낼 곳을 찾아야 한다는 것을 깨닫고 여관에 가서 방을 잡았다. 다음 날 아침에 고향에 돌아갈 동안 필요할 음식이나 물건을 사야겠다고 생각했다. 나는 깊은 잠에 빠져 다음날 해가 떠오를 때 일어났다. 그때 비명 소리가 들려왔다. 무슨 일이 생긴 것인가 싶어 창밖을 내다보았을 때 저 멀리 건물에서 화염과 연기가 치솟아오르는 걸 볼 수 있었다.]], "_t")
t("Escapades of Fay Willows [Book 2, Chapter 3] - Blazing Madness", "페이 윌로우의 탈출기 [2권, 제 3장] - 타오르는 광기", "_t")
...
Moving away from the market I wondered what other scenes of chaos I might see if I remained within the Nargol city. While I had evaded danger, it could have very well been me getting trampled or knocked aside in that market. I made a decision then to begin making my way back towards the city gates. As I made my way towards the gates though I noticed a gathering mob of refugees and even some citizens in front of me. I should have headed past them but beyond them I heard a voice ringing out above. "The time has come for action, but it must be directed at the source of those behind all the harm." I stopped and turned my head as I heard the words, something compelling me to stay and listen to what was being said. Drawn in by the voice I began to make my way towards the outskirt of the crowd.]], [[[i]탈로레의 땅으로 돌아가는 길에 필요한 물자들을 시장에서 몇 구입했었다. 3주 정도 먹을 수 있는 식료품을 샀었는데, 집으로 돌아가기 전에 어느 정도 '탐험'을 할 것이라 생각했기 때문이었다. 그리고 철제 다용도 칼과 도끼도 챙겨뒀다. 이것들이 정말로 내 여행에 필요할지는 확신하지 못 했으나, 마즈'에이알을 여행하는 데에는 이 정도면 충분하다고 생각했다. 그러나 그 시장에서 산 것들이 훗날에 어떤 역할을 수행할 지에 대해서는 전혀 알지 못했다.[/i]

창 바깥으로 수많은 시민들이 화재 때문에 도움을 요청하며 이리저리 뛰어다닌 것을 봤다. 시민들은 그 구역의 출입을 통제하려 하고 있었고 불이 더 퍼지는 걸 막으려 했다. 그러나 그런 노력에도 불구하고, 불길이 완전히 잡히기 전까지 수많은 가옥이 화마에 휩싸였다. 이내 병사들이 도착하여 시민들을 통제했고 불길을 잡으려고 도와주던 시민들도 마찬가지로 대피시켰다. 잠시 동안 불길이 잡히지 않고 그대로 있었으나, 이내 사그라들기 시작했다. 그들이 어떻게 불길을 잡았는지는 알 수 없었으나, 어쨌든 불은 거의 다 사그라들었다. 몇몇 마법사들이 은신처에서 나와 비밀스럽게 물의 마법이라도 썼었던 것일까? 정확히 알 수는 없으나 다른 방도를 생각하기는 어렵다.

불길이 사그라들고 있을 때, 병사 몇 명이 미처 불 속에서 대피하지 못한 사람이 있는지 찾기 위해 불탄 가옥들 사이로 들어갔다. 불의 진원지에 도착한 뒤, 병사들이 한 건물에 들어가서 담요에 둘러싸인 무언가를 가지고 나오는 걸 볼 수 있었다. 나중에 난 그것들이 화재를 일으켰던 자들의 시체라는 이야기를 들었다. 그것이 사고였든, 의도적이었든 간에, 그들은 스스로 저지른 방화에 죽었던 것이다. 그리고 그 시체들이 인간 한 명, 하플링 두 명, 드워프 한 명이었다는 것도 알게 되었다. 전령의 요청을 뒤로 하고 자리를 뜬 것이 참 다행이었다.

이 일이 일어났을 때 난 계속 방에 남아 그것들을 보고 있었다. 방에서 나와 여관 주인과 이 일에 대해 이야기하고 나서, 그 건물이 피난민들에게서 압수한 물품들을 보관해두는 곳이었다는 것을 알았다. 여관을 나온 뒤 길거리에서도 그 창고에 있던 거의 모든 마법 물품들이 파괴되었다는 이야기를 들을 수 있었다. 그 주변 집에서 살고 있던 이들도 화재 때문에 죽었다는 이야기 또한 엿들을 수 있었다. 처음에 불을 끄려고 달려들었던 이들 또한 마찬가지라고 했다.

나르골 시장으로 가면서 그 불에 대한 이야기를 끊임없이 들을 수 있었다. 시장의 상인과 고객들조차 모두 그 불에 대한 이야기를 하고 있었다. 거기서 내가 필요한 물품들을 산 뒤, 피난민들의 불만이 쌓이고 있다는 이야기를 한 행인에게서 듣게 됐다. "도대체 왜 저 피난민들이 난리인거야?" 나는 그 얘기를 하던 행인에게 다가갔다. 그 하플링은 꽤 고급스런 옷을 입고 있었으나 계급이 높아보이진 않았다. 이내 그는 나를 쳐다보며 꽤 당황스러워 했다. 나는 한숨을 쉬며 말했다. "그래요. 난 탈로레에요. 피난민들에게 무슨 일이 있었던 거예요?" "확실히 탈로레구만," 하플링은 이내 말을 이어갔다. "음, 그들이 왜 그렇게 불만투성이인지는 잘 모르겠네. 그들은 끔찍한 천막 속에서 살고 있지만 음식이나 마실 것들을 부족함 없이 보급받고 있는데 말이야. 아마 오늘 있었던 화재가 문제였던 것 같네."

하플링은 갑자기 말을 멈추고 불안한 눈빛으로 어딘가를 쳐다보았다. 그리고 뒤돌아 허둥지둥 도망치기 시작했다. 하플링이 도망친 직후 나는 뒤쪽에서 고함소리를 들을 수 있었다. 뒤를 돌아보자 허름한 피난민들로 구성된 무리가 노점 사이를 달려오고 있었고, 상인들은 도망치고 있었다. 그 피난민들이 지나간 자리엔 노점들이 죄다 엉망이 되었다. 나는 그들로부터 멀찍이 떨어져 자리를 피했으나, 미처 도망치지 못 한 손님들과 상인들이 구타당했다. 몇몇은 폭도들에게 맞서거나 매점을 지키려고 했으나 이내 그들은 흠씬 두들겨맞고 바닥에 나동그라졌다.
...
A group of the Nargol Guards would eventual appear and they began to gather themselves to disperse the crowd and restore order. The crowd offered little resistance to the encroaching force of guards that rushed forward, and many fled into the dark alleys of buildings or through the tents of the refugees. As the guards took control of the area, their attention turned towards the simmering fire and the charred corpses. Cries of anguish came from individuals who I assumed to be loved ones and friends of those killed. At this point I could take no more of the events that were unfolding in front of me, and I turned to leave the area and the fiery carnage that had taken place. However as I passed by a tent a hand reached out of its opening, throwing me inside.]], [[[i]사람들을 마법사에 대한 폭력 행위로 이끈 것은 마법폭발의 여파로 인한 분노였는가, 아니면 다른 것이었을까? 인간이나 드워프, 하플링들이 어떤 자들인지 잘 안다고 할 수는 없으나, 나르골 왕국의 길거리에서부터 퍼져나간 그 악행은 어떤 지성을 지닌 존재라도 할 수 있으리라 생각했던 것들이 아니었다.[/i]

다시 들려오는 목소리에 다시 귀를 기울였다. "당신들의 분노는 아무런 책임도 없는 자들에게 목적없이 휘둘리고 있습니다. 이런 사태를 야기한 자들에게 당신들의 분노를 뿜어내십시오." 나는 군중들 사이로 들어가 누가 말하고 있으며 무엇에 대해 말하는 것인지 알아내고자 했다. 연설은 계쏙 이어졌다. "마법이 있는 곳 그 어디든, 결국 이는 파괴를 불러올 것입니다. 오늘 아침의 화재는 그 본보기입니다. 몇 피난민들이 압수된 마법 물품들을 보관하던 창고에 들어갔습니다. 그들의 오만 때문에 그 물품들 속에 있던 마법의 힘으로 건물을 불타 무너졌습니다."

군중 한 가운데로 들어가, 나는 군중을 마주 보는 하플링 한 명과 인간 한명을 올려다 보았다. 그들은 신원을 숨기기 위해 가면을 쑤고 있었으나, 인간이 입고 있던 검은 망토를 알아보았다. 인간이 손을 높게 쳐올리고 있었기에 그가 말하고 있는 것 같았으나, 그들이 쓴 가면 때문에 얼굴이 가려져 확신할 수는 없다. 목소리가 다시 울려 퍼졌다. "화재 때문에 주변에 자고 있던 거주민들이 죽고 말았습니다. 더 많은 생명이 마법으로 인해 죽었습니다. 이 사건 속에서 다행이라고 할 점은 오직 마법 물품들이 화재 속에서 파괴되었다는 것뿐입니다. 이 세계를 더럽힐 악이 사라진 것입니다."

그들이 외치는 말들이 내 머리 속을 번뜩 스쳐지나갔다. 그들이 말하는 것을 들으며 그 속에 있는 분노를 느낄 수 있었다. 내 주변의 군중들은 그들의 말과 분노에 휘둘려지고 있었다. 많은 자들이 '마법 탓이야' 혹은 '마법을 타도하라' 따위의 말을 하는 것이 들려왔다. 이런 외침이 여기저기 들리는 와중에 목소리가 계속 됐다. "물론, 당신들이 직접 본 참상들에 대한 이야기는 할 필요 없으리라 생각합니다. 창고를 불태워 버린 그런 행동처럼, 대지를 가르고 하늘을 뒤틀어놓은 그 재앙을 풀어놓은 것은 샬로레 마법사들입니다. 제가 계속 말했듯이, 마법이 있는 어디든, 결국 파괴를 불러올 뿐입니다."

목소리가 점점 더 빨라지면서 더욱더 격앙되기 시작했다. "마법으로부터 해방되는 것이 더욱 바람직하다는 것은 이제 부정할 수 없는 사실입니다. 그렇지 않으면 이와 같은 재앙은 반복될 것입니다. 나르골 평의회는 도시 안에 있는 하플링에게 아무런 조치도 취하지 않았습니다. 우리가 이 세계를 지키고자 한다면, 우리 스스로가 직접 이뤄내야 합니다. 마법이 조금이라도 서려 있는 물품이나 유물을 모두 식별해내어 신속히 파괴해야 합니다. 또한 마법을 연구하거나 고약한 마법과 조금이라도 관련된 자들을 찾아내어 처리해야 할 것입니다. 그렇지 않으면 그들의 오만함 속에서 세상은 또 다른 재앙을 맞이할 것입니다."

이쯤 되자 군중은 '마법을 파괴하라', '마법사들을 죽여라', '마법을 끝장내자' 따위의 구호를 외치고 있었다. 나 또한 그런 충동을 느꼈으나 겨우내 이를 억누르고 동참하지 않았다. 이내 그 목소리는 여러 지시를 내리기 시작했다. 길가에 목재를 가져다 쌓고, 정의의 심판을 천명했다. 사람들은 각자 주변의 건물들로 흩어지고 나무를 쌓아올리기 시작했다. 가면을 쓴 자들이 더 나타나 나무 말뚝을 들쳐 메고 밧줄 더미를 들고 왔다. 목재 더미가 쌓아 올려지고 그 안에 나무 말뚝을 박아넣어 하늘로 우뚝 세웠다. 이런 상황 속에서 나는 혼란스럽기 그지 없었다.

사람들이 목재를 옮기는 동안, 마법에 연관된 것으로 의심받는 자들의 이름이 호명되었다. 그들을 이곳으로 끌고 오라는 지시가 새롭게 내려졌으며, 마법 물품을 발견한다면 그것 또한 가지고 오라는 지시 또한 내려졌다. 이내 폭도들이 나아가 가정 집에 들어가 누군가는 피난민의 천막에까지도 들어가 호명된 자들을 끌고 왔다.  끌려온 자들은 바닥에 질질 끌리는 동안 혼란스러움과 충격 속에서 비명을 질렀다. 그리고 나무 말뚝에 그들을 묶고 마법 물품들을 내던지라는 지시가 내려졌다. 이 지시를 들은 즉시 군중들은 밧줄로 희생자들의 손과 발을 나무에 묶었다.

마치 뒤틀린 힘에 의한 것처럼, 마법으로써 해악을 끼친 자들에게 대한 비난이 쏟아졌다. 가면을 쓴 자들은 말뚝에 묶인 자들에게 고발하듯 소리쳤다. 때때로 몇몇 마법 물품들을 들어올리자, 거기에서 불길한 힘으로 섬뜩한 빛이 일렁였다. 군중들은 고발당한 자들을 발로 차고 패대기 쳤으며, 그들은 나무 말뚝에 묶여 아무 것도 하지 못 하고 얻어맞을 수 밖에 없었다. 이내 가면을 쓴 자들이 횃불을 들고 걸어나왔다. 이때 나는 그 목재가 무엇을 위한 것이었는지 깨달았다. 횃불에 불이 붙고 타오르기 시작했다. 그 다음에 벌어졌던 일은 아직도 내 머리 속에 생생하다. 호를 그리며 날아가는 횃불과, 나뭇더미를 따라 퍼지는 화염의 불길이 잊히지 않는다.

불길에 휩싸인 희생자들은 곧 끔찍한 비명 소리를 쏟아냈으며, 타오르는 열기가 그들의 몸을 갉아먹어 그을리고 타오르기 시작했다. 이 광경을 앞두고 이 끔찍한 행위를 선동한 목소리가 내 머릿속에서 울려퍼졌다. 군중들은 그 요청에 따랐다. 비명 소리가 거리를 가득 메우고 마지막 한 명이 죽음을 맞이할 때까지 계속 됐다. 나는 구역질을 멈출 수 없었고 건물 한 편으로 쓰러져 있을 수 밖에 없었다.
...
t("Escapades of Fay Willows [Book 5, Chapter 1] - Dead On Arrival", "페이 윌로우즈이 여행기 [5권, 제 1장] - 죽은 채로 온 자들", "_t")
