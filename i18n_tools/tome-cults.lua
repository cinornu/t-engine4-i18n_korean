...
With these things established, we will discuss the gods of Eyal and what influence their actions had, and continue to have, on our world. While I discovered many gods in my studies, it is entirely possible that Eyal had even more gods than what are documented in my findings, but their existence cannot be substantiated by existing scholarly texts.]], [[신들은 에이얄의 역사속에서 자주 언급된 존재들이다. 대부분의 독자들에게는 이질적인 개념으로, 현 시대 대부분의 에이얄인들은 신들을 접해보지 못했기 때문이다. 신이라는 단어는 당신에게 어떤 전능하고 터무니없이 강력한 존재의 인상을 주는데, 이 존재들은 확실히 그러하다. 그러나, 정확히 신이 무엇인지 정의하는데 적절한 학문적 성과물은 거의 없다. 에이얄의 역사를 통틀어 여러 문화권에서 같은 이름으로 자주 등장함에도 불구하고 신에 대한 설명은 모두 제각각이다.

크로슈쿠르의 학자로서 나는 에이얄의 표면을 배회하고 앙골웬과 같은 많은 유명한 배움의 터에서 지상종종으로부터 신에관해 배우는 데 많은 시간을 보냈다. 부당한 거래였지만, 나는 심지어 임프를 간신히[i]설득[/i]해 울'흐록 에게서 어떤 문서를 회수하기도 했다. 이 일련의 문서들은 신들에 관한 정보를 분류하고 신화나 역사가 허락하는한 그들의 정확한 모습을 묘사하기 위해 쓰여졌다. 그리고 이 서문은 신이 정확히 무엇인가에 대한 개괄적인 느낌을 주기 위해 쓰여졌다.

에이얄의 표면을 가로지르며 걸어온 강력한 존재들은 많이 있었다. 그러나 이런 존재들이 가진 엄청난 힘에도 불구하고 신이 된다는 것은 단순한 힘의 문제가 아니다. 신과 다른 존재를 구분하는 것은 엔트로피를 역전시키는 능력에 있다. 향후 참조를 위해 이 힘을 반-엔트로피라고 칭하겠다. 이 힘은 신들이 자신의 변덕과 욕망에 따라 현실을 재구성할 수 있게 해주었다. 어떤 신들은 그들만의 종족을 만들었고, 다른 신들은 에이얄에 사는 존재들을 변화시켰다, 신들은 진화를 가지고 놀았고, 에이얄에 사는 존재들을 헤아릴 수 없는 방법으로 변화시켰다. 어떤 이들은 이러한 행동을 우리가 모르는 더 큰 목적에 기인한다고 주장했지만, 신들이 인간처럼 실수하기도 하고 우리처럼 하찮은 것들에서 동기부여를 받는다는 것을 암시하는 증거들이 충분히 있다. 내 학구적 견해로는, 우리는 단순히 그들의 즐거움을 위해 창조된 것이다.

이것이 일부 사람들을 절망으로 몰아넣고 필멸자의 의지가 무의미하다고 믿게 만들지도 모르지만, 고대 신화에서는 신들이 쉐르'툴에 의해 도살되거나 우리 세계에서 쫓겨났다고 언급하고 있다. 그들의 부재가 좋은 것으로 여겨질 수 있는지 아닌지는 말할 수 없지만. 지금까지 살아남은 몇가지 이야기들에 따르면 신들이 서로 다툴때 신들은 그들이 만든 종족들을 잔인하게도 전혀 신경쓰지 않고 이 세상의 표면을 가로질러 큰 상처들을 내었다고 한다. 또한 주목할 점은, 신들이 그들의 인상적인 힘에도 불구하고, 항상 지적인 존재는 아니었다는 점이다. 신들 중 몇몇은 간신히 지적능력을 가졌거나 심지어 자각력이 없었다고 전해진다. 이것에 대한 한 가지 이론은 신들이 에이얄 표면에 살고 있던 원시 존재들이었고 반-엔트로피적 에너지들이 우연히 그들에게 스며들어 인공적으로 승천되어진 존재들일 뿐이라는 것이다.

이러한 내용이 머리속에 확립된 상태에서 우리는 에이얄의 신들과 그들의 행동이 우리 세계에 어떤 영향을 미쳤고, 또 어떤 영향을 끼치고 있으며, 또 어떤 영향을 끼칠지에 대해 토론할 것이다. 나는 내 연구과정에서 많은 신들을 발견했지만, 에이얄에는 내 연구 결과보다 훨씬 더 많은 신들이 존재했을 가능성이 확실히 있지만, 그들의 존재는 현존하는 학문적 자료를 통해서는 증명할 수 없었다.]], "_t")
...
Xadoch was one of the first gods to be felled in the God Hunt by the hunter Branzir. The Sher'tul had a particular dislike of the god, as it had tried to undermine them with plagues numerous times. Strains of Xadoch's diseases are thought to still be on Eyal to this day, waiting for some unfortunate victim to carry them back to civilisation, so Xadoch may commit one last act of spite against sapient life.]], [[자도크는 황폐를 부르는 자라는 별명을 갖고 있었다. 그것은 지표면 가까이 기어다니며 에이얄의 오물 속에서 고생하는 생물들을 사랑했지만, 자신의 지성종족에 대한 사랑은 없었다. 많은 신화에서 수많은 질병과 역병이 자도크에 의해 만들어졌다고 한다. 하지만 어떤 신화들은 자도크의 존재가 필요했다고 말했다. 자도크의 재앙은 세계를 어떤 한 종족이 독점하는 것을 막을 수 있었고, 일종의 균형을 유지했기 때문이다. 반면에, 많은 다른 신화들은 신이 잔인한 호기심을 가졌다는 것을 증명한다. 자도크는 황폐를 전세계로 흩뿌렸고, 단순히 지성종족들에게 어떤 종류의 영향을 미치게 될지 보기 위해 질병을 만들었다고 한다. 만약 에이얄의 다른 신들이 아니었다면, 자도크가 온 세상의 지성종족을 시들어버리게 만들었을거라고 믿어진다.

자도크는 신 사냥꾼 브란지르에 의해 쓰러진 첫번째 신들중 하나다. 쉐르'툴은 이 신을 특히나 싫어했는데, 자도크가 몇번씩이나 역병으로 그들을 약화시키려 했기 때문이다. 자도크의 질병은 오늘날까지도 에이얄에 남아 있는 것으로 생각되며, 어떤 불행한 희생자가 그것들을 다시 문명으로 데려가기를 기다리고 있다, 그로인해 자도크는 지적생명에 대한 마지막 악행을 저지를지도 모른다.]], "_t")
...
When Ugg'matho was slained by Branzir, it is said that its blood took on a life of its own, spreading out into the wilderness in the form of living ooze.]], [[우그'마토는 트롤의 창조에 책임이 있는 신이다. 현 시대의 대부분의 에이얄인들은 트롤을 멍청한 짐승이라고 생각하지만, 그들은 종종 그들이 평가받는 것보다 훨씬 더 똑똑하다는 것을 증명해 왔다. 우그'마토의 가장 보편적으로 귀속된 영토는 에이얄의 숲과 산이었다. 고대 문헌에서, 그것에 부여된 이름은 '정원사'로, 그것은 에이알의 숲과 녹지를 깊이 사랑했기 때문이다. 그것은 야만적이고 강력한 야생의 지배자의 이미지로 트롤을 창조했다고 생각된다.
...
그 역시 신살자가 되어 달라는 요청을 받았다. 왜냐하면 그의 봉술 솜씨는 전설적인 수준이었기 때문이다. 그는 정중하게 거절했지만, 그를 향한 도움 요청은 계속 되었다. 그가 방랑하던 땅이 그의 눈 앞에서 불타버리는 것을 본 후, 그는 마침내 에이얄의 신들에 대항하는 입장을 택했다. 그는 한쪽 끝에 크레센트 칼날이 달린 독특하게 만들어진 지팡이, 이쓰랄을 선물받았다.
...
Hithre was one of The Teacher's pupils, a Shalore who became one of the first to wield entropic magic in the entirety of Eyal.]], [[황혼의 시대, 많은 에이얄 주민들은 세상이 끝나고 있는 것 같다고 보았다. 마법폭발에 의한 파괴는 땅을 시들게 하고 황폐하게 하였다. 식량도 부족했고 질병도 만연했고 모두가 절박했다. 선별된 소수의 사람에게, 구원은 예상 밖의 방문객에게서 왔다. 단순히 스승이라고 알려질 존재가 고대 쉐르'툴 장거리 관문을 통해 별 너머 어딘가에서 에이얄을 방문했다. 그것은 에이얄의 깊은 곳에서 살아남은 한 무리의 생존자들을 발견했고 그들은 자신들의 세계를 유린하는 공포체들에 대항하기 위한 무기로써 그것에게 지식을 간청했다.
...
히트레는 스승의 제자 중 한 명인 샬로레로, 에이얄 전체에서 최초로 엔트로피의 마법을 다루는 이 중 한 명이 되었다.]], "_t")
...
스승이 어찌 되었는지는 알려지지 않았다. 어쩌면 그것은 형언할 수 없는 그것과의 만남에서 살아남지 못했거나, 아니면 에이얄 훨씬 너머 고향으로 돌아갔는지도 모른다.]], "_t")
...
그들이 이전의 자아없는 상태에서 나온 지 얼마 되지 않았기 때문에, 드렘은 그들을 둘러싼 세계와 완전히 단절된 종족이다. 드렘에겐 어떤 역사나 문화도 없는 것으로 보이며 그들은 에이얄 표면의 문명화된 종족과 에이얄 지하의 공포체 사이에 놓인 벼랑에 기대어 앉아있는 상태이다 많은 사람들은 그들이 드워프들과 어떤 연관성을 가지고 있다고 의심하고 있는데, 일반적인 이론은 그들이 그 자랑스러운 종족의 타락한 일부라는 것이다. 그러나 이 주제에 대한 연구는 거의 없었고 이러한 주장을 입증하는 증거는 거의 발견되지 않았다. 드렘이 에이알의 미래에 어떤 영향을 미칠지는 지금으로서는 알 수 없다.]], "_t")
