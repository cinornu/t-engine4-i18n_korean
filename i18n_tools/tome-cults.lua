...
t("Escapades of Fay Willows [Book 5, Chapter 1] - Dead On Arrival", "페이 윌로우즈의 여행기 [5권, 제 1장] - 죽은 채로 온 자들", "_t")
...
나는 가로수길을 걸으면서 지금까지의 일을 되돌아보고 있었다. 난 지금 이 자리에 한 병사로서 순찰을 돌고 있다. 마법폭발로부터 33년이 지났지만 그때의 일은 내 마음과 몸에 깊게 박혀있다. 난 여러 가지 사건들을 헤쳐나가며 결국 엘발라에서 샬로레와 함께 살고 있다. 난 샬로레를 도우러 여기까지 왔으나 결국은 그들 또한 나를 도왔다. 난 함께 훈련했던 병사들 중 한 명과 사랑에 빠져 그와 가족이 되었다. 지금에 이르러서도 난 지금 엘발라 바깥이 어떤지, 탈로레의 고향은 어떤지 궁금했다. 내가 한때 원했듯이 바깥 세상으로 떠나고 싶기도 했다.
...
엘발라가 처한 위기를 직감하고 난 즉시 귀환의 룬을 발동시켰다. 그리고 나는 도시의 성벽 안으로 돌아와 있었다. 경치가 바뀌자마자 샬로레 병사 하나가 내게 다가오더니 그 자리에서 쓰러졌다. 병사는 곧 일어서서 "미안"이라고 말하더니 날 보조하기 위해 왼쪽 겨드랑이에 손을 넣었다. 그때 내 팔에 난 상처를 보고 진중한 눈빛을 보이며 말했다. "너가 봤던 불사자들에 대해 사령관님께 빨리 보고해. 너가 정찰을 나갔을 때에 장막을 뚫고 시체 몇 놈이 들어왔어."
