...
t("Escapades of Fay Willows [Book 4, Chapter 5] - Festival of Happiness", "페이 윌로우즈의 여행기 [4권, 제 5장] - 기쁨의 축제", "_t")
...
Making my way back to my dwelling I felt in control of myself and my actions. Whatever the enigma within me was, it did not and would not lord over me. As I came up to the guards I smiled and gave a friendly gesture. While I was heading back in for now, I knew that I would leave this dwelling again tomorrow. While the ogres are quick to note that I had saved them when conversation touches on past events, in reality I believe that they were the ones who had actually saved me. The ogres are quick to dismiss this as modesty, but since that time when I was at that festival I have been working to gain full control over my myself, to take a hold of my life once more. For that I say thank you to them.]], [[[i]내가 격리된 사이에 엘발라에는 훨씬 더 많은 오우거들이 모여들었다. 수백명은 족히 되는 정도였다. 내가 구했던 오우거들이 대의회에 바깥의 다른 오우거들을 찾고 구해달라고 청원한 게 분명했다. 그런 요청을 받아들여, 나르골 왕국 및 마즈'에이알 북서쪽의 인간 왕국들과 조약을 맺어 비밀리에 가능한 많은 수의 오우거들을 도와 샬로레의 땅으로 인도했다.[/i]

내가 부상을 완전히 회복했을 때는 내 인생에 있어서 가장 최악의 시기라고 할 수 있다. 생각에 빠져들 시간은 남아돌았고, 마법폭발로부터 지금까지 일어났던 모든 일들을 되새기며 생각에 빠지는 것을 멈출 수가 없었다. 매 순간순간이 끔찍한 악몽을 꾸는 것 같았고 이 느낌은 나를 좀먹어갔다. 광신도들과 싸울 때 느꼈던 그 충동이 언제든지 나를 찢고 튀어나오려고 했다. 잠이 들었을 때에도, 깨어있을 때에도 항상 그랬다. 묘사할 수조차 없는 끔찍한 고통 속에서 나는 내 삶을 끝없이 저주했다. 그런 와중에 난 감정에서도 자유로워질 방법을 찾지 못 했고 스스로를 옭아맸다.
...
'나'는 정말 괜찮은 것일까? 누군가에게 달려들거나 하진 않을까? "그게 좋은 생각인 것 같지는 않은데..." 나는 말을 흐렸다. 내가 느끼는 불편함이 전달되면서도 어느 분노나 다른 감정이 끓어오르지 않기를 바랬다. 이를 본 오우거가 바로 도중에 끼어들어 말을 꺼냈다. "당신이 스스로를 통제하지 못 할까봐 그럽니까? 그 마법부여사한테 했던 것처럼요?" 아픈 곳을 찔려 나는 눈을 부릅 떴다. 하지만 참모는 아무 말도 하지 않았고 처음 이 방에 들어왔을 때처럼 진중한 표정으로 날 볼 뿐이었다. 나는 정신을 가다듬고 시선을 돌리며 말했다. "난 누구도 해치고 싶지 않아요. 다른 사람과 만나지 않고 떨어져 지내는 게 최선일 거예요."

내가 스스로 내뱉은 말이 다른 누군가가 했던 말보다도 내게 깊숙이 꽂혔다. 직접 내 입으로 말하기 전까지는 깨닫지 못 했으나, 난 지금까지 나 자신을 통제하려고 애썼음에도 이미 은둔해버릴 생각을 하고 있었던 것이다. 슬픔에 빠져 비관에 빠진지 벌써 3개월 째인데, 이제 와서 여기서 해방될 기회를 거부한다고? 그 순간 증오가 치밀었다. 지금까지 내가 겪었던 끔찍한 사건들 속에서 느꼈던 증오였다. 그러나 지금까지 그 증오가 다른 사람을 향했다면 지금은- "그러면 당신 스스로를 해치는 건 괜찮습니까?" 오우거가 내뱉은 말이 비수와도 같았다. 내가 생각하는 것을 정확히 꿰뚫은 듯 했다. 다른 이들과 만나는 것이 과연 괜찮을지 잠시 고민했으나, 어느새 내 안의 증오가 스러졌다.

자리에서 일어나 참모를 바라보며 말했다. "나가도록 하죠." 참모는 뛸듯이 기뻐하며 내 팔을 잡고 문 바깥으로 데려나갔다.  그가 내 갈 길을 안내하는 것인지 아니면 내가 엄청나게 신이 난 오우거에게 질질 끌려가는 것인지 알 수 없었다. 하지만 지금까지 우울했던 시간에 비하면 훨씬 더 행복한 순간임은 분명했다. 다른 사람들과 좀 더 만난다면 훨씬 더 나아질지 모른다는 생각이 들기 시작했다. 최소한 지금 당장은 격리에서 벗어나는 것이기도 했고, 그리고 잘 하면 과거의 기억으로부터 벗어날 수 있을지도 몰랐다.

엘발라의 한 광장까지 도착하자, 흥겨운 노랫소리와 목소리가 들려왔다. 샬로레와 오우거가 모여있는 것을 볼 수 있었다. 열댓명 쯤 되는 오우거들이 온화한 표정으로 그 집단의 중심에서 춤을 추고 있었다. 천천히, 그리고 오우거들끼리 한 마음이 되어 눈을 뗄 수 없는 춤을 추고 있었다. 관객들은 사로잡힌 듯이 이를 보고 있었고, 중앙의 오우거들은 공연을 계속했다. 그들의 움직임은 조금씩 더 빨라지더니 박수를 치며 관객들에게 손장단을 재촉했다. 주변의 관객들이 하나둘씩 박수를 치기 시작했고 이내 그들의 분위기도 고조되었다. 난 그들에게서 피어오르는 미소를 볼 수 있었다.
