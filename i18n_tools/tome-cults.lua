...
The soldier led me to the center of the city where a grand building lay. After meeting with a couple of the guards clad head to toe in shiny plate armor, we were let in. It took several minutes walking through the building’s halls, seemingly walking the building’s entire length to the end of it. Eventually I came to a luxurious looking room, decorations made of stralite and gold lining the walls and displayed pictures of what I assumed to be important figures in Shaloren history. Here I was told to wait, and left by the lieutenant as he entered a nearby room.]], [[[i]샬로레가 주입물을 얼마나 싫어하는 지에 대해 생각하면 아직도 난 놀랍기 그지 없다. 그들은 주입물을 쓰느니 차라리 자신들의 운명을 시험하고자 했다. 주입물이 지니는 목적들 중 하나는 부상을 겪은 뒤 건강을 회복하는 것이다. 그러나 샬로레에게 주입물은 죽음을 피하기 위한 최후의 보루 쯤이었다. 게다가, 그들은 주입물을 쓰지 않고 버티는 것이 결국 더 오랫동안 주입물을 써야하는 결과로 이어진다는 걸 이해하지 못 하는 듯했다. 단순히 상처를 메꾸는 것을 넘어서서 벌어진 상처에서 발생할 수 있는 감염을 막아야 하는데 말이다.[/i]

그 이후로 며칠 동안 나는 샬로레가 쓸 수 있도록 주입물들을 섞고 만들었다. 작업소에는 편안한 잠자리가 마련되어 있었고, 치유사는 나에게 계속 음식과 마실 것들을 가져다 주었다. 글쎄, 샬로레들에게 이게 기본적인 음식과 음료는 되겠지만 탈로레에게는 다소 사치스러웠다고 할 수 있겠다. 그러니까, 드워프가 술을 주식처럼 삼는 건 알고 있었지만 내가 받은 와인의 양에 따라 판단해보면 샬로레에겐 와인이 주식에 포함되는 듯했다. 어쨌든, 내가 받은 대우는 기대한 것 이상으로 좋았다.

넷째 날 즈음에, 꽤 많은 주입물을 만들고 난 뒤에, 지하실에서 올라와 주입물로 치료하는 것을 도와달라는 부탁을 받았다. 내가 치료했던 자들의 상당수가 죽어가고 있었고, 심하게 곪아버린 감염증에 시달리고 있었다. 상처를 붕대로 감기만 하고 다른 조치는 하지 않은 탓이었다. 내가 가건물에 누워있던 샬로레들을 치료했던 것과 비슷하게, 그들이 죽음의 문턱을 겨우 벗어날 정도로밖에 주입물을 쓰지 않았다. 주입물이 부족해서 그런 것이 아니었다. 샬로레들이 주입물의 사용을 완강히 거부한 탓이었다.

일주일이 지나 피난민 대부분의 치료가 끝난 즈음에, 오크들과 전투를 벌이던 샬로레 병사들이 복귀했다는 소식이 들려왔다. 마법폭발이 일어났을 때 인간 왕국과 함께 대륙의 동쪽에서 싸우고 있었던 게 분명했다. 엘발라까지 돌아오는 길에서 살아남은 자들은 매우 적었다. 대륙의 중앙을 통해 곧바로 돌아올 수 없었기에 긴 여정이었을 것이다. 살아온 자들은 수백명 뿐이었다.

수백명의 탈로레를 간호한 뒤였으니, 이 즈음엔 샬로레들에게 어느 정도 동정심이 들었다. 하지만 나의 이목을 사로잡았던 것은 그들이 엘발라로 곧바로 돌아올 수가 없었다고 말한 점이었다. 대륙의 중앙은 미드 베일 평원이 있는 곳으로, 말 그대로 광활한 평야만을 볼 수 있는 곳이었다. 대륙의 지형에 관한 내 기본적인 지식에 따르면, 그 평야는 완전히 개방되어 있으며 통행에 매우 용이했다. 엄청난 규모의 오크 군대가 길을 막는 게 아니라면, 북쪽으로 돌아서 올 필요는 없었을 것이다.

금방 조수가 나에게 다가왔기에 오랫동안 생각할 겨를은 없었다. 그는 나에게 처음 보는 석판들이 담긴 주머니를 건넸다. 주머니에서 석판 하나를 꺼내자 거기에 새겨진 빛나는 도장을 알아볼 수 있었다. 마법의 힘이 흐르는 듯했다. 무엇에 쓰는 것인지 물어보기 위해 고개를 돌렸으나, 거기엔 아무도 없었다. 치유사는 건물로 들어오는 병사들을 치료하기 위해 자리를 옮겼다. 이 기묘한 석판들로 무엇을 해야 하는건지 나는 혼란스러웠다. 그러자 병사들 중 한 명이 다가와 내 어깨를 두드렸다. 그 병사는 바로 손을 뻗어 주머니에서 석판 하나를 가져갔다.

그 병사가 무엇을 하려는 것인지 보기 위해 시선을 돌리자, 그의 그을린 갑옷을 관통한 채로 난 커다란 상처를 발견했다. 난 그때 손에 룬들을 잔뜩 쥔 채였기 때문에 허둥지둥하고 주입물을 쓸 생각조차 하지 못 했다. 잠시 후 나는 특이한 광경을 목격했다. 놀랍게도 석판 위의 도장에서 빛이 나고 변형하면서 병사의 손에 옮겨졌다. 푸른 빛이 병사의 눈에 감돌며 기이한 에너지가 그의 몸을 타고 흐르는 듯했다. 그 다음에 일어난 일을 보고서 나는 어안이 벙벙해질 수 밖에 없었다. 병사가 무엇인가 중얼거리자 심하게 벌어졌던 상처들이 저절로 닫히기 시작했던 것이다.

무슨 일이 일어나고 있는 것인지 난 갈피를 잡을 수가 없었다. 그 병사는 내 앞에서 스스로를 치료하고 있는 것 같았다. 푸른 빛이 그의 눈에서 사그라들자 평소의 눈빛으로 돌아왔다. 그에게 났던 상처들은 치료됐을 뿐만 아니라 아예 상처가 있지도 않았다는 듯이 아무런 흔적도 남지 않았다. 이때 난 처음으로 치료 주문이나 룬을 사용하는 것을 봤다. 주문에 관한 것은 들어본 적이 있었으나, 난 살면서 룬의 존재조차 들어본 적이 없었다. 이내 나는 그 석판들이 마나 쇄도 룬이라고 불린다는 것을 알았으며, 신체 내 마나의 흐름을 복구해준다는 것 또한 알게 됐다.

난 지금도 마법에 대해 아는 것이 별로 없고 어떻게 이뤄지는 것인지도 모른다. 하지만 명백한 것은, 마법폭발로 인한 무언가 때문에 그 사건을 기점으로 마법의 작동 방식이 영원히 바뀌어 버렸다는 것이다. 마법의 힘을 불러일으키는 것은 여전히 훈련을 통해 가능한 일이지만, 이전보다 훨씬 어려워졌다. 다른 부상자들이 다가와 비슷한 방식으로 마나 쇄도 룬을 가져갔고, 손이나 팔, 혹은 다리든 어디든 원하는 신체 부위에 빛나는 룬의 도장을 새겼다. 그러고선 주문을 사용하여 스스로를 치료하거나 이따금 다른 병사들을 치료했다.

잠시 후 부상을 입은 병사들의 수는 줄어들었고, 치료한 후에는 휴식조차 필요 없다는 자들이 대부분이었다. 상당수의 병사들이 완쾌되자, 의무관 주임이 다가와 샬로레를 대표하여 감사를 표했다. 그 순간 내가 애초에 이곳에 오게 된 이유를 떠올렸고, 내가 했던 거래에 대하여 충분히 할만큼 했다고 말했다. 의무관 주임은 고개를 끄덕이며 내 뒤를 쳐다보았다. 그러자 병사 한명이 다가왔다. "부관이 자네를 장군님께 데려다 줄 걸세." 나는 잠시 당혹스러웠으나 그 장군이 지금까지 일어났던 사건들에 대하여 답을 알고 있으리라고 짐작했다.
