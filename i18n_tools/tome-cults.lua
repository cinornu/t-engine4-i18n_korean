...
나는 당황하며 그 자리에 앉아 있었고, 잠깐 동안 우리 둘 사이에 침묵이 흘렀다. "당신은 탈로레군요." 샬로레가 말했고, 난 눈을 몇 번 끔뻑거리다가 맞다고 대답했다. 정신 차리기 전까지 잠깐 멍하니 있었다. 여기서 뭘 하냐고 물었다. 그런 말을 들으면서, 뭐라고 대답해야 할지 고민했다. 날 이끌던 분노는 이미 거의 사라져 버렸고, 여기까지 왜 왔는지 이유도 알 수 없었다. 조금 더 앉아 있다가 대답했다. "그 이유를 알아내기 위해 여기까지 왔습니다." ]], "_t")
...
대장은 뒤돌아 걸어나갔다. 정찰병은 나에게 따라오라고 손짓했고, 우리는 화톳불까지 걸어갔다. 넝마짝이나 다른 없는 꼴인 샬로렌들이 모여 앉아 있었고 다른 자들처럼 두꺼운 망토를 걸친 한 샬로렌이 활을 쥐고 보초를 서고 있었다. 그 주변에 급조된듯 한 가건물엔 몇몇 샬로렌들이 누워 있었다. 그들의 몸에 감긴 붕대는 붉게 물들어 있었다. 대장은 주변에 있던 상자에서 활과 깨끗한 붕대를 꺼내 정찰병에게 건네 주었다. 잠시 혼란스러움이 내 얼굴에 스쳐 지나갔고, 대장은 그걸 눈치챈 듯했다.

대장은 내게 물었다. "무슨 문제가 있나, 탈로레?" 드디어 그들이 왜 주입물을 쓰지 않는 것인지 대답을 들을 수 있는 기회였다. "왜 붕대를 쓰는 겁니까? 주입물이 없습니까?" 대장은 이 질문에 살짝 즐거운 듯이 대꾸했다. "샬로레가 주입물을 쓴다라?" 대장은 마치 농담이라도 들은 듯이 웃었다. 주변에서 망토를 걸친 자들이 내는 웃음 소리가 들렸다. 대화를 이어가기 위해 대장이 다시 입을 열었다. "자네들이 주입물을 써먹는 건 충분히 이해하지만, 우리 샬로레는 자연 속에서 그런 것들을 넘어서서 살아가려고 한다네."

나는 이런 대답이 조금 당혹스러웠다. 부상을 입은 샬로레가 내뱉는 기침 소리가 들려왔지만, 나는 정중히 말했다. "주입물을 쓰지 않아서 죽을 수도 있다고 해도 말입니까?" 이 물음에 대장은 짐짓 엄숙한 모습으로 가건물의 부상을 입은 샬로레 쪽을 쳐다보며 말했다. "물론 아니지." 나는 그 샬로레를 쳐다보며 난 확고한 목소리로 대답했다. "그렇다면 왜 저 샬로렌들은 부상을 입은 채로 누워있습니까?" 이에 대한 대답은 조용한 목소리로 돌아왔다. "왜냐하면 샬로레는 주입물을 가지고 다니지 않기 때문이네."

어찌나 멍청한지, 나는 그렇게 생각했다. 하플링들이 오만하다는 건 익히 들었지만 이 정도로 무모하진 않을 것이다. 나는 내 짐에서 주입물을 몇 개 꺼내어 그들에게 쥐어줬다. 그 샬로렌들은 손에 쥔 주입물을 일종의 경멸감을 느끼면서 쳐다보는 듯했으나, 아무런 말도 하지 않았다. 마침내 뒤쪽에서 정찰병이 말했다. "많은 이들이 죽었습니다. 그런 부상을 지닌 채로는 저 둘은 이 밤을 넘기지 못 할 겁니다." 그 순간 나는 대장의 얼굴에 비친 불편함을 느낄 수 있었다. 그러나 그는 눈을 감으며 이렇게 말할 뿐이었다. "그들을 치료하고 싶다면, 탈로렌이여, 뜻대로 하게."
...
터널 안쪽은 끔찍할 정도로 어지러웠다. 먼지와 바람 소리가 끔찍한 불협화음을 내며 소리쳤다. 앞으로 길을 나아가면서 나는 연기 속 깊은 곳에서 인간의 시체들을 본 것 같았다. 도시가 눈 앞에 보이면서, 난 황량한 광경을 마주했다. 순찰자들과 거리 위를 걸어가면서, 내가 볼 수 있었던 건 다른 샬로렌의 얼굴에 띤 공허함 뿐이었다. 그들은 마치 희뿌연 안개속을 이리저리 헤매는 듯했다. 내가 지나가며 본 모든 샬로렌 속에서 흐르는 기묘한 공황이 느껴졌다. 마치 소중했던 무언가를 잃어버린 것 같았다.
...
The soldier led me to the center of the city where a grand building lay. After meeting with a couple of the guards clad head to toe in shiny plate armor, we were let in. It took several minutes walking through the building’s halls, seemingly walking the building’s entire length to the end of it. Eventually I came to a luxurious looking room, decorations made of stralite and gold lining the walls and displayed pictures of what I assumed to be important figures in Shaloren history. Here I was told to wait, and left by the lieutenant as he entered a nearby room.]], [[[i]샬로렌이 주입물을 얼마나 싫어하는 지에 대해 생각하면 아직도 난 놀랍기 그지 없다. 그들은 주입물을 쓰느니 차라리 자신들의 운명을 시험하고자 했다. 주입물이 지니는 목적들 중 하나는 부상을 겪은 뒤 건강을 회복하는 것이다. 그러나 샬로레에게 주입물은 죽음을 피하기 위한 최후의 보루 쯤이었다. 게다가, 그들은 주입물을 쓰지 않고 버티는 것이 결국 더 오랫동안 주입물을 써야하는 결과로 이어진다는 걸 이해하지 못 하는 듯했다. 단순히 상처를 메꾸는 것을 넘어서서 벌어진 상처에서 발생할 수 있는 감염을 막아야 하는데 말이다.[/i]

그 이후로 며칠 동안 나는 샬로렌이 쓸 수 있도록 주입물들을 섞고 만들었다. 작업소에는 편안한 잠자리가 마련되어 있었고, 치유사는 나에게 계속 음식과 마실 것들을 가져다 주었다. 글쎄, 샬로레들에게 이게 기본적인 음식과 음료는 되겠지만 탈로레에게는 다소 사치스러웠다고 할 수 있겠다. 그러니까, 드워프가 술을 주식처럼 삼는 건 알고 있었지만 내가 받은 와인의 양에 따라 판단해보면 샬로레에겐 와인이 주식에 포함되는 듯했다. 어쨌든, 내가 받은 대우는 기대한 것 이상으로 좋았다.

넷째 날 즈음에, 꽤 많은 주입물을 만들고 난 뒤에, 지하실에서 올라와 주입물로 치료하는 것을 도와달라는 부탁을 받았다. 내가 치료했던 자들의 상당수가 죽어가고 있었고, 심하게 곪아버린 감염증에 시달리고 있었다. 상처를 붕대로 감기만 하고 다른 조치는 하지 않은 탓이었다. 내가 가건물에 누워있던 샬로렌들을 치료했던 것과 비슷하게, 그들이 죽음의 문턱을 겨우 벗어날 정도로밖에 주입물을 쓰지 않았다. 주입물이 부족해서 그런 것이 아니었다. 샬로레들이 주입물의 사용을 완강히 거부한 탓이었다.

일주일이 지나 피난민 대부분의 치료가 끝난 즈음에, 오크들과 전투를 벌이던 샬로렌 병사들이 복귀했다는 소식이 들려왔다. 마법폭발이 일어났을 때 인간 왕국과 함께 대륙의 동쪽에서 싸우고 있었던 게 분명했다. 엘발라까지 돌아오는 길에서 살아남은 자들은 매우 적었다. 대륙의 중앙을 통해 곧바로 돌아올 수 없었기에 긴 여정이었을 것이다. 살아온 자들은 수백명 뿐이었다.

수백명의 탈로렌을 간호한 뒤였으니, 이 즈음엔 샬로레들에게 어느 정도 동정심이 들었다. 하지만 나의 이목을 사로잡았던 것은 그들이 엘발라로 곧바로 돌아올 수가 없었다고 말한 점이었다. 대륙의 중앙은 미드 베일 평원이 있는 곳으로, 말 그대로 광활한 평야만을 볼 수 있는 곳이었다. 대륙의 지형에 관한 내 기본적인 지식에 따르면, 그 평야는 완전히 개방되어 있으며 통행에 매우 용이했다. 엄청난 규모의 오크 군대가 길을 막는 게 아니라면, 북쪽으로 돌아서 올 필요는 없었을 것이다.
...
The discomfort within my mind was obviously made clear across the desk, but the general refrained from saying anything, perhaps out of some underlying guilt for his part in the Spellblaze or just due to being unable to say anything that could aid in my aligning my thoughts. For a time we sat in silence, though before long he soon got up and headed towards the window. His back turned I couldn't see his expression, but I could tell he thought heavily in regards to how events had unfolded. [i]Aranion if you are reading this now, know that at least I have forgiven you.[/i] ]], [[[i]아라니온 가웨일 장군, 엘발라의 대의회장. 아마 가족 이외의 사람에게서 들은 이름 중 제대로 기억하는 건 이번이 처음일 것이다. 아라니온이 직접 이름을 댄 적은 없었으나, 다른 샬로렌들이 계속 그의 이름을 재잘거리는 통에 결국 이름을 기억해버리는 경지에 이른 것이다. 자신의 이름을 가볍게 대는 이들에게서 배울 점이 별로 없다고 한다면, 난 아라니온을 남들에게서 이름을 알게 된 자로서 존경할 만한 자라고 생각한다. 샬로렌들이 그의 이름을 말할 땐 항상 경애심이 담겨 있었다.[/i]

오래지 않아 병사가 다시 나와서 나를 훨씬 더 검소하게 생긴 방으로 안내했다. 방 한가운데에는 탁자가 있었고, 그 뒤로 북향으로 난 창에서 숲이 보였다. 방의 맞은편엔 호화로운 방어구들이 전시되어 있었고 그 가운데엔 서슬퍼런 무기가 놓여 있었다. 방 안으로 들어가면서, 장군으로 보이는 한 사람을 보았다. 방 한 구석에 있는 탁자 위에서 서류 같은 것들을 보고 있었다. 다른 샬로렌이 초라해보일 정도로 찬란한 기운이 그에게서 스며나왔으나, 그의 주변에 내려앉은 무거운 짐 같은 것을 느낄 수 있다.

진지한 눈빛으로 나를 관찰한뒤 그는 방 한가운데에 있는 탁자의 옆자리를 권했다. 부관이 있는 쪽으로 고개를 끄덕이자, 이내 나를 안내했던 병사는 문을 조용히 방을 나가 문을 닫았다. 그리고 방에는 단 둘만 남았다. 그가 말한 대로 난 자리에 앉았고, 그도 반대쪽으로 의자를 가져와 앉았다. 그는 앉자마자 말하기 시작했다. "의사들이 말해준 것과 순찰자들에게서 받은 보고에 따르면, 당신은 샬로렌 부상자들을 보살피느라 며칠동안 여기 있었다지. 이에 대해 감사를 표하네."
...
익살맞은 목소리로 그가 말했다. "글쎄, 만약 살로레가 숲을 떠나서 여기까지 당도할 이유라고 한다면 만나는 샬로레들을 죄다 몰살하기 위한 것이라고 밖에 상상이 안 갔거든." 마치 펼쳐진 책을 읽듯이 그는 나를 읽어냈다. 내 낯짝을 쳐다보는 것만으로도 머리 속 생각까지 훔쳐보는 듯했다. 그 말을 듣자 나는 조금 움츠러 들었고, 장군이 말한 것을 확인해주는 꼴이 되었다. 그것을 본 장군은 긴장을 풀고 말을 이어갔다. "아직까지 샬로렌을 죽이지 않을 걸보니 분명 뭔가가 자네의 마음을 바꿔놓았군. 잘 알았네. 심지어 우리에게 큰 도움이 되어주기까지 했어. 그러니 내가 아는 것을 알려주도록 하지."

그제서야 그 샬로레 장군은 지금까지 일어났던 일들에 대해 설명해주기 시작했다. 이 땅에 닥친 재앙이 마법폭발이라고 명명되었다 것과, 온 땅을 휩쓸고 다니던 오크들을 소탕하기 위한 목적으로 이뤄졌다는 것을 알았다. 샬로렌은 최선을 다했으나, 그 힘을 조작하던 마법사들은 방대한 에너지를 통제하지 못했다. 그 결과 오크, 샬로렌들 자신과, 마즈'에이알 전체에 파멸의 폭풍을 풀어버렸다. 온갖 파괴가 전 대륙에 걸쳐 일어났으며, 심지어 다른 세계에까지 영향을 미쳤을 것이라고 했다.

이 모든 이야기가 끝날 때까지 나는 침묵을 지키며 듣고 있었다. 마법폭발에 관한 이야기가 끝난 뒤, 샬로렌이 저지른 행위에 대해 어떻게 판단해야 할지 갈피를 잡지 못 했다. 마법폭발이 이 대지에 불어닥치며 찢을 수 없는 상처를 남겼으나, 이것은 전대미문의 위협을 막아내기 위해 한 행동이었다. 그 행동에 따른 결과로, 모든 샬로렌들은 지금 고통받고 있었다. 그리고 난 그들이 이미 충분한 대가를 치루고 있는 것이라고 생각했다.
...
잠시 후 장군이 입을 뗐다. "이제 뭘 할 생각인가?" 좋은 질문이라고 생각했다. "딱히 생각해둔 게 없군요"라고 대답했다. 그는 여전히 내게 등을 돌리고 있었으나, 그의 뒤통술 너머로 피식 웃는 것을 느낄 수 있었다. 그는 나를 돌아보며 물었다. "자네는 이제 숲으로 돌아갈 것 같군. 하지만 돌아가는 길에서도 우리 샬로렌을 도와줄 방법이 있지 않을까 싶네. 우리에게 구호 물자를 전달해줄 수 있겠는가? 또 이용당하는 것이 아닌가 생각했지만, 그의 요청에 어느 정도 흥미가 생겼다.

의문을 품으며 말했다. "듣자하니 제게 남은 호의를 최대한 긁어모아서 어떻게 해보려는 생각인 것 같은데, 샬로레가 직접 공식적인 특사라도 보내서 도음을 청하는 게 어떻겠습니까?" 장군은 무거운 목소리로 대답했다. "나라고 해서 그러고 싶지 않은 건 아닐세. 다만 지금 샬로레를 엘발라 바깥으로 내보내는 것 자체가 매우 위험한 일이야. 당신이 여기 오기 전에, 서쪽에서 온 몇 인간들이 분노한 채로 엘발라의 경계를 습격했네. 당신이 외곽 정착지에서 구해온 대다수의 샬로렌들은 마법폭발이 아니라, 코르낙의 땅에서 온 농노들의 분노 아래 희생당했네."
...
그때서야 나는 이 인간이 내가 생각했던 것 이상으로 꾸미는 것이 있는 인물이라는 것을 깨달았다. 단순히 재담꾼이나 믿을 만한 사람으로 생각하기에는 위험한 구석이 있는 것 같았다. 무모하긴 하지만 이 인간이 뭔가 더 알고 있는지 더 알아보기로 했다. 나는 조용히 말을 꺼냈다, "샬로렌에 관해 뭔가 계획이라도 있나요?" 그 즉시 인간은 자세를 바로 잡았고 이어가는 말의 목소리가 달라졌다. "아, 에이알의 대지에서 그 하찮은 촌뜨기들을 쓸어버린다면 더 좋을 게 없지 않겠소? 보아하니 당신도 그들에게 책임이 있다는 걸 알고 그들의 피로 몸을 적시고자 숲에서 나왔을 거 같은데. 분명 다들 그러고 싶을 거요. 머지않아 샬로렌은 마즈'에이알에 마법폭발을 일으킨 대가를 톡톡히 치룰 것이오."

조심스레 목소리에 분노를 최대한 담아 물었다. "마법폭발, 그걸 그렇게 부르나보죠?" 그렇다고 말하며 그는 대답했다. "그렇소, 최소한 그렇게 들었지." 그는 꽤나 떠들기 좋아했으니 무언가 더 말하기를 기다렸다. "내 제안 하나 하지. 이 계획에 관해 당신도 우리 무리에 참여하지 않겠나? 자연이 이런 참극에 빠지지 않도록 우리의 계획을 곧 실행에 옮길 거야. 당신은 탈로레니 자연의 고통을 아주 제대로 실감하고 있겠지. 그리고, 샬로렌이 가장 큰 책임이 있긴 하지만 다른 종족들이 그 원대한 계획을 아예 모르고 있었던 건 아니라고. 모든 종족이, 아마 드워프를 제외하고는, 마법폭발에 대해 어느 정도 알고 있었을 걸."
...
전령은 웃음을 마추고 조용히 미소지으며 말했다. "물론 자네와 얘기를 하고 싶었기 때문이지. 여기에 무엇 때문에 왔나? 나르골 왕국엔 왜 온 거지?" 그 말에 나는 얼어붙었다. 위험한 상황에 빠진 것이 아닌가. 전령은 섬뜩하게 침묵을 지켰다. 그의 눈이 나를 읽어내고자 하는듯 했고, 그 짧은 순간 속에서 수많은 생각이 스쳐 지나갔다. 난 공포에 질려 말을 더듬었다. "나.. 나는 구호.. 물품을 전하려고 했어.. 나.. 나르골에 도움이 되도록." 전령이 내 얼굴에 주먹을 갈겼고 나는 천막 옆으로 휘청거렸다.  전령은 노기를 띤 목소리로 말했다. "그렇겠지," 내게 고개를 돌리며 소리쳤다. "샬로렌으로부터 말이야!"

전령은 내게 다가와 내 배를 발로 찼고, 나는 바닥에 쓰러졌다. 이내 뒤통수로 발길질이 내려쳤다. 피가 쏟아져 나왔다. 전령은 내 머리를 붙잡고 날 들어올리더니 나를 코앞에 두고 눈을 마주쳤다. 내 면전에 침을 튀기며 말을 쏟아냈다. "그 엘도랄 하플링을 죽였을 땐 자네가 꽤 마음에 들었지. 자연의 동반자라고 생각했단 말이야. 그런데 그렇지 않은 것 같군. 그렇지? 샬로렌이랑 편을 먹었군. 그 하찮은 마법의 안개 속에 숨어있는 놈들이랑 말이야. 자네는 자연의 분노를 마땅히 휘두를 수 있었어. 그런데 자연의 분노를 등지고 우리에게 마법폭발을 끼얹은 자들과 손을 잡아!!"

내 얼굴에서 피가 흘러나오고 눈물이 섞여 나왔다. 나는 눈물을 쏟아내며 빠르게 말했다. "이미 수많은 이들이 고통 받았어. 더 이상의 고통을 더할-" 말을 채 끝내기도 전에 전령은 내 얼굴을 바닥에 처박았다. 그는 소리쳤다. "그 어떤 고통도! 그들이 한 짓에 대한 대가를 치룰 수 없다, 페이! 모든 샬로렌은 하나도 남김없이 모두 죽어야 해. 우리가 불태운 자들처럼 고통스럽게 죽어야-." 전령은 계속 말을 쏟아냈으나, 갑자기 들려온 내 이름 속에서 나는 그가 하는 나머지 말을 모두 무시하고 생각에 빠졌다. 그가 어떻게 내 이름을 알고 있지? 알려준 적이 없는데, 나르골 왕국에서도 말한 적이 없다고. 심지어 샬로레에게도 말한 적이 없어. "도대체 내 이름을 어떻게 아는 거야?" 나는 전령에게 말했다.
...
그 뒤로는 잘 기억이 나지 않는다. 대장과 참모가 서로 이야기하는 것은 기억하지만, 그 도중에 난 기절해버렸다. 내가 다시 일어났을 땐 옆에서 모닥불이 피워져 있었고 난 깔개를 겹쳐 깔아놓은 곳에 누워있었다. 오우거들이 모닥불 위에 꼬챙이에 꽂힌 늑대 고기를 천천히 돌리며 익히고 있었다. 내가 깨어난 것을 본 오우거가 뒤를 돌아보며 이를 알렸다. 주변을 둘러보니 오우거들이 풀뗴기나 벽에 아무렇게나 놓인 탁자 따위를 의자나 침대로 삼아서 숙면을 취하고 있었다. 보아하니 버려진 샬로렌 마을인 것 같았고, 내가 얼마나 정신을 잃었으며 무슨 일이 있었던 건지 궁금해졌다.

대장과 참모가 내 뒤편에 있던 건물에서 나와 내게 다가왔다. 참모가 말했다, "탈로레 당신은 어떤가? 잘 쉬었나?" 나는 자리에서 일어나면서 조금 휘청거렸지만 이내 대답했다. "엘발라에 도착하고 나면 더 잘 쉴 수 있겠죠. 무슨 일이 있었나요?" 이렇게 묻자 난 간단한 설명을 들었다. 우리는 지금 샬로렌 영역의 외곽에 도착했으며 오우거들이 쓰러진 나를 옮겨줬다는 것이었다. 이 얘기를 하는 와중에도 이따금씩 대장이 정찰 룬으로 이곳저곳을 돌아보고 있었다. 참모는 광신도들 중에서도 정찰병들이 우리에게 따라부었으나, 여전히 멀리 떨어진 곳에 있다고 말해주었다.
...
나는 미소를 지으며 대답했다. "당신들 모두 들어갈 수 있을 거예요. 내가 해야할 일이 뭔지만 알려줘요." 그녀는 얼굴에 흐르는 눈물을 훔쳤다. 나는 룬 사용 방법에 대하여 간단한 설명을 들었다. 그리고 귀환의 룬을 쓰기 직전에 오우거들에게 진중하게 고개를 끄덕였다. 잠시 후 주변의 경관히 완전히 바뀌어 있었고,주변의 샬로렌들이 웅성거리는 소리가 들렸다. 룬이 새겨졌던 목 뒤에서 강렬한 감각이 느껴졌으나 그 외엔 딱히 문제되는 것은 없었다. 몇몇 샬로레게 내 쪽을 보고선 적잖이 놀란듯 했으나 내가 예상한 정도는 아니었다. 한 샬로레가 외쳤다. "예전에 우릴 도와줬던 탈로레 아닙니까? 다시 온걸 환영합니다!"
