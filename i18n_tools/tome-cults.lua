...
[i]내가 강령술사에게 패배했다고 해서 엘발라를 떠날 마음이 없어진 건 아니고, 그렇다고 내가 인생을 내다 버리겠다는 것도 아니다. 이 세상에는 도움이 필요한 사람들이 있고, 쳐부수어버려야 할 사악한 계획을 품고 있는 자들도 있다. 그리고 나는 사람들을 도울 수 있다면 무엇이든지 할 것이다. 하지만, 밖에서 무슨 일을 하게 되든 항상 조심할 것이다. 아웨인, 조만간 또 다른 여행기를 써낼게. 기다려 줘, 내 사랑. 내가 집으로 돌아오게 되면, 가장 먼저 네 품에 안길 거야. 하지만 지금은, 우리 집이 있는 이 땅을 떠나 사람들을 돕고 올게.[/i]]], "_t")
...
그때부터 우리는 탐구해왔다. 우리는 이 세상의 비밀들을 낱낱이 밝혀내고, 지표면의 거주자들이 감히 볼 수 없는 어두운 곳들을 파고들었다. 무엇을 보게 될지 모른다는 공포심은 없었다, 우리에게는 그런 두려움이 없다. 왜냐하면 우리는 과거를 돌아보는 것이기 때문이다. 이 곳들에서 우리는 많은 진실을 알아냈고, 에이알의 역사의 흐름을 바꿀 마법을 발견했다.
...
To that end, we all gather here. Are we spiteful for how this world openly rejects us? It would be a lie if we said no. To that end, we shall plunge head first into the places no one else dares look. We shall use the dark secrets of this world to carve out our own place in it. We shall create wonders while the world above us rests in fitful dreams.]], [[우리는 한때  소수였다. 다른 이들이 오래전에 잊어버린 어떤 틈새와 어두운 장소들에서 추방된 자들. 우리가 이 요새를 차지했을 때, 더 많은 이들이 오기 시작했다. 공포체도 아니고, 지상의 거주자도 아니었으며, 그 사이에 끼어버린 우리같은 찾아왔다. 우리들 중 몇몇은 이렇게 태어났고 다른 이들은 우리가 이해할 수 없는 힘에 의해 변이되었다. 우리 모두에게 공통적인 것은 우리가 어디에도 속하지 않는다는 것이다. 주의 깊게 들여다 본다면 우리는 에이알 깊은 곳의 공포를 분명히 이해할 수 있다. 뒤틀리고 타락한 몸으로, 어떤 '문명화된' 사람들도 우리가 그들 사이에 있는 것을 용납하지 않을 것이다. 그러나 우리가 크로슈쿠르에 거주할 때, 우리는 장인, 학자, 은둔자, 시인, 전사들이다.
