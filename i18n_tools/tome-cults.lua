...
그 말이 마치 비수같이 내게 꽂혔고, 나는 꽤 화가 났다. 나는 대장에게 소리치며 대답했다. "아뇨, 난 함께 싸우겠어요." 내 안의 분노 때문에 그렇게 외쳤는지는 잘 모르겠다. 하지만 난 오우거들을 내버려두지 않을 것이었다. 그 싸움에서 죽을 수도 있었지만, 나는 도망치지 않으리라 다짐했다. 내가 외치는 소리에 대장과 다른 오우거들은 나를 쳐다봤다. 놀라워하면서도 어째 기뻐하는 듯했다. 어떤 오우거가 쾌활하게 외쳤다. "전투로!" 다른 오우거들도 이내 "전투로!"라고 외쳤다. 대장은 미소를 지으며 이내 손을 들어올렸고, 다른 오우거들에게 조용히 하라는 신호를 보냈다. 그러고선 작게 고개를 끄덕이며 내게 말했다. "전투로."
...
t("Escapades of Fay Willows [Book 3, Chapter 4] - To Battle!", "페이 윌로우즈의 여행기 [3권, 제4장] - 전투로!", "_t")
...
그런 대장의 고무적인 모습의 다른 오우거들도 돌격하여 전투를 시작했다. 거대한 오우거들이 일제히 달려드는 모습에 대부분의 신병들은 사기가 바닥났고, 이내 수많은 자들이 도망치기 시작했다. 가면을 쓴 광신도들은 맞서 싸웠지만 곧 포위되어 주먹과 통나무에 얻어맞으며 죽어갔다. 갑옷을 입은 광신도들은 조금 더 버티고 있었지만 이내 하나씩 나가떨어졌다. 적들은 우리 앞에 쓰러져갔고 나는 그때 이긴 것이나 다름없다고 생각했다. 어떤 오우거가 내 머리 위로 날아가더니 근처 바다에 끓어오르는 물속으로 처박히는 것을 보기 전까지는. 
...
다른 오우거가 이내 하플링을 공격하기 위에 다가갔으나, 하플링은 그저 옆으로 피하더니 어둠 속으로 사라졌다. 그 오우거는 급히 그를 뒤쫓았지만, 신음소리와 비명이 몇 차례 들린 것을 보아 그 오우거 또한 상대가 되지 않았던 것 같다. 하플링은 여기저기서 갑자기 튀어나오며 오우거들을 손쉽게 물리쳤고, 반격을 허용하지 않았다. 오우거들은 어둠 속에서 공격당하며 고통 속에 비명을 질렀고, 그 난장판 속에서 위험한 지형에 가까이 있던 이들은 이내 그곳에 메다꽂혔다. 순식간에 승기는 광신도들 쪽으로 기울었고, 공포와 혼란이 오우거들을 휩쓸기 시작했다.]], "_t")
...
그때 내가 고향을 나섰을 때 죽였던 엘도랄의 하플링이 떠올랐다. 마법폭발을 옹호하면서 쏟아내는 헛소리들에 분노했었다. 주변 식탁에 올려져 있던 고기 써는 칼을 들고 나간 뒤, 하플링을 따라 나가서... 죽였다. 생명을 빼앗을 때의 느낌은 정말 끔찍했지만, 음산한 기운이 내 혈관을 타고 흐르면서 다른 놈들을 더 죽여버리고 싶은 충동이 솟구쳤다. 살인 충동, 그것이 내가 처음 여행을 나섰던 근원이었다. 나는 누군가를 죽이는 것이 두려웠다. 죽어 마땅한 자들만이 있는 것은 아니니까. 그 하플링은 죽어 마땅한 자가 아니었다. 하지만, 이 광신도들은 어떤가?
...
그때 가면을 쓴 인간 하나가 나와 땅에 쓰러진 드워프의 시체를 번갈아 보는 것을 알아챘다. 나는 그에게 천천히 걸어갔고, 인간은 손에 든 칼을 휘두르며 위협했다. 분명 내 목숨을 앗아갈만한 칼질이었고 강렬한 공포를 느낄 만했으나, 어째선지 그저 우스울 뿐이었다. 인간은 무어라 웅얼거리며 외치고 있었으나, 나는 그가 뭐라고 말하는 것인지 제대로 들을 수 없었다. 내가 가까이 다가가자 인간이 몸을 벌벌 떨었다. 어찌나 덜덜 떨어댔는지 가면이 조금 기울어져 그 자의 얼굴이 보일 정도였다. 자기 몸을 지키려고 방패를 들고 떠는 인간의 눈에서 공포가 엿보였다. 난 그때 그 공포를 즐기고 있었다.

난 도깨를 휘둘러 인간이 들고 있던 방패를 옆으로 치워버려 내동댕이 쳤다. 인간은 내 시선을 더 이상 피할 수 없었고 나는 그의 공포를 그대로 음미할 수 있었다. 인간에게서 공포가 차오르자 나는 소름끼치는 미소를 지었던 것 같다. 그와 동시에 내 안에 슬픔 또한 차오르는 것 같았다. 그것이 나를 더 깊은 어둠 속으로 빠뜨리려 하고 있었다. 인간은 공포에 질린 채 내게 돌진했다. 무어라 소리지르며 칼을 내질렀다... 그가 도대체 무얼 공격하고 있었지? 그는 날 공격할 셈이었던 것 같지만 내 옆쪽으로 내질렀을 뿐이었다. 난 도끼를 들쳐올리고, 방금 드워프에게 했던 것처럼, 그의 어깨에 휘둘렀다.

검을 쥐었던 팔이 아예 떨어져 나가고, 인간은 비명을 지르며 땅에 쓰러졌다. 그는 팔이 있었던 자리를 움켜쥐었다. 붉은 피가 잘려나간 팔에서 솟구쳐나왔고, 검은 손에 꽉 쥐어진 채로 남아있었다. 인간은 어떻게든 기어서 도망가려고 했고, 그때 나는 옆에 있던 용암 웅덩이를 발견했다. 그때만큼 용암 웅덩이가 사랑스러웠던 적도 없었다. 나는 히죽 웃으며 그의 몸뚱이를 걷어차 웅덩이로 빠뜨렸다. 내 앞에서 산 채로 불타는 인간을 보며 기묘한 즐거움이 느껴졌다. 그러나 그 동시에 내가 저지른 행위에 대한 경멸감 또한 느껴졌다. 그 인간이 마침내 죽자 또 다른 기운이 내 안에서 흐르는 것이 느껴졌고, 난 더한 살인 충동을 느꼈다. 더 이상 나 스스로를 멈출 수 없었고, 누군가 날 막을 수 있으리라 생각하기도 어려웠다.

주위에서 공포의 비명이 들렸고, 그 비명의 주인들은 가면을 쓴 자들도 아니었다. 손쉬운 먹잇감들이었다. 난 비명을 지르던 놈들에게 다가갔고, 내 깊은 증오심 또한 매 걸음마다 끓어올랐다. 그때 갑자기 누군가가 내 어깨를 잡아당겼다. 누가 나를 붙잡고 있는 것인지 뒤를 돌아보자, 가면을 쓴 하플링이 내 팔을 붙잡고 있었다. 순식간에 증오심이 불타올라 이내 내가 오직 생각할 수 있었던 건 이 하플링이 천막에서 내게 저지른 짓에 대해 어떻게 갚아줄까에 대한 것뿐이었다. 난 다른 잡졸들에 대한 것은 잊고, 내 앞에 새 먹잇감에 온 신경을 집중했다.]], "_t")
