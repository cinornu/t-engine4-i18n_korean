...
I jostled around attempting to break free of the halfling’s hold, yet somehow despite the halfling’s smaller size than my own I could not break free, and he was doing this with just one arm. Taking the dagger in hand, the human pulled back and then thrust forward to finish me off. I was sure I would be killed, but in the next instant I noticed the dagger tumbling in the air. A bit confused at this, it would take me a moment to realize that the halfling that was holding me down had prevented the human from killing me. Seemingly as confused as me, the human seemingly look at the halfling with disbelief. Finally coming to his senses, the human finally regained his composure to ask the simple question on both of our minds. "What are you doing?"]], [[[i]내가 그 천막에서 본 것들은 초능력을 통한 노예화로 인한 것이었다. 나는 나의 생각을 염상하여 내 정신에 스스로 대항했고, 이로써 노예술사가 내 정신에 손대려는 것에 대항할 수 있었다. 운이 정말 좋았다. 노예술사의 염상으로부터 벗어날 수 있었으니까. 그렇게 하지 못 했다면, 나는 완전히 노예가 되어 그들이 시키는 것을 그대로 하는 꼭두각시가 되었을 것이다.[/i]

나는 천막 바닥에 나동그라지며 바닥에 세게 부딪혔다. 어지러운 상태로 나는 나를 집어던진 자를 올려다 보았다. 하나같이 가면을 쓴 자들이었으며, 방금 있었던 행위에 동참한 자들이었다. 그들 중 한 명이 손을 천천히 움직여 가면을 벗었다. 인간 전령의 얼굴이었다. 그는 소리내어 웃다가 이내 입을 열었다. "여기서 만나니 반갑군, 우리가 여관에서 대화했을 때 당신에게서 무언가 봤지." 전령은 내가 겨우내 일어서는 동안 또 웃었다. 내동댕이쳐진 충격으로 인해 시야가 흐릿하여 천막 안에 있던 것들이 제대로 보이지 않았다. 나는 전령에게 대답했다. "원하는 게 뭐야, 그리고 왜 나를 끌고 들어왔지?"

전령은 웃음을 마추고 조용히 미소지으며 말했다. "물론 자네와 얘기를 하고 싶었기 때문이지. 여기에 무엇 때문에 왔나? 나르골 왕국엔 왜 온 거지?" 그 말에 나는 얼어붙었다. 위험한 상황에 빠진 것이 아닌가. 전령은 섬뜩하게 침묵을 지켰다. 그의 눈이 나를 읽어내고자 하는듯 했고, 그 짧은 순간 속에서 수많은 생각이 스쳐 지나갔다. 난 공포에 질려 말을 더듬었다. "나.. 나는 구호.. 물품을 전하려고 했어.. 나.. 나르골에 도움이 되도록." 전령이 내 얼굴에 주먹을 갈겼고 나는 천막 옆으로 휘청거렸다.  전령은 노기를 띤 목소리로 말했다. "그렇겠지," 내게 고개를 돌리며 소리쳤다. "샬로레으로부터 말이야!"

전령은 내게 다가와 내 배를 발로 찼고, 나는 바닥에 쓰러졌다. 이내 뒤통수로 발길질이 내려쳤다. 피가 쏟아져 나왔다. 전령은 내 머리를 붙잡고 날 들어올리더니 나를 코앞에 두고 눈을 마주쳤다. 내 면전에 침을 튀기며 말을 쏟아냈다. "그 엘도랄 하플링을 죽였을 땐 자네가 꽤 마음에 들었지. 자연의 동반자라고 생각했단 말이야. 그런데 그렇지 않은 것 같군. 그렇지? 샬로레와 편을 먹었군. 그 하찮은 마법의 안개 속에 숨어있는 놈들이랑 말이야. 자네는 자연의 분노를 마땅히 휘두를 수 있었어. 그런데 자연의 분노를 등지고 우리에게 마법폭발을 끼얹은 자들과 손을 잡아!!"

내 얼굴에서 피가 흘러나오고 눈물이 섞여 나왔다. 나는 눈물을 쏟아내며 빠르게 말했다. "이미 수많은 이들이 고통 받았어. 더 이상의 고통을 더할-" 말을 채 끝내기도 전에 전령은 내 얼굴을 바닥에 처박았다. 그는 소리쳤다. "그 어떤 고통도! 그들이 한 짓에 대한 대가를 치룰 수 없다, 페이! 모든 샬로레는 하나도 남김없이 모두 죽어야 해. 우리가 불태운 자들처럼 고통스럽게 죽어야-." 전령은 계속 말을 쏟아냈으나, 갑자기 들려온 내 이름 속에서 나는 그가 하는 나머지 말을 모두 무시하고 생각에 빠졌다. 그가 어떻게 내 이름을 알고 있지? 알려준 적이 없는데, 나르골 왕국에서도 말한 적이 없다고. 심지어 샬로레에게도 말한 적이 없어. "도대체 내 이름을 어떻게 아는 거야?" 나는 전령에게 말했다.

그는 쏟아내는 말을 멈추고 나를 내려다보며 대답했다. "무슨 말이 하고 싶은 거야, 페이. 너는 예전에 이름을 알려줬어. 그때.. 예전에-." 갑작스레 그는 말을 멈추고 얼굴이 굳어갔으며 이내 표정이 사라졌다. 무슨 일이 벌어지고 있는지 몰랐으나, 난 이때 이것이 얕은 속임수라고 생각했다. 나는 내 속에서 분노가 끓어오르는 것을 느낄 수 있었다. 난 나를 붙잡고 심문하던 '무언가'를 손으로 잡아챘다. 그것은 나를 붙잡아두고 제압하려고 했으나, 나는 이내 그를 끌어내려 같이 바닥으로 넘어졌다. 나는 다른 손으로 그것의 머리를 후드려 쳤으나, 이내 그것의 모습은 희미해지고 사라져갔다.

나는 다시 주변 사물을 또렷하게 볼 수 있었고 주변을 둘러보자 검은 망토를 두른 인간을 보았다. 이내 그 인간이 여관에서 전령과 이야기를 나눌 때 다가와 귓속말을 나누었던 그 인간이라는 것을 깨달았다. 또한 군중 속에 스며들어 야만스런 행위를 선동했던 자였다. 나는 똑바로 일어서서 말했다. "당신 정체가 뭐야?" 천막의 입구 쪽으로 한 인물이 뒷걸음치고 있었다. 나를 사로잡고 있었던 무언가를 내가 떨쳐낸 것을 보고 도망치려는 듯 했다.  그가 천막 바깥으로 도망치기 전에 그 악당을 붙잡기 위해 입구로 달려갔다. 그 다음에 무슨 일이 일어났는지는 알 수 없다. 나는 바닥에 엎어져 있었다.
