...
드워프는 쪼개다 말고 말을 이었다. "이제 우리 좀 도와주는 게 어때 뾰족귀 아가씨? 안 그러면 어쩔 수 없이 널 죽[b]여어으으아아아악!![/b] 
...
나는 곧바로 바닥에서 일어나며 하플링을 찢어 죽이고 싶은 충동을 느꼈다. 그다음에 어떤 일이 일어났는지는 잘 기억나지 않지만 내가 곧바로 하플링의 등짝을 내려찍었던 건 기억난다. 나도 어떻게 한 건지는 모르겠지만, 내가 찰나의 순간에 놈의 등 뒤로 움직인 것 같았다. 정통으로 맞은 하플링은 고통에 찬 비명을 질렀다. 하플링도 분노를 터뜨리며 나한테 주먹질을 날렸지만, 나는 그냥 다른 쪽 손으로 몇 번 두들겨 패서 하찮은 공격을 떨쳐냈고 이내 전력을 다해 하플링을 마구 공격했다. 내가 먹잇감에게 도끼질을 할 때마다 놈의 갑옷이 찢겨나갔다. 이때 내가 얼굴을 괴상하게 일그러뜨리며 웃고 있었던 것과, 내가 도끼를 휘두를 때마다 내 안의 증오가 뿜어져 나오던 걸 기억하고 있다.
...
배고픈 오우거를 본 적이 있는가? 배고픈 오우거들은 눈 앞의 음식이란 음식은 순식간에 먹어치워 버린다. 나는 겨우 자리를 비켜줄 수 있었으나 모든 오우거들이 눈 앞의 때깔좋은 식량에 달려들어 먹어치웠다. 이내 그 광경을 돌아보자, 내가 내려놓았던 식량은 모두 온데간데 없었고 내 배낭을 뒤지며 식량이 더 남아있는지 찾고 있었다. 먹을 것을 더 찾지 못 하자, 그제서야 그들은 조금이나마 지성인인처럼 행동하기 시작했다. 오우고 대장이 일어나 내게 와선 음식에 대해 감사를 표하고, 지나치게 식탐을 부린 것에 대해 사과했다. 그런 사과가 내 허기를 채워주진 못 했지만, 그들이 배를 어느 정도 채웠다는 사실만으로 난 꽤나 기분이 좋았다.

뒤에서 참모가 다가와 손에 쥐고 있던 비상 식량 하나를 건네주었다. 난 이를 보자마자 음식을 낚아채어 허겁지겁 먹어치웠다. 이미 반쪽은 먹힌 음식이었으나 배가 고픈 마당에 그런 걸 신경쓸 겨를이 없었다. 대장과 참모는 날 보며 잠깐 낄낄 웃었다. 잠시 후 자신들이 처한 상황을 다시 깨달았다는 듯이, 웃음을 멈추고 진정했다. 대장은 남쪽 해안선을 바라보며 눈에 검푸른 빛을 띠었다. "아직도 쫓아오고 있나요?" 참모가 물었다. "아니, 하지만 그렇다고 안심할 순 없지." 대장이 대답했다.

그 뒤로는 잘 기억이 나지 않는다. 대장과 참모가 서로 이야기하는 것은 기억하지만, 그 도중에 난 기절해버렸다. 내가 다시 일어났을 땐 옆에서 모닥불이 피워져 있었고 난 깔개를 겹쳐 깔아놓은 곳에 누워있었다. 오우거들이 모닥불 위에 꼬챙이에 꽂힌 늑대 고기를 천천히 돌리며 익히고 있었다. 내가 깨어난 것을 본 오우거가 뒤를 돌아보며 이를 알렸다. 주변을 둘러보니 오우거들이 풀뗴기나 벽에 아무렇게나 놓인 탁자 따위를 의자나 침대로 삼아서 숙면을 취하고 있었다. 보아하니 버려진 샬로레 마을인 것 같았고, 내가 얼마나 정신을 잃었으며 무슨 일이 있었던 건지 궁금해졌다.

대장과 참모가 내 뒤편에 있던 건물에서 나와 내게 다가왔다. 참모가 말했다, "탈로레 당신은 어떤가? 잘 쉬었나?" 나는 자리에서 일어나면서 조금 휘청거렸지만 이내 대답했다. "엘발라에 도착하고 나면 더 잘 쉴 수 있겠죠. 무슨 일이 있었나요?" 이렇게 묻자 난 간단한 설명을 들었다. 우리는 지금 샬로레 영역의 외곽에 도착했으며 오우거들이 쓰러진 나를 옮겨줬다는 것이었다. 이 얘기를 하는 와중에도 이따금씩 대장이 관측 룬으로 이곳저곳을 돌아보고 있었다. 참모는 광신도들 중에서도 정찰병들이 우리에게 따라부었으나, 여전히 멀리 떨어진 곳에 있다고 말해주었다.

"여기에 오래 머물 순 없네." 참모가 말했다. 난 참모를 돌아보며 말했다. "언제부터 다시 움직일 건가요?" 참모가 대답하기도 전에 대장이 불쑥 튀어나와 대답했다. "자네가 뭐든 입에 뭘 집어넣고 나면 바로." 대장의 표정을 보아하니 모닥불 위에서 돌아가는 늑대 고기를 먹으라는 것 같았다. 고기를 먹는 생각만으로 조금 역겨웠다. 나는 내 음식은 직접 구할 것이라고 말했다. 내가 이렇게 말하니 대장이 나를 잠시 쳐다보다가, 한숨을 쉬며 "그러면 서두르게." 라고 말했다. 그러고선 잠에 푹 빠진 오우거들을 깨우기 위해 발을 돌렸다.

주변 건물을 잠시 뒤져보니 녹슨 자물쇠로 잠긴 지하실 문을 발견했다. 자물쇠를 부수고 사다리를 내려가자 지하 저장고가 있었다. 원래 살던 샬로레들이 떠나고 나서 아무도 건드린 흔적이 없었다. 나는 와인 몇 병과 오래된 야채, 말린 과일 등을 발견했다. 주변에 있던 의자와 식탁에 쳐진 거미줄을 치워버리고, 거기에 앉아 허기를 채웠다. 그리고 야채와 과일을 챙길 수 있을만큼 챙겨 오우거들에게 돌아갔다. 대장은 이미 오우거들을 깨우고 정리를 거의 끝마쳤다. 오우거들의 어깨에는 최근에 사냥한듯한 동물의 사체가 걸쳐져 있었다. 대장과 참모는 내가 음식을 들고 온 것을 보고 어디서 식량을 찾았는지 물어보며 운반을 도와주겠다고 말했다.

난 지하 저장고의 위치와 그 안에 어떤 것드링 있는지 알려주었다. 음식을 더 찾을 수 있다는 말에 꽤 흥미를 보였던 대장은 샬로레의 지하 저장고에서 찾았다는 말을 듣고는 꽤 실망한 기색이었다. 저장고에서 들고 올라오는 데에도 시간이 꽤 걸리는 데다가, 오우거들은 이 마을에 있는 어떤 문에도 들어갈 수가 없었으며 특히 지하 저장고 따위로 들어가는 접이식 문에는 특히나 맞을리가 없었다. 하지만 참모는 앞으로의 여행을 위해서 충분한 음식을 구비해 놓아야 하며, 탈로레인 나는 드나드는 데에는 문제가 없을 것이라고 역설했다. 대장은 이곳에 좀 더 머물러야 한다는 것에 조금 꺼려지는 듯했으나, 이내 동의했다. 한 시간 쯤 시간을 들여 나는 저장고 안의 음식들을 모두 꺼내올 수 있었고 그제서야 우리는 엘발라로 다시 걸음을 옮겼다.]], "_t")
