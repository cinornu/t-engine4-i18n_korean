...
목표 더미에는 가짜 공허 에너지가 배어 있다; 그것들에 너희의 운명파괴자를 시전하고, 그 다음 생명력이 낮아진 때에 황천폭발을 자신에게 사용해라. 나의 학생들아, 이것은 고난도의 훈련이다. 지금 목숨을 걸고 있다는 것을, 실수 하면 죽을 수 있다는것을 명심해라.
...
...It is too late. Something is coming. Even I do not know what. I knew that this was a mistake.]], [[안 돼, 안 돼! 정신 집중이 안됐잖아! 머릿속에 선명한 이미지를 반드시 새기라고 말했거늘! 너의 어리석은 야망이 너를 이기게 두지 마라! 너는 그 너머에 있는것을 통제할 수 없어!

...너무 늦었다. 뭔가가 오고 있어. 나조차도 무엇인지 알 수 없다. 나는 이걸 가르치는것이 실수라는 것을 알았거늘.]], "_t")
...
크로그의 대다수는 지구랏 추종자들의 영토 심장부가 있는 대륙의 중앙이나 그 부근에 사는 경향이 있고 그들은 반마법적 대의에 봉사하기 위해 무기를 든다고 알려져 있다. 실제로 어떤 사람이 마주칠지 모르는 지구랏 추종자 순찰대의 대부분은 보통 크로그 투사로 이루어져 있다는 것을 발견할 수 있을 것이다. 모든 크로그는 어떤 식으로든 마법을 다루는 사람에 대해 엄청난 증오를 품고 있으며, 마법사와 싸울 수 있는 능력을 소유하는 것뿐만 아니라 자연과 교감하는 능력을 보여주는 것 같다. 결과적으로 크로그는 마법사들을 강하게 경멸하는데 지구라트 추종자들은 크로그에게 단순히 룬을 제거하고 피를 채워넣는것 외에 다른 짓을 한걸지도 모른다
...
그들이 이전의 자아없는 상태에서 나온 지 얼마 되지 않았기 때문에, 드렘은 그들을 둘러싼 세계와 완전히 단절된 종족이다. 드렘에겐 어떤 역사나 문화도 없는것으로 보이며 그들은 에이얄 표면의 문명화된 종족과 에이얄 지하의 공포체 사이에 놓인 벼랑에 기대어 앉아있는 상태이다 많은 사람들은 그들이 드워프들과 어떤 연관성을 가지고 있다고 의심하고 있는데, 일반적인 이론은 그들이 그 자랑스러운 종족의 타락한 일부라는 것이다. 그러나 이 주제에 대한 연구는 거의 없었고 이러한 주장을 입증하는 증거는 거의 발견되지 않았다. 드렘이 에이알의 미래에 어떤 영향을 미칠지는 지금으로서는 알 수 없다.]], "_t")
