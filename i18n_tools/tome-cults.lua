...
그들의 고향 행성은 순전히 울흐'록의 의지에 의해 붙들어져 있는 조각난 대륙들의 집합체로 묘사된다. 악마들에 의하면, 행성이 이렇게 된 것은 쉐르'툴의 장거리 차원문을 통해 쏟아진 대재앙 때문이라고 한다. 그들의 기록은 이 '대재앙'이 대략 에이알의 마법폭발과 비슷한 시기에 발생했음을 말해 주고 있다. 이것은 마법폭발의 영향이 우리가 현재 알고 있는 수준을 훨씬 넘어서고 있으며 다른 여러 세계에까지 영향을 미쳤을 수 있다는 것을 시사한다. 
