...
검을 쥐었던 팔이 아예 떨어져 나가고, 인간은 비명을 지르며 땅에 쓰러졌다. 그는 팔이 있었던 자리를 움켜쥐었다. 붉은 피가 잘려나간 팔에서 솟구쳐나왔고, 검은 손에 꽉 쥐어진 채로 남아있었다. 인간은 어떻게든 기어서 도망가려고 했고, 그때 나는 옆에 있던 용암 웅덩이를 발견했다. 그때만큼 용암 웅덩이가 사랑스러웠던 적도 없었다. 나는 히죽 웃으며 그의 몸뚱이를 걷어차 웅덩이로 빠뜨렸다. 내 앞에서 산 채로 불타는 인간을 보며 기묘한 즐거움이 느껴졌다. 그러나 그 동시에 내가 저지른 행위에 대한 경멸감 또한 느껴졌다. 그 인간이 마침내 죽자 또다른 기운이 내 안에서 흐르는 것이 느껴졌고, 난 더한 살인 충동을 느꼈다. 더 이상 나 스스로를 멈출 수 없었고, 누군가 날 막을 수 있으리라 생각하기도 어려웠다.
...
마법 폭발 이후로 일어났던 여러 사건들을 되돌아보면, 내가 고향을 떠나지 않았다면 내가 어떤 삶을 살았을지 의문이다. 내가 여행을 시작한 뒤로 긴 시간이 흘렀지만, 지금 또다시 나는 엘발라를 떠나 낯선 땅을 향해 세상이 어떻게 변했는지 보고자 한다. 에이알의 사람들이 어떻게 지내고 있는지, 이 상처받은 대지가 회복될 기미가 보이는지, 고향의 탈로레는 어떻게 지내는지 알고 싶다. 앞으로 무엇이 내 앞에 기다리고 있든, 나는 그 모든 것을 헤쳐나갈 주닙가 됐다. 그것은 내 또다른 모험의 시작이리라!]], "_t")
