...
내 마음속에서 감도는 불편함이 탁자 사이에서도 감돌았으나, 장군은 아무 말도 꺼내지 않았다. 마법폭발의 책임이 그에게도 어느 정도 있다는 것 때문이거나 내가 생각을 정리하는 데에 도움을 줄만한 말을 꺼낼 수 없었기 때문인 것 같았다. 잠시 동안 정적이 일었고, 이내 그는 자리에서 일어나 창가 쪽을 바라보고 섰다. 그가 등을 보였으니 나는 그의 표정을 볼 수 없었다. 그러나 지금까지 일어났던 사태들에 대해 진중하게 생각하고 있음은 알 수 있었다. [i]아라니온, 이걸 지금 읽고 있다면, 알아두세요. 최소한 나는 당신을 용서했어요.[/i] ]], "_t")
