...
t("Escapades of Fay Willows [Book 4, Chapter 2] - Seeking Sanctuary", "페이 윌로우즈의 여행기 [4권, 제 2장] - 안식처를 찾아서", "_t")
...
그 오우거가 말하는 것들은 나에겐 마치 다른 언어로 말하는 것 같았다. 그녀는 훗날 나의 선생이 된다. 그녀는 나에게 룬에 대한 여러 설명을 해주었지만, 결국 룬의 이론에 관하여 수업을 늘어놓기보단 내게 귀환의 룬을 부여하는 것이 좋겠다고 판단했다. 룬을 활성화함에 가장 문제가 없을 신체 부위에 새기기로 결정한 것이 바로 내 목 바로 밑의 등이었다. 룬을 새기는 과정에서 느꼈던 고통이 아직도 생생하다. 척추의 신경이 바늘로 찔리는 듯한 고통이었다. 하지만 그 고통 속에서도 처음으로 마법을 받아들이는 것에서 느껴지는 고양감 또한 생생히 기억한다.

"자, 다 됐어요." 그녀는 만족스러워 하며 내 앞으로 와서 어깨에 손을 올렸다. "이제, 남은 일은 당신이 이 장벽을 통과해서 우리를 들여보내달라고 부탁하는 거예요. 탈로레, 룬을 작동하기 전에 말할게 있어요. 우리르 여기까지 오게 해주셔서 정말 감사해요. 당신이 없었으면 난... 우리 오우거들은 모두 죽었을 거예요." 그녀는 말을 이어가며 눈물을 흘렸다. "또다시 우리의 목숨이 당신에게 달렸어요. 샬로레들을 설득할 수 있으면 정말 좋겠죠. 하지만 실패하더라도 감사하다는 것엔 변함이 없어요. 우리 모두가요." 주변의 다른 오우거들도 고개를 숙였다.

나는 미소를 지으며 대답했다. "당신들 모두 들어갈 수 있을 거예요. 내가 해야할 일이 뭔지만 알려줘요." 그녀는 얼굴에 흐르는 눈물을 훔쳤다. 나는 룬 사용 방법에 대하여 간단한 설명을 들었다. 그리고 귀환의 룬을 쓰기 직전에 오우거들에게 진중하게 고개를 끄덕였다. 잠시 후 주변의 경관히 완전히 바뀌어 있었고,주변의 샬로레들이 웅성거리는 소리가 들렸다. 룬이 새겨졌던 목 뒤에서 강렬한 감각이 느껴졌으나 그 외엔 딱히 문제되는 것은 없었다. 몇몇 샬로레게 내 쪽을 보고선 적잖이 놀란듯 했으나 내가 예상한 정도는 아니었다. 한 샬로레가 외쳤다. "예전에 우릴 도와줬던 탈로레 아닙니까? 다시 온걸 환영합니다!"

"음, 어, 고마워요." 내가 한때 엘발라에 비집고 들어왔었다는 사실을 다시금 깨닫고 대답했다. 오우거들이 엘발라 바깥에서 기다리고 있다는 것을 되새겼다. 그리고 내게 말을 건넨 샬로레에게 양해를 구하면서도 재빠르게 장군을 만났던 도시의 중앙으로 달려갔다. 그 건물에는 예전처럼 경비병들이 서있었다. 내가 건물에 다가가 경비병들이 날 알아봤다. 나는 숨을 헐떡이며 깊은 숨을 들이쉬고 내쉬고를 반복하다 겨우 말을 토해냈다. "오우거들이... 피난을 왔어... 여기... 엘발라에." 이 말을 듣자 경비병들이 적잖이 당황했으며 내 말을 이해하긴 했지만 어찌해야 할 바를 모르는 것 같았다.

그리고 내 뒤에서 목소리가 들려왔다. "오우거가 뭐 어떻다고?" 뒤를 돌아보자 젊은 여자 샬로레가 서있었다. 내가 엘발라를 떠날 때 있었던 마법사들 중 한 명이었다. 그녀는 잘 보고선 잠시 움찔했다가 이내 날 알아보고선 말했다. "오, 당신 그 탈로레군요. 우리가 서로 얘기한 적은 없지만 그때 엘발라 바깥으로 전이시켰었죠. 엘발라로 돌아온 걸 환영해요." 나는 숨을 고르며 그녀에게 상황을 설명했다. 오우거들이 바깥에 있으며, 광신도들이 쫓아오고 있고, 그들이 엘발라로 피난을 오고 싶다는 것을 모두 말해주었다. 내가 말을 마치자 젊은 샬로레가 말했다. "당신의 말에 따르면, 오우거들이 여기로 빨리 들어오는 게 최선이겠네요."

그녀가 경비병에게 다가가 무언가 말하자, 이내 그들의 당혹스런 표정이 침울한 표정으로 바뀌었다. 샬로레 마법사가 무어라 말한 것인지는 모르겠지만, 경비병들은 그 샬로레에게 무언가에 대해 계속 탄원하고 있는 것 같았다. 결국 그녀는 내게 따라오라고 말했고 내가 귀환의 룬으로 도시에 들어왔던 장소로 가기 시작했다. 이 샬로레는 무언가 계획을 하고 있는 것 같았고 오우거들을 안으로 들여보내주려는 것 같았다. 내가 그녀를 따라가려 할 때, 두 경비병이 무언가 중얼거리며 대화하고 있었다. 그러고선 한 명은 건물로 뛰어들어갔고, 다른 한 명은 멀어져가는 나와 마법사 쪽을 걱정스런 눈빛으로 쳐다보고 있었다.]], "_t")
