...
With this the halfling turned to leave the tent. The anger within me had not subsided much, but I made no further attempt to confront the halfling. Battered and bruised I sank down to the ground and rested a moment. Pulling one of the infusions I had recently purchased from the market, I began to treat my wounds. When I felt I was in better shape I got up again and left the tent. Looking up I noticed the evening sky, and decided that I would be staying one more night in the Nargol Kingdom. I made my way back to the inn where I slept in a bed until the next day. When I left I headed straight to the gates of the city to make my way out. There I pondered where my next destination would be, before finally heading south.]], [[[i]시간이 지날수록 나르골 왕국은 끔찍한 참극을 주모한 자들을 진압했고, 내가 왕국을 떠난 뒤에도 비슷한 일들이 일어났다. 나르골 왕국은 주모자들을 처형하여 길거리에 효수해 놓았다. 그럼에도 불구하고, 산채로 화형시키는 등의 잔악무도한 행위는 시민들에 의해 직접 이뤄지게 된다. 전령들은 처형되었을지 몰라도, 그들의 뜻은 오히려 널리 퍼지게 된다.[/i]

하플링이 대답할 틈도 없이 그 인간은 하플링에게 말을 쏟아냈다. "이 자를 살려줄 생각은 아니겠죠? 이년은 샬로레랑 편을 먹었습니다. 마법사들과 한패라고요!" 폭언이 이어지면서 인간의 언성은 계속 높아졌다. "우리의 사명과 책무를 잊었습니까? 이 탈로레는 자연을 배신했다고요! 당장 죽여야-" 하플링은 더 이상의 폭언을 제지하고자 손을 올렸다. 그리고 하플링 같이 작은 체구에서는 나오리라 생각하지 못 했던 낮은 목소리로 말했다. "충분하다." 인간은 잠시 움츠러들며 물러섰으나, 가면 뒤로 그에게서 떠오르는 불신의 표정이 느껴졌다.

하플링이 손을 내리고 설명을 하기 시작했다. "우리의 사명은 더러운 마법사들을 뿌리뽑고 마법의 해악으로부터 더 이상의 비극이 발생하는 것을 막는 것이다." 하플링은 심호흡을 하고 말을 이었다. "이 탈로레는 마법사가 아니-." 인간이 하플링의 말을 끊고 분개하며 소리쳤다. "그래서 뭡니까!? 샬로레랑 관련된 년입니다! 마법폭발을 일으킨-" 또다시 하플링이 손을 올리고 인간은 말을 멈췄다. 마침내 조용해지자, 하플링은 손을 내렸고 나를 붙잡고 있던 힘이 조금 풀어지는 것을 느꼈다. 결국 인간은 역정을 내며 돌아섰으며 천막 바깥으로 나갔다.

인간이 자리를 뜨자, 하플링은 나를 내려놓고 옆으로 자리를 옮겼다. 나는 천천히 일어났으며 하플링을 고개를 돌려 나를 쳐다봤다. 일어서서 정신을 차린 나는 말을 꺼냈다. "당신 정체가 뭡니까?" 내 쪽으로 몸을 돌리며, 하플링은 대답하기 전에 잠시 뜸을 들였다. "정말로 알고 싶나?" 그 질문을 듣고 이번엔 내가 뜸을 들여야 했다. 이 미치광이들은 내가 바깥에서 목격한 참상에 책임이 있는 자들이었다. 나는 이 천막에서 당한 일들에 화가 난 상태였고, 이제 이 모든 것에 대한 설명을 들어야 했다. 난 하플링에게 말했다. "왜 이런 짓을 저지른 거냐?"

하플링은 대답하지 않고 침묵을 지켰다. 가면 아래로 표정이나 어떤 몸짓도 알아볼 수가 없었다. 내가 알 수 있었던 것은 이 하플링이 군인 복장을 하고 있다는 것이었다. 장갑과 신발까지 모두 맞춰진 가죽 갑옷으로 무장하고 있었다. 우리는 아무 말도 하지 않으며 서로를 노려보고 있었다. 하플링은 나에게서 무언가 보고 싶었던 것일까? 난 잘 모르겠다. 다만 말할 수 있는 것은, 침묵이 이어질수록 내 속에서 분노가 끓어올랐다는 것이다. 더 이상 참을 수 없어 무어라 소리치려던 순간, 마침내 하플링이 입을 열었다. "자연은 이미 충분히 고통받았으니까. 그렇지 않나?"

그 말을 듣고 나는 순간 강한 충격을 받았다. 내가 처음에 엘발라로 향했던 이유가 내 머릿속에 떠올랐다. 분노로 가득 찼었고, 결국 그 분노가 날 이 여행으로 몰아넣었다. 하지만 가면을 쓴 자들이 했던 짓은 자연을 더럽힌 자들에 대한 복수가 아닌 것 같았다. 아니, 마법에 대한 복수에 가까웠다. 마법폭발을 빌미로 마법사들을 죽이고 그들이 쌓아온 것들을 파괴했다. 나는 자세를 가다듬고 대답했다. "그게 무고한 자들을 죽인 걸 정당화해?" 하플링에게서 어두운 감정이 솟아오르는 것을 느낄 수 있었다. 하플링의 심기를 제대로 건드링 모양이었다. 그 직후, 내가 느낄 수 있었던 것은 고통뿐이었다.

그 하플링이 움직이는 것조차 보지 못 했지만, 어느새 나는 복부에 주먹을 얻어맞았다. 연달아 나는 턱에 주먹을 얻어맞았다. 나는 정신없이 휘청거리다가 넘어지고 말았다. 그리고 하플링을 올려다 보자, 내가 꺼낸 말에 대해 터져나오는 분노가 쏟아졌다. "무고하다고? 자연을 희롱하고 자연의 설계에 대적하는 자들 중에 무고한 자는 없다. 그들에겐 어떤 자비도 주어지지 않을 것이다. 이때 나는 하플링을 마땅히 두려워 하고 몸을 간수해야 했으나, 끓어오르는 분노가 내 등을 떠밀었다. 겨우내 일어나서 나는 다시 쏘아붙였다. "내가 본 그 참상, 그걸 정당화할 수 있냔 말이야! 닥치는대로 밀고 들어가 죄인으로 몰아세우고, 불태워 죽이는 게 정당화될 수 있겠냐고?"

하플링은 노기를 누그러뜨리며 대답했다. "만약 우리가 지목했던 자들을 말하는 거라면, 그들은 자연을 더럽힌 자들이라는 걸 알아둬라. 물약 조제자, 룬 장인, 마법 장비를 만드는 대장장이, 그리고 주문을 쓰는 마법사들이지. 자기들 마음대로 자연을 왜곡하는 자들을 식별하는 데에 많은 공을 들였지..." 하플링은 목소리를 낮추고 숨을 고르며 말을 이어갔다. "그들을 죽임으로써, 우리의 뜻은 전해졌다. 이 도시와 다른 모든 곳의 사람들의 가슴 속에 새겨졌겠지. 이런 걸 감당하 배짱이 없어 보이니, 너는 그 고향 숲으로 돌아가 처박히는 게 낫겠군. 방금 있었던 일이 더 일어날 거니까."

잔혹하기 그지없는 하플링의 태도나 나에게 고향으로 돌아가라는 그 말 때문에, 내 속의 분노가 더욱 불붙었다. 나는 화가 더욱 치밀어 올랐다. 하플링이 이를 눈치챈 듯, 자세를 바로잡았다. 그리고 내 분노의 화살을 돌리기 위해 곧바로 말을 이었다. "그래, 다른 놈들보단 무르지 않은 편인가보군. 남쪽의 해안으로 간 뒤, 동쪽으로 가라. 거기서 우리의 본거지로 가는 길을 찾을 수 있을 거다." 그가 했던 말이 무슨 말을 하고 싶은 것인지 잠시 생각을 가듬다가 물었다. "내가 왜 네 말대로 해야 하지?" 곧바로 하플링은 대답했다. "이유를 알고 싶다고 하지 않았나? 우리가 진짜 누구인지 알고 싶다면 가서 우리의 지도자와 만나서 이야기해라."
