...
As the front lines drew closer, we would be caught off guard when the ghouls made giant leaps over our entire formation. We soon found ourselves boxed in as ghouls clawed us in the back while the remaining undead forces collided into us from the front. With little room to maneuver, shaloren archers and mages behind us were cut down, while soldiers in front could do little more than keep their shields in front of them to block attacks. Panicking, those who could teleport broke from the line, leaving the rest of us to fend off the encroaching undead horde. The situation was looking quite bleak as we found ourselves trapped by the undead and everything was thrown into complete disarray.]], [[[i]언데드의 소름끼치는 본성을 마주하던 그 순간 속에서도, 이들이 펼치는 전략 전술의 뛰어남을 엿볼 수 있었다. 모든 것이 세밀하게 짜여진 계획에 따라 움직이는 듯 했고, 언데드였기에 미리 계획된 대로 완벽하게 행동할 수 있는 것 같았다. 그 덕에 이들을 통제하는 사령술사는 전투가 벌어지는 와중에도 어떤 피해도 입지 않고 멀찍이 사태를 관망할 수 있었다.[/i]

갑자기 순찰대장은 눈을 부릅 뜨며 장막에 나타난 무언가를 쳐다보았다. 나 또한 무언가가 흔들리는 형상이 나타나는 것을 볼 수 있었다. 곧바로 순찰대장은 "쏴라!"라고 외쳤고, 수많은 궁수들과 마법사들이 일제히 화살과 마법을 발사했다. 화살과 마법이 그 뒤틀린 형상에 명중하자 그 모습이 휘몰아치는 소용돌이가 되었다. 그런 일제사격에도 불구하고 장막 속에서 대형을 갖춘 해골들이 부서져가는 갑옷을 입은 채로 나타났다. 스켈레톤들이 몇 줄로 나뉘어 서서 방어진형을 갖추고 있었다. 방패를 높이 쳐들고, 발걸음을 정확히 맞추며 천천히 다가오고 있었다. 

샬로레는 끊임없이 성벽 너머로 공격을 퍼부었지만, 스켈레톤 한 구가 박살날 때마다 뒤쪽에서 두 구가 더 나타나는 형세였다. 자유의지가 없는 불사자들의 군세는 아무리 쓰러뜨려도 끄떡도 하지 않으며 다가왔다. 스켈레톤이 점점 다가오자, 성벽 밑의 병사들은 돌과 바위 무더기를 운반해왔고, 성벽 바로 밑으로 스켈레톤이 다가올 때마다 바위를 아래로 떨어뜨렸다. 화살과 주문과는 달리, 스켈레톤들은 무거운 바위를 견디지 못하고 짜부라졌다.

전황을 내려다보며, 순찰 대장은 무언가 중얼거렸다. "사다리를 안 가지고 왔어. 그런데도 계속 밀려오는 걸 보면 뭔가 다른 계획이 있는 거야." 계속 상황을 지켜보던 와중, 어딘가에서 쉰 듯한 목소리가 들렸다. 갑자기 성벽 위의 병사들이 공황에 빠진 채 소리를 지르며 공격받고 있다고 소리를 질렀다. 주변을 둘러보아도 어떤 습격자도 보이지 않았으나, 근처에 적이 있다는 것은 분명히 알 수 있었다. 그 순간 순찰대자오가 나의 뒤쪽에서 희미한 인기척이 느껴졌다. 빠르게 무기를 뽑고 뒤돌아 허공을 갈랐다. 아무것도 보이지 않았으나, 내 칼이 허공을 가르는 순간 작은 신음소리가 들렸다.

순찰대장이 현재 벌어지고 있는 상황을 이해하자, 성벽의 수비병들에게 고했다. "그림자들의 공격이다! 대비해라!" 순찰대장의 격문을 들은 수비병들은 성벽 밑의 스켈레톤보다는 새로운 위협에 대처해야 했다. 모습을 감춘 적들이 어디 있는지 알 수 있는 자들은 빠르게 적을 쓰러뜨렸으나, 그러지 못 하는 자들은 이리저리 무기를 넓은 호를 그리며 휘둘렀다. 머지 않아 단말마가 허공에서 차례로 울려퍼졌다. 하지만 이내 그림자들은 단순히 미끼일 뿐이었음이 명백해졌다. 스켈레톤이 뼈의 사다리와 피라미드를 형성하며 성벽을 올라오고 있었다.

위로 올라올 수 있게 된 스켈레톤들은 성벽을 기어 올라왔고, 압도적인 수로 밀어붙였다. 완전히 압도되어버린 전황 속에서 순찰 대장은 성벽을 버리고 후퇴하라는 명력을 내렸다. 병사들은 어떻게든 빠져나오려 했고 그 아수라장 속에서 많은 병사들이 미처 빠져나오지 못 한 채 무참히 도륙당했다. 성벽의 통제를 잃자 스켈레톤들은 관문을 열고 다른 스켈레톤들이 들어올 수 있도록 했다. 그리고 나머지는 성벽에서 내려와 우리를 빠르게 쫓아오고 있었다.

엘발라의 좁은 길목까지 후퇴하자, 순찰 대장은 기회를 놓치지 않고 마법사들에게 공격 대형을 갖추도록 지시했다. 우리를 쫓아오던 스켈레톤들은 기다란 일자 대형을 갖추고 들어오고 있었으며, 마법을 쏟아붓기에는 최적의 형태였다. 번개와 화염, 냉기 주문들이 전장에 빗발쳤고, 온갖 길목에 뼈다귀들이 박살이 나고 부서졌다. 대부분의 스켈레톤이 쓰러지자 수비병들은 반격을 개시하려 했다. 그러나 그것도 잠시, 뒤로 수많은 스켈레톤의 행렬이 쏟아지고 있었으며 관문을 통해 끊임없이 들어오고 있었다.

구울의 모가지에서 끓어오르는 소리가 전장을 메웠고, 그 옆으로 스켈레톤 군단이 떼거지로 몰려들었다. 그러나 그 뒤에 훨씬 더 끔찍한 언데드가 움직이고 있었다. 엘발라의 건물만큼이나 높게 솟구친 거대한 형상이 보였다. 그 뒤로 또다시 스켈레톤의 행렬이 보였으나, 그들은 다른 스켈레톤과 달리 활과 지팡이를 들고 있었다. 언데드 군단은 대열을 갖추고 한치의 오차없이 발을 맞추며 우리에게 행진해오고 있었다. 우리 진영의 마법사들 또한 주문 시전을 준비했으나, 스켈레톤에게서 화살과 마법이 쏟아져나오자 이마저도 여의치 않았다. 이제 언데드 군단과 맞서야 한다는 것을 깨닫고, 우리는 방패를 쳐들고 앞으로 나아갔다.

전선이 점점 가까이 다가왔고, 구울들이 이번엔 우리의 머리 위를 뛰어넘어 아예 배후를 잡혀버리고 말았다. 눈 깜짝할 새에 구울들에게 포위되어 후방에서 맹습을 받았고, 전방에서는 언데드 군단이 밀려들어왔다. 도망갈 곳을 잃은 궁수와 마법사들은 후방에서 구울의 손에 살해당하고, 전방의 병사들은 공격을 막아내기 위해 안간힘을 썼다. 샬로레들은 공황 상태에 빠져 전이 마법을 쓸 수 있는 자들은 전선을 이탈했다. 전황이 심각해짐에 따라 언데들에게 둘러싸였고, 모든 것은 더 이상 돌이킬 수 없을 것 같았다.]], "_t")
