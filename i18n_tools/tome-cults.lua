...
대장은 내게 물었다. "무슨 문제 있나, 탈로레?" 드디어 그들이 왜 주입물을 쓰지 않는 것인지 대답을 들을 수 있는 기회였다. "왜 붕대를 쓰는 겁니까? 주입물이 없습니까?" 대장은 이 질문에 살짝 즐거운 듯이 대꾸했다. "샬로레가 주입물을 쓴다라?" 대장은 마치 농담이라도 들은 듯이 웃었다. 주변에서 망토를 걸친 자들이 내는 웃음소리가 들렸다. 대화를 이어가기 위해 대장이 다시 입을 열었다. "자네들이 주입물을 써먹는 이유는 충분히 이해하지만, 우리 샬로레는 자연 속에서 그런 것들을 넘어서서 살아가려고 한다네." 
...
이런 무관심한 말투에 기가 막힐 정도였으나, 부상당한 샬로레가 내는 기침 소리를 듣고 입을 다물었다. 당장은 부상당한 샬로레을 치료하는 게 우선이라고 생각하며, 나는 가건물로 걸어갔다. 나는 그들이 감고 있던 붕대를 모두 없애고 이내 치료를 시작했다. 내 주입물을 쓰자 벌어진 상처가 빠르게 아물었고 상태도 호전되기 시작했다. 내 주입물을 모두 썼음에도 완전히 회복되진 않았으나, 내가 치료했던 샬로레 둘은 이전보다 훨씬 나아졌다.
...
As the healer finished writing he handed the paper to me "The shalore and thalore are near identical in biology when it comes to infusions, so anything that you could use on yourself will work on a shalore. Here is a list of the infusion ingredients we have available. I'll lead you to our workshop where you can get to work making some." The healer rose to get up, grabbing a key from a shelf. Moving towards the door I was led down to the basement where the infusion workshop was. Unlocking the door, the healer handed me the key, and led me inside.]], [[[i]샬로레들은 더 이상 내가 엘발라에 처음 들어갔을 때만큼 정신 없어 보이진 않지만, 내가 이 글을 쓰는 순간에도 그들의 얼굴에 서린 혼란스러움을 읽을 수 있다. 이들은 탈로레가 자연의 파괴를 느끼는 것과 같은 방식으로 그들과 연결되었던 무언가를 잃어버린 듯한 느낌을 받는 것 같다. 마법과 자연 사이에 무슨 연결점이 있는지는 난 모른다. 그러나 나는 그 둘 간에 어떠한 관계가 있음을 알고 있으며, 한 쪽에 부담이 가해진 다면 다른 쪽에도 그런 일이 일어날 것임을 안다. [/i]

다른 고통받는 샬로레가 있다는 것을 알고난 뒤, 샬로레 대장은 나에게 다른 순찰자 그룹이 있다는 것을 알려주었다. 그들이 다른 정착지에 있던 피난민들을 수도로 재집결시키려 했다는 것을 알려주었다. 다른 이들을 돕는 것에 아예 관심이 없다고는 할 수 없었으나, 내가 방금 치료했던 인원 외에 다른 샬로레들에게 내 주입물을 더 사용하는 것은 끌리는 제안이 아니었다. 그러나 나의 입장을 어느 정도 알고 있던 정찰병이 거래를 제시했다. 만약 순찰자들이 가능한 한 많은 샬로레을 구하는 것을 도와준다면, 내가 찾는 답이 무엇인지 알아낼 수 있도록 돕겠다고 한 것이다.

나는 그 조건 하에 승낙했으며, 이들과 여정을 함께 했다. 이틀동안 순찰자들은 최대한 사람들을 찾아모았다. 세 번째 날에 우리는 남쪽에 우거진 숲으로 나아가기 시작했다. 우리가 숲의 경계를 헤쳐나가면서 부자연스러운 희뿌연 연기가 멀리서 소용돌이쳤다. 나는 연기 너머에 엘발라가 있다는 이야기를 들었다. 엘발라가 그들의 수도 이름이라는 것을 그때 알았다. 몇 분 동안 앞으로 나아가자, 작은 호수 옆에 도달했다. 그곳에서 갑자기 터널이 하나 열렸으며, 우리를 안으로 초대하는 듯했다.

터널 안쪽은 끔찍할 정도로 어지러웠다. 먼지와 바람 소리가 끔찍한 불협화음을 내며 소리쳤다. 앞으로 길을 나아가면서 나는 연기 속 깊은 곳에서 인간의 시체들을 본 것 같았다. 도시가 눈 앞에 보이면서, 난 황량한 광경을 마주했다. 순찰자들과 거리 위를 걸어가면서, 내가 볼 수 있었던 건 다른 샬로레의 얼굴에 띤 공허함 뿐이었다. 그들은 마치 희뿌연 안개속을 이리저리 헤매는 듯했다. 내가 지나가며 본 모든 샬로레 속에서 흐르는 기묘한 공황이 느껴졌다. 마치 소중했던 무언가를 잃어버린 것 같았다.

처음엔 그들에게 복수하기 위해서 여기에 왔으나, 지금 나는 이런 상태에 빠진 사람들을 보고나서도 그럴 수 있을까 의문에 빠졌다. 이 샬로레들은 망가질 대로 망가졌다. 이 행위의 주모자들은 에이알에 잔악무도한 짓을 저질렀으나, 내가 여기서 본 자들은 혹독한 대가를 치루고 있는 것 같았다. 내 안의 깊은 분노를 여전히 남아있었 수 있었으나, 저지른 행위에 대가를 받는 그들의 모습은 어느 정도 만족스러운 처벌이었다. 내가 샬로레들에게 느꼈던 적대감은 이때 거의 다 누그러졌다. 그들은 저지른 범죄에 따른 대가를 치루고 있었다.
...
치유사가 걸어가기 시작하자 나는 순찰자의 대장에게 시선을 돌렸다. 그는 나를 돌아보며 대답했다. "그 의사는 당신을 주 진료소로 데려갈 거야. 걱정 말게. 당신에게 한 약속은 잊지 않았으니. 당신이 찾는 답을 구해줄 자를 찾아다 주겠네." 그는 나를 있는 대로 부려먹을 생각인 것 같았고 난 차갑게 대답했다. "내 인내심을 너무 오랫동안 시험하지 않는 게 좋을 겁니다." 그는 미소를 짓는 듯한 표정을 보이며 날 기다리던 치유사에게 고갯짓하고선 천천히 발걸음을 돌렸다.
...
수백명의 탈로레을 간호한 뒤였으니, 이 즈음엔 샬로레들에게 어느 정도 동정심이 들었다. 하지만 나의 이목을 사로잡았던 것은 그들이 엘발라로 곧바로 돌아올 수가 없었다고 말한 점이었다. 대륙의 중앙은 미드 베일 평원이 있는 곳으로, 말 그대로 광활한 평야만을 볼 수 있는 곳이었다. 대륙의 지형에 관한 내 기본적인 지식에 따르면, 그 평야는 완전히 개방되어 있으며 통행에 매우 용이했다. 엄청난 규모의 오크 군대가 길을 막는 게 아니라면, 북쪽으로 돌아서 올 필요는 없었을 것이다.
...
잠시 후 부상을 입은 병사들의 수는 줄어들었고, 치료한 후에는 휴식조차 필요 없다는 자들이 대부분이었다. 상당수의 병사들이 완쾌되자, 의무관 주임이 다가와 샬로레을 대표하여 감사를 표했다. 그 순간 내가 애초에 이곳에 오게 된 이유를 떠올렸고, 내가 했던 거래에 대하여 충분히 할만큼 했다고 말했다. 의무관 주임은 고개를 끄덕이며 내 뒤를 쳐다보았다. 그러자 병사 한명이 다가왔다. "부관이 자네를 장군님께 데려다 줄 걸세." 나는 잠시 당혹스러웠으나 그 장군이 지금까지 일어났던 사건들에 대하여 답을 알고 있으리라고 짐작했다.
...
익살맞은 목소리로 그가 말했다. "글쎄, 만약 살로레가 숲을 떠나서 여기까지 당도할 이유라고 한다면 만나는 샬로레들을 죄다 몰살하기 위한 것이라고 밖에 상상이 안 갔거든." 마치 펼쳐진 책을 읽듯이 그는 나를 읽어냈다. 내 낯짝을 쳐다보는 것만으로도 머리 속 생각까지 훔쳐보는 듯했다. 그 말을 듣자 나는 조금 움츠러 들었고, 장군이 말한 것을 확인해주는 꼴이 되었다. 그것을 본 장군은 긴장을 풀고 말을 이어갔다. "아직까지 샬로레을 죽이지 않을 걸보니 분명 뭔가가 자네의 마음을 바꿔놓았군. 잘 알았네. 심지어 우리에게 큰 도움이 되어주기까지 했어. 그러니 내가 아는 것을 알려주도록 하지."

그제서야 그 샬로레 장군은 지금까지 일어났던 일들에 대해 설명해주기 시작했다. 이 땅에 닥친 재앙이 마법폭발이라고 명명되었다 것과, 온 땅을 휩쓸고 다니던 오크들을 소탕하기 위한 목적으로 이뤄졌다는 것을 알았다. 샬로레은 최선을 다했으나, 그 힘을 조작하던 마법사들은 방대한 에너지를 통제하지 못했다. 그 결과 오크, 샬로레들 자신과, 마즈'에이알 전체에 파멸의 폭풍을 풀어버렸다. 온갖 파괴가 전 대륙에 걸쳐 일어났으며, 심지어 다른 세계에까지 영향을 미쳤을 것이라고 했다.
...
잠시 후 장군이 입을 뗐다. "이제 뭘 할 생각인가?" 좋은 질문이라고 생각했다. "딱히 생각해둔 게 없군요"라고 대답했다. 그는 여전히 내게 등을 돌리고 있었으나, 그의 뒤통술 너머로 피식 웃는 것을 느낄 수 있었다. 그는 나를 돌아보며 물었다. "자네는 이제 숲으로 돌아갈 것 같군. 하지만 돌아가는 길에서도 우리 샬로레을 도와줄 방법이 있지 않을까 싶네. 우리에게 구호 물자를 전달해줄 수 있겠는가? 또 이용당하는 것이 아닌가 생각했지만, 그의 요청에 어느 정도 흥미가 생겼다.
...
내 얼굴에서 피가 흘러나오고 눈물이 섞여 나왔다. 나는 눈물을 쏟아내며 빠르게 말했다. "이미 수많은 이들이 고통 받았어. 더 이상의 고통을 더할-" 말을 채 끝내기도 전에 전령은 내 얼굴을 바닥에 처박았다. 그는 소리쳤다. "그 어떤 고통도! 그들이 한 짓에 대한 대가를 치룰 수 없다, 페이! 모든 샬로레은 하나도 남김없이 모두 죽어야 해. 우리가 불태운 자들처럼 고통스럽게 죽어야-." 전령은 계속 말을 쏟아냈으나, 갑자기 들려온 내 이름 속에서 나는 그가 하는 나머지 말을 모두 무시하고 생각에 빠졌다. 그가 어떻게 내 이름을 알고 있지? 알려준 적이 없는데, 나르골 왕국에서도 말한 적이 없다고. 심지어 샬로레에게도 말한 적이 없어. "도대체 내 이름을 어떻게 아는 거야?" 나는 전령에게 말했다.
