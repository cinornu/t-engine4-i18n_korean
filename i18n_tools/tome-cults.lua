...
t("Escapades of Fay Willows [Book 4, Chapter 3] - The Enchantress", "페이 윌로우즈의 여행기 [4권, 제 3장] - 부여술사", "_t")
...
Eventually when I woke up, and after the healers had checked me over, I was told to wait as someone wished to visit me. After a period of time I was greeted by the enchantress once more. "I see you are doing alright, you’re certainly quite tough thalore. Don't worry about the ogres, Aranion has granted them the asylum here as requested." She spoke proudly though I could sense a hint of disappointment in her voice. "Now then, I realize you have only woken up, but Aranion wants me to get the story from you as to what transpired after you had left for the Nargol Kingdom to the point when you came back to Elvala. Perhaps as well you might shed some light on why exactly it took you so long to heal as well?"  ]], [[[i]알레이웬 테일, 완고한 부여술사. 서로 이야기를 나누는 대화 상대로서는 최악이고, 그녀만큼 거만한 샬로레도 도 없다. 하지만, 그녀의 마법 실력이나 정의감은 대단하다고 할 수 있다. 오우거들의 입국 허가를 요청할 때 그녀가 없었으면 어떻게 됐을지 알 수 없는 일이다.[/i]

걸어가는 동안 앞장서던 그 젊은 마법사는 내게 지금까지의 여행에서 무슨 일을 겪었고 무엇을 목격했는지 다양한 질문을 했다. 그중에서도 오우거들에 관한 이야기가 가장 기억에 남는다. "그러니까 그 오우거들 말예요. 그들에 대해선 들은 적이 있죠. 그들이 엘발라로 온 적은 한 번도 없긴 하지만, 그들의 영웅담이나 남들을 무작정 돕고 다니는 이야기를 들어본 적 있어요. 그런데 그 미친 광신도라는 사람들은, 좀 이상하네요. 오우거들을 바로 죽이지 않았잖아요. 내 말은, 오우거들은 몸에 룬을 대놓고 새기고 다니는데, 왜 그냥 죽이지 않는 걸까요? 왜 그들을 그대로 살려둔 이유가 뭐라고 생각해요?"

나는 차갑게 대답했다. "난 이유 따윈 모릅니다. 알고 싶지도 않고. 그러면 당신은 왜 그런 미친 행위들에서 의미를 찾아내고자 하는 거예요? 당신이나 어느 샬로레든 간에 그런 걸 신경쓸 이유는 없는 것 같은데." 젊은 샬로레는 웃으며 대답했다. "아마도 당신이 맞겠네요. 하지만 그 '신도들'이 당신이 보기에 미친 것 같다고 해서 그들이 아무렇게나 행동한다는 뜻은 아니에요. 훗날 그들은 우리의 적이 되겠죠. 하지만 최소한 그들을 대면하기 전까지 그들이 그렇게 움직이는 이유가 뭔지 알아두면 좋겠죠. 그들이 행동하는 이유를 알 수 있다면, 그들이 행동을 개시하는 요인을 알 수 있을 거고, 그러면 그들의 구상을 맞받아칠 계획을 세울 수도 있겠죠."

계속 나아가는 와중에, 샬로레가 내 목 뒷쪽을 계속 보고 있다는 것을 깨달았다. "룬을 새긴 위치를 보아하니, 아마 오우거들이 제 귀환의 룬을 새기는 걸 도와줬나 보죠?" 샬로레가 말한 것을 듣고선 이해하는데 잠시 시간이 필요했다. "당신이 만들었다고?" 샬로레는 미소를 지으며 잠시 웃다가 말했다. "그럼요. 제가 만들었죠. 엘발라 최고의 부여술사가 만들어낸 걸작이죠! 어쨌거나 왜 당신이 직접 피부에 부여하지 않았나 궁금하네요. 혹시, 탈로레는 마법에 관련해선 '그 정도'로 뒤떨어져 있나요?" 나는 그때 싸늘하기 그지없는 표정을 지었던 것 같다. 그녀는 이걸 바로 알아채고 나선 대답했다. "아, 그래요. 알았어요. 다음에 다른 탈로레를 만날 때 염두에 두도록 하죠."
...
곧바로 오우거들이 이쪽으로 달려오기 시작했다. 몇 분 뒤 가장 먼저 엘발라의 장벽을 통과해 들어온 오우거가 들어오자마자 바로 쓰러졌다. 뒤쪽에서 예상치 못 한 사건이 벌어지는 것을 보고 구경꾼들이 모여들었다. 오우거들이 모두 관문을 통과하자 마법사는 두 팔을 내렸고, 이내 바로 장막이 드리워졌다. 곧바로 그녀 또한 땅바닥에 쓰러져 깊은 숨을 몰아쉬었다. 엄청난 마법을 쓴 뒤에 모든 힘을 다 써버린 것 같았다. 그녀는 나를 올려다보며, 숨을 몰아쉬면서도 나에게 태연하게 말할 뿐이었다. "다 됐어요. 당신은 이 오우거들을 구했어요."

"물론, 제대로 된 방법은 아니었지만 말이야." 뒤쪽에서 또 다른 목소리가 들렸다. 뒤를 돌아보니 거기에 아라니온 장군이 있었다. 수많은 경비병 무리가 군중을 뚫고 다가오는 것이 보였다. 그 순간 나는 또 문제가 터지는 것이 아닌가 했지만, 장군은 장병들에게 오우거들을 치유사들에게 데려가라는 명령을 내릴 뿐이었다. 장군이 부여술사에게 다가가면서 나를 쏘아보는 것 같았다. 장군은 잠시 나를 살펴보다가 조용하면서도 근엄한 목소리로 말했다. "자네도 오우거들을 따라가게." 그리고 나를 지나쳐서 부여술사의 앞에 섰다. 젊은 샬로레가 숨을 가다듬고 있었고 그 앞에서 장군이 팔짱을 끼는 것이 보였다.

일단은 장군의 명령을 따르는 것이 최선인 것 같았다. 나는 엘발라의 치료소를 향해 걸어갔고 거기서 주임 치유사를 만나 뭔가 도울 수 있을 것이라는 안일한 생각을 했다. 난 지금도 내 꼴을 본 치유사가 충격에 빠졌던 그 표정을 기억한다. 장군이 나에게 치유사에게 가보라는 말을 난 완전히 잘못 이해하고 있었다. 그는 오우거들의 부상 때문이 아니라 나 자신의 부상 때문에 그렇게 명령한 것이었다. 얼마 지나지 않아 그 치유사는 다른 치유사를 불렀고, 나중에는 모든 치유사 중의 반이 날 치료하는 데에 매달렸다. 오우거들을 치료하던 자들 또한 중간에 끌려오기도 했다.
