...
A bit perplexed by this I sat there looking confused. For a moment we stared at each other in silence before the shalore finally exclaimed "You're a thalore." I blinked a couple of times at this before I replied yes. Seemingly in shock for a brief moment before finally coming to his senses, I was soon asked what I was doing here. Upon hearing that question, I wondered what I should answer. I then realized I no longer knew the answer to why I had come here, as the anger that had driven me to come had mostly dissipated. After a while I finally gave an answer. "I've come to find out why." ]], [[[i]내가 엘발라로의 첫 여행길을 떠났던 시절 벌어졌던 참상을 똑똑히 기억한다. 마법폭발의 참상에서 도망칠 수 있었던 자는 없었고, 탈로레보다 이 땅이 겪은 고통과 슬픔에 공감할 수 있는 자들은 없을 것이다. 고향으로 돌아온 탈로레들의 마음속에서 아직도 화가 치미는 것은 잘 알고 있다. 나조차도 가끔 그 기억 때문에 감정이 치밀어 올라오니까. 끔찍한 그날을 잊어버리고 싶지만 나는 그러지 않겠다[/i]

고향에서 내가 자라온 나날을 짧게 표현하자면 '재밌는 일 없이 지루한 일상의 반복'이라고 요약할 수 있다. 난 지금은 없어진 한 숲에서 자랐다. 쓰러지고 죽은 나무들에게서 장작을 모으면서 새로운 나무가 자랄 수 있게 작은 묘목들을 심었다. 모은 나무들은 집 뒤편에 크게 쌓아두었으며, 나무들은 숙련된 탈로레 장인이 깎고 다듬어서 지팡이와 활을 만들었다. 그리고 그것들을 가져다가 다른 마을에 팔았다. 이렇게 팔아서 모은 돈으로 우리 숲 주변이나 근처에 있는 인간과 하플링의 땅에서 쉽게 찾기 힘든 물픔들을 샀다. 

그런 일상은 갑자기 끝나버렸다. 그 날 하늘이 진한 보라빛으로 바뀌고, 내가 길렀던 나무들의 윗동이 마치 불협화음처럼 얼룩덜룩 끔찍한 색으로 변해갔다. 발 아래 대지가 깊은 곳부터 송두리째 뒤흔들리고, 내가 서 있던 땅이 갈라지면서 나무가 뽑혀서 쓰러졌다. 많은 일이 일어났지만 내 주위에서 소용돌이치던 바람이 그 중 최악이었다. 점점 퍼져나가는 어두운 기운이 나무들을 휘감으며 퍼져나가고, 바람에 닿은 땅은 뒤틀리고 죄다 썩어버렸다. 어떻게 내가 이런 재앙속에서 살아남았는지 모르겠지만, 나는 굉장히 운이 좋았던 것 같다. 나랑 같이 있었던 많은 탈로레들은 살아남지 못했기 때문이다.

결국 내가 살던 집과 열심히 모은 나무들은 흔적도 없이 사라져버렸다. 수 세대 동안 서있던 나무들과 내가 심은 나무들도 함께... 남은 건 껍질만 남은 채 죽은 나무들과 폐허가 된 고향, 그리고 형체조자 알아볼 수 없게 썩은 내가 알던 사람들의 시체들... 간신히 살아남은 사람들과 만나서 어떻게든 쓰러진 사람들을 살리려고 노력했다. 하지만 우리가 찾기도 전에 많은 사람들이 상처를 이기지 못하고 죽었고. 간신히 찾아낸 생존자들도 많은 수가 죽었다. 시체를 묻기 시작했을 때 사방에서 사랑하던 이를 잃은 사람들이 처절하게 울던 광경이 생생하다. 사방에 풍만했던 자연이 완전히 파괴된 것도.

병사들이 우리를 찾아 와서 수도에 마련된 대피소로 우리를 데려갔다. 이젠 오염되버린 땅에서 온, 우리같은 사람들을 위해 마련된 장소로...  도시로 가면서 나를 반긴건 혼란 그 자체였다. 다른 정착지들에서 온 난민들이 줄을 있고, 부상자들이 나란히 뉘여져 있었다. 게다가 모두들 제정신이 아니었다. 처음 이 난장판을 보면서 왜 부상자들이 적절히 치료받지 못하고, 난민들이 수용받지 못하고 여기저기 나도는지 의문이 들었다. 발작에 가까운 외침이 여기저기 들리는 가운데, 얼마 지나지 않아서 이 재앙이 샬로렌 마법사에 의한 것이라는 소문을 들었다. 순간 내 속에서 분노가 치밀어 올랐으며, 그 때의 분노는 아직도 생생하다.

샬로레의 땅으로 향하겠다고 결심했지만, 그때는 샬로레에게 복수하겠다는 강한 의지가 있었다. 지금은 잘 모르겠지만... 생각할 겨를없이 폐허가 된 집으로 돌아가서 챙길 수 있는 건 다 챙겼다. 그 다음날에 숲의 경계를 나섰고. 다음 며칠간 검게 변하고 부서진 땅을 지나는 동안 물과 음식은 거의 찾아 볼 수 없었다. 사방이 폐허였기에 걷는 것도 느릴 수밖에 없었고, 먹을 거리를 찾는 것도 마찬가지였다. 간신히 부서지는 것을 면한 작은 정착지를 찾았을 때 난 굶주려서 쓰러지기 직전이었다.

처음 본 작은 여관에 잽싸게 들어가서 약간의 음식을 주문해서, 허겁지겁 먹어치울때 옆에서 누가 이야기하는 걸 주워들었다. '이 사건'때문에 말다툼하는 것 같았다. 인간의 목소리가 소리쳤다. "오크들이라고 해도 이정도의 참상을 만들지는 못 해!". 좀 더 잘 들으려고 고개를 돌리자, 곧 하플링이 반박했다. "그렇게 말해봤자 오크들은 곧 이 땅에 올거고, 너는 그때는 이미 죽은 몸이라 불평조차 하지 못할 걸." "오호라. 그런 말을 하는걸 보니 저주받을 마법사들에게 감사하시겠네? 그 놈 때문에 상상도 못할만큼 많은 사람이 죽었다고, 죽었다고!" "오크들은 더 하지. 한 놈도 빠짐없이 죽일 거야. 넌 최소한 살아남은 친구들과 사랑하는 가족이 남았잖아. 내가 알던 사람들은 전부 죽었다고. 전부 다!"

적막이 흐르고. 인간이 나처럼 내심 화를 참으려고 노력하는 게 보였다. 그는 곧 일어나서 나갔다. 나도 그러고 싶었지만, 불행하게도 그러지 못 했고. 하플링이 주섬주섬 소지품을 챙겨서 나갈 때 나도 조용히 따라나갔다. 하플링이 알아챘고, 우리는 밖에서 맞닥뜨렸다. 거친 말이 오갔고, 그 다음에 정확히 무슨 일이 있었는지는 잘 기억나지 않지만, 하플링이 내 앞에 쓰러져 있다. 내 손에는 피가 잔뜩 묻어 있던 건 똑똑히 기억한다. 정신 차려서 내가 한 짓을 깨닫고, 정착지에서 도망쳐 나와버렸다.

그 날 이후 이틀간 먹지도 자지도 않았다. 이틀 동안 생존자들로부터 버려진 정착지들을 지나갔고, 내가 죽인 하플링에 대해 생각하는 걸 멈출 수 없었다. 그래도 내 마음 속에는 샬로렌에 대한 분노가 가득했지만, 점차 내가 대체 무엇을 하고 있는지 다시 생각하기 시작했다. 그리고 갓 벌어졌던 전투의 흔적을 보면서 더 의문을 가지게 됐다. 새까맣게 타서 알아보기 힘들었지만, 오크로 짐작되는 시체가 하나 둘을 넘어 수십체가 땅에 뉘여있고, 시체들 너머에는 샬로레 병사들의 시신이 있었다. 이 광경을 보고나니 너무나 혼란스러웠다.

그때까지 샬로레들에게 품었던 분노가 혼란스러움으로 바뀌었다. 어떤 광기가 그들을 죽음으로 내몬 것일까? 오크를 막기 위해 희생이라도 한 것일까? 스스로의 의지로 싸운 게 맞을까? 그럼 샬로레들을 비난하는 게 옳은가? 머리에 마구 떠오르는 이런 질문들에 제대로 대답할 거리를 생각해 낼 수가 없었다. 그저 이제 뭘 해야 하는지 고민할 뿐이었다. 그래도 나는 어찌어찌 나아가서 샬로레 시골마을에 도착했다. 무너진 건물 사이로 늑대들이 주민들로 보이는 시신들로 만찬을 즐기는 광경을 보았다. 저 멀리에서 도움을 간청하는 외침도 들렸다.
...
나는 당황하며 그 자리에 않아 있었고, 잠깐동안 우리 둘 사이에 침묵이 흘렀다. "당신은 탈로레군요" 샬로레가 말했고, 난 눈을 몇 번 끔뻑거리다가 맞다고 대답했다. 정신 차리기 전까지 잠깐 멍하니 있었다. 여기서 뭘 하냐고 물었다. 그런 말을 들으면서, 뭐라고 대답해야 할지 고민했다. 날 이끌던 분노는 이미 거의 사라져버렸고, 여기까지 왜 왔는지 이유도 알 수 없었다. 조금 더 앉아 있다가 대답했다. "그 이유를 알아내기 위해 여기까지 왔습니다." ]], "_t")
...
일주일이 지나 피난민 대부분의 치료가 끝난 즈음에, 오크들과 전투를 벌이던 샬로렌 병사들이 복귀했다는 소식이 들려왔다. 마법 폭발이 일어났을 때 인간 왕국과 함께 대륙의 동쪽에서 싸우고 있었던 게 분명했다. 엘발라까지 돌아오는 길에서 살아남은 자들은 매우 적었다. 대륙의 중앙을 통해 곧바로 돌아올 수 없었기에 긴 여정이었을 것이다. 살아온 자들은 수백명 뿐이었다.
...
난 지금도 마법에 대해 아는 것이 별로 없고 어떻게 이뤄지는 것인지도 모른다. 하지만 명백한 것은, 마법 폭발로 인한 무언가 때문에 그 사건을 기점으로 마법의 작동 방식이 영원히 바뀌어 버렸다는 것이다. 마법의 힘을 불러일으키는 것은 여전히 훈련을 통해 가능한 일이지만, 이전보다 훨씬 어려워졌다. 다른 부상자들이 다가와 비슷한 방식으로 마나 쇄도 룬을 가져갔고, 손이나 팔, 혹은 다리든 어디든 원하는 신체 부위에 빛나는 룬의 도장을 새겼다. 그러고선 주문을 사용하여 스스로를 치료하거나 이따금 다른 병사들을 치료했다.
...
장군은 말을 이어가기 전에 숨을 골랐다. "이 이야기를 계속하기 전에 말이야. 이유를 말해줄 수 없을까? 무엇이 자네를 숲에서 떠나 샬로레의 영토까지 이끌었냐는 말이야?" 그의 질문을 듣자 나는 말을 잃었다. 마법 폭발이 처음 일어났을 때 내가 느꼈던 분노는 이제 온데간데 없었기 때문이다. 내가 여기에 와야 했던 이유는 더 이상 없는 것이었다. 잠시 후 나는 거친 목소리로 대답했다. "제가 이유를 말할 필요라도 있습니까?" 상당히 직설적인 대답에 장군은 혀를 차는 듯이 웃었다.
...
그제서야 그 샬로레 장군은 지금까지 일어났던 일들에 대해 설명해주기 시작했다. 이 땅에 닥친 재앙이 마법 폭발이라고 명명되었다 것과, 온 땅을 휩쓸고 다니던 오크들을 소탕하기 위한 목적으로 이뤄졌다는 것을 알았다. 샬로렌은 최선을 다했으나, 그 힘을 조작하던 마법사들은 방대한 에너지를 통제하지 못했다. 그 결과 오크, 샬로렌들 자신과, 마즈'에이알 전체에 파멸의 폭풍을 풀어버렸다. 온갖 파괴가 전 대륙에 걸쳐 일어났으며, 심지어 다른 세계에까지 영향을 미쳤을 것이라고 했다.
...
내 마음 속에서 감도는 불편함이 탁자 사이에서도 감돌았으나, 장군은 아무 말도 꺼내지 않았다. 마법 폭발의 책임이 어느 정도 그에게도 있다는 것 때문이거나 내가 생각을 정리하는 데에 도움을 줄만한 말을 꺼낼 수 없었기 때문인 것 같았다. 잠시 동안 둘 사이에 침묵이 감돌았으며, 이내 그는 자리에서 일어나 창가 쪽을 바라보고 섰다. 그기 등을 보였으니 나는 그의 표정을 볼 수 없었다. 그러나 지금까지 일어났던 사태들에 대해 심중하게 숙고하고 있음은 알 수 있었다. [i]아라니온, 이걸 지금 읽고 있다면, 알아두세요. 최소한 나는 당신을 용서했다고.[/i] ]], "_t")
...
의문을 품으며 말했다. "듣자하니 제게 남은 호의를 최대한 긁어모아서 어떻게 해보려는 생각인 것 같은데, 샬로레가 직접 공식적인 특사라도 보내서 도음을 청하는 게 어떻겠습니까?" 장군은 무거운 목소리로 대답했다. "나라고 해서 그러고 싶지 않은 건 아닐세. 다만 지금 샬로레를 엘발라 바깥으로 내보내는 것 자체가 매우 위험한 일이야. 당신이 여기 오기 전에, 서쪽에서 온 몇 인간들이 분노한 채로 엘발라의 경계를 습격했네. 당신이 외곽 정착지에서 구해온 대다수의 샬로렌들은 마법 폭발이 아니라, 코르낙의 땅에서 온 농노들의 분노 아래 희생당했네."
...
장군의 눈이 나와 마주쳤다. 그 눈 속에서 느껴지는 진중함이 나를 옥죄는 듯했다. 무엇이든 물어야 한다는 생각이 들어 입을 열었다. "무어라 소리쳤습니까?" 다시 목소리가 가라앉았다. "그들은 샬로레가 마법 폭발에 대한 대가를 치룰 것이라 소리쳤네." 이해할 수 없어 다시 말했다. "정당한 분노를 표출한 것을 당신이 왜 두려워 하는 겁니까?" 이에 대해선 분명한 대답이 돌아왔다. "왜냐하면 우리의 원대한 계획을 마법 폭발이라고 부르고 있었다는 걸 아는 자는 거의 없었기 때문이지. 다양한 종족의 지도자들, 그리고 심지어 탈로레의 왕과 왕비에게도 그저 대규모 마법을 위해 쉐르'툴의 폐허를 이용할 것이라고밖에 말하지 않았다. 누군가 인간 평민들에게 샬로레에게 책임이 있다고 말한 거야. 하지만 실수를 저질렀군. 샬로레에 대한 모종의 비밀 작전이 진행되고 있다는 것을 알았거든."
...
나는 관문을 통과해 들어갔고 경비병들은 다시 내 뒤에 있던 피난민들을 다시 심사하기 시작했다. 주변에는 수많은 천막과 급조된 판잣집이 즐비했다. 도시로 몰려드는 피난민들을 수용하기 위해 지은 것 같았다. 피난민들은 주변에 멍하니 앉아있을 뿐이었다. 몇몇 생기가 다 빠져나간 듯한 눈빛으로 서쪽을 쳐다보고 있었는데, 아마도 그들이 피난해온 정착지 쪽을 보는 것 같았다. 어떤 자들은 멍하니 하늘을 쳐다보며, 마치 마법 폭발이 벌어졌을 때처럼 휘몰아치는 죽음을 기다리는 듯했다.
...
His words made me think for a moment, but I simply got up and left. I remember him calling out that should I change my mind, that I would be 'welcomed as a new initiate for sure'. The sun had begun to set in the sky as I left the building. Figuring I should look for a place to stay for the night I found an inn and purchased a room. I figured that in the morning I would go to the market and buy some food and supplies for my journey home. I slept soundly until early in the morning before the sun had begun to rise when the sounds of screaming filled my ears. Wondering what was going on I looked out the window of my room to see fire and smoke rising from a large building in the distance.]], [[[i]누군가를 알아간다는 건 참 어려운 일이다. 그 전령이 좋은 예라는 것을 곧 깨닫게 된다. 나는 그가 마법 폭발 때문에 분개한 인간 정도로 생각하고 있었다. 지금 와서 생각해보면, 그는 단순히 화가 난 인간이 아니라 마법 사냥을 선동한 집단의 구성원이었던 것 같다. 전령과, 그가 나간 뒤따라 나갔던 검은 망토의 인간들이 그 다음 날 일어났던 극악무도한 음모를 수행하다 죽었던 것이 틀림없다. 헌데 그는 자신의 의지로 죽었던 것인가? 그 점이 내가 오늘 날에 이르러서 드는 의문이다.[/i]
...
그때서야 나는 이 인간이 내가 생각했던 것 이상으로 꾸미는 것이 있는 인물이라는 것을 깨달았다. 단순히 재담꾼이나 믿을 만한 사람으로 생각하기에는 위험한 구석이 있는 것 같았다. 무모하긴 하지만 이 인간이 뭔가 더 알고 있는지 더 알아보기로 했다. 나는 조용히 말을 꺼냈다, "샬로렌에 관해 뭔가 계획이라도 있나요?" 그 즉시 인간은 자세를 바로 잡았고 이어가는 말의 목소리가 달라졌다. "아, 에이알의 대지에서 그 하찮은 촌뜨기들을 쓸어버린다면 더 좋을 게 없지 않겠소? 보아하니 당신도 그들에게 책임이 있다는 걸 알고 그들의 피로 몸을 적시고자 숲에서 나왔을 거 같은데. 분명 다들 그러고 싶을 거요. 머지않아 샬로렌은 마즈'에이알에 마법 폭발을 일으킨 대가를 톡톡히 치룰 것이오."

조심스레 목소리에 분노를 최대한 담아 물었다. "마법 폭발, 그걸 그렇게 부르나보죠?" 그렇다고 말하며 그는 대답했다. "그렇소, 최소한 그렇게 들었지." 그는 꽤나 떠들기 좋아했으니 무언가 더 말하기를 기다렸다. "내 제안 하나 하지. 이 계획에 관해 당신도 우리 무리에 참여하지 않겠나? 자연이 이런 참극에 빠지지 않도록 우리의 계획을 곧 실행에 옮길 거야. 당신은 탈로레니 자연의 고통을 아주 제대로 실감하고 있겠지. 그리고, 샬로렌이 가장 큰 책임이 있긴 하지만 다른 종족들이 그 원대한 계획을 아예 모르고 있었던 건 아니라고. 모든 종족이, 아마 드워프를 제외하고는, 마법 폭발에 대해 어느 정도 알고 있었을 걸."
...
하플링이 손을 내리고 설명을 하기 시작했다. "우리의 사명은 더러운 마법사들을 뿌리뽑고 마법의 해악으로부터 더 이상의 비극이 발생하는 것을 막는 것이다." 하플링은 심호흡을 하고 말을 이었다. "이 탈로레는 마법사가 아니-." 인간이 하플링의 말을 끊고 분개하며 소리쳤다. "그래서 뭡니까!? 샬로레랑 관련된 년입니다! 마법 폭발을 일으킨-" 또다시 하플링이 손을 올리고 인간은 말을 멈췄다. 마침내 조용해지자, 하플링은 손을 내렸고 나를 붙잡고 있던 힘이 조금 풀어지는 것을 느꼈다. 결국 인간은 역정을 내며 돌아섰으며 천막 바깥으로 나갔다.
...
하플링에게서 들었던 대로 나는 남쪽으로 향했다. 왜 내가 그냥 북쪽의 고향으로 향하지 않았는지는 모르겠지만, 내 안에 끓어오르는 분노 때문에 가면 쓴 자들의 지도자를 만나야겠다고 생각했다. 남족으로 가면 갈수록 하늘은 하늘색에서 보라색으로, 보라색에서 검붉은 색으로 변해갔으며, 이내 태양조차 보이지 않았다. 이 주변의 땅도 마법 폭발의 파괴적인 힘으로부터 벗어나지 못 한 게 틀림없었다. 한나절동안 걸은 두에야 나는 불타버린 나무들 옆자리에 천막을 쳤다. 이 파괴된 황야에서 채집할 수 있는 것은 거의 없었으나, 산딸기나 버섯 따위를 조금 찾아내 먹을 수 있었고, 내 식량은 좀 더 아낄 수 있었다.

다음 날 난 여정을 계속했다. 몇 시간 뒤, 남쪽 해안가에 도착했고 거기에서 끔찍한 광경을 목격했다. 바닷물이 마치 물 끓이듯 거품이 올라왔으며, 땅은 새까맣게 타버렸다. 아직 자리를 지키고 있던 초목들은 완전히 타버려 생기를 모두 잃어버렸다. 마법 폭발로 파괴된 자연의 잔재는 벌레나 곤충들에게 파먹히지도 않고 그대로 남아있었다. 위를 올려다보자 검은 구름과 시커먼 하늘 뿐이었다. 동쪽에는 땅속에서 용암이 나와 웅덩이를 만든 것이 보였다. 그 용암은 작은 호수를 만들어 붉고 뜨거운 죽음의 흐름을 형성했고, 나는 이것들을 피해 움직이느라 매우 조심해야 했다. 북쪽을 쳐다보자 대지가 불쑥불쑥 튀어나와 하늘로 치솟는 이상한 광경까지 볼 수 있었다.

솟아난 지형으로 가까이 다가가자, 그것이 먼 산봉우리처럼 솟아오르고 있다는 것을 알았다. 언덕을 오르면서, 그 너머로 바위들이 부자연스럽게 협곡과 뾰족한 가시를 형성하고 있는 것이 보였으며, 그 사이를 넘어가려는 건 자살 행위나 다름 없었다. 엘발라에서 후퇴해 온 병사들을 기억하면서, 그들이 고향으로 돌아오기 위해 왜 북쪽을 경유해야 했는지 다시금 깨달았다. 미드베일 평원이 있던 대륙의 중앙은 이제 더 이상 없었다. 평원은 이제 바위가 솟아난 끔찍한 아수라장이 되어 들어오는 자들을 모두 죽여버릴 곳이고, 마법 폭발 이전에 그곳에서 살았던 자들이 맞이한 운명도 그랬을 것이다.
...
그 분노를 되새기자마자, 광인들의 희생양이 되었던 이들을 고울 수 있는 방도가 있다면 돕겠다고 결심했다. 이전에 엘발라에서 귀환의 룬을 넘겨받았다는 것을 기억해내며 난 그들을 올려다보며 물었다. "만약 날 따라온다면, 당신들을 엘발라로 데려다 줄 수 있어요. 샬로레는 바깥 세계와의 연결을 끊었지만, 내게 당신들을 그곳으로 보내줄 방법이 있으니. 거기로 가면 당신들은 안전할 겁니다." 그렇게 말하자 오우거들은 나를 쳐다봤다. 그들에게서 충격과 불안함을 느낄 수 있었다. "우리에게 샬로레에게 가라고 말하는 건가? 그들이 이 마법 폭발의 배후에 있는 자들 아닌가? 샬로레가 세상을 이렇게 뒤집어 놓지만 않았다면 우리는 평화롭게 잘 살고 있었을 걸세."
...
내가 부상을 완전히 회복했을 때는 내 인생에 있어서 가장 최악의 시기라고 할 수 있다. 생각에 빠져들 시간은 남아돌았고, 마법 폭발로부터 지금까지 일어났던 모든 일들을 되새기며 생각에 빠지는 것을 멈출 수가 없었다. 매 순간순간이 끔찍한 악몽을 꾸는 것 같았고 이 느낌은 나를 좀먹어갔다. 광신도들과 싸울 때 느꼈던 그 충동이 언제든지 나를 찢고 튀어나오려고 했다. 잠이 들었을 때에도, 깨어있을 때에도 항상 그랬다. 묘사할 수조차 없는 끔찍한 고통 속에서 나는 내 삶을 끝없이 저주했다. 그런 와중에 난 감정에서도 자유로워질 방법을 찾지 못 했고 스스로를 옭아맸다.
...
마법 폭발 이후로 일어났던 여러 사건들을 되돌아보면, 내가 고향을 떠나지 않았다면 내가 어떤 삶을 살았을지 의문이다. 내가 여행을 시작한 뒤로 긴 시간이 흘렀지만, 지금 또다시 나는 엘발라를 떠나 낯선 땅을 향해 세상이 어떻게 변했는지 보고자 한다. 에이알의 사람들이 어떻게 지내고 있는지, 이 상처받은 대지가 회복될 기미가 보이는지, 고향의 탈로레는 어떻게 지내는지 알고 싶다. 앞으로 무엇이 내 앞에 기다리고 있든, 나는 그 모든 것을 헤쳐나갈 주닙가 됐다. 그것은 내 또 다른 모험의 시작이리라!]], "_t")
