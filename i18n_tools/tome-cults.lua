...
t("Escapades of Fay Willows [Book 4, Chapter 6] - Rebuilding Anew", "페이 윌로우즈의 여행기 [4권, 제 6장] - 다시금 나아가며", "_t")
...
When I look back at the many events the occurred after the Spellblaze, I wonder what life might have held for me had I not left to travel as I did. Much time has now passed since the time of my initial journey, but I consider whether now is the time that I will leave Elvala to explore distant lands and see what has become of everything in the world. I wonder how the rest of the people in Eyal are faring and whether the lands have shown any signs of healing, as well as wonder what has happened to my fellow thaloren back home. Whatever may lie in my future I know that I am ready to make my way through it. And when I do, my escapades will continue once more!]], [[[i]시간이 지남에 따라 오우거와 샬로레는 바깥으로부터 단절된 생활에 천천히 적응해갔다.[/i] 샬로레는 북쪽의 버려진 정착지에 비밀리에 모여 최대한 많은 자산을 확보하고, 엘발라를 감추는 장막이 영구적으로 유지될 수 있도록 여러 작업을 했다. 이들은 장막이 엘발라의 숲을 모두 감싸도록 확장시켰고, 바깥 세상으로부터 엘발라 반도를 완전히 봉쇄했다. 그 이후, 많은 샬로레들은 이 대지에 흩뿌려진 혼돈의 힘을 연구하여 에이알이 입은 피해와 앞으로 이 힘이 어떤 영향을 끼칠지 알아내고자 했다.

[i]오우거들은 엘발라 반도의 남부에 정착하여 새로운 생활을 꾸려갔다.[/i] 이들은 모두를 위해 식량을 재배하기 시작했고 샬로레가 해내기 어려운 육체적인 작업을 도맡아서 해냈다. 많은 오우거들이 자손을 낳았고 인구는 극적으로 증가했다. 오우거 중 일부는 각인에 관련된 일을 맡았다. 난 룬에 대해선 아직도 잘 모르지만, 오우거들이 지닌 주입물에 대한 지식과 기술은 내가 고향에서 알고 지내던 탈로레들만큼이나 뛰어났다. 이런 생활에 불만을 지닌 오우거가 없었던 것은 아니지만, 결국 샬로레와 좋은 관계를 유지하며 번영했다. 오랫동안 이런 관계가 지속되기를 바란다.
...
나의 선생은 룬의 작용을 내가 제대로 이해할 수 있도록 시연하는 데에도 공을 들였다. 그녀가 처음 시연을 할 때 내 앞에서 갑작스레 사라져버린 때가 기억난다. 나는 어리둥절하며 이리저리 고개를 돌렸고, 이내 그녀는 웃음을 터뜨리며 내 앞에 다시 나타났었다. 그녀는 여러 오우거들을 소개해줬는데, 그들은 룬을 통한 다양한 능력을 보여줬고 이것을 전투 속에서 어떻게 활용했는지 이야기를 해주었다. 모든 과정을 마치고 나서, 선생은 내게 열선 발사 룬을 건네주었다. 귀환의 룬과는 달리, 나는 이 룬을 직접 내 왼팔에 새겼으며 지금까지도 이 룬은 내 팔에 남아있다.

샬로레로부터는 다양한 기술을 배웠는데, 특히 전투 장비와 관련된 것들이었다. 무기 장인은 내게 무기를 어떻게 휘두르는 지에 대한 기초적인 교육을 해주었고, 그 후 훈련용 인형을 상대로 커다란 대검과 망치부터 단검과 몽둥이까지 활용하며 훈련을 받았다. 방어구 장인은 다양한 소재의 의류와 갑옷을 보여주고 각각의 방어구들이 여러 무기에 대해 어느 정도의 효율성을 지니는지 보여주었다. 한 번은 온 몸을 판금갑옷으로 무장하고 연습 교장을 내달리며 지치지 않고 몸을 가누며 달리는 법을 배운 적도 있었다.

그리고 베테랑 샬로레 병사들이 나와 겨뤄준다고 했을 때, 나는 내가 배웠던 모든 지식을 쏟아부어야만 했다. 모의 전투에 임할 때에는, 전투 간에 체력을 온존하고 룬을 적절히 사용하는 방법을 익혔으며, 룬을 통해 전투 간에 이득을 취하거나 수세에 몰렸을 때 극복하는 법을 배웄다. 머지 않아 나는 노련한 병사들과도 큰 문제없이 전투를 치룰 수 있게 됐다. 이 수준에 다다르자 샬로레 군대에 입대하라는 권유를 받았다. 딱히 다른 할 일이 있는 것도 아니었고, 지금까지 갈고닦은 전투 기술을 시험하고자 나는 몇 년간 엘발라에서 병사로서 복무했다.

군대에서 복무하는 기간동안 나는 스스로의 감정을 통제하는 방법에 대해 상당히 많은 경험을 얻게 됐다. 독자적인 능력을 가진 자들을 대상으로한 훈련에 참여하여, 난 내 몸에까지 영향을 끼치는 사악한 힘에 대해 느리게나마 배울 수 있었고, 심지어 이것을 전투 간에 활용하는 방법마저 터득할 수 있었다. 이것을 내 주변 환경에 적용하는 방법, 즉 그것이 살아있든 살아있지 않든 간에 내 힘을 불어넣을 수 있는 방법을 배웠고, 때때로 그 검은 충동을 다른 이들에게 불어넣는 훈련 또한 허용됐다. 지금까지 이 혼돈의 힘을 완전히 통제했다고 할 수는 없지만, 정신을 집중하여 이 힘을 다른 이들로부터 돌리고 내 주변 사람들에게 영향을 끼치지 않는 방법을 터득했다.

마법폭발 이후로 일어났던 여러 사건들을 되돌아보면, 내가 고향을 떠나지 않았다면 내가 어떤 삶을 살았을지 의문이다. 내가 여행을 시작한 뒤로 긴 시간이 흘렀지만, 지금 또다시 나는 엘발라를 떠나 낯선 땅을 향해 세상이 어떻게 변했는지 보고자 한다. 에이알의 사람들이 어떻게 지내고 있는지, 이 상처받은 대지가 회복될 기미가 보이는지, 고향의 탈로레는 어떻게 지내는지 알고 싶다. 앞으로 무엇이 내 앞에 기다리고 있든, 나는 그 모든 것을 헤쳐나갈 주닙가 됐다. 그것은 내 또 다른 모험의 시작이리라!]], "_t")
