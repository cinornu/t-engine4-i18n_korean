...
The other ogre soon moved to attack the halfling, but with a sidestep the halfling simply moved out of the way before disappearing into the darkness. The ogre followed, but from the grunting and yelling it seemed that the ogre did not fare well either. The halfling would emerge again and again, knocking ogres down with seemingly ease, before escaping from counterattack. Ogres in the darkness would be attacked and shout in pain while those who strayed too close to the hazards of the landscape would soon find themselves sent spiraling into the deathtraps of the land. In an instant the battle had shifted in the fanatics favor, and panic and fear was beginning sweep over the ogres.]], [[[i]하늘을 뒤덮은 어둠과 전장에 드리운 어두운 대지 때문에 무언가를 보기 어려웠으나, 난 아직도 그 전투의 소리를 자세하기 기억하고 있다. 용암에서 거품이 올라오고 물이 끓어오르는 소리, 전장을 메우는 전투의 함성 소리, 오우거들의 룬에서 마법이 발사되는 소리, 서로의 무기가 맞부딪히는 소리, 온갖 소리가 끊임없이 이어졌다. 물론, 그 어떤 소리도 광신도들과 오우거들이 죽어가면서 내는 단말마와 비교할 수는 없었다.[/i]

우리가 점점 다가가면서, 광신자들이 공격 대형을 갖추며 다가오는 모습을 볼 수 있었다. 그들의 전투 대열은 두 줄로 이루어져 있었으며, 근접 투사들이 앞 열에, 궁수들이 뒷 열에 있었다. 우리보다 훨씬 수가 많아 언뜻 보면 우리가 열세인듯 했으나, 저들의 상황도 썩 좋진 않았다. 많은 이들이 가면을 쓰고 있지 않았으며 넝마짝이 된 옷을 입은 모습이 나르골 왕국의 피난민들을 연상케 했다. 아마도 그들은 갓 들어온 신입들인 것 같았고 자신들의 세력에 참여하라는 가면 쓴 광신도들의 충동질에 넘어간 이들인 것 같았다. 그들은 모두 무기를 들고 있었다. 하지만 무기에는 조예가 없는 나조차도 그들은 무기를 제대로 다루는 법을 모르는 자들이라는 걸 확실히 알 수 있었다.
