...
나는 그 즉시 내 존재의 힘을 마법부여사에게서 물러나게 했다. 그녀는 곧바로 의자에서 뛰쳐나가 도망치듯 자리를 피했다. 내가 가했던 중압감이 사라지면서 그녀는 숨을 헐떡였다. 두 눈을 부릅 뜬채로 어둔 나의 일면을 목도했다. 이제 그녀는 그저 숨으려고밖에 하지 않았다. "미안해요." 난 겨우내 그렇게 말할 수밖에 없었다. 그녀는 날 쳐다봤다. 방금 전보다도 훨씬 더 늙은 것 같았다. 부들부들 떨면서 그녀는 문을 열고 바깥으로 나갔다. 안전한 곳으로 가기 위해, 나로부터 도망치기 위해. 그녀가 떠난 뒤부터 내 방 바깥에서 경비병 한 명이 지키기 시작했다. 마법부여사가 오기 전엔 경비병이 내 방을 지키는 경우는 없었다.
...
t("Escapades of Fay Willows [Book 4, Chapter 5] - Festival of Happiness", "페이 윌로우즈의 여행기 [4권, 제 5장] - 행복의 축제", "_t")
