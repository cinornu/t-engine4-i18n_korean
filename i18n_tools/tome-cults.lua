...
그 이후 그중에서도 덩치가 큰 오우거들이 죽은 나무들을 통째로 부러뜨렸다. 그리고 놀라울 정도로 쉽게 나무를 땅에서 뽑아냈다. 나무에서 가지를 쳐내고 뿌리를 정리한 뒤, 그들은 나무통을 마치 거대한 몽둥이처럼 휘둘렀다. 머리가 잘 돌아가는 몇몇 오우거는 자신들의 옷가지를 찢어 노끈을 만들었다. 그러고선 허리띠에 연결한 뒤 조잡하게나마 투석구를 만들어냈다. 다른 오우거들은 돌멩이를 주워 주변에 쌓아두었으며, 투석구의 탄환으로 쓸 심산인 듯 했다. 또 다른 오우거들은 짝을 지어 서로 기묘한 자세를 취했다. 그리고 얼마 지나지 않아 허공에 주먹을 날리고 발차기를 했다. 맨몸전투를 위한 연습인 것 같았다.

난 오우거들의 모습과, 그들이 전투 태세로 순식간에 변환하는 모양새를 보고 압도되었다. 오우거 대장이 내게 오는 것조차 눈치채지 못 할 정도였다. 내 주의를 돌리기 위해 그는 크게 소리쳤다. "탈로레, 나 좀 보게!" 난 그에게 고개를 확 돌렸다. "뭐, 뭐, 뭐요?" 나는 말을 더듬다가 이내 내가 처한 상황을 바로 인식했다. "우리를 도와줄 수 있을만한 물건을 가지고 있소?" 그 오우거의 말을 듣자마자 나는 메고 있던 배낭을 내려놓고 안에 있던 물건들을 보여주었다. "이게 내가 가진 전부에요." 내가 말했다. 대장은 가방 안을 들여다 보더니 도끼와 다용도 칼을 꺼냈다. 나르골 왕국에서 사둔 것들이었다.

그는 두 손에 그것들을 각각 들어본 뒤, 도끼를 들어올리곤 이리저리 휘둘러봤다. 만족스런 표정을 지으며 그는 내게 칼을 돌려주면서 말했다. "내가 이걸 쓸 수는 없지. 내 손에 잡고 쓰기엔 너무 작네. 당신이 쓰게. 스스로를 지켜야 하니." 그 말을 듣자 나는 무언가 깨달았다. 나도 이 싸움에 참여할 것이다. 그때까지 난 굶주린 동물 따위를 사냥해본 적은 있었으나, 진짜 적과 싸워서 전투해본 경험은 없었다. 근심에 찬 내 표정을 보더니 대장이 말했다. "여기까지 온 것을 보아하니 당신은 그 광신도들과 같은 편이 아닌 건 확실하군. 만약 상황이 안 좋아지면, 그냥 도망쳐서 목숨을 보전하게. 그들은 당신을 쫓지 않을 거야. 쫓는 것은 우리 오우거지, 자네가 아니니까."

그 말이 마치 비수같이 내게 꽂혔고, 나는 꽤 화가 났다. 나는 대장에게 소리치며 대답했다. "아니, 난 함께 싸울 겁니다." 그렇게 외치게 된 것은 내 안의 분노 때문이었는지 아닌지 확신할 수 없다. 하지만 난 오우거들을 내버려둘 수는 없었다. 그 싸움에서 죽을 수도 있었으나, 나는 도망치지 않으리라 다짐했다. 내 외침에 대장과 다른 오우거들은 나를 쳐다봤다. 놀라워하면서도 어째 즐거워하는 듯했다. 한 오우거가 째지는 목소리로 외쳤다. "전투로!" 다른 오우거들도 이내 "전투로!"라고 외쳤다. 대장은 미소를 지으며 이내 손을 들어올렸고, 다른 오우거들에게 조용히 하라는 신호를 보냈다. 그러고선 작게 고개를 끄덕이며 말했다. "전투로."
