...
나는 당황하며 그 자리에 앉아 있었고, 잠깐 동안 우리 둘 사이에 침묵이 흘렀다. "당신은 탈로레군." 샬로레가 말했고, 난 눈을 몇 번 끔뻑거리다가 맞다고 대답했다. 정신 차리기 전까지 잠깐 멍하니 있었다. 여기서 뭘 하냐고 물었다. 그런 말을 들으면서, 뭐라고 대답해야 할지 고민했다. 날 이끌던 분노는 이미 거의 사라져 버렸고, 여기까지 왜 왔는지 이유도 알 수 없었다. 조금 더 앉아 있다가 대답했다. "그 이유를 알아내기 위해 여기까지 왔습니다." ]], "_t")
...
대장은 내게 물었다. "무슨 문제 있나, 탈로레?" 드디어 그들이 왜 주입물을 쓰지 않는 것인지 대답을 들을 수 있는 기회였다. "왜 붕대를 쓰는 겁니까? 주입물이 없습니까?" 내가 이렇게 되묻자 대장은 살짝 즐거운 듯이 대꾸했다. "샬로레가 주입물을 쓴다라?" 대장은 마치 농담이라도 들은 듯이 웃었다. 주변에서 망토를 걸친 자들이 내는 웃음소리가 들렸다. 대화를 이어가기 위해 대장이 다시 입을 열었다. "자네들이 주입물을 써먹는 이유는 충분히 이해하지만, 우리 샬로레는 자연 속에서 그런 것들을 넘어서서 살아가려고 한다네." 

나는 이런 대답이 조금 당혹스러웠다. 부상당한 샬로레 한 명이 내뱉는 기침 소리가 들려왔지만, 나는 정중히 말했다. "주입물을 쓰지 않아서 죽을 수도 있다고 해도 말입니까?" 이 물음에 대장은 짐짓 엄숙한 모습으로 가건물에 누워 있는 샬로레들 쪽을 쳐다보며 말했다. "물론 아니지." 나는 그 샬로레를 쳐다보며 확고한 목소리로 대답했다. "그렇다면 왜 저 샬로레들은 부상을 입은 채로 누워 있습니까?" 이에 대한 대답은 조용한 목소리로 돌아왔다. "왜냐하면 샬로레는 주입물을 가지고 다니지 않기 때문이네." 
...
치료를 마무리하기 위해 주입물을 꺼내려고 내 배낭에 손을 뻗었을 때, 대장이 말하는 것이 들렸다. "그거면 충분하네." 어이가 없어서 고개를 확 돌렸다. 난 입을 다물고 있지 않기로 했다. "저들을 치료하는 걸 원치 않기라도 합니까?" 다소 완곡한 대답이 돌아왔다. "이제 저들이 곧 죽을 것 같지는 않네. 그렇지 않나? 자네가 가진 그 주입물들, 그건 한정된 자원이지. 죽음에 더 가까워질 자들을 위해 남겨두는 게 좋을 것이야." 나는 조금 진정한 뒤, 그 샬로레 대장이 말했던 것에 대해 의문이 들었다. 그리고 물었다. "무슨 뜻입니까? 누구를 위해 남긴다구요?"]], "_t")
...
치유사가 걸어가기 시작하자 나는 순찰대의 대장에게 시선을 돌렸다. 그는 나를 돌아보며 대답했다. "그 의사는 자네를 주 진료소로 데려갈 거야. 걱정 말게. 자네에게 한 약속은 잊지 않았으니. 자네가 찾는 답을 구해줄 자를 찾아다 주겠네." 그는 나를 있는 대로 부려먹을 생각인 것 같았고, 그래서 차갑게 대답했다. "내 인내심을 너무 오랫동안 시험하지 않는 게 좋을 겁니다." 그는 미소를 짓는 듯한 표정을 보이며 날 기다리던 치유사에게 고갯짓하고선 천천히 발걸음을 돌렸다. 
...
그 순간 전장의 모든 소리가 사라진 것 같았다. 나는 내 눈 앞에 선 드워프에게 모든 신경을 집중했다. 눈앞에 있던 것들 중 새빨간 피만 눈에 들어올 뿐이었다. 내 손과 팔, 내가 그 드워프의 모가지에 꽂아넣은 단검, 그리고 드워프가 쓰고 있던 가면에 흩뿌려진 피. 이내 가면 아래에서 드워프가 피를 토했다. 도끼와 방패를 떨어뜨리고 목에 꽂힌 단검을 붙잡은 채로 허우적거리며 가래 끓는 소리를 냈다. 나는 천천히 몸을 굽혀 두 손으로 도끼를 집어들고, 힘껏 내 머리 뒤쪽으로 젖혀들어, 온 힘을 다해 드워프의 머리통에 도끼를 꽂아넣었다. 그렇게 드워프가 단번에 죽어버리자, 내 안에서 묘한 느낌이 피어올랐고 이내 그 느낌이 나라는 존재를 이루는 아주 조그만 부분들을 하나하나, 모조리 파고들었다.
...
t("Escapades of Fay Willows [Book 3, Chapter 6] - Hateful Wrath", "페이 윌로우즈의 여행기 [3권, 제 6장] - 증오에 휩싸인 분노", "_t")
