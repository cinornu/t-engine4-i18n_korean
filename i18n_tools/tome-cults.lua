...
This series will analyse what little information about the Godslayers that is still available. Given the obscure nature of the Sher'tul race, there are no solid records regarding their most prominent figures.]], [[에이알 신들의 본성을 탐구하는 학문적 노력의 일환으로, 그들의 죽음에 있어 쉐르'툴의 역할은 잊혀져서는 안 된다. 9명의 쉐르'툴이 신들을 살해했는데, 지금은 신살자로 알려진 인물들이다. 그 이상으론, 이 개인들에 대해 확실하게 말할 수 있는 것이 거의 없다. 쉐르'툴은 많은 형태의 기술, 마법 주문, 그리고 초능력 기술을 숙달했다고 믿어진다. 그때나 지금이나 에이알에게는 그들의 힘에 필적할 만한 존재가 하나도 없다. 우리가 짐작조차 할 수 없는 방법으로, 그들은 에이알의 신들을 죽일 수 있는 무기를 제조했는데, 그것들을 휘두르는 9명의 신살자에게 맞춰 9개가 존재했다.
...
In the end, it was Caldizar who commanded the Sher'tul to slay Amakthel. It was thought that this command was not carried out by all Sher'tul and was, in fact, openly reviled by many of them, leading to conflicts within their ranks. There are no records of the Sher'tul after the Godhunt ended, let alone of Caldizar. No one is certain what became of their race. It is also noted that there is a strange absence of Sher'tul ruins on Eyal, almost as if they have been removed.]], [[모든 신살자의 신화는 한 인물에게로 돌아온다. 칼디자르는 신살자들을 모아 쉐르'툴을 에이알의 신들과 맞서게한 장본인이었다. 쉐르'툴 사회에서 그의 지위는 완전히 분명하지는 않지만, 그가 활용한 자원과 쉐르'툴에 대한 그의 영향력을 볼 때, 그가 그들의 지도자 중 한 사람, 혹은 적어도 쉐르'툴 사회의 저명한 인물이라고 생각된다.

신 사냥이 시작된 것은 아마크텔이 쉐르'툴에게 다른 신들을 죽이라고 명령했기 때문이다. 칼디자르는 직접 나서서 잠재적인 후보들을 색출하여 신살자의 무기를 휘두르게 했다. 그도 역시 신살자의 무기를 휘두르는 것을 선택했고, 신 사냥에 참여할 아홉 명의 지도자가 되었다. 그러나 쉐르'툴들은 임무를 마치고 나서 어떻게 아마크텔이 자신의 목적을 달성하기 위한 도구로 자신들을 이용한건지 생각하기 시작했다. 그들의 창조자는 엄청난 힘을 휘두르면서도 쉐르'툴에 비한다면 유아에 가까운 지적 능력을 가지고 있었다.

결국 쉐르'툴중에게 아마크텔을 살해하라고 명령한 이는 칼디자르였다. 이 명령을 쉐르'툴 전부가 수행한 것은 아니며, 사실 그들 중 다수가 공개적으로 이 명령을 비판했으며 계급 내 갈등으로 이어졌다고 생각되었다. 칼디자르는 고사하고 신 사냥이 끝난 이후의 쉐르'툴에 대한 기록은 없다. 아무도 그들의 종족이 어떻게 되었는지 확신하지 못한다. 에이알에는 쉐르'툴 폐허가 거의 증발한 것처럼 기이한 부재가 느껴진다는 점도 눈에 띈다.]], "_t")
...
When he fought against the Gods, he acted completely without passion. His staff hammered them down, sliced them open and slaughtered them. He killed without mercy and without malice. When the last of the gods were dead, he returned to his wanderings, carrying Ythral and his old iron staff with him.]], [[방랑자 오슬레이는 쉐르'툴 종족 사이에서도 신화적인 존재로 여겨졌다. 그는 대부분의 나날을 에이알 표면을 배회하면서 야만에서 막 벗어난 어린 종족들을 조용히 관찰하며 보냈다. 대부분의 쉐르'툴은 '더 하등한' 종으로부터는 거리를 두는 것을 선택했지만, 오슬레이는 그들 사이를 걷고 그들과 대화하는 데까지 시간을 할애했다. 그는 걸을 때마다 평범한 철제 지팡이를 들고 다녔는데, 이것은 그가 소중히 간직하고 있던 구식 무기였다.

그 역시 신살자가 되어 달라는 요청을 받았다. 왜냐하면 그의 봉술 솜씨는 전설적인 수준이었기 때문이다. 그는 정중하게 거절했지만, 그를 향한 도움 요청은 계속 되었다. 그가 방랑하던 땅이 그의 눈 앞에서 불타버리는 것을 본 후, 그는 마침내 에이알의 신들에 대항하는 입장을 택했다. 그는 한쪽 끝에 크레센트 칼날이 달린 독특하게 만들어진 지팡이, 이쓰랄을 선물받았다.
...
신 사냥이 진행 중일 때, 그녀는 신에게 치명적인 타격을 주는 데 필요한 무기를 생산하기 위해 그녀가 알고 있는 가장 훌륭한 대장장이들을 불러온 사람이었다. 그녀에게도 신살자의 무기인 히투라크라는 검이 제공되었다. 그녀의 대장장이와 무기를 제조하는 그녀의 전문지식이 없었더라면, 그 무기들은 만들어질 수 없었을 것이다.

신 사냥의 때 그녀는 여러 번 신들보다 전술에서 앞서며 매복을 이용해 그녀가 원하는 정확한 장소로 그들을 몰아갔다. 신들은 그들의 막강한 힘에 비해, 무르타스의 전술에 필적할 만한 교활함이 부족하여, 궁지에 몰린채 무기력한 동물처럼 도살되었다.]], "_t")
...
신 사냥이 끝나자 하르퀠은 조용한 삶으로 돌아왔다. 살아남은 쉐르'툴은 신살자들을 영웅으로 취급했고 각각은 후하게 보상 받았지만, 하르퀠은 단순히 누구에게도 방해받지 않을 별들 어딘가에 은신처를 요청했을 뿐이다.]], "_t")
...
His fate after the Godhunt is unknown. Some sources speculate that he still remains in his library today, waiting for a student worthy of learning the full contents of his archives.]], [[쉐르'툴은 비범한 인물들을 많이 보유했던 종족이었다. 프로사트의 이야기는 다른 신살자들에 비해 평범하다. 그는 대부분의 시간을 독서와 연구, 가르침으로 보낸 학자였다. 프로사트 도서관은 그가 일생 동안 쌓아온 방대한 지식의 기록 보관소이자 전설적인 수준의 배움의 터였다. 아마도 그의 경력에 있어서 가장 주목할 만한 것은 오직 에이알의 신들만이 가지고 있는 반-엔트로피적 힘의 본질에 대한 연구였을 것이다.
...
신 사냥 이후 그의 운명은 알려지지 않았다. 일부 자료들은 그가 오늘날에도 여전히 그의 도서관에 남아 그의 기록물의 모든 내용을 배울 가치 있는 학생을 기다리고 있다고 추측한다.]], "_t")
...
Judging by surviving records, she was one of the Godslayers who was killed during the climax of the Godhunt. The fate of the spear Thoral is unknown.]], [[아조롤은 명사수였다. 그녀는 무기 사용법의 강사였고, 오래된 무기를 선호하는 것 같았다. 많은 쉐르'툴은 훨씬 더 파괴적인 무기가 이미 개발되어 있는데 왜 원시적인 발사체 무기를 사용하는지 알 수 없기 때문에 그녀가 어리석다고 믿었다. 그녀는 비평가들의 언사가 아무리 가혹해도 그녀의 방식을 포기하지 않았다. 왜냐하면 그녀는 전쟁의 오래된 방식을 보존하는 것은 가치가 있다고 믿었기 때문이다. 많은 이야기들에서 그녀의 틀림없는 정확성을 말해준다. 아무리 과녁이 작고 거리가 멀어도 그녀의 힘찬 투창은 언제나 적중할 것이었다.

그녀를 위해 창 쏘랄은 비길 데 없는 힘을 지닌 투척무기였다. 그녀는 신 사냥의 이유에는 신경을 쓰지 않는 것 같았는데, 창만으로도 그녀에게 있어 이미 대단한 보상이었기 때문이다. 이 새로운 무기와 함께 아조롤이 에이알의 평평한 평야에 서서 우리 세계 너머의 어둠 속에 있는 목표물을 명중시키는 이야기가 펼쳐졌다. 그녀의 쏘랄과 그 사용자로부터 안전한 곳은 에이알 어디에도 없었기 때문에 아조롤은 그녀가 신살자들 중 가장 힘센 이 중 한 명이라는 것을 증명했다.

살아남은 기록으로 미루어 보아 그녀는 신 사냥의 절정기에 살해된 신살자 중 한 명이었다. 창 쏘랄의 운명은 알 수 없다.]], "_t")
...
신 사냥이 시작되자 우쓰칼은 자원봉사를 시작 했다. 그는 신들을 처분해야 한다는 것은 알았지만 동시에 신들이 고통받는건 바라지 않았다. 그에게 있어 그것은 또 다른 처형이었다. 할버드 쓰라구샬은 그를 위해 만들어졌는데, 그 무기는 처형인을 위해 만들어진 무엇과도 비할 수 없는 강력한 무기였다. 쓰라구샬은 희생양의 작은 신경 마저도 절단할 수 있는 방식으로 설계되었고, 그것의 거대한 칼날을 통해 신들은 고통 없이 잘려나갔다.

우쓰칼은 신 사냥이 끝난 후 오랫동안 신들의 시체 위를 맴돌면서 그들이 진정으로 죽었고 신들이 망각 속으로의 길고 고통스러운 여정을 겪지 않았음을 확인했다고 생각되었다.]], "_t")
...
그가 처음 신들을 죽이는 계획을 들은 후, 그는 열정적으로 자원해 신살자가 되고자 했다. 그는 검 시라레이를 받았는데 시라레이는 그가 경기장에 휘둘렀던 유명한 검과 무척이나 흡사했다. 후에 그는 신 사냥이 끝난후, 그는 기꺼이 Cirarey을 포기하고 나중에 다른 경쟁자에게 살해당했을것이라 추측되는 경기장으로 되돌아갔다. 뒤늦게야 그의 경쟁자가 그의 칼날에 독을 바르는 부정을 저지른것이 밝혀졌다. 유라쉬는 사후 무패의 유라쉬라는 타이틀을 얻었다.]], "_t")
...
t("Lessons of Inevitability - Introduction", "필연성의 교훈들 - 서론", "_t")
...
Hithre was one of The Teacher's pupils, a Shalore who became one of the first to wield entropic magic in the entirety of Eyal.]], [[황혼의 시대, 많은 에이알 주민들은 세상이 끝나고 있는 것 같다고 보았다. 마법폭발에 의한 파괴는 땅을 시들게 하고 황폐하게 하였다. 식량도 부족했고 질병도 만연했고 모두가 절박했다. 선별된 소수의 사람에게, 구원은 예상 밖의 방문객에게서 왔다. 단순히 스승이라고 알려질 존재가 고대 쉐르'툴 장거리 관문을 통해 별 너머 어딘가에서 에이알을 방문했다. 그것은 에이알의 깊은 곳에서 살아남은 한 무리의 생존자들을 발견했고 그들은 자신들의 세계를 유린하는 공포체들에 대항하기 위한 무기로써 그것에게 지식을 간청했다.

자선과 친절의 관점에서 그것은 엔트로피 그 자체의 힘을 어떻게 휘두르는지 가르쳐 주기로 합의했다. 그러나, 그것은 그들에게 이것은 가볍게 여겨질 힘이 아니며 그들의 파멸을 가져올 수 있다는 것을 분명히 했다. 절박했던 만큼, 그들 모두는 두 번 생각하지 않고 동의했고, 그 힘이 가져올 수 있는 결과에 개의치 않았다.

히트레는 스승의 제자 중 한 명인 샬로레로, 에이알 전체에서 최초로 엔트로피의 마법을 다루는 이 중 한 명이 되었다.]], "_t")
t("Lessons of Inevitability - Entropic Backlash and Healing", "필연성의 교훈들 - 엔트로피 반발과 회복", "_t")
...
#{italic}#Go check your new spell for detailed information.#{normal}#]], [[나의 제자들아, 너희에게 주는 첫 번째 교훈은 엔트로피를 다룬다는 것이 무엇을 의미하는지 이해하는 것이다. 그 힘을 사용할 때, 그것의 시드는 손길을 피할 수는 없다. 너희들의 몸은 주문의 반발로 고통 받을 것이고 그 에너지의 잔여물을 항상 지니고 있을 것이다. 그런 만큼 상처와 부상에서 회복하는 능력이 현저히 떨어질 것이다. 하지만 너희는 이런 반발에 저항하고 운명의 실타래까지 조작하여 적에게 떠넘길 수 있는법을 배울 수 있다.

#{italic}#자세한 내용은 새로운 주문을 확인하십시오.#{normal}#]], "_t")
t("Lessons of Inevitability - Netherblast", "필연성의 교훈들 - 황천폭발", "_t")
...
#{italic}#Go check your new spell for detailed information.#{normal}#]], [[이 훈련을 위해, 너희는 어떻게 엔트로피 에너지를 조작하고 유도 하는지 배울 것이다. 이 주문은 너희의 적들에 대한 주된 방어책이 될 것이고 이것을 사용하는데 따르는 반발을 관리하는 법을 가르쳐 줄 것이다. 황천폭발로부터 자신을 방어할 수 있는 존재는 거의 없으므로 완벽해질 때까지 자주 이것을 연습해라.

#{italic}#자세한 내용은 새로운 주문을 확인하십시오.#{normal}#]], "_t")
t("Lessons of Inevitability - Fatebreaker", "필연성의 교훈들 - 운명파괴자", "_t")
...
#{italic}#Go check your new spell for detailed information.#{normal}#]], [[이 주문은 너희가 나에게서 배울 가장 중요한 주문이 될 것이다. 운명은 많은 실로 이루어진 힘이다. 모든 실이 어떻게 서로 연결되는지 이해한다면, 너희는 그것을 자신의 목적대로 조작할 수 있다. 이 주문은 너희가 예정 된 죽음에서 벗어나 상대에게 너희의 불운한 실타래를 떠넘길 수 있게 해줄 것이다. 이 주문을 가볍게 써서는 안 되며, 어떤 실들은 아무리 힘껏 잡아당긴다 해도 누구의 뜻에도 굽어지지 않는다는 것을 기억하라.

목표 더미에는 가짜 공허 에너지가 배어 있다; 그것들에 너희의 운명파괴자를 시전하고, 그 다음 생명력이 낮아진 때에 황천폭발을 자신에게 사용해라. 나의 학생들아, 이것은 고난도의 훈련이다. 지금 목숨을 걸고 있다는 것을, 실수 하면 죽을 수 있다는 것을 명심해라.

#{italic}#자세한 내용은 새로운 주문을 확인하십시오.#{normal}#]], "_t")
t("Lessons of Inevitability - Unravel Existence", "필연성의 교훈들 - 존재 해체", "_t")
...
#{italic}#Go check your new spells for detailed information.#{normal}#]], [[만물의 구성 요소는 무수한 법칙에 의해 한데 묶여 있다. 바로 이 법칙들이 모든 현실을 지배하고 대부분의 경우에 고정불변한다. 하지만 너희가 마법을 적절히 사용한다면, 이 결속들을 끊고 이 법칙들을 거스르면서 적들의 존재 자체를 해체하는 것이 가능하다. 대상만이 이 주문에 영향 받을 뿐만 아니라, 주변 지역도 영향을 받는다. 이 주문은 현실에 균열을 일으켜 사물이 드나들 수 있게 한다. 너희는 이 순간을 이용하여 공허 속에서 너희를 도울 피조물을 끌어내야 한다.

나는 이 주문을 가르치는 것이 다소 망설여지지만, 너희들 모두는 훌륭하게 수행 해오고 있다. 이 주문은 [i]절대로[/i] 가볍게 사용해서는 안 된다. 소환하고 싶은 것에 대한 명확한 이미지를 머릿속에 간직해라. 그렇지 않으면 너희 스스로 공허의 자비를 받게 될 것이다. 별들 사이에는 셀 수 없이 많은 실체들이 살고 있는데, 그 중 많은 실체는 무념하고 무자비한 것이다.

모두 중앙의 표적 더미에 집중해라. 히트레 너는 표적에게 허무를 남기기 위해  황천폭발을 시전해라 다른 학생들은 어둠의 속삭임 주문을 사용해라.

#{italic}#자세한 내용은 새로운 주문을 확인하십시오.#{normal}#]], "_t")
t("Lessons of Inevitability - Unravel Existence Failure", "필연성의 교훈들 - 존재 해체 주문의 실패", "_t")
...
...It is too late. Something is coming. Even I do not know what. I knew that this was a mistake.]], [[안 돼, 안 돼! 정신 집중이 안됐잖아! 머릿속에 선명한 이미지를 반드시 새기라고 말했거늘! 너의 어리석은 야망이 너를 이기게 두지 마라! 너는 그 너머에 있는 것을 통제할 수 없어!

...너무 늦었다. 뭔가가 오고 있어. 나조차도 무엇인지 알 수 없다. 나는 이걸 가르치는 것이 실수라는 것을 알았거늘.]], "_t")
t("Lessons of Inevitability - Epilogue", "필연성의 교훈들 - 끝맺는 말", "_t")
...
What became of The Teacher is unknown. Perhaps it didn't survive the encounter with the Unspeakable Thing, or perhaps it returned to its home somewhere far beyond Eyal.]], [[오직 한 사람만이 '형언할 수 없는 그것'의 소환에서 살아남아 탈출했다. 그녀는 동료 학생들의 실패와 그녀가 본 것에 대한 공포에도 불구하고 스승의 지혜는 마법폭발이 창조한 종말론적 세계에서 여전히 가치를 지니고 있다고 믿었다. 결국, 그들의 존재를 모르는 것보다 바깥의 공포에 대해 아는 것이 더 낫지 않은가? 그녀는 엔트로피의 힘을 다른 사람들에게 물려주기 시작했고, 그들 역시 엔트로피를 물려주었다. 이 금지된 전설을 배운 사람들은 엔트로피의 신봉자로 알려지게 되었다.

스승이 어찌 되었는지는 알려지지 않았다. 어쩌면 그것은 형언할 수 없는 그것과의 만남에서 살아남지 못했거나, 아니면 에이알 훨씬 너머 고향으로 돌아갔는지도 모른다.]], "_t")
...
Of course no analysis of the krog would be complete without mentioning the many stories, songs, and artwork that revolve around their many pursuits. A lot of encouragement is directed at younger krogs by their peers to venture out into the world and perform heroic deeds. This course of action seems less to do with valor, glory, or riches; something one might expect of a typical 'adventurer' and more to do with the mistrust that followed them formerly being ogres. In an effort to combat their initial image they had as former ogres, the krog sought to commit themselves to gaining a new image through achievement of impressive feats. To this end they seem to have been rather successful as evidenced by the creation of the many artistic works told about them. ]], [[크로그는 아마도 마즈'에이알의 지적인 종족들 중 가장 어린 종족일것이다. 크로그는 오우거였던 자신들이 어떻게 해서든지 룬을 자연적인 주입물과 용의 피로  대체하여 살아남았다고 주장하는 이들이다. 그들의 룬 제거는 지구랏 추종자들이 조직한 것인데, 지구랏 추종자들은 마법사냥의 결과로 모든 오우거들이 끔찍하고 잔인하게 살해되는 것을 막기 위해  조치를 취해야 할 필요가 있다고 결정한 것으로 보인다. 지구랏 추종자들이 이 행동에 대해 발표한 공식적인 이유는 오우거들이 오히려 그 당시 가해자였던 마법의 불행한 희생자들이었기 때문이었고, 지구랏인들은 단지 그들을 비전마법의 얼룩에서 해방시키기 위해 도움을 주고 있었을 뿐이라고 주장한다.

그들이 원래 오우거였다는 사실 때문에, 두 종족이 서로 많은 것을 공유하고 있다는 것은 놀랄 일이 아니다. 그들은 비슷한 색상의 머리색, 얼굴 생김새, 그리고 다른 비슷한 특징들을 가지고 있는 경향이 있다. 크로그는 평균적으로 250cm보다 약간 짧고 약간 갸름하지만, 다른 신체 치수는 오우거와 같다. 만약 그들의 눈과 피부 속에 있는 짙은 녹색과 갈색의 색조가 없다면, 사람들은 크록과 오우거를 구별하기 매우 어려웠을 것이고, 그 반대의 경우도 마찬가지일 것이다. 그것은 지구랏 인들이 그들의 룬을 벗겨내기 위해 시행한 자연적인 처리과정의 부작용일 것이다.

크로그의 대다수는 지구랏 추종자들의 영토 심장부가 있는 대륙의 중앙이나 그 부근에 사는 경향이 있고 그들은 반마법적 대의에 봉사하기 위해 무기를 든다고 알려져 있다. 실제로 어떤 사람이 마주칠지 모르는 지구랏 추종자 순찰대의 대부분은 보통 크로그 투사로 이루어져 있다는 것을 발견할 수 있을 것이다. 모든 크로그는 어떤 식으로든 마법을 다루는 사람에 대해 엄청난 증오를 품고 있으며, 마법사와 싸울 수 있는 능력을 소유하는 것뿐만 아니라 자연과 교감하는 능력을 보여주는 것 같다. 결과적으로 크로그는 마법사들을 강하게 경멸하는데 지구라트 추종자들은 크로그에게 단순히 룬을 제거하고 피를 채워넣는 것 외에 다른 짓을 한걸지도 모른다
...
As they have only recently come out of their previously mindless states, the Drem are a people who are completely disconnected with the world around them. They possess no cultural identity or history to fall back on and sit on the precipice between the civilised races of Eyal's surface and the horrors of Eyal's underground. Many suspect that they possess some connection to the dwarves, the prevailing theory being that they are some sort of corrupted offshoot of that proud race. There has been little research into the subject and little evidence found to substantiate these claims, however. What impact the Drem will have on Eyal's future can only be speculated upon at this point.]], [[에이알의 지하에는 이상하고, '특별히 건전한' 생물들이 풍부하다. 그들 중 다수는 의식없는 괴물들이며 홀로 남겨지는 것이 최선인 존재들이다, 아마도 이 생물들 중 가장 특이한 것은 드렘일 것이다. 오랫동안, 드렘은 단순히 Eyal의 지하에 있는 또 다른 공포체의 한 형태로 추정되었다. 그러나 최근 생각할 줄 아는 드렘의 등장으로 인해 많은 학자들이 종족 전체를 재평가하지 않을 수 없게 되었다.

드렘은 대략 드워프와 키가 같고 얼굴 구조도 막연하게 비슷하다. 여기서 두 종족의 유사성은 끝나는 경향이 있다. 드렘은 얼굴 생김새가 뚜렷하지 않고 드워프와 같은 수염을 기를 수 없으며, 대신 두께가 크게 다른 뻣뻣하고 단정하지 않은 머리카락을 기른다. 드렘은 눈, 귀, 입, 코 등의 기관이 얼굴에 아무것도 없으며 드렘이 어떻게 먹거나 주변 사물을 감지하는지는 알려지지 않았다. 드렘이 가진 사고능력은 각 개인마다 크게 다른 것 같다. 어떤 이들은 야만적인 드렘보다 겨우 이성적인 사고를 할 수 있는 능력이 있는 반면, 어떤 이들은 에이알의 가장 총명한 정신에 버금가는 지능을 얻었다.

그들이 이전의 자아없는 상태에서 나온 지 얼마 되지 않았기 때문에, 드렘은 그들을 둘러싼 세계와 완전히 단절된 종족이다. 드렘에겐 어떤 역사나 문화도 없는 것으로 보이며 그들은 에이알 표면의 문명화된 종족과 에이알 지하의 공포체 사이에 놓인 벼랑에 기대어 앉아있는 상태이다 많은 사람들은 그들이 드워프들과 어떤 연관성을 가지고 있다고 의심하고 있는데, 일반적인 이론은 그들이 그 자랑스러운 종족의 타락한 일부라는 것이다. 그러나 이 주제에 대한 연구는 거의 없었고 이러한 주장을 입증하는 증거는 거의 발견되지 않았다. 드렘이 에이알의 미래에 어떤 영향을 미칠지는 지금으로서는 알 수 없다.]], "_t")
...
t("A towering manifestation of entropy stands before you. You feel tiny.", "우뚝솓은 엔트로피의 현현이 눈앞에 서 있다. 당신은 자신이 한없이 작게 느껴진다 ", "_t")
...
While the hide of the creature has proven too tough to break through, we have devised a clever method to rid ourselves of it. By feeding it a special artifact, we shall be able to open a portal directly into its soft, vulnerable insides. May it taste the results of our research.]], [[오랫동안 우리가 땅속에 머무른만큼, 지상의 햇빛은 우리의 성소에 닿지 않는다. 우리는 거의 아무도 짐작조차 할 수 없는 힘을 탐구했고 공허 속에서 꿈틀거리는 어둠의 힘을 휘두르는 법을 배웠다. 그러나 우리의 오랜 은둔 끝에, 깊은 곳에서 온 생명체가 우리의 요새를 파괴하기 위해 왔다. 이 '구더기'는 땅속을 미끄러져 다니며 그 앞에 있는 모든 것을 집어삼키는, 파괴의 길을 조각하는 생물이다. 이 생명체는 여기서 멈춰져야 한다. 우리가 모은 힘으로 이 침입자를 처치할 것이다

그 생물의 가죽이 너무나 단단해서 뚫을 수 없다는 것이 증명된 와중에, 우리는 그것을 제거할 수 있는 교묘한 방법을 고안해 냈다. 특별한 유물을 먹임으로써, 우리는 부드럽고 연약한 내부로 직접 포탈을 열 수 있을 것이다. 그것이 우리의 연구 결과를 맛보길 바란다.]], "_t")
...
It seems that it falls to me alone to deal with this creature. Only my entropic power could hope to put an end to it. The density of its fleshling defenders grows and grows as we push our way to the creature's brain. If we destroy that, then this will be over in an instant.]], [[우리는 그 짐승의 안에 들어가기 위해 애썼다. 아아, 우리는 그 생명체 자체의 면역 체계를 상대할 준비가 되어 있지 않았다. 짐승의 살점 조각들이 우리를 파괴하기 위해 왔다. 우리는 저 너머의 어둠을 불렀고 어둠이 응답했다, 어둠은 구더기의 살을 바로 우리 눈앞에서 시들게 했다! 하지만, 우리의 모든 힘에도 불구하고, 살점은 계속해서 몰려왔다. 많은 조사자를 잃었다.

이 생물을 처치하는 일은 오직 나만이 할 수 있는 일이 된 것 같다. 오직 나의 엔트로피적 힘만이 그것을 처치하길 바랄 수 있었다. 살점 방어자들의 밀도는 우리가 생물체의 뇌로 나아가면서 점점 더 높아진다. 우리가 뇌를 파괴한다면, 이놈은 순식간에 끝날 것이다.]], "_t")
...
When we return to the Sanctuary triumphant, we shall be hailed as saviours and they shall see their error in doubting the power we have obtained.]], [[우리는 지금 며칠째 구더기 안에 갇혀 있다. 아직 이 생물을 파괴하려는 마음이 있는 자는 오직 나뿐이다. 여기에 남아 있는 자들은 나를 향해 음모를 꾸미고 있다. 나는 그들이 그들 사이에서 속삭이는 것을 듣는다. 그들은 나를 버리고 지금쯤 틀림없이 살점 방어자들로 북적거리는 포탈로 돌아갈 작정이다. 내일, 나는 그들에게 마지막 공세를 위해 나를 따라오라고 선동할 것이다. 우리가 다시 포탈로 돌아가는 것보다 뇌로 향하는 것에 더 좋은 기회가 있을 것이다.

우리가 의기양양하게 성소로 돌아오면, 우리는 구원자로서 찬양받을 것이며, 그들은 우리가 얻은 힘을 의심하던 그들의 오점을 보게 될 것이다.]], "_t")
...
With that in mind, my only option is to kill it from the inside. Dunno how I'm going to do that just yet.]], [[어떻게 해야 할지 모를 난장판에 빠져본 적 있어? 글쎄, 지금 내가 있는 곳이 바로 그런 곳이야. 이게 뭐든 간에 그냥 땅에서 터져 나와 나를 통째로 삼켜버렸어. 보통 여자애들은 이렇게 먹히려면 괴물의 제물로 제단에 올려져야 하는데, 이놈은 그냥 나한테 이끌린 것 같아.

나는 많은 것을 봤어. 언데드, 공포체, 때로는 초능력을 가진 곰도 있었지만, 그게 무엇이든 간에, 그 나름대로 곰의 범주에 있는 것같아. 마치 내가 뱀 안에 있는 것 같아. 뱀의 바람이 불 정도로 크고 기다란 뱃속에 말이야. 가끔 이 고깃덩어리 같은 것들이 그 속에서 산을 쏟아내며 내 뒤를 쫓아와... 나는 이놈이 나를 소화하려 한다는 느낌을 받고 있어. 배주름 중 한 곳에 간신히 작은 은신처를 만들었지만, 이 보호 룬들이 얼마나 오래 지속될지는 알 수가 없어.

그래서, 내 계획은 여기서 빠져나갈 방법을 찾는 거야. 아니면 이놈 속을 따라 내려가는 것 같아. 대부분은, 음식은 한 쪽에서 다른 끝으로 가고... 글쎄, 나머지는 너도 알잖아. 하지만 이건... 이놈은 삼키는 모든 것을 완전히 소화해 내는 거 같아. 난 저것들이 바위 덩어리와 집들, 숲을 가득 채울 수 있는 충분한 나무들을 부수는 걸 봐왔어... 이놈은 거의 아무거나 다 먹을 수 있는 것 같아.
