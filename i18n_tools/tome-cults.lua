...
With these things established, we will discuss the gods of Eyal and what influence their actions had, and continue to have, on our world. While I discovered many gods in my studies, it is entirely possible that Eyal had even more gods than what are documented in my findings, but their existence cannot be substantiated by existing scholarly texts.]], [[신들은 에이알의 역사속에서 자주 언급된 존재들이다. 대부분의 독자들에게는 이질적인 개념으로, 현 시대 대부분의 에이알인들은 신들을 접해보지 못했기 때문이다. 신이라는 단어는 당신에게 어떤 전능하고 터무니없이 강력한 존재의 인상을 주는데, 이 존재들은 확실히 그러하다. 그러나, 정확히 신이 무엇인지 정의하는데 적절한 학문적 성과물은 거의 없다. 에이알의 역사를 통틀어 여러 문화권에서 같은 이름으로 자주 등장함에도 불구하고 신에 대한 설명은 모두 제각각이다.

크로슈쿠르의 학자로서 나는 에이알의 표면을 배회하고 앙골웬과 같은 많은 유명한 배움의 터에서 지상종종으로부터 신에관해 배우는 데 많은 시간을 보냈다. 부당한 거래였지만, 나는 심지어 임프를 간신히[i]설득[/i]해 울'흐록 에게서 어떤 문서를 회수하기도 했다. 이 일련의 문서들은 신들에 관한 정보를 분류하고 신화나 역사가 허락하는한 그들의 정확한 모습을 묘사하기 위해 쓰여졌다. 그리고 이 서문은 신이 정확히 무엇인가에 대한 개괄적인 느낌을 주기 위해 쓰여졌다.

에이알의 표면을 가로지르며 걸어온 강력한 존재들은 많이 있었다. 그러나 이런 존재들이 가진 엄청난 힘에도 불구하고 신이 된다는 것은 단순한 힘의 문제가 아니다. 신과 다른 존재를 구분하는 것은 엔트로피를 역전시키는 능력에 있다. 향후 참조를 위해 이 힘을 반-엔트로피라고 칭하겠다. 이 힘은 신들이 자신의 변덕과 욕망에 따라 현실을 재구성할 수 있게 해주었다. 어떤 신들은 그들만의 종족을 만들었고, 다른 신들은 에이알에 사는 존재들을 변화시켰다, 신들은 진화를 가지고 놀았고, 에이알에 사는 존재들을 헤아릴 수 없는 방법으로 변화시켰다. 어떤 이들은 이러한 행동을 우리가 모르는 더 큰 목적에 기인한다고 주장했지만, 신들이 인간처럼 실수하기도 하고 우리처럼 하찮은 것들에서 동기부여를 받는다는 것을 암시하는 증거들이 충분히 있다. 내 학구적 견해로는, 우리는 단순히 그들의 즐거움을 위해 창조된 것이다.

이것이 일부 사람들을 절망으로 몰아넣고 필멸자의 의지가 무의미하다고 믿게 만들지도 모르지만, 고대 신화에서는 신들이 쉐르'툴에 의해 도살되거나 우리 세계에서 쫓겨났다고 언급하고 있다. 그들의 부재가 좋은 것으로 여겨질 수 있는지 아닌지는 말할 수 없지만. 지금까지 살아남은 몇가지 이야기들에 따르면 신들이 서로 다툴때 신들은 그들이 만든 종족들을 잔인하게도 전혀 신경쓰지 않고 이 세상의 표면을 가로질러 큰 상처들을 내었다고 한다. 또한 주목할 점은, 신들이 그들의 인상적인 힘에도 불구하고, 항상 지적인 존재는 아니었다는 점이다. 신들 중 몇몇은 간신히 지적능력을 가졌거나 심지어 자각력이 없었다고 전해진다. 이것에 대한 한 가지 이론은 신들이 에이알 표면에 살고 있던 원시 존재들이었고 반-엔트로피적 에너지들이 우연히 그들에게 스며들어 인공적으로 승천되어진 존재들일 뿐이라는 것이다.

이러한 내용이 머리속에 확립된 상태에서 우리는 에이알의 신들과 그들의 행동이 우리 세계에 어떤 영향을 미쳤고, 또 어떤 영향을 끼치고 있으며, 또 어떤 영향을 끼칠지에 대해 토론할 것이다. 나는 내 연구과정에서 많은 신들을 발견했지만, 에이알에는 내 연구 결과보다 훨씬 더 많은 신들이 존재했을 가능성이 확실히 있지만, 그들의 존재는 현존하는 학문적 자료를 통해서는 증명할 수 없었다.]], "_t")
...
According to the records of Anglowen, Quekorja was slain during the Godhunt and its body discovered by the mage Linaniil. Linaniil managed to absorb a small portion of the god's power through a dangerous ritual. This tiny shard of power she acquired made her an archmage without peer, a testament to the sheer might of the gods.]], [[쿠에코르자는 시간과 가능성의 신이었다. 쿠에코르자에 관한 에이알의 신화에서 눈에 띄는 것은 기록들이 심하게 일관성이 없다는 것이다. 특히 신사냥 이후의 이야기가 신사냥 이전의 신화보다 쿠에코르자에 대해 훨씬 덜 호의적인 관점을 갖는 경향이 있다. 이에 관한 가설은 쿠에코르자가 아마도 역사를 기록하는데 관심을 갖고 자신의 이야기를 기록하기 위해 자기 휘하의 사서들을 임명했기 때문이라는 것이다. 현재엔 이런 기록물이 살아남아 존재하지 않기 때문에, 이 이론은 순수한 추측으로 간주되며, 그것을 증명할 구체적인 증거가 없다. 같은 날짜에 같은 작가들에 의해 쓰여진 것으로 추측되는 기록들에서도, 저자들의 어조와 신에 대한 묘사 자체가 엄청나게 다양하다. 시간을 통제할 수 있는 쿠에코르자의 능력을 감안할 때, 이 기록들은 대체 시간선에서 나온 것일 수도 있다고 생각되어, 신 자체에 대한 진실을 더욱 모호하게 한다.
...
t("Researcher Dremnot's Demystification of the Gods: Chapter 9 - Xadoch", "연구원 드렘낫의 신들에 대한 해체분석: 챕터 9 - 자도크", "_t")
...
Xadoch was one of the first gods to be felled in the God Hunt by the hunter Branzir. The Sher'tul had a particular dislike of the god, as it had tried to undermine them with plagues numerous times. Strains of Xadoch's diseases are thought to still be on Eyal to this day, waiting for some unfortunate victim to carry them back to civilisation, so Xadoch may commit one last act of spite against sapient life.]], [[자도크는 황폐를 부르는 자라는 별명을 갖고 있었다. 그것은 지표면 가까이 기어다니며 에이알의 오물 속에서 고생하는 생물들을 사랑했지만, 자신의 지성종족에 대한 사랑은 없었다. 많은 신화에서 수많은 질병과 역병이 자도크에 의해 만들어졌다고 한다. 하지만 어떤 신화들은 자도크의 존재가 필요했다고 말했다. 자도크의 재앙은 세계를 어떤 한 종족이 독점하는 것을 막을 수 있었고, 일종의 균형을 유지했기 때문이다. 반면에, 많은 다른 신화들은 신이 잔인한 호기심을 가졌다는 것을 증명한다. 자도크는 황폐를 전세계로 흩뿌렸고, 단순히 지성종족들에게 어떤 종류의 영향을 미치게 될지 보기 위해 질병을 만들었다고 한다. 만약 에이알의 다른 신들이 아니었다면, 자도크가 온 세상의 지성종족을 시들어버리게 만들었을거라고 믿어진다.

자도크는 신 사냥꾼 브란지르에 의해 쓰러진 첫번째 신들중 하나다. 쉐르'툴은 이 신을 특히나 싫어했는데, 자도크가 몇번씩이나 역병으로 그들을 약화시키려 했기 때문이다. 자도크의 질병은 오늘날까지도 에이알에 남아 있는 것으로 생각되며, 어떤 불행한 희생자가 그것들을 다시 문명으로 데려가기를 기다리고 있다, 그로인해 자도크는 지적생명에 대한 마지막 악행을 저지를지도 모른다.]], "_t")
...
When Ugg'matho was slained by Branzir, it is said that its blood took on a life of its own, spreading out into the wilderness in the form of living ooze.]], [[우그'마토는 트롤의 창조에 책임이 있는 신이다. 현 시대의 대부분의 에이알인들은 트롤을 멍청한 짐승이라고 생각하지만, 그들은 종종 그들이 평가받는 것보다 훨씬 더 똑똑하다는 것을 증명해 왔다. 우그'마토의 가장 보편적으로 귀속된 영토는 에이알의 숲과 산이었다. 고대 문헌에서, 그것에 부여된 이름은 '정원사'로, 그것은 에이알의 숲과 녹지를 깊이 사랑했기 때문이다. 그것은 야만적이고 강력한 야생의 지배자의 이미지로 트롤을 창조했다고 생각된다.

어떤 전설에선 그것이 하늘에서 내려와 정착지들을 섬멸한다는 이야기가 있는데, 우그'마토는 문명을 에이알이라는 녹색 캔버스 표면에 있는 얼룩으로 보았기 때문이다. 그 대신 문명화를 막기 위해 자연 자체를 바꾸는 것을 선택했고, 다양한 식물과 수호자를 만들어 지성종족이 자원을 위해 숲을 약탈하는 것을 막았다. 우그'마토의 신화에서 많이 반복되는 주제는 자연과 조화되지 않고 사는 지성존재에 대한 그의 격렬한 적개심이다.

우그'마토는 그런 신화에서 다른 신들과 자주 충돌했다. 많은 이야기는 신들과 그들이 선택한 챔피언들이 어떻게 광야에서 거대한 트롤 사냥에 나섰는지, 어떻게 에이알의 지표에서 그들을 없애기 위해 우그'마토의 아이들을 쫓아갔는지에 대해 이야기한다. 이 이야기들은 종종 트롤의 위협을 제거하는데 있어서 그들의 큰 성공을 묘사했지만, 시대를 거쳐간 어마어마한 트롤들의 숫자를 생각해보면 이야기들이 실제로도 성공적이지는 못했음을 암시한다. 한 신화는 우그'마토가 결국 다른 신들과 계약을 맺어 숲을 그대로 두는 대가로 그의 창조물을 내버리게 되었다고 말한다. 또 다른 진술에서는 우그'마토가 다른 신들에게 강제로 복종당했고, 마지못해 트롤들을 약화시켰다고 전해진다.
...
그가 신화속에서 보여준 자비롭고 온화한 태도에도 불구하고, 악마들은 그의 이름으로 에이알인들에게 저지른 만행을 자주 선언해 왔다. 에이알 종족들에 대한 태도와 그 자신의 창조물들에 대한 이러한 대조적인 태도는 자비로운 성질을 암시하지 않는다, 이러한 일은 단순히 버릇없는 아이들을 보호하는 아버지와 비슷한 것으로 보이며 그의 존재는 신들이 단순히 에이알에서만 국한된 현상이 아니라 수많은 다른 세계에도 존재할 수 있다는 것을 증명한다]], "_t")
...
결국 쉐르'툴중에게 아마크텔을 살해하라고 명령한 이는 칼디자르였다. 이 명령을 쉐르'툴 전부가 수행한 것은 아니며, 사실 그들 중 다수가 공개적으로 이 명령을 비판했으며 계급 내 갈등으로 이어졌다고 생각되었다. 칼디자르는 고사하고 신사냥이 끝난 이후의 쉐르'툴에 대한 기록은 없다. 아무도 그들의 종족이 어떻게 되었는지 확신하지 못한다. 에이알에는 쉐르'툴 폐허가 거의 증발한 것처럼 기이한 부재가 느껴진다는 점도 눈에 띈다.]], "_t")
...
그녀를 위해 창 쏘랄은 비길 데 없는 힘을 지닌 투척무기였다. 그녀는 신사냥의 이유에는 신경을 쓰지 않는 것 같았는데, 창만으로도 그녀에게 있어 이미 대단한 보상이었기 때문이다. 이 새로운 무기와 함께 아조롤이 에이알의 평평한 평야에 서서 우리 세계 너머의 어둠 속에 있는 목표물을 명중시키는 이야기가 펼쳐졌다. 그녀의 쏘랄과 그 사용자로부터 안전한 곳은 에이알 어디에도 없었기 때문에 아조롤은 그녀가 신살자들 중 가장 힘센 이 중 한 명이라는 것을 증명했다.
