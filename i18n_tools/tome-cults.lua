...
안타깝게도 스켈레톤들은 내 생각만큼 멍청하진 않았고, 놈들은 모퉁이에서 안전거리를 유지했다. 스켈레톤들은 그 자리에서 마법을 시전하기 시작했고, 그걸 본 나는 욕지거리를 하면서 뛰쳐나가, 최대한 빨리 놈들과의 거리를 좁히려 했다. 그때 내 안의 분노가 폭발하며 어두운 에너지가 내 안쪽을 채워가는 것이 느껴졌다. 다음 순간, 나는 마법사 한 놈의 몸통을 비스듬하게 쪼개 버렸다. 나머지 스켈레톤은 한순간도 지체하지 않고 곧바로 고개를 돌려 비전 마법 광선을 쏘았고, 광선은 내 어깨를 꿰뚫었다. 그 광선을 쏜 놈에게 집중하려는 찰나, 화살이 날아와 내 발을 뚫었고 나는 그 자리에 못박힌 듯 움직일 수가 없게 되었다. 
