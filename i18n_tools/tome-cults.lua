...
터널의 안쪽은 끔찍할 정도로 어지러웠다. 새된 먼지와 바람 소리가 끔찍한 부조를 이루었다. 계속 앞으로 나아가면서, 왠지는 모르겠지만 연기 속 깊은 곳에서 인간의 시체들도 본 것 같았다. 터널 너머 도시가 보이기 시작하자, 난 황량한 광경을 마주하게 되었다. 순찰대와 함께 거리를 걸으며 내가 볼 수 있었던 건, 다른 샬로레들의 얼굴에 띤 공허함 뿐이었다. 그들은 마치 희뿌연 안갯속을 이리저리 헤매는 듯했다. 지나가며 보이는 샬로레들 중 침착해 보이는 사람이 한 명도 없었다. 모두 묘하게 허둥지둥했다. 마치 소중한 무언가를 잃어버린 것 같았다. 
...
The discomfort within my mind was obviously made clear across the desk, but the general refrained from saying anything, perhaps out of some underlying guilt for his part in the Spellblaze or just due to being unable to say anything that could aid in my aligning my thoughts. For a time we sat in silence, though before long he soon got up and headed towards the window. His back turned I couldn't see his expression, but I could tell he thought heavily in regards to how events had unfolded. [i]Aranion if you are reading this now, know that at least I have forgiven you.[/i] ]], [[[i]아라니온 가웨일 장군, 엘발라의 대의회장. 아마 가족 이외의 사람에게서 들은 이름 중 제대로 기억하는 건 이번이 처음일 것이다. 아라니온이 직접 이름을 댄 적은 없었으나, 다른 샬로레들이 계속 그의 이름을 재잘거리는 통에 결국 이름을 기억해버리는 경지에 이른 것이다. 자신의 이름을 가볍게 대는 이들에게서 배울 점이 별로 없다고 한다면, 난 아라니온을 남들에게서 이름을 알게 된 자로서 존경할 만한 자라고 생각한다. 샬로레들이 그의 이름을 말할 땐 항상 경애심이 담겨 있었다.[/i]

오래지 않아 병사가 다시 나와서 나를 훨씬 더 검소하게 생긴 방으로 안내했다. 방 한가운데에는 탁자가 있었고, 그 뒤로 북향으로 난 창에서 숲이 보였다. 방의 맞은편엔 호화로운 방어구들이 전시되어 있었고 그 가운데엔 서슬퍼런 무기가 놓여 있었다. 방 안으로 들어가면서, 장군으로 보이는 한 사람을 보았다. 방 한 구석에 있는 탁자 위에서 서류 같은 것들을 보고 있었다. 다른 샬로레가 초라해보일 정도로 찬란한 기운이 그에게서 스며나왔으나, 그의 주변에 내려앉은 무거운 짐 같은 것을 느낄 수 있다.

진지한 눈빛으로 나를 관찰한뒤 그는 방 한가운데에 있는 탁자의 옆자리를 권했다. 부관이 있는 쪽으로 고개를 끄덕이자, 이내 나를 안내했던 병사는 문을 조용히 방을 나가 문을 닫았다. 그리고 방에는 단 둘만 남았다. 그가 말한 대로 난 자리에 앉았고, 그도 반대쪽으로 의자를 가져와 앉았다. 그는 앉자마자 말하기 시작했다. "의사들이 말해준 것과 순찰자들에게서 받은 보고에 따르면, 당신은 샬로레 부상자들을 보살피느라 며칠동안 여기 있었다지. 이에 대해 감사를 표하네."

내가 뭔가 말하기도 전에, 샬로레는 말을 이어갔다. "솔직히 말하면, 자네에 대한 이야기를 들었을 땐 그다지 신뢰가 가지 않았다네. 내 고문들이 당신과 만나 이야기하겠다고 했지만, 이곳에 진짜 탈로레가 왔다면 내가 직접 만나야 한다고 생각했지. 내가 아는 바에 따르면, 탈로레는 지난 4천년간 숲에서 거의 나오는 경우가 없었어. 당신은 내가 살면서 처음으로 본 유일한 탈로레야. 그런 탈로레를 직접 대면할 기회를 놓칠 수는 없었지." 샬로레는 이렇게 말한 뒤 미소를 지었지만, 나는 조금 짜증이 나기 시작했다. 내가 여기에 온 이유가 있다고 한다면, 일단 관찰 및 연구 대상은 해당 사항이 아니었으니까.

장군은 말을 이어가기 전에 숨을 골랐다. "이 이야기를 계속하기 전에 말이야. 이유를 말해줄 수 없을까? 무엇이 자네를 숲에서 떠나 샬로레의 영토까지 이끌었냐는 말이야?" 그의 질문을 듣자 나는 말을 잃었다. 마법폭발이 처음 일어났을 때 내가 느꼈던 분노는 이제 온데간데 없었기 때문이다. 내가 여기에 와야 했던 이유는 더 이상 없는 것이었다. 잠시 후 나는 거친 목소리로 대답했다. "제가 이유를 말할 필요라도 있습니까?" 상당히 직설적인 대답에 장군은 혀를 차는 듯이 웃었다.

익살맞은 목소리로 그가 말했다. "글쎄, 만약 살로레가 숲을 떠나서 여기까지 당도할 이유라고 한다면 만나는 샬로레들을 죄다 몰살하기 위한 것이라고 밖에 상상이 안 갔거든." 마치 펼쳐진 책을 읽듯이 그는 나를 읽어냈다. 내 낯짝을 쳐다보는 것만으로도 머리 속 생각까지 훔쳐보는 듯했다. 그 말을 듣자 나는 조금 움츠러 들었고, 장군이 말한 것을 확인해주는 꼴이 되었다. 그것을 본 장군은 긴장을 풀고 말을 이어갔다. "아직까지 샬로레를 죽이지 않을 걸보니 분명 뭔가가 자네의 마음을 바꿔놓았군. 잘 알았네. 심지어 우리에게 큰 도움이 되어주기까지 했어. 그러니 내가 아는 것을 알려주도록 하지."

그제서야 그 샬로레 장군은 지금까지 일어났던 일들에 대해 설명해주기 시작했다. 이 땅에 닥친 재앙이 마법폭발이라고 명명되었다 것과, 온 땅을 휩쓸고 다니던 오크들을 소탕하기 위한 목적으로 이뤄졌다는 것을 알았다. 샬로레는 최선을 다했으나, 그 힘을 조작하던 마법사들은 방대한 에너지를 통제하지 못했다. 그 결과 오크, 샬로레들 자신과, 마즈'에이알 전체에 파멸의 폭풍을 풀어버렸다. 온갖 파괴가 전 대륙에 걸쳐 일어났으며, 심지어 다른 세계에까지 영향을 미쳤을 것이라고 했다.

이 모든 이야기가 끝날 때까지 나는 침묵을 지키며 듣고 있었다. 마법폭발에 관한 이야기가 끝난 뒤, 샬로레가 저지른 행위에 대해 어떻게 판단해야 할지 갈피를 잡지 못 했다. 마법폭발이 이 대지에 불어닥치며 찢을 수 없는 상처를 남겼으나, 이것은 전대미문의 위협을 막아내기 위해 한 행동이었다. 그 행동에 따른 결과로, 모든 샬로레들은 지금 고통받고 있었다. 그리고 난 그들이 이미 충분한 대가를 치루고 있는 것이라고 생각했다.

내 마음 속에서 감도는 불편함이 탁자 사이에서도 감돌았으나, 장군은 아무 말도 꺼내지 않았다. 마법폭발의 책임이 어느 정도 그에게도 있다는 것 때문이거나 내가 생각을 정리하는 데에 도움을 줄만한 말을 꺼낼 수 없었기 때문인 것 같았다. 잠시 동안 둘 사이에 침묵이 감돌았으며, 이내 그는 자리에서 일어나 창가 쪽을 바라보고 섰다. 그기 등을 보였으니 나는 그의 표정을 볼 수 없었다. 그러나 지금까지 일어났던 사태들에 대해 심중하게 숙고하고 있음은 알 수 있었다. [i]아라니온, 이걸 지금 읽고 있다면, 알아두세요. 최소한 나는 당신을 용서했다고.[/i] ]], "_t")
...
Putting the chest in my pack, I began to make my way towards the road leading to the gates as well. I did not know this but what I thought would be a brief stop on my way back to my home forests would soon herald the start of another adventure for me. I would find atrocities within the home of the Nargols that would only be dwarfed by the devastation caused by the Spellblaze. Such were the earlier events of what would soon be called the Spellhunt, which even now spreads over the face of Maj'Eyal, and threatens to throw all the races ever closer to oblivion.]], [[[i]그땐 아라니온이 꽤 편집증이 있는 인물이라고 생각했다. 하지만 다른 사람의 생각을 읽어내고 이 세계에서 벌어지는 사건들을 인식하는 그의 능력은 놀라울 정도로 정확하다고 묘사할 수 있겠다. 어느 단체가 마법 사냥을 부추겼는지는 이것을 쓰는 순간에도 알려지지 않았으나, 그들은 저 바깥에서 도사리고 있으며 그들이 저지른 행위를 몇 번이나 직접 목격했다.[/i]

잠시 후 장군이 입을 뗐다. "이제 뭘 할 생각인가?" 좋은 질문이라고 생각했다. "딱히 생각해둔 게 없군요"라고 대답했다. 그는 여전히 내게 등을 돌리고 있었으나, 그의 뒤통술 너머로 피식 웃는 것을 느낄 수 있었다. 그는 나를 돌아보며 물었다. "자네는 이제 숲으로 돌아갈 것 같군. 하지만 돌아가는 길에서도 우리 샬로레를 도와줄 방법이 있지 않을까 싶네. 우리에게 구호 물자를 전달해줄 수 있겠는가? 또 이용당하는 것이 아닌가 생각했지만, 그의 요청에 어느 정도 흥미가 생겼다.

의문을 품으며 말했다. "듣자하니 제게 남은 호의를 최대한 긁어모아서 어떻게 해보려는 생각인 것 같은데, 샬로레가 직접 공식적인 특사라도 보내서 도음을 청하는 게 어떻겠습니까?" 장군은 무거운 목소리로 대답했다. "나라고 해서 그러고 싶지 않은 건 아닐세. 다만 지금 샬로레를 엘발라 바깥으로 내보내는 것 자체가 매우 위험한 일이야. 당신이 여기 오기 전에, 서쪽에서 온 몇 인간들이 분노한 채로 엘발라의 경계를 습격했네. 당신이 외곽 정착지에서 구해온 대다수의 샬로레들은 마법폭발이 아니라, 코르낙의 땅에서 온 농노들의 분노 아래 희생당했네."

그가 말을 이어가면서 심각한 어조로 바뀌어갔다. "그리고 그들은 엘발라로 들어와서 똑같은 일을 자행하려 하지. 자네가 여기로 장막을 뚫고 들어오면서 그들의 시체를 본 적이 있을 거야." 내가 이 모든 이야기를 되새기는 순간 속에서 그는 잠시 아무 말도 하지 않았다. 그는 목소리를 가다듬고 다시 말을 이었다. "물론, 이런 잠깐의 소요 때문에 사절단을 보내지 못 하는 건 아니야. 누군가가 외지인들을 선동하고 있네. 누가, 어떤 단체가 이런 짓을 하고 있는지는 모르겠지만, 인간들이 왔을 때 소리치던 것들을 생각하면 심히 두렵네."

장군의 눈이 나와 마주쳤다. 그 눈 속에서 느껴지는 진중함이 나를 옥죄는 듯했다. 무엇이든 물어야 한다는 생각이 들어 입을 열었다. "무어라 소리쳤습니까?" 다시 목소리가 가라앉았다. "그들은 샬로레가 마법폭발에 대한 대가를 치룰 것이라 소리쳤네." 이해할 수 없어 다시 말했다. "정당한 분노를 표출한 것을 당신이 왜 두려워 하는 겁니까?" 이에 대해선 분명한 대답이 돌아왔다. "왜냐하면 우리의 원대한 계획을 마법폭발이라고 부르고 있었다는 걸 아는 자는 거의 없었기 때문이지. 다양한 종족의 지도자들, 그리고 심지어 탈로레의 왕과 왕비에게도 그저 대규모 마법을 위해 쉐르'툴의 폐허를 이용할 것이라고밖에 말하지 않았다. 누군가 인간 평민들에게 샬로레에게 책임이 있다고 말한 거야. 하지만 실수를 저질렀군. 샬로레에 대한 모종의 비밀 작전이 진행되고 있다는 것을 알았거든."

잠시 나는 입을 열지 않았고, 이내 자리에서 일었났다. 마침내 결정을 내리고 난 결연히 말했다. "그렇다면 구호물자를 조달하도록 하지. 내가 뭘 하면 되는 거요?" 장군은 이 대답에 안심하며 바로 대답했다. "자네도 이제 알다시피, 샬로레는 주입물이나 다른 자연적인 치료법을 쓰지 않는 편이네.  하지만 상당히 많은 재료를 쌇아두고 있지. 이 안에 쌓아두는 것보단 바깥으로 옮기는 게 더 나을 거야. 모든 재료를 다 담아서 옮길 수 있는 특수한 상자를 입수해놓았네. 이걸 자네가 인근의 나르골 왕국에 옮겨줬으면 하네. 다른 종족의 대다수 피난민들이 그들이 사는 곳의 수도로 모여둘고 있을 것이고, 그렇다면 지금 그들은 필요한 만큼 주입물을 다 만들지 못 하고 있겠지."

나는 고개를 끄덕이며 그가 말한 대로 행할 준비가 되었다고 표시했다. 그러나 장군은 손을 들어올리며 멈추라고 했다. 그리고 내가 이 방에 들어와있을 때 앉아있던 구석의 탁자에 걸어갔다. 무언가를 집어들며 나를 슬쩍 쳐다보더니, 내게 다가와 내 손 위에 룬을 올리고 꽉 쥐었다. 짓눌린 룬이 핑크빛 광채를 발했고 장군을 입을 열었다. "이 룬을 쓰면 자네가 어디 있든 간에 엘발라로 수 있을 거야. 언제 오든 자네를 환영할 걸세." 장군은 고개를 끄덕이며 명령서를 건네주었다. 내가 여행을 떠날 때 필요한 물건들을 받을 수 있도록 한 것이었다.

병참 장교를 만나고 다음 날 내가 준비을 마쳤을 때, 나는 엘발라의 문으로 갔다. 그곳에서 마법사 몇 명과 중무장한 경호원들을 대동한 장군을 다시 만날 수 있었다. 내가 다가가자 장군은 마법사들이 나를 하플링 도시와 가까운 곳으로 공간이동시킬 것이라고 말했다. 그리고 그는 내게 작고 무게가 거의 느껴지지 않는 상자와 샬로레의 인장이 찍힌 문서 몇 장을 건네주었다. 그 종이는 외교 문서 같았으나 작은 상자는 어디에 쓰는 것이며 내가 운반해야 할 주입물 재료는 어디있는 것인지 궁금했다.

이에 대해 물어보자, 마법사 한 명이 내게 다가와 상자의 쓰임새와 목적을 알려주었다. 그는 상자 안에 있는 주입물 재료를 몇개 꺼냈는데, 보통 그 크기의 상자가 담을 수 있는 양 이상의 재료가 나왔다. 재료를 다시 넣은 뒤 마법사는 상자를 다시 돌려주었다. 장군이 말하는 바에 따르면 나르골 왕국의 입구에 다다랐을 때 나르골 경비병에게 이 종이를 보여주기만 하면 된다고 한다. 그러면 그 경비병들이 상자를 가져갈 것이라 했다. 난 그들의 수도에 들어가서 추가적으로 필요할 지도 모를 보급품을 사고 싶었다. 이에 대해 말하자, 장군은 동전 주머니를 건네주었고 이는 보급품을 사기에 충분한 양이었다.
...
내 짐 속에 상자를 넣은 뒤, 관문으로 향하는 도로로 걸어갔다. 이 당시에는 몰랐으나, 고향 숲으로 돌아가는 길에 잠시 들를 뿐이라 생각했던 곳은 다른 모험의 시작을 알리는 전조였다. 나는 나르골에서 대학살을 목격하게 된다. 이는 마법폭발의 피해로 인한 것으로 일축되었으나, 이는 훗날 마법 사냥으로 불리우는 활동의 초기 모습이었다. 마법 사냥은 이제 마즈'에이알 전역에 퍼져 우리 모든 종족을 재앙으로 몰아넣고 있다.]], "_t")
