...
물론, 그런 등장인물을 그냥 내버릴 수는 없다.  이야기는 끝이 났지만, 그 이야기는 다시 이야기되고, 또다시, 또다시, 계속해서 이야기될 수는 있다. 그리고 그 이야기를 들을 때마다 사람들은 제각기 다른 인물상을 상상할 테니, 그 이야기를 듣는 사람들의 수만큼 수많은 마즈'에이알의 영웅들이 생겨나게 되는 것이다.  심지어 "작가" 자신도 마즈'에이알의 영웅을 위한 상황을 더 많이 떠올려내고, 항상 궁금해한다 - "이 최고의 전사에게 딱 알맞은 적수를 찾게 되면 어떻게 할까?  내가 <?=Lore.pocket_time_winner.himher?>에게 <?=Lore.pocket_time_winner.heshe?>가 싸우고 싶어서 안달이 날 만한 전투를, <?=Lore.pocket_time_winner.himher?>에게 <?=Lore.pocket_time_winner.heshe?>가 그렇게나 간절히 바라던 도전이라는 보상을 아직 안 내려주지 않았던가?  그런 결투라면 충분히 써내려갈 가치가 있지 않을까?"  그리하여, 그것은 <?=Lore.pocket_time_winner.name?>에게 약속을 하였다.  자신이 <?=Lore.pocket_time_winner.himher?>를 상대할 만한 가치가 있는 자를 찾아내거나, 만들어내게 된다면, <?=Lore.pocket_time_winner.himher?>를 떠올리겠노라고.
