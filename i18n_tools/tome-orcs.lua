...
증기 고갈이 가속화되고 있는 현재, '손쉬운 해결책' 이란 것은 당연히 구미가 당기는 말입니다.  저 또한 현시점에선, 제겐 우리의 새로운 평의원장의 계획 - 크룩 오크들의 발밑에 있는 유망한 지열관들을 탈취하는 계획을 막을 힘이 없다는 것을 잘 알고 있습니다. 그러나 만약 우리가 실패한다면, 여러분들은 자신을 "충신" 이라 칭하는 그... '존재' 와 거래를 하고 싶어질 수도 있을 것입니다.  저는 그러한 결정을 내리는 것은 굉장히 어리석은 짓이라고 생각합니다.
