------------------------------------------------
section "tome-ashes-urhrok/data/achievements/all.lua"
...
t("Weapon in hand and sheathed in flame, a Doombringer is a terrifying force in combat.", "불꽃에 휩싸인 무기를 든 파멸의 사도는 전투에서 무시무시한 힘을 발휘합니다.", "_t")
...
t("The most powerful Doombringers can harness the full power of their demonic ties and transform themselves into a gigantic demon.", "극히 강력한 몇몇 파멸의 사도들은 악마의 힘을 마음껏 휘두르며, 거대한 악마로 변신할 수도 있습니다.", "_t")
...
t("They use those demonic powers for their own purpose, often evil but a few have been known to use demonic powers to fight demons.", "이들은 악마의 힘을 스스로의 목적을 위해 사용합니다. 대개는 사악하지만, 몇 안 되는 악마학자들은 악마의 힘으로 악마와 싸우는 법을 알게 되었습니다.", "_t")
...
t("They create acid pools from their corrupted blood and use them in a number of ways.", "이들은 자신들의 오염된 피로 산성액 웅덩이를 만들어내고 다양하게 이용합니다.", "_t")
t("They have developed fiendish, acid-dripping claws, and caustic powers.", "또한 이들은 산성액이 뚝뚝 떨어지는 악마의 발톱과 같은 다양한 능력을 가지고 있습니다.", "_t")
...
t("Their most important stats are: Magic, Dexterity, and Strength", "가장 중요한 능력치는 마법, 민첩, 힘입니다.", "_t")
...
오직 세 악마만이 그들에게 엘프들이 불러일으킨 공포에 대해 말할 수 있으니,
...
t("Demonic Tatoos 1", "악마의 문신 1", "_t")
t("Demonic Tatoos 2", "악마의 문신 2", "_t")
t("Demonic Tatoos 3", "악마의 문신 3", "_t")
t("Demonic Tatoos 4", "악마의 문신 4", "_t")
t("Demonic Tatoos 5", "악마의 문신 5", "_t")
...
t("Way to a mysterious crater", "불가사의한 크레이터로 가는 길", "_t")
t("There is a green flash in the sky", "하늘에 초록색 불빛이", "_t")
t("You see a bright green streak of light flash though the sky toward a distant forest...", "웬 밝은 초록색 빛줄기가 하늘을 가르고, 멀리 떨어진 숲으로 떨어지는 것을 보았습니다...", "_t")
...
------------------------------------------------
section "tome-ashes-urhrok/data/general/events/fire-haven.lua"
...
t("This rugged stone shield flickers with bursts of pitch black flame.", "칠흑 같은 빛깔의 불꽃이 터져나오는 견고한 바위 방패입니다.", "_t")
...
t("These massive gauntlets once belonged to a very powerful demon named Ul'Gruth. The behemoth was said to be able to level entire buildings with a single swing of his hands.", "이 거대한 전투장갑은 한때 울'그루쓰라는 아주 강력한 악마의 것이었습니다. 그 거수는 손을 한 번 휘저으는 것만으로 건물을 여러 채 무너뜨릴 수 있었다고 합니다.", "_t")
...
t("Black fires born of a blackened heart.", "검게 탄 심장에서 검은 불꽃이 피어오릅니다.", "_t")
...
t("darkness infused staff", "어둠이 깃든 지팡이", "_t")
t("The flames of Mal'Rok can be more stubborn than most. When they run out of fuel they have been known go out of their way to find more.", "말'록의 불꽃은 평범한 불보다 더 집요합니다. 불에 탈 거리가 떨어져가면 말'록의 불꽃은 스스로 움직여 태울 것을 찾는다고 알려져 있습니다.", "_t")
...
t("fire a bolt of plaguefire, dealing damage over time based on your magic stat", "역병 화염의 화살을 발사해, 착용자의 마법 능력치에 비례한 지속 피해를 가합니다", "_t")
t("Dethblyd", "주금칼랄", "entity name")
t("pitch black sword", "칠흑의 검", "_t")
t("Grushgore the Destroyer was as famous for his incredible brutality as he was for his childlike intelligence. He wasn't known for his subtlety of naming, but there's no denying the power of his massive sword.", "파괴자 그루쉬고어는 말도 안 되는 폭력성과 어린 아이 같은 지능으로 유명했습니다. 그에게는 이름 짓는 재능이 없었지만, 적어도 이 거대한 검의 강력한 힘은 그 누구도 부정하지 못합니다.", "_t")
t("Increases all damage dealt, and reduces all damage taken, by 1%, stacking up to 10 times. Resets after 10 turns without attacking.", "공격 시 가하는 모든 피해량과, 피격 시 피해 감소량이 1% 증가합니다. 최대 10 번 중첩되며, 공격을 하지 않은 채로 10 턴이 지나면 모든 중첩이 사라집니다.", "_t")
t("Quasit's Skull", "콰짓의 해골", "entity name")
t("rocky helm", "바위 투구", "_t")
t("Some enterprising adventurer seems to have noticed the skin of quasits is actually tougher than most metals, and fashioned this helm from one. Shame about the smell.", "몇몇 진취적인 모험가들은 콰짓의 피부가 실제로 대부분의 금속보다 강하다는 사실을 알아차린 것 같습니다. 그들은 콰짓의 가죽으로 이 투구를 만들었습니다. 냄새가 구린 게 흠입니다.", "_t")
...
t("Wheel of Fate", "운명의 수레바퀴", "entity name")
t([["This isn't what I wished for!" - Howar Muransk, Cornac demonologist.

This band of gothic obsidian menaces with an embossed image of a grinning skull. It beckons you to tempt fate and put it on. Do you?]], [["이딴 거 말고!" - 코르낙 악마학자 하워 머란스크.

이 고풍적인 흑요석 반지의 활짝 웃고 있는 해골 조각은 겉보기에도 위협적입니다. 운명에 몸을 맡기라고 손짓하며 유혹하고 있습니다. 하시겠습니까?]], "_t")
t("strange black ring", "이상한 검은 반지", "_t")
t("#RED#The ring refuses to be removed!", "#RED#반지는 손가락에서 빼내어지길 거부했다!", "logPlayer")
t("Cannot be unequipped or rerolled until level %d.", "레벨 %d 까지 재부여하거나 해제할 수 없습니다.", "tformat")
...
t("#GREEN#The skull embossed in the ring twists around momentarily. ...Did it just laugh?", "#GREEN#반지에 조각된 해골이 순간 뒤틀렸다. ...방금 웃은 건가?", "logPlayer")
t("Helm of the Dominated", "지배당한 자의 투구", "entity name")
...
t("Increases the range of Haste of the Doomed by 1.", "몰락한 자의 신속함의 사거리가 1 칸 증가합니다.", "_t")
t("The Black Crown", "검은 왕관", "entity name")
t("cracked obsidian crown", "금이 간 흑요석 왕관", "_t")
t("\"For the demon who has everything.\"", "\"모든 것을 가진 악마를 위해.\"", "_t")
t("Increases all saves by your Shadow Power.", "그림자의 힘에 비례해 모든 내성이 상승합니다.", "_t")
t("The Black Core", "검은 핵", "entity name")
t("pitch black gemstone", "칠흑의 보석", "_t")
t("\"Lock your soul away, and death will never reach you.\"", "\"영혼을 멀리 봉인하면, 죽음이 결코 그대에게 이르지 아니하리라.\"", "_t")
t("Grants spellpower equal to your Shadow Power.", "그림자의 힘 만큼 주문력이 증가합니다.", "_t")
t("The Black Spike", "검은 송곳", "entity name")
t("thin black sword", "얇은 검은색 검", "_t")
t("\"All the better to pierce the heart of the world.\"", "\"세계의 심장을 꿰뚫기에 충분하도다.\"", "_t")
t("Increases all damage penetration by 1% for each point of your Shadow Power.", "그림자의 힘 1 점 당 모든 속성 관통이 1% 증가합니다.", "_t")
t("The Black Boots", "검은 장화", "entity name")
t("pair of pitch black boots", "칠흑의 장화", "_t")
t("\"It's a treacherous road to the top of the world.\"", "\"세상의 정점에 오르기까지의 여로는 위험천만하니.\"", "_t")
t("Grants 2.5% movement speed for each point of Shadow Power.", "그림자의 힘 1 점 당, 이동 속도가 2.5% 증가합니다.", "_t")
t("The Black Ring", "검은 반지", "entity name")
t("obsidian ring", "흑요석 반지", "_t")
t("\"An innocuous bauble. Until you look through the hole.\"", "\"자세히 보기 전까지는 그저 악의 없는 싸구려 보석에 지나지 않으리라.\"", "_t")
t("Grants spell-crit equal to half of your Shadow Power.", "그림자의 힘의 절반만큼 주문 치명타 확률이 증가합니다.", "_t")
t("The Black Plate", "검은 흉갑", "entity name")
t("pitch black breastplate", "칠흑의 흉갑", "_t")
t("\"Wreckage all about you. Is there anything left inside?\"", "\"그대 주변의 잔해들. 그 안에 무언가 남아 있긴 한 것인가?\"", "_t")
t("Grants physical power equal to your Shadow Power.", "그림자의 힘만큼 물리력이 증가합니다.", "_t")
t("The Black Maul", "검은 망치", "entity name")
t("massive black hammer", "거대한 검은 망치", "_t")
t("\"A fitting weapon for the Champion.\"", "\"대전사에게 어울리는 무기로다.\"", "_t")
t("Increases all damage by 1% for each point of your Shadow Power.", "그림자의 힘 1 점당 가하는 모든 피해량이 1% 증가합니다.", "_t")
t("The Black Wall", "검은 방벽", "entity name")
t("massive obsidian shield", "거대한 흑요석 방패", "_t")
t("\"With this, no one will ever harm you again.\"", "\"이 방패와 함께라면, 그 누구도 그대를 해하지 못하리니.\"", "_t")
t("Increases all resists by 0.4% for each point of your Shadow Power.", "그림자의 힘 1 점당 모든 저항이 0.4% 증가합니다.", "_t")
t("Planar Beacon", "차원 신호기", "entity name")
t("glowing red orb", "빛나는 붉은 보주", "_t")
t("A strange orb of demonic origins. It glows with a surreal red light.", "악마로부터 기인하는 기이한 구체입니다. 비현실적인 붉은색으로 빛나고 있습니다.", "_t")
...
t("A hide buckler with a green sheen and a caustic coating.", "녹색 광택이 나는 가죽 버클러입니다. 산성액으로 뒤덮여 있습니다.", "_t")
t("Gain 25% movement speed and 5% attack speed for each of your acid pools within 4 tiles of yourself, up to 4 pools at most. Moving onto an acid pool will create a radius 4 splash dealing 50 acid damage with a chance to blind for 2 turns (highest power vs physical save) and remove the acid pool.", "착용자 주변 반경 4 칸 안에 있는 (착용자의) 산성액 웅덩이 하나 당 이동 속도를 25%, 공격 속도를 5% 얻습니다 (최대 4 개까지). 착용자가 산성액 웅덩이로 이동하면 반경 4 칸의 물보라를 일으켜 50 산성 피해를 가하고 2 턴 동안 실명시킵니다 (가장 높은 위력 vs 물리 내성). 이동한 자리에 있던 웅덩이는 사라집니다.", "_t")
t("35% chance to create an acid pool within 2 tiles lasting 4 turns.", "35% 확률로 반경 2 칸 내에 4 턴 동안 유지되는 산성액 웅덩이를 하나 만들어냅니다.", "_t")
t("#Source# creates an acid pool!", "#Source1# 산성액 웅덩이를 만들었다!", "logCombat")
t("Caustic Lash", "산성 채찍", "entity name")
...
t("history of Mal'Rok (mistranslated)", "말'록의 역사 (오역본)", "_t")
...
]], [[(이상한 비문 더미가 있습니다. 모두 잘 정돈되어 쌓여 있습니다.  맨 위에 있던 것을 하나 집어서, 살펴 보았습니다.  그 모서리에 있는 사각형에 손가락을 미끄러뜨리자, 이상한 문장들이 머릿속으로 흘러 들어오기 시작합니다.  당신은 이런 낯선 단어와 개념들을 이해해 보려 안간힘을 씁니다.)

#{italic}##FIREBRICK#[우리 아버지]#{normal}##LAST#께서 우리를 #{italic}##FIREBRICK#[심으시고]#{normal}##LAST# #{italic}##FIREBRICK#[휴식을 취하신]#{normal}##LAST# 뒤 수많은 #{italic}##FIREBRICK#[달 크레이터]#{normal}##LAST# 생겼고, 그분께서는 그분의 #{italic}##FIREBRICK#[고치]#{normal}##LAST#에서 나오시었고 우리가 #{italic}##FIREBRICK#[덜컹거리는]#{normal}##LAST# 모습을 보셨다.  그분께서는 우리가 #{italic}##FIREBRICK#[시든]#{normal}##LAST# 것을 보시고 충격에 빠지시어, 왜 #{italic}##FIREBRICK#[덜컹거리]#{normal}##LAST#었는지 물으셨다. 우리는 그분께 우리가 고통받아 왔던 #{italic}##FIREBRICK#[흔들림]#{normal}##LAST#과 어떻게 이 행성이 #{italic}##FIREBRICK#[궁지에 몰리]#{normal}##LAST#게 되었는지, 그리고 우리의 #{italic}##FIREBRICK#[꼬투리 속 완두콩들]#{normal}##LAST#이 #{italic}##FIREBRICK#[틈새를 메워]#{normal}##LAST# #{italic}##FIREBRICK#[구슬들]#{normal}##LAST#이 #{italic}##FIREBRICK#[떨어지는]#{normal}##LAST# 것을 막았음에도 어떻게 #{italic}##FIREBRICK#[빗자루들]#{normal}##LAST#이 우리의 #{italic}##FIREBRICK#[먼지의 토끼들]#{normal}##LAST#을 쓸어버렸는지, 그리고 #{italic}##FIREBRICK#[구슬들]#{normal}##LAST#이 #{italic}##FIREBRICK#[깨지는]#{normal}##LAST# 것을 막는 데 필요한 빈 방이 충분치 않았다는 것을 모두 말씀드렸다.

(더 큰 사각형이 있습니다. 당신은 손으로 그것을 눌렀고, 그러자 갑자기 끊임없이 몰아치는 모래먼지 폭풍에 쓸려나가고 있는 어떤 사막 행성이 보였습니다.  당신은 다 죽어버린 농작물들을 바라보고 있는 조그만 녹색 생명체의 허무함을 느낄 수 있고, 한 손에는 검을, 다른 손에는 화염구를 들고 조그만 오닉스 색 생명체의 대군을 향해 달려들고 있는, 붉은색 피부를 가진 인간형 생명체의 분노도 느낄 수 있습니다.  사각형에서 손을 떼자 그 영상들이 사라졌습니다.)

#{italic}##FIREBRICK#[우리 아버지]#{normal}##LAST#께서는 우리에게 그분의 #{italic}##FIREBRICK#[연장들]#{normal}##LAST#을 하사하셨고, 우리가 #{italic}##FIREBRICK#[문지기들을 넘어뜨린?]#{normal}##LAST# 뒤에 그분께서는 우리를 #{italic}##FIREBRICK#[상냥하게 흔드셨다?]#{normal}##LAST#. 하지만 우리는 #{italic}##FIREBRICK#[덜컹거리는]#{normal}##LAST# 대신에 #{italic}##FIREBRICK#[선율을 연주했]#{normal}##LAST#고, 단지 우리가 #{italic}##FIREBRICK#[불협화음을 내게]#{normal}##LAST# 만드는 #{italic}##FIREBRICK#[구슬들]#{normal}##LAST#을 #{italic}##FIREBRICK#[깨지게]#{normal}##LAST# 만드셨다. 우리의 #{italic}##FIREBRICK#[구슬들]#{normal}##LAST#은 더 강하게 성장했고, #{italic}##FIREBRICK#[우리 아버지]#{normal}##LAST#께서 하사하셨던 것들보다도 더 다양한 #{italic}##FIREBRICK#[색깔]#{normal}##LAST#의 #{italic}##FIREBRICK#[연장들]#{normal}##LAST#을 사용하는 방법을 배웠다. #{italic}##FIREBRICK#[우리 아버지]#{normal}##LAST#께서는 #{italic}##FIREBRICK#[우리의 음악을 듣는]#{normal}##LAST# 것을 좋아하셨고, 우리는 원할 때마다 #{italic}##FIREBRICK#[작곡]#{normal}##LAST#해 주시는 그분께 감사했다. 머지않아 우리는 #{italic}##FIREBRICK#[우리 자신만의 음악을 작곡]#{normal}##LAST#할 수 있었고 더 이상 #{italic}##FIREBRICK#[겁에 질릴]#{normal}##LAST# 필요도 없었다. 그리고 #{italic}##FIREBRICK#[우리 아버지]#{normal}##LAST#께서는 #{italic}##FIREBRICK#[휴식을 취하셨다]#{normal}##LAST#.

(더 큰 사각형이 또 있습니다.  아주 멋지고 사랑스러우신 #{italic}##FIREBRICK#[우리 아버지]#{normal}##LAST#께서 행성에 내려와, 손짓으로 사막을 우거진 숲으로 바꾸는 장면이 보입니다. 당신은 다양한 크기의 에메랄드, 오닉스, 루비의 형제들과 함께 그분을 숭배하고, 처음으로 형제들과 통합을 이루었습니다. 이 모든 것이 그분 덕분이었기에, 당신은 그분께 감사했습니다.  역사상 처음으로 당신은 먹을 것을 걱정하지 않게 되었고, 다른 이들이 당신의 농지를 탐내어 당신을 죽이려 드는 것도, 그리고 그 먼지폭풍도 두려워할 필요가 없게 되었습니다.  그분께서는 은둔하며 폭풍을 일으켰던 땅의 마법사들의 시체들을 건져 올리셨습니다. 본래라면 당신은 그 마법사들에게 분노를 터뜨렸었지만, 다가올 미래에 대한 기대감 때문에 행복함만을 느낄 수 있습니다.  당신과 형제들은 체계적인 방식으로 경쟁을 벌이기 시작했고, 가끔은 다시 싸우게 되었지만, 만약 당신이 죽게 된다 하더라도 그게 이 행성에 도움이 된다는 것을 알고 있습니다.  후세가 되면 당신과 형제들은 더 똑똑해지고, 더 강해지고, 그리고 훨씬 더 행복해져, 낙원에서 살게 될 것이었습니다.  당신은 즉시 사각형에서 손을 뗐고, 그러자 신앙심과 존경심이 머릿속에서 빠져나갔습니다.)

마침내, #{italic}##FIREBRICK#[풀알들]#{normal}##LAST#이 왔다.  우리는 #{italic}##FIREBRICK#[놈들의 구슬들을 깨뜨리]#{normal}##LAST#려 했으나 놈들은 아무렇지도 않았다. 놈들은 우리를 #{italic}##FIREBRICK#[깨뜨리]#{normal}##LAST#려 하지는 않았으나 그 대신에 #{italic}##FIREBRICK#[우리 아버지]#{normal}##LAST#께서 우리에게 선사하신 것보다도 더 경이로운 #{italic}##FIREBRICK#[악보]#{normal}##LAST#를 주겠노라 제안했다. 하지만 그 조건으로 우리가 그분이 #{italic}##FIREBRICK#[산산조각]#{normal}##LAST#나도록 두길 바랐다.  우리는 거부했지만, 우린 다 함께 #{italic}##FIREBRICK#[비열한 꼬투리]#{normal}##LAST#에 이르렀다. 우리는 #{italic}##FIREBRICK#[우리 아버지]#{normal}##LAST#를 그분께서 하사하셨던 #{italic}##FIREBRICK#[연장들]#{normal}##LAST#로 #{italic}##FIREBRICK#[침묵시켜? 화분에 심어?]#{normal}##LAST# 그분이 #{italic}##FIREBRICK#[게으른 목수]#{normal}##LAST#가 되도록 했고 #{italic}##FIREBRICK#[우리의 꼬투리가 닫혔다]#{normal}##LAST#는 것을 #{italic}##FIREBRICK#[풀알들]#{normal}##LAST#에게 보였다.  #{italic}##FIREBRICK#[우리 아버지]#{normal}##LAST#께서는 #{italic}##FIREBRICK#[덜컹거리거나 깨지지]#{normal}##LAST# 않으실 것이었고, 그걸 알지도 못하실 것이었다.  #{italic}##FIREBRICK#[풀알들]#{normal}##LAST#은 기뻐했고, 우리의 행성에 #{italic}##FIREBRICK#[알빨이들]#{normal}##LAST#을 #{italic}##FIREBRICK#[발라]#{normal}##LAST# 우리가 온갖 종류의 #{italic}##FIREBRICK#[정원들]#{normal}##LAST# 출신 #{italic}##FIREBRICK#[다른 식물들의 꼬투리들]#{normal}##LAST#과 거래할 수 있게 했다.  우리는 새로운 음식을 맛보았고, 새로운 #{italic}##FIREBRICK#[연장들]#{normal}##LAST#을 배웠고, 몇몇 #{italic}##FIREBRICK#[화려한]#{normal}##LAST# 종류의 새 #{italic}##FIREBRICK#[구슬들]#{normal}##LAST#이 우리의 #{italic}##FIREBRICK#[정원]#{normal}##LAST#에 오기도 했다.  우리는 #{italic}##FIREBRICK#[우리 아버지]#{normal}##LAST#에 대해 약간의 #{italic}##FIREBRICK#[소음]#{normal}##LAST#을 느꼈지만, 그분께서는 #{italic}##FIREBRICK#[시끄럽지]#{normal}##LAST# 않으셨고 그 어떤 #{italic}##FIREBRICK#[소리]#{normal}##LAST#도 #{italic}##FIREBRICK#[듣지]#{normal}##LAST# 못하실 것이었다.  #{italic}##FIREBRICK#[풀알들]#{normal}##LAST#은 우리의 #{italic}##FIREBRICK#[꼬투리의 콩들]#{normal}##LAST#처럼 행동했고, 우리는 놈들이 #{italic}##FIREBRICK#[꼬투리에서 미끄러질]#{normal}##LAST# 때까지 놈들을 #{italic}##FIREBRICK#[경청]#{normal}##LAST#으로 대했으며, 우리는 더 이상 #{italic}##FIREBRICK#[서로의 연주회에 참석]#{normal}##LAST#할 수 없게 되었다.

(당신은 다음 장의 패널을 만졌습니다.  어떤 생명체가 거대한 요새에서 걸어 나왔습니다 - 그 몸뚱이는 알처럼 생겼고 그 팔다리는 #{italic}##FIREBRICK#[덩굴풀]#{normal}##LAST#이 넷 달린 것처럼 생겼습니다.  당신은 그 존재를 극도로 증오했습니다. 이때 당시에는 그런 감정이 없었다는 것을 알고 있었음에도 말입니다.  그들은 #{italic}##FIREBRICK#[우리 아버지]#{normal}##LAST#가 죽기를 바란다 말했고, 그 보상으로 엄청난 마법과 기술을 제공하겠다 제안했습니다. 당신은 그들의 제안을 혐오했지만, 그들의 요새와 무기들 때문에 그들이 제안하는 것이 진정 "제안"일 뿐인가 의구심이 들었습니다.  당신은 #{italic}##FIREBRICK#[우리 아버지]#{normal}##LAST#를 깨워 도움을 요청해 볼까 생각해 보았지만, 그분마저도 #{italic}##FIREBRICK#[풀알들]#{normal}##LAST#에게 맞서지 못하시는 것이 아닐까 두려웠습니다.  결국 당신은 그분께서 계속 잠든 채로 계시도록 봉인하는 것을 선택했고, 그분께서 이후 방해받지 않으시는 한, 의식이 없는 상태에서 해를 끼치지도, 당하지도 못하시는 상태로 만들었습니다. #{italic}##FIREBRICK#[풀알들]#{normal}##LAST#은 이걸 마지못해 받아들였고, 제안했던 것들을 제공했습니다.  그들은 당신에게 낯설고 강력한 힘을 품은 유물들을 주었고, 당신의 세상에 차원문들을 지어 당신이 놀랍고 아름다운 낯선 세계들로 여행하여 다른 종족들에게서 선물을 받고 거래를 할 수 있도록 했습니다.  당신은 새로운 음식을 맛보고, 새로운 마법을 배우고, 새로운 음악을 듣고, 당신 종족의 역사를 통틀어 가장 아름다운 것들을 발견했습니다.  가슴을 파고드는 죄책감이 없었더라면, 이보다 더 좋을 수는 없었을 것입니다.  패널에서 손을 떼자 머릿속에서 영상들이 빠르게 사라져갔고, "풀알들"이란 쉐르'툴을 의미한다는 것을 알아차렸습니다.)

그리고, 엄청난 #{italic}##FIREBRICK#[소음]#{normal}##LAST#이 일어났다.  점점 #{italic}##FIREBRICK#[더 시끄러워졌다]#{normal}##LAST#.  점점 #{italic}##FIREBRICK#[더 시끄러워졌다]#{normal}##LAST#.  점점 #{italic}##FIREBRICK#[더 시끄러워졌다]#{normal}##LAST#.  점점 #{italic}##FIREBRICK#[더 시끄러워졌다]#{normal}##LAST#.  점점 #{italic}##FIREBRICK#[더 시끄러워졌다]#{normal}##LAST#.  점점 #{italic}##FIREBRICK#[더 시끄러워졌다]#{normal}##LAST#.  점점 #{italic}##FIREBRICK#[더 시끄러워졌다]#{normal}##LAST#.  점점 #{italic}##FIREBRICK#[더 시끄러워졌다]#{normal}##LAST#.  점점 #{italic}##FIREBRICK#[더 시끄러워졌다]#{normal}##LAST#.  점점 #{italic}##FIREBRICK#[더 시끄러워졌다]#{normal}##LAST#.  점점 #{italic}##FIREBRICK#[더 시끄러워졌다]#{normal}##LAST#.  점점 #{italic}##FIREBRICK#[더 시끄러워졌다]#{normal}##LAST#.  점점 #{italic}##FIREBRICK#[더 시끄러워졌다]#{normal}##LAST#.  점점 #{italic}##FIREBRICK#[더 시끄러워졌다]#{normal}##LAST#.  점점 #{italic}##FIREBRICK#[더 시끄러워졌다]#{normal}##LAST#.  점점 #{italic}##FIREBRICK#[더 시끄러워졌다]#{normal}##LAST#.  점점 #{italic}##FIREBRICK#[더 시끄러워졌다]#{normal}##LAST#.  점점 #{italic}##FIREBRICK#[더 시끄러워졌다]#{normal}##LAST#.  점점 #{italic}##FIREBRICK#[더 시끄러워졌다]#{normal}##LAST#.  점점 #{italic}##FIREBRICK#[더 시끄러워졌다]#{normal}##LAST#.  점점 #{italic}##FIREBRICK#[더 시끄러워졌다]#{normal}##LAST#.  점점 #{italic}##FIREBRICK#[더 시끄러워졌다]#{normal}##LAST#.  점점 #{italic}##FIREBRICK#[더 시끄러워졌다]#{normal}##LAST#.  점점 #{italic}##FIREBRICK#[더 시끄러워졌다]#{normal}##LAST#.  점점 #{italic}##FIREBRICK#[더 시끄러워졌다]#{normal}##LAST#.  점점 #{italic}##FIREBRICK#[더 시끄러워졌다]#{normal}##LAST#.  점점 #{italic}##FIREBRICK#[더 시끄러워졌다]#{normal}##LAST#.  점점 #{italic}##FIREBRICK#[더 시끄러워졌다]#{normal}##LAST#.  점점 #{italic}##FIREBRICK#[더 시끄러워졌다]#{normal}##LAST#.  점점 #{italic}##FIREBRICK#[더 시끄러워졌다]#{normal}##LAST#.  점점 #{italic}##FIREBRICK#[더 시끄러워졌다]#{normal}##LAST#.  점점 #{italic}##FIREBRICK#[더 시끄러워졌다]#{normal}##LAST#.  점점 #{italic}##FIREBRICK#[더 시끄러워졌다]#{normal}##LAST#.  점점 #{italic}##FIREBRICK#[더 시끄러워졌다]#{normal}##LAST#.  #{italic}##FIREBRICK#[고막이 터질]#{normal}##LAST# 지경이었다.

(또 다른 패널이 있습니다.  당신은 이걸 건드릴 엄두가 나지 않습니다. 하지만 그걸 치우려 할 때, 손가락이 그 위를 스쳤습니다.  굶주림, 불길, 질식, 빈곤함, 격노, 그리고 순수한 고통이 일 초도 되지 않는 찰나 동안 당신의 정신을 휘저었지만, 마치 몇십 초는 지나간 것 같습니다.  다음 사각형으로 손가락을 옮기는 와중에도 여전히 귓속이 울리고 있습니다.)

#{italic}##FIREBRICK#[알빨이들]#{normal}##LAST#은 함정이었다. #{italic}##FIREBRICK#[풀알들]#{normal}##LAST#이 우릴 전부 #{italic}##FIREBRICK#[깨뜨리기]#{normal}##LAST# 위해 심은 #{italic}##FIREBRICK#[불협화음]#{normal}##LAST#이었고, 우리의 #{italic}##FIREBRICK#[정원]#{normal}##LAST#에 #{italic}##FIREBRICK#[가느다란 금]#{normal}##LAST#만 낼뿐이었다.  놈들의 #{italic}##FIREBRICK#[잘못된 음]#{normal}##LAST#은 우리 행성을 #{italic}##FIREBRICK#[불협화음]#{normal}##LAST#으로 바꿔 놓았고, 거의 우리 모두를 #{italic}##FIREBRICK#[꼬투리에서 떨어뜨릴]#{normal}##LAST# 뻔했다.  #{italic}##FIREBRICK#[사과는 껍질이 벗겨졌]#{normal}##LAST#고 우리의 #{italic}##FIREBRICK#[껍데기]#{normal}##LAST# 조각이 #{italic}##FIREBRICK#[바다]#{normal}##LAST# 위를 떠다녔다.  우리의 #{italic}##FIREBRICK#[잡역부들]#{normal}##LAST#은 #{italic}##FIREBRICK#[껍질]#{normal}##LAST#과 우리의 #{italic}##FIREBRICK#[정원]#{normal}##LAST#에 #{italic}##FIREBRICK#[박자]#{normal}##LAST#를 주기 위해 신속하게 행동했고, 그것조차 #{italic}##FIREBRICK#[소음]#{normal}##LAST#으로 #{italic}##FIREBRICK#[우리 아버지]#{normal}##LAST#께서 깨지 않으셨다면 모두 실패했을 것이다.

우린 죄송했다.  우린 정말로 죄송했다.  우리의 #{italic}##FIREBRICK#[꼬투리]#{normal}##LAST#는 #{italic}##FIREBRICK#[썩었]#{normal}##LAST#고 우리는 그것을 알고 있었다. 우리는 결코 #{italic}##FIREBRICK#[그것을 심지]#{normal}##LAST# 말았어야 했다.  아버지께서는 우리의 #{italic}##FIREBRICK#[엎질러진 통]#{normal}##LAST#을 용서하셨고 #{italic}##FIREBRICK#[우리의 정원을 비옥하게]#{normal}##LAST# 만드셨다. 여전히 불타고 있고 #{italic}##FIREBRICK#[소금이 뿌려져]#{normal}##LAST# 있지만, #{italic}##FIREBRICK#[연장통을 부수는]#{normal}##LAST# 것으로 변함없이 #{italic}##FIREBRICK#[씨앗을 심을]#{normal}##LAST# 수 있었다.  우리는 #{italic}##FIREBRICK#[꽃피우지]#{normal}##LAST# 못했지만 #{italic}##FIREBRICK#[연주, 단 하나의 음을 연주할]#{normal}##LAST# 수 있었다.  #{italic}##FIREBRICK#[우리 아버지]#{normal}##LAST#께서는 여전히 그분의 의지를 #{italic}##FIREBRICK#[우리의 정원을 모아 못질하는]#{normal}##LAST# 데에 쏟고 계신다. 그분께서 단 일 초라도 멈추신다면 #{italic}##FIREBRICK#[산산조각나 시들]#{normal}##LAST# 것이다.  #{italic}##FIREBRICK#[우리 아버지]#{normal}##LAST#의 헌신을 기리라.  #{italic}##FIREBRICK#[우리 아버지]#{normal}##LAST#를 기리라.  정말로 죄송하나이다.

(당신은 떨리는 손으로 다음 패널을 눌렀습니다.  당신은 검게 불타 부글거리고 있는 절벽 위에 서 있었고, 머리 위와 발밑으로는 별이 반짝거리는 새까만 공간이 보였습니다.  당신의 발은 끊임없이 불타고 있습니다. 마법사들은 당신에게 산소를 공급하고 주변의 마법을 열량으로 전환해 줄 수 있었지만, 산산조각난 대륙을 휘젓고 당신의 행성이었던 것을 영원토록 불태우고 있는 그 끔찍한 마법을 취소할 수는 없었습니다.  당신이 알고 있던 사람들은 거의 다 죽었고, 당신의 점술가들은 #{italic}##FIREBRICK#[풀알들]#{normal}##LAST#의 고향은 경미한 수준의 피해밖에 입지 않았다고 이야기했습니다. 당신이 차원문을 통해 만났던 다른 종족들은 하나도 남김없이 한순간에 산산조각났습니다.  당신의 고향이 살아남은 것은 #{italic}##FIREBRICK#[우리 아버지]#{normal}##LAST#의 끊임없는 노력과 집중 덕분이었고, 그분은 지금도 산산이 부서진 조각들이 공허 속으로 빨려 들어가는 것을 막기 위해 온 힘을 기울이고 계십니다.  깊은 후회를 느끼지 않을 수가 없습니다.  온몸을 바쳐가며 끊임없이 노력하시는 #{italic}##FIREBRICK#[우리 아버지]#{normal}##LAST#께 사죄할 방법이 없었다면, 당신은 망설임 없이 자결을 택했을 것입니다.  패널에서 손을 떼자 그 후회가 빠져나갔습니다.)

우리는 어떤 #{italic}##FIREBRICK#[노래를 불러]#{normal}##LAST#야 #{italic}##FIREBRICK#[우리 아버지]#{normal}##LAST#께서 다시 #{italic}##FIREBRICK#[춤을 추실지]#{normal}##LAST# 여쭈었다.  그분께서는 이렇게 말씀하셨다. #{italic}##FIREBRICK#[풀알들]#{normal}##LAST#의 마지막 #{italic}##FIREBRICK#[구슬이 떨어질]#{normal}##LAST# 때까지 놈들을 #{italic}##FIREBRICK#[덜컹거리게]#{normal}##LAST# 해라.  우리에게는 #{italic}##FIREBRICK#[합주 공연장]#{normal}##LAST#이 있고, 이제 #{italic}##FIREBRICK#[파티를 부술]#{normal}##LAST# 것이다.  이는 우리를 위해, #{italic}##FIREBRICK#[풀알들]#{normal}##LAST#이나 놈들의 #{italic}##FIREBRICK#[싹들]#{normal}##LAST#이 우리에게서 빼앗아간 것을 대신할 새로운 #{italic}##FIREBRICK#[정원]#{normal}##LAST#을 얻기 위해서이다. 또 #{italic}##FIREBRICK#[우리 아버지]#{normal}##LAST#를 위해, 우리를 다시 한 번 #{italic}##FIREBRICK#[심어]#{normal}##LAST# 그분께서 다시 #{italic}##FIREBRICK#[휴식을 취하]#{normal}##LAST#실 수 있도록 하기 위해서이다.  마지막으로 모든 이들을 위해, #{italic}##FIREBRICK#[대화재]#{normal}##LAST#로 #{italic}##FIREBRICK#[쏟아진 구슬들]#{normal}##LAST#의 복수를 하고 #{italic}##FIREBRICK#[풀알들]#{normal}##LAST#과 놈들이 #{italic}##FIREBRICK#[심은]#{normal}##LAST# 그 어떤 #{italic}##FIREBRICK#[잡초들]#{normal}##LAST#에게 #{italic}##FIREBRICK#[침묵]#{normal}##LAST#을 안겨다 주기 위해서이다.

(또 다른 패널이 있습니다.  당신은 그걸 살짝 건드렸습니다.  당신은 스스로를 증오합니다.  당신은 에이알을 증오합니다.  당신은 쉐르'툴을 증오합니다.  당신은 주변의 만물을 증오합니다.  당신은 그것들을 파괴하여, 수천 조에 달하는 영혼들에게 정의가 실현되었다고 알리고 싶습니다.  당신은 쉐르'툴뿐만이 아니라, 그것과 관계가 있는 모든 것들을 정화하고 싶습니다.  엘프. 하플링. 오크. 인간. 놈들의 오염을 이어받을 수 있는 모든 것들을. 다른 모든 것들이 그 차원문 때문에 불살라지는 동안, 살아남게 된 모든 것들을.  만약에 에이알에 쉐르'툴이 단 하나라도 남아 있을 가능성이 있다면, 황폐의 불길로써 정화해야만 합니다.  에이알은 정의의 심판을 받아야 합니다.  패널에서 손을 떼고도, 갈 곳 없는 분노가 10분 정도 남아 있었습니다.)

#{italic}##FIREBRICK#[우리 아버지]#{normal}##LAST#께서는 우리의 #{italic}##FIREBRICK#[목수]#{normal}##LAST#들이 #{italic}##FIREBRICK#[강력한 도구]#{normal}##LAST#를 만드는 것을 도우셨는데, 그것은 그분의 축복받은 #{italic}##FIREBRICK#[수리용 렌치]#{normal}##LAST#의 일종이었고 우리가 #{italic}##FIREBRICK#[더 세게 흔들]#{normal}##LAST# 수 있도록 우릴 변신시킬 수 있었다.  #{italic}##FIREBRICK#[완두콩들]#{normal}##LAST#은 산성액을 떨어뜨렸고, #{italic}##FIREBRICK#[비트들]#{normal}##LAST#은 터무니없는 속도를 얻었으며, #{italic}##FIREBRICK#[고추들]#{normal}##LAST#은 #{italic}##FIREBRICK#[소음의 흙]#{normal}##LAST#을 손에 이식하여 #{italic}##FIREBRICK#[그 소리를 만들어낸]#{normal}##LAST# 자들에게 던졌다.  #{italic}##FIREBRICK#[꽃피우는]#{normal}##LAST# 것은 조금 #{italic}##FIREBRICK#[시끄럽]#{normal}##LAST#지만, #{italic}##FIREBRICK#[풀알들의 괴성]#{normal}##LAST#에 비하면 아무것도 아니었다.  우리는 #{italic}##FIREBRICK#[잡역부가 되거]#{normal}##LAST#나 #{italic}##FIREBRICK#[태양 속에서 시들]#{normal}##LAST# 것이다. 다음 패널을 눌러 #{italic}##FIREBRICK#[연장통을 잡아]#{normal}##LAST#라. #{italic}##FIREBRICK#[잡역부]#{normal}##LAST#가 돼라.
...
t("history of Mal'Rok (1)", "말'록의 역사 (1)", "_t")
...
수 없을 것이다. 우리는 황폐의 불길로 에이알을 정화함으로써 이를 확실히 할 것이다. 그리고 그 생존자들은 우리 행성으로 데려가 불타는 대지에 묶어 두고, 자신들이 만들어냈던 불꽃이 자신들의 살점을 불사르는 것을 영원토록 느낄 수 있도록 살려 둘 것이다.  그 영원한 고통조차도 놈들이 가했던 고통에 비하면 티끌에 지나지 않으므로, 정의를 실현하기에는 부족할 것이다...  그러나 이것은 단지 시작일 뿐이다.
]], "_t")
t("Lost Memories (1)", "잃어버린 기억들 (1)", "_t")
...
]], [[#{italic}#당신은 머리를 움켜쥐었다.  이곳에 들어서니 당신이 수감됐던 때의 기억들이 물밀듯 밀려들어온다...#{normal}#

"자, 다음 녀석 데려와." 루비 피부를 가진 지도자가 말했다.  키가 작은 녹색과 검은색의 생물들이 본래 드워프였던 쓰레기 더미를 치웠다. 그리고 당신이 줄의 맨 앞으로 움직여 드워프가 있던 곳에 섰다.  방 저편에, 당신의 동족 한 명이 똑같은 단 위에 섰다.  정말 기대된다 - 당신은 특별히 실험 대상으로 뽑힌 것이다!  당신은 저들이 효과적이고 매우 고통스러운 무언가를 찾는 데 자신이 기여할 수 있길 바랐고, 자신에게 고통이 찾아오길 기대하고 있었다.  이쪽 방에는 녹색 임프 한 마리가 서 있었는데, 지금껏 봤던 다른 임프들보다 조금 더 변이된 것 같았고 피부도 더 울퉁불퉁했다. 그것은 기대하는 눈빛으로 당신을 바라보며 씩 웃었다.  반대편에는 좀 더 평범한 임프가 실험체에게 다가갔다.  "대조군... 시작."  평범한 렛츨링이 <?=_t(player.descriptor.subrace, "birth descriptor name")?>의 얼굴을 향해 뛰어들었다. 그것이 얼굴을 움켜쥐자 피부에서 산성액이 쏟아져 나왔고, 곧 놓아주었다.  빨간 임프는 그의 녹아내린 살점을 지켜본 다음, 무언가 기록해 두고는 중얼거렸다.  "이제 고통 차단 해제..."  <?=_t(player.descriptor.subrace, "birth descriptor name")?>의 미소가 사라졌고, 그는 자신의 얼굴을 움켜쥐었다. 그리고는 고통에 찬 비명을 내지르고 쓰러져, 바닥에서 나뒹굴기 시작했다.  빨간 임프는 다시 내려다보고는 지루하다는 듯 한숨을 내쉬었고, 몇 가지를 더 적었다.  "이 정도면 됐다. 고통 차단 활성화, 놈을 치료해."  당신의 동족은 움직이는 걸 멈추곤 일어서서 다시 웃었고, 그의 살점은 계속해서 산성액에 녹아내리고 있었지만 이내 바닥에 깔린 관에서 몇 종류의 화학물질이 쏟아져 나와 그를 뒤덮었다.  또 다른 빨간 임프가 무언가를 중얼거리곤, 손을 흔들어서 그를 데리고 나갔다. 당신은 그의 끔찍한 상처들이 천천히 아물고 있는 것을 보았다.

"실험군... 시작."  돌연변이 렛츨링이 엄청난 속도로 당신의 얼굴로 뛰어들었고, 너무 빨라서 당신은 그것이 뛰어드는 것을 알아차리지도 못했다.  산성액이 가슴팍까지 흘러내렸고, 피부가 겉면부터 녹기 시작하면서 이상한 느낌이 들긴 했지만, 당신은 그 고통을 전혀 느끼지 못했다.  그 임프는 얼굴에서 뛰어내렸다. 보아하니 산성액이 당신의 눈을 피해 간 것 같았는데, 왜냐하면 빨간 임프가 다소 실망한 것 같은 모습을 볼 수 있었기 때문이다.  "구조적인 피해가 평균 이하로군... 좋아, 고통 차단 해제."  당신은 지금부터 비명을 질러서는 안 된다는 것을 알고 있었다.

당신은 비명을 질렀다.  지금 성대가 산산조각으로 찢기고 있을지도 모른다는 생각이 들 정도로, 지금껏 살아오며 질러본 어느 비명보다 더 처절하게 내질렀다. 지금껏 겪어보았던 어떤 것보다도 더, 어떤 감각보다도 훨씬 더 고통스러웠다.  당신은 바닥에 쓰러져 자신의 피부를 손톱으로 마구 긁고, 산성액을 떨치기 위해서 살점을 찢었다.  당신은 허우적거리며 몸부림쳤고, 근처에는 아무것도 없다는 것을 알면서도 본능적으로 자신을 도울 수 있는 것이라면 무엇이든 붙잡으려고 했다.

"아주 좋아, 훌륭해! 고통 차단 활성화!"  갑자기 고통이 사라졌다. 당신의 피부는 여전히 부글거렸지만, 그 끔찍한 고통은 사라졌고 목도 따끔거리지 않았다.  "놈을 세척하고 치료해라. 고통 증폭 특성이... 상당히 증가함... 고통이 적고 부식성이 높은 종과 교배하는 것을 권장."  정체모를 점액이 머리 위로 쏟아지자 부글거리던 피부가 가라앉았다. 당신의 담당관은 당신을 붙잡고 데려가면서 치료 주문을 중얼거렸고, 그러자 당신의 상처들이 또다시 천천히 아물며 매끄러운 피부로 바뀌어갔다.  당신은 소리를 질렀다고 해서 저들이 너무 가혹하게 대해 주지 않기만을 바랐다. 하지만 그 임프의 말투로 보아...  당신은 저들이 무언가를 알아내는 데에 기여한 것이 틀림없었다!  문이 닫히고 방에서 나갈 때 빨간 임프가 "다음!" 하고 고함을 지르는 소리가 들렸고, 그걸 들으며 당신은 입이 귀에 걸릴 정도로 씩 웃었다.

#{italic}#당신은 몸서리쳤다.#{normal}#
]], "_t")
t("Lost Memories (2)", "잃어버린 기억들 (2)", "_t")
...
그렇긴 하지만, <?=player:he_she()?>가 탈출한 이후로 그 힘이 극적으로 성장하였다는 것을 고려하면 적절한 전술을 염두에 두는 것이 중요하다.  우리는 몇몇 동족들이 <?=player:he_she()?>의 편에서 싸우는 것을 목격했다는 충격적인 보고를 받았다. 녀석은 비문의 힘을 비틀어 사용하여, 우리 전력의 일부를 노예로 삼고 있는 것으로 추정된다.  <?=player:his_her()?>의 전투력은 대부분 그 자신의 능력보다는 그러한 노예들로부터 나온다.  따라서, 다음 세 가지를 명심하라.

-노예들보다 그들을 조종하는 에이알인을 우선시하라.  우리는 아직 <?=player:he_she()?>가 어떻게 우리 동료들을 조종하는지에 대해 구체적으로 알고 있는 것이 없다. 하지만 녀석이 무력화되는 즉시 정신 지배가 풀릴 것으로 보인다.  만약 녀석이 울흐'록의 대전사나 그에 버금가는 요원을 예속하였다면, 우리는 녀석에게 화력을 집중할 필요가 있다.  그렇긴 하지만, 그 노예들을 다소 희생하더라도 <?=player:he_she()?>를 무력화하는 것이 더 중요하다. 병력은 또 만들어내면 되는 것이다. 특히, 교차사격 중에는 노예가 된 임프 몇 마리 정도는 신경 쓰지 마라.  녀석이 무슨 수단을 쓰고 있든 간에, 우리 쪽이 우위다.

-모든 상황을 상정하라.  우리는 지금까지 우리 자신의 힘에 맞서려면 무엇을 해야 할지 생각해 볼 필요가 없었다. 또, 우리 종족은 매우 다양하기 때문에 이제 <?=player:he_she()?>는 우리를 향해 온갖 종류의 마법과 무술을 모두 사용할 수 있다.  이것이 절망적으로 들릴지도 모르지만, 기억하라: 너희는 동료들이 훈련을 하며, 또 전투 중에 이런 힘들을 사용하는 것을 목격했을 것이다.  너희의 전우들이 어떤 힘을 사용하는 것을 본 적이 있다면, <?=player:him_her()?>가 그것을 사용할 수도 있다고 생각하라.

-<?=player:his_her()?>의 노예들이 전부 죽었다고 해서 상황이 종료되었다고 섣불리 생각해선 안 된다.  녀석은 자신의 육체에 우리의 마법을 직접 주입하는 데 성공했다. 즉, 우리의 화염구나 산성 폭발 등등을 사용할 수 있을지도 모른다.  침묵 마법을 사용하면 도움이 될 것이며, 녀석의 에너지를 흡수할 수 있는 주문 또한 효과적일 것이다. 더해서, <?=player:his_her()?>의 방어 수단을 제거하면 녀석은 우리의 손톱과 도끼를 사용한 공격에 특히 취약해질 것이다.

무엇보다, 기억하라: 비록 <?=player:he_she()?>는 동족들을 예속하여 하수인으로 부리고 있지만, 녀석은 요행으로 우리의 우월한 힘의 일부를 얻게 되었을 뿐, 그 본질은 그저 한심하고 열등한 에이알인이다.  녀석은 이 힘을 적절하게 사용하는 법을 전혀 알지 못하며, 우리처럼 영겁의 세월 동안 사용해 본 경험이 있는 것도 아니다.  우리는 수적으로 우위이고, 힘에 익숙하며, 적절한 전술도 있다. 무엇보다도 우리는 울흐'록의 축복을 받는다.  이번 작전을 훈련이라고 생각하라. 우리가 평정심과 집중을 유지하는 한 희생자가 나오는 일은 없을 것이다.
]], "_t")
...
그렇긴 하지만, <?=player:he_she()?>가 탈출한 이후로 그 힘이 극적으로 성장하였다는 것을 고려하면 적절한 전술을 염두에 두는 것이 중요하다.  우리의 기본 변화 마법이 샬로레가 가진 고반응성 마법과 시너지를 일으켜 그 엘프는 드래보르 녀석에게 필적할 만한 단거리 순간이동 능력을 얻게 되었고, 그 덕분에 녀석에게 뭔가를 명중시키기가 극도로 어려워졌다.  심지어 <?=player:his_her()?>의 내부 장기도 그 영향을 받고 있어서, 급소가 공격받을 것 같으면 그 내장이 움직여서 피해버린다.  일반적인 샬로레와 비교하여, 그 엘프는 투명화 능력을 상실하였으나 여전히 눈에 보이지 않는 것으로 보아 듀아세들렌으로 변신하는 마법이라도 얻게 된 것 같다. 만약 빛에 기반한 보호막 사용 허가가 나게 된다면 듀아세들렌으로 변하는 것과 어둠의 마법 둘 다 별다른 문제가 되지 않을 것이다.  마지막으로 고도의 기술을 사용하려고 하면 <?=player:his_her()?>는 모종의 능력으로 우리가 집중하는 것을 방해할 것이고, 우리가 <?=player:his_her()?>의 회복력을 강화했기 때문에 독과 불꽃에 당해도 큰 효과는 없을 것이며 회복 속도 자체도 빠를 것이다.

그래서 결론은 무엇이냐?  그냥 그 엘프를 공격하고, 녀석이 다른 곳으로 순간이동할 때까지 기다렸다가 막다른 곳으로 몰아서 더 이상 움직이지 않을 때까지 후려쳐라.  어려울 거 없다.  일반적인 <?=string.a_an(_t(player.descriptor.subclass, "birth descriptor name"):lower())?> 상대법을 활용하라. 만약 <?=player:he_she()?>가 어둠 속으로 사라졌다면, 대열을 흩뜨리지 말아야 한다는 것을 기억해라. 그리하면 이 난장판을 순식간에 해결할 수 있을 것이다.

무엇보다, 기억하라: 비록 <?=player:he_she()?>의 육체는 보다 강화되었지만, 녀석은 요행으로 우리의 우월한 힘의 일부를 얻게 되었을 뿐, 그 본질은 그저 한심하고 열등한 에이알인이다.  녀석은 이 힘을 적절하게 사용하는 법을 전혀 알지 못하며, 우리처럼 영겁의 세월 동안 사용해 본 경험이 있는 것도 아니다.  우리는 수적으로 우위이고, 힘에 익숙하며, 적절한 전술도 있다. 무엇보다도 우리는 울흐'록의 축복을 받는다.  이번 작전을 훈련이라고 생각하라. 우리가 평정심과 집중을 유지하는 한 희생자가 나오는 일은 없을 것이다.
...
#{italic}#마지막 글자에서 이어진 선은 이 장의 끝까지 이어져 있습니다. 마치 펜이 한순간에 날아가 버린 것 같습니다. 그 선의 끝부분에는 당신이 양날 카타나를 휘두르며 "닌자 아타마쏜" 이라고 적힌 거대한 골렘과 전투를 벌이는 모습을 묘사하는 낙서가 그려져 있습니다.  당신의 휘몰아치는 폭풍간지가 이 악마가 보고서를 쓰는 것을 방해한 것이 틀림없습니다.#{normal}#
]], "_t")
...
t("demon statue: wretchling", "악마상: 렛츨링", "_t")
t("Behold, the humble wretchling, a testament to our devotion to our Father!  These children of emerald were among the first to alter themselves for our quest for vengeance, and managed an astounding degree of success.  With their bursts of blinding speed, overwhelming numbers, and skin that can release prodigious amounts of corrosive fluid, wretchlings can storm onto the battlefield and pounce on our foes one-by-one, dissolving the ground they walk on while leaving them helpless against our onslaught.  Wretchlings will readily give their lives in combat, serving as obstructions and shields while their acid and our casters do their work, and still remain the most populous of our species thanks to their incredible birth rates.  It is rare to see a wretchling survive to maturity, but make no mistake - every wretchling that fights does an incredible service to our cause.", "보아라! 겸손한 렛츨링을, 우리 아버지를 향한 헌신의 증거를!  이 에메랄드의 자손들은 우리의 복수를 위하여 가장 처음 신체를 변형시킨 자들 중 하나였고, 그 결과는 놀라울 정도였다.  그들은 눈에 보이지도 않는 빠른 속도와 압도적인 머릿수, 그리고 엄청난 양의 산성액을 뿜어낼 수 있는 피부를 갖게 되었고, 렛츨링들은 그것을 살려 전장으로 몰려가 우리의 적들에게 하나하나 달려들어, 발밑의 땅을 녹이고 놈들이 우리의 맹공을 버틸 수 없게 만들 수 있다.  전장에서 렛츨링들은 기꺼이 자신들의 생명을 바칠 것이며, 자신들의 산성액과 우리의 마법사들이 제 역할을 하는 동안 몸을 던져 벽이 되고 방패가 되어 줄 것이다. 그럼에도 렛츨링은 우리 종족 중 가장 많은 비율을 차지하고 있는데, 이는 그들의 놀라운 번식력 덕택이다.  렛츨링이 성체가 될 때까지 살아남는 일은 드물지만, 착각해서는 안 된다 - 전장에서 싸우는 모든 렛츨링들은 우리의 대의를 위해 헌신하고 있는 것이다.", "_t")
t("demon statue: fire imp", "악마상: 화염 임프", "_t")
t("If the Wretchling speaks to our worship, the Fire Imp speaks to our commitment and loyalty.  When a child of ruby goes out onto the battlefield, she fuses some of the Eyal-scarred earth from our planet to her hands, having perfected a type of magic that uses the raging magic contained within to blast our foes with the fires they've caused.  Aside from this means of appropriate justice being pleasing to Urh'Rok (as he showed when dealing with the dust-mages), it shows how dedicated we are to our cause: without hands, there's very little a Fire Imp would be able to do if she deserted or became demoralized.  Fighting and destroying is what we live for, and what better way to show it than making oneself unable to do anything but fight and destroy?  Although the bulk of the ruby species do not pursue this path, instead focusing on magical research and furthering our alteration projects, the example that the Fire Imp sets is a shining standard of commitment for all of Urh'Rok's children.", "렛츨링이 우리의 헌신을 대변한다면, 화염 임프는 우리의 집념과 충성심을 대변한다.  루비의 자손들은 전장에 나설 때 에이알의 불로 검게 탄 우리 행성의 흙을 양 손에 품는다. 그 흙은 여전히 날뛰는 마법을 담고 있고, 루비의 자손들은 그것을 이용해 우리의 적들에게 그 불길을 돌려주는 마법을 완벽히 구사한다.  이러한 정의 실현 방식은 울흐'록을 기쁘게 하는 것을 제쳐두더라도 (그분께서도 먼지의 마법사들을 처리할 때 이렇게 하시었다), 우리가 대의에 얼마나 전념하는지를 보여준다. 양 손을 쓸 수가 없기 때문에, 화염 임프들은 고립되거나 사기가 꺾인다 하더라도 할 수 있는 것이 거의 없다. 우리는 싸움과 파괴를 위해서 살아가는데, 누군가가 그것 외에는 할 수 있는 것이 없다는 것을 보여주는 데에 이보다 더 좋은 방법이 있을까?  비록 대부분의 루비 종족들은 이런 방식을 추구하지 않고 그 대신에 마법 연구나 더 나은 신체 변이 계획에 집중하지만, 화염 임프는 우리 울흐'록의 자식들에게 집념이란 무엇인가를 보여주는 훌륭한 본보기이다.", "_t")
t("demon statue: water imp", "악마상: 물 임프", "_t")
t("Though they retain use of their hands, this altered offshoot of the Fire Imp has made a much more powerful sacrifice: the ability to breathe air.  Most of the dominant species of Eyal reside above the water, making its oceans and lakes a prime location for carrying out covert operations, conducting experiments too dangerous to perform on our own soil, and preparing portals for a full-scale invasion.  As our scouts and servants beneath the seas, water imps forego the fire-slinging abilities shared by their brethren, instead focusing on ice-magic that is similarly effective underwater.  Like a wretchling, a Water Imp does not expect to live to see peacetime, and thus has no need to breathe above the surface.  Remember to pay tribute to the Water Imp whenever you can; since they do not fight alongside our land-based forces, it's all too easy to forget the selfless sacrifices they've made, and their enormous contributions in gathering intelligence and setting up remote bases.", "화염 임프의 변종인 이들은 비록 여전히 손을 사용하고 있지만, 훨씬 더 큰 희생을 치렀다. 이들은 공기로 호흡하는 능력을 희생했다.  에이알의 우점종들 대부분은 물 위에 살기 때문에, 바다나 호수는 놈들이 비밀리에 작전을 수행하기 안성맞춤인 장소이다. 놈들은 땅 위에서는 너무 위험한 실험들을 물 밑에서 진행하고, 전면적인 침공을 위한 차원문 연구도 수행하고 있는 것이다.  물 임프들은 그들의 형제들이 갖고 있는 화염 투사 능력을 포기했지만, 그 대신 물밑에서 보다 효과적인 얼음 마법에 집중하여 우리의 바다 밑 정찰대이자 하인의 역할을 하고 있다.  물 임프들은 렛츨링들과 마찬가지로 살아남아서 평화의 시대를 보겠다는 마음을 버렸으며, 그렇기 때문에 물밖에서 숨을 쉴 필요가 없다고 생각한 것이다.  항상 물 임프들에게 감사하고, 잊지 말라. 그들은 우리의 지상군과 함께 싸울 수 없기 때문에, 그들의 이타적인 희생을 잊기 쉽다. 정보 수집과 전초기지 건설에 막대한 기여를 하고 있는 그들을 잊지 말라.", "_t")
t("demon statue: quasit", "악마상: 콰짓", "_t")
t("Clever and tough, the engineers and warriors of our kind, making armor for our forces and holding the front lines against the hordes of Eyal.  While the children of ruby study new magical spells for our arsenal, and the children of emerald study ways to make our own bodies deadlier, the children of onyx focus on making new constructs from scratch, lashing flesh, magic, and steel together into towering creations that strike fear into Eyal.  Those who fight on the front lines have been created to do so rather than born, churned out in a semi-mature state by factories with Forge-Giant-produced armor bolted onto their skin at \"birth.\"  Though they are mostly flesh, the warrior onyx known as Quasits are very much machines, made with bolstered muscles without losing the clever minds they come from.  As eager as they are brilliant, Quasits are well-disciplined and capable in combat, and their armor allows them to easily take blows that would devastate a Wretchling or Fire Imp.  Devotion will get us far on its own, but the Quasit shows how much more we can do when we have fervor and patience working hand-in-hand.", "영리하고 강인하며, 기술자인 동시에 전사인 콰짓은 우리의 군대를 위한 갑주를 만들며 에이알 침공 군단의 최전선에 선다.  루비의 자손들이 새로운 마법 주문을 연구하여 우리의 군사력에 기여하고, 에메랄드의 자손들이 우리의 육체를 보다 치명적으로 만드는 법을 연구하는 동안, 오닉스의 자손들은 새로운 병기를 만들어내는 데에 집중하고 있다. 육체와 마법, 그리고 강철을 아울러 에이알을 공포에 빠뜨릴 거대한 생명체를 만들어내는 것이다.  최전선에서 싸우는 이들은 타고난 전사들이라 표현하기보다는 그러기 위해 창조되었다고 하는 것이 더 적절할 것이다. 그들은 공장에서 반쯤 성체인 채로 대량 생산되고, \"태어나자마자\" 대장간 거인이 만들어낸 갑옷을 피부 위에 씌우고 나사로 고정한다.  물론 그 육체는 대부분 살점으로 이루어져 있긴 하지만, 콰짓이라 불리는 오닉스의 전사는 실로 전투 기계라 할 수 있고, 강화된 육체를 갖고 있음에도 타고난 영리함을 잃지 않는다.  콰짓들은 그 열정만큼이나 두뇌도 명석하고, 전장에서는 뛰어난 전사이며, 갑옷 덕분에 렛츨링이나 화염 임프가 즉사할 수준의 공격도 쉽게 받아넘길 수 있다.  물론 우리 아버지에 대한 헌신만으로도 충분히 잘 해낼 수 있으나, 콰짓들은 우리가 열정과 인내심을 갖고 협동하면 훨씬 더 많은 일을 해낼 수 있다는 것을 보여준다.", "_t")
t("demon statue: onilug", "악마상: 오닐루그", "_t")
...
#{bold}#WE SEE YOU.#{normal}#]], [[#{italic}#이 명판은 대부분 물결치는 그림자에 덮여 있습니다.  전체의 일부분만 읽을 수 있습니다.#{normal}#

#927e64#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#LAST#헤레그만으로 재사용하는 것은 아니다. 우#927e64#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#LAST#놈들의 공포와 의심을 활용하#927e64#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#LAST#된다.  조심스러우면서도 가학적인 이런 암살자들은 #927e64#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#LAST#접 전투에서 놀라울 정도로 효과적이며, 매복을 준#927e64#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#LAST#정의를.  게다가, 그들이 만들어내는 그림자는 #927e64#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#LAST#첩 활동, 정찰, 그리고 #927e64#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#LAST#들을 가#927e64#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#LAST#우리의 정보 수집 기지에 #927e64#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#LAST#그들이 기여한 자료를 보완하#927e64#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#LAST#은 우리가 침공할 길을 마련할 것이다.

#{italic}#끝까지 읽자 글자들이 전부 검게 변했고, 새로운 문장이 나타났습니다.#{normal}#

#{bold}#네가 보인다.#{normal}#]], "_t")
t("demon statue: Ruin Banshee", "악마상: 파멸의 밴시", "_t")
t("The onslaught of the Sher'Tul portals never truly stopped.  Magic still pours from them, threatening to do even more damage to our home; it would be completely destroyed by now, if not for our Father.  Part of his work to keep Mal'Rok structurally intact is to blow great gusts across the devastated land, forcing the ravenous flames back into the portal network from whence they came.  It would seem, though, that the flames took souvenirs with them; our scouting parties have noted that Sher'Tul portals on Eyal, even those which have been completely deactivated, will occasionally emit a shade of one of our fallen citizens, imbued by some of Urh'Rok's power, smelling of Mal'Rok's ashes, and warped to insanity by its transit through the unstable rifts.  While this is a troubling revalation of the true horror of the Sher'Tul weapons, telling us that even now our fallen cannot rest in peace, the fact that they are arriving on Eyal in defiance of the shield is some consolation, as it means that those most wronged by the betrayal can claim their revenge personally.", "쉐르'툴 차원문의 맹공은 진정한 의미로는 결코 끝나지 않았다.  여전히 마법이 그것으로부터 쏟아지고 있고, 우리의 고향에 더욱 심각한 피해를 입히려 하고 있다. 우리 아버지께서 나서지 않으셨다면 우리의 고향은 진작에 완전히 파괴되었을 것이다.  말'록을 구조적으로 온전한 상태로 유지하는 그분의 작업 중에는 이 황폐화된 땅에 엄청난 바람을 일으켜, 이 땅의 맹렬한 불길을 그것들이 처음 나왔던 차원문 연결망으로 밀어넣는 것이 있다.  그런데 그 불길들은 모종의 기념품을 챙겨서 돌아가는 것 같다. 우리 정찰대의 보고로는 에이알의 쉐르'툴 차원문들은 완전히 비활성 상태임에도 불구하고 가끔씩 죽음을 맞이한 우리 동포의 유령을 뱉어낸다고 한다. 그 유령에는 울흐'록의 힘이 다소 깃들어 있고, 말'록의 잿더미의 냄새를 풍기며, 불안정한 균열을 통과한 탓에 이성을 잃은 상태라는 말도 덧붙였다.  이것은 쉐르'툴의 무기가 실로 무시무시하다는 것을 되새겨준다. 우리의 동포들은 죽어서도 안식을 취하지 못한다는 것이다. 하지만 그들이 보호막을 무시하고 에이알에 도착한다는 사실이 다소 위안이 되는데, 이는 배신자들 때문에 가장 큰 고통을 받은 이들이 손수 복수를 이룰 수 있다는 뜻이기 때문이다.", "_t")
t("demon statue: Draebor, the Imp", "악마상: 임프 드래보르", "_t")
t("Teleportation is one of the most crucial areas of magical research to our cause of revenge; until we break the Sher'Tul-made shield surrounding Eyal, it will remain our only means of reaching the surface.  One of our leading scholars, a child of onyx known as Draebor, has perfected short-range teleportation and has been studying methods to work his skills into a mass-producible artifact to grant this ability to all of our troops.  He's kept his work under wraps as of late, but rumor has it that he's been reverse-engineering the Sher'Tul portals, letting our invasion get through via their own weapons.  Whatever he's up to, keep an eye out - big things are just around the corner, courtesy of his dedicated research!", "순간이동 마법은 우리의 복수를 이루기 위해 가장 중요한 연구 분야 중 하나이다. 우리가 에이알을 둘러싸고 있는 쉐르'툴의 보호막을 깨뜨리기 전까지는, 그 지표로 내려갈 수 있는 유일한 방법이 바로 순간이동이기 때문이다.  이 분야의 권위자 중 드래보르라는 오닉스의 자손이 있는데, 그는 단거리 순간이동 기술을 완성했으며 이제 그 기술을 담은 유물을 대량생산하여 우리 병사들에게 지급할 방법을 연구하고 있다.  최근에는 연구를 비밀리에 수행하고 있지만, 소문에 따르면 그는 쉐르'툴의 차원문들을 역설계하고 있다고 한다. 놈들의 무기를 침공에 이용한다는 것이다.  뭐가 어떻게 되든 간에, 그를 주목하라. 그의 열정에 보답할 엄청난 성과가 곧 모습을 드러낼 것이다!", "_t")
t("demon statue: Shasshhiy'Kaish", "악마상: 샤쉬'카이쉬", "_t")
...
#{italic}#아래쪽에 짤막한 메시지가 새겨져 있습니다.#{normal}#

귀엽네.  이건 그대로 둬야겠어.  
-S.
]], "_t")
t("demon statue: Walrog", "악마상: 왈록", "_t")
...
-S.]], [[#{italic}#이 석상에 새겨져 있던 메시지는 모두 지워져 있고, 그 대신에 다른 메시지가 새겨져 있습니다.#{normal}#

왈록에게: 우리도 아직 살아 있어. 하지만 계속 힘내 줘.
-S.]], "_t")
t("demon statue: Kryl-Feijan", "악마상: 키릴-페이얀", "_t")
...
-S.]], [[#{italic}#이 석상에 새겨져 있던 글은 모두 지워졌습니다.  글이 새겨져 있던 부분에 어떤 쪽지가 하나 붙어 있습니다.#{normal}#
...
t([[#{italic}#The shifting runes on this singed paper swim before your eyes and strange visions come to you:#{normal}#
	...
	#{italic}#As nausea quickly overtakes you, the vision is gone, and the paper scrap hisses and crackles as it disappears in a puff of acrid mist. You shudder and move on.#{normal}#]], [[#{italic}#그슬린 종잇조각에 그려진 움직이는 룬들이 당신의 눈앞에서 빙빙 돈다. 이상한 광경이 눈앞에 나타난다.#{normal}#
	
		피부가 녹색인 조그만 악마가 좀 더 커다란 악마들을 이끌고 있다. 그들은 밝은 녹색의 액체가 넘실거리는 커다란 통을 옮기고 있다. 액체는 쉭쉭거리는 소리를 내고 있고 표면에서는 거품이 끓어 터지고 있다. 조그만 악마는 다소 신경질적으로 보이고 다른 악마들에게 좀 더 조심스럽게 옮기라고 재촉하고 있다. 장면이 바뀌고, 악마들이 어떤 커다란 돌판에 통을 옮기고 있는 게 보인다. 그들이 돌판에 가까워지자 훨씬 더 작은 어떤 형체가 돌판에 묶여 있는 게 보인다. 그 형체는 비명을 지르면서 자신을 묶고 있는 것을 풀어내려 안간힘을 쓰고 있다. 악마들은 돌판 앞까지 왔고, 그러자 조그만 악마가 미친 듯이 팔을 휘저어 그들의 주의를 끌려 한다. 너무 늦었다. 커다란 악마 중 하나가 발을 헛디뎠고 들고 있던 통이 기울어진다. 통의 내용물이 돌판에 완전히 쏟아진다. 곧바로 조그만 악마가 벌컥 화를 내지만, 당신은 한때 에이알인이었을 것이 분명한, 뼈와 붉은 진흙 같은 것이 뒤섞인 덩어리가 지글거리는 광경에서 눈을 뗄 수가 없다.
		피부가 녹색인 조그만 악마가 돌판에 묶인 어떤 하플링을 바라보고 있다. 작은 초록색 약병들이 그 조그만 형체를 둥글게 에워싸고 있다. 병들 하나하나에서는 밝은 색의 증기가 피어오르고 있고, 마치 하플링을 어루만지고 있는 것처럼 보인다. 악마는 종이 몇 장을 정리하고 있다. 장면이 흐릿해지더니 잠시 뒤 다시 선명해진다. 방금 본 것과 똑같은 일이 눈앞에서 반복되지만, 어째서인지 돌판에 묶인 희생자는 달라져 있다. 피부가 군데군데 이상한 색으로 물들어 있다. 악마가 두루마리를 휘갈기자 또다시 장면이 흐릿해지고 또다시 같은 일이 반복된다. 하지만 하플링은 이제 확실하게 원래 상태와는 달라져 있다. 두 손이 마음대로 구부리고 할퀼 수 있는 흉악한 발톱으로 변해 있다. 악마가 매우 만족스러운 얼굴로 두루마리에 무언가를 끄적인다. 눈앞이 다시 흐릿해지기 시작하자 당신은 또 똑같은 일이 반복될 거라 예상했지만, 다시 나타난 것은 하플링이 웬 우리에 갇혀서, 흉폭해 보이는 커다란 악마들에게 둘러싸인 장면이었다. 조그만 녹색 악마는 다른 악마들에게 뭐라고 끊임없이 주절거리며 손으로는 하플링을 가리킨다. 그러자 곧바로 커다란 악마들이 조그만 형제에게서 눈을 떼고 우리에 집중한다. 당신은 그 이유를 알 수 있다. 하플링의 모습이 이상할 정도로 희미하고, 거의 영체에 가까워 보인다. 그리고 하플링이 밝은 녹색의 증기 구름으로 변한다. 구름은 빠르게 우리 밖으로 빠져나가고, 악마들의 머리 너머로 날아간다. 조그만 악마는 믿기지가 않아서 입을 떡 벌린 채로 멍하니 쳐다보지만, 이내 매섭게 화를 내면서 고함을 쳐 댄다. 당신은 머리를 마구 흔들어 눈앞의 광경을 치우려 한다.
	
	#{italic}#다행히 장면은 사라졌고, 종잇조각은 쉭쉭 소리와 탁탁 소리만을 남기고 매캐한 연기로 변해 사라졌다. 당신은 몸서리치고는 다시 움직였다.#{normal}#]], "_t")
t([[#{italic}#The shifting runes on this singed paper swim before your eyes and strange visions comes to you:#{normal}#
	...
	#{italic}#You almost smile thinking of the tiny green demon stomping around like an angry child, but then the colossal form of its transformed subject returns to your mind. A heavy weight settles in the pit of your stomach. You shudder and move on.#{normal}#]], [[#{italic}#그슬린 종잇조각에 그려진 움직이는 룬들이 당신의 눈앞에서 빙빙 돈다. 이상한 광경이 눈앞에 나타난다.#{normal}#
	
		피부가 녹색인 조그만 악마가 친숙하게 느껴질 지경이 되었다. 똑같이 악마의 연구실이 보이지만 이번에 돌판에 묶인 실험체는 훨씬 더 크고 근육질인 초록 피부의 악마다. 그 주변에는 예의 녹색 액체가 담긴 커다란 통이 여러 개 놓여 있다. 조그만 악마는 통 사이를 빠르게 오가면서 주문을 점점 더 크게, 더 빠르게 왼다. 악마가 손짓하자 통에서 두꺼운 증기가 피어오르고 실험체의 머리 위에서 소용돌이친다. 악마의 손짓에 따라 증기는 까딱거리고 서로 엮이며, 그가 발톱을 더욱 넓게 휘젓자 이리저리 회전하고 올라갔다 내려갔다 하면서 더욱 복잡한 패턴들을 만들어낸다. 그리고 별안간 증기가 격렬한 빛을 내뿜으면서 커다란 악마의 위쪽에서 소용돌이친다. 그러더니 그대로 머리 쪽으로 내려와, 악마가 숨을 깊게 들이쉬는 순간 그 입속으로 빨려들어간다. 조그만 악마는 숨을 죽
	
	#{italic}#조그만 악마와 그 부하가 거대한 렛치가 땅에 곤두박질치기 전에 (또는 후에) 여기 도착했었는가는 알 수 없지만, 일단 지금은 그 둘의 흔적은 전혀 보이지 않는다. 동료 악마들이 조사하러 오기 전에 움직이는 게 최선일 것이다.#{normal}#]], "_t")
...
------------------------------------------------
section "tome-ashes-urhrok/data/quests/start-ashes.lua"
...
]], [[당신은 이곳, 세계들 사이의 공허에 위치한 불타는 대륙에서 살기 전의 삶에 대해서는 대부분 기억하지 못합니다. 당신은 악마들을 도왔고, 에이알을 향한 그들의 정당한 복수를 막고 있는 모종의 보호막 같은 것을 부수는 실험에 기쁘게 참여했습니다.
...
깨어나고 보니 당신이 있는 불타는 땅 조각은 대륙에서 분리되어 있었고, 당신의 옛 기억이 한꺼번에 밀려들어왔고 의식이 깨어났습니다 - 악마들이 당신의 고향을 파괴하려 합니다! 탈출해야 합니다... 하지만 놈들이 당신을 추적하는 데 쓰던 수정을 먼저 파괴해야 합니다.
]], "_t")
...
------------------------------------------------
section "tome-ashes-urhrok/data/talents/corruptions/black-magic.lua"
...
t("demon seeds", "악마의 씨앗", "talent type")
t("Demon seeds powers can not be learnt, they must be used from demon seeds attached to your equipment.", "악마의 씨앗의 힘은 배울 수 없고, 악마의 씨앗을 장비에 장착시켜 사용해야 합니다.", "_t")
t("demonic pact", "악마의 계약", "talent type")
t("Bind and use demons to do your bidding.", "악마를 속박하고, 명령에 따르게 합니다.", "_t")
t("infernal combat", "지옥의 전투", "talent type")
t("Imbue your melee attacks with lethal demonic powers.", "근접 공격에 치명적인 악마의 힘을 더합니다.", "_t")
t("doom shield", "파멸의 방패", "talent type")
t("Imbue yourself with the forces of Mal'Rok, the demon's homeworld, to protect and enhance.", "악마들의 모성인 말'록의 힘으로 자신에게 힘을 주입해 보호 효과를 받습니다.", "_t")
t("black-magic", "흑마법", "talent type")
t("That Old Black Magic.", "그 오래된 흑마법들...", "_t")
t("doom covenant", "파멸의 계약", "talent type")
t("Control darkness to crush your foes.", "어둠을 조종해 적들을 박살냅니다.", "_t")
t("spellblaze", "마법폭발", "talent type")
t("Use the very power of the Spellblaze to destroy your foes.", "마법폭발의 강력한 힘으로 적을 파괴합니다.", "_t")
t("brutality", "흉포", "talent type")
t("Devastating two-handed physical attacks fueled by demonic power.", "악마의 힘으로 가득 찬 양손 무기 물리 공격을 가합니다.", "_t")
t("torture", "고문", "talent type")
t("Cripple your enemies with vicious two-handed attacks.", "악랄한 양손 무기 공격으로 적들을 무력화합니다.", "_t")
t("wrath", "분노", "talent type")
t("Destroy your enemies with intense two-handed physical attacks fueled by demonic power.", "더욱 강력한 악마의 힘으로 가득 찬 양손 무기 물리 공격을 가합니다.", "_t")
t("Fearfire", "공포의 화염", "talent type")
t("Call upon the flames of the Fearscape, incinerating all.", "공포의 영역의 화염을 불러와 모든 이를 불사릅니다.", "_t")
t("Heart of Fire", "불의 심장", "talent type")
t("Fire is your lifeblood; it revitalizes you as it burns your foes.", "화염이 생명선이 됩니다. 적을 불태우면 활력을 얻게 됩니다.", "_t")
t("demonic strength", "악마의 힘", "talent type")
...
t([[You curse a target for 5 turns to sever its connection to Nature %s.
		...
		The damage increases with you Spellpower stat.]], [[대상을 5 턴 동안 저주하여 자연과의 연결을 끊어버립니다 %s.
		대상이 자연이나 초능력 기술을 사용하려고 할 때마다 %d%% 확률로 실패하고, 그 대신 화염구를 발동시켜 반경 1 칸 내에 %0.2f 화염 피해를 줍니다.
		피해량은 주문력에 비례하여 증가합니다.]], "tformat")
t("Acid Burst", "산성 폭발", "talent name")
t([[Whenever you block an attack with your shield, you release a cloud of acidic vapour, dealing %d damage in an area of radius 3 over %d turns.
		The damage will increase with your spellpower.]], [[방패로 공격을 막아내면 산성 증기를 뿜어내 반경 3 칸에 %d 피해를 %d 턴에 걸쳐 가합니다.
		피해량은 주문력에 비례합니다.]], "tformat")
t("Corrosive Cone", "부식성 원뿔", "talent name")
t([[When you deal a critical strike in melee, you send out a cone of acid, dealing %d damage to all enemies and melting walls you hit.
		The damage will increase with your Spellpower.]], [[근접 공격으로 치명타를 가하면 부식성 물질을 뿜어내어 범위 내에 %d 피해를 주고, 벽을 녹여버립니다.
		피해량은 주문력에 비례하여 증가합니다.]], "tformat")
...
t([[Fire a blast of frostfire in radius %d, doing %0.2f fire damage and freezing creatures in ice blocks for 4 turns %s.
		...
		The damage will increase with your Spellpower.]], [[반경 %d 칸 내에 서리 화염을 폭발시켜 %0.2f 화염 피해를 주고, 적을 4 턴 동안 얼립니다 %s.
		빙결된 적 하나마다 시전자는 원기를 %d 회복합니다.
		피해량은 주문력에 비례하여 증가합니다.]], "tformat")
...
t([[For every turn where you take damage you have a %d%% chance to store a seismic charge.
		...
		이 주문을 활성화하여 중첩 당 2 턴 동안 유지되는 분출하는 화산을 일으켜 세울 수 있습니다. 기술 시전 시 중첩을 소모합니다.
...
t("13%% chance to trigger a Blood Spray cast of level %d", "13%% 확률로 %d 레벨 혈액 흩뿌리기 기술을 발동합니다", "tformat")
...
t("#CRIMSON#You extract a %s and add it to your inventory.", "#CRIMSON#당신은 %s 추출해, 가방에 넣었다.", "logPlayer", nil, {"를"})
...
t([[Strike a blow with your weapon for %d%% blight damage.
		...
		명중 시 악마의 씨앗이 적에게 심어지고 %s, 이어서 %d%% 피해의 방패 공격을 가해 대상을 %d 턴 동안 혼절시킵니다 %s.
...
t([[Your knowledge of demonic forces grows, allowing you to bind more seeds to you and to summon demons.
		...
		기술 점수 2 점: 반지에 맞는 씨앗을 얻을 수 있게 됩니다.
		기술 점수 3 점: 방패에 맞는 씨앗을 얻을 수 있게 됩니다.
		기술 점수 4 점: 두 번째 반지에도 씨앗을 결합할 수 있게 됩니다.
		기술 점수 5 점: 가슴 방어구에 맞는 씨앗을 얻을 수 있게 됩니다.
		]], "tformat")
...
t([[Your melee attacks cripple your targets when they critically strike, lowering their movement speed by %d%% and their accuracy by %d for %d turns %s.
		Additionally, you gain %d%% chance to critically strike with your melee attacks.]], [[근접 치명타를 가하면 공격받은 적들은 무력화되어, %d 턴 동안 이동 속도가 %d%% 감소하고 정확도가 %d 감소합니다 %s.
		추가로, 시전자의 근접 공격의 치명타 확률이 %d%% 증가합니다.]], "tformat", {3,1,2,4,5})
t("Surge of Power", "힘의 쇄도", "talent name")
...
t("You require a weapon and a shield to use this talent.", "방패와 근접 무기를 장비하지 않으면 이 기술을 사용할 수 없다.", "logPlayer")
t("#SLATE#(%d turned into osmosis)#LAST#", "#SLATE#(%d 삼투 방패)#LAST#", "tformat")
t([[You infuse your shield with the energies of Urh'Rok, bringing about a magical shield that heals you for the first points of all damage you receive (based on your shield's block value) over 3 turns. This effect stacks.
		...
		피해량은 주문력에 비례하여 증가합니다.]], "tformat")
t("Hardened Core", "경화된 핵", "talent name")
t([[Taking example from Mal'Rok, the demon's homeworld you harden yourself.
		Increases total armour by %d%% + 10 and spellpower by %d.]], [[악마들의 모성인 말'록의 과거를 바탕으로 스스로를 경화합니다.
...
t("Burning Sacrifice", "불타는 제물", "talent name")
...
t([[Using demonic forces you create a link of pain from a source creature to a victim for %d turns.
		...
		숙주가 피해를 받으면 희생양도 해당 피해의 %d%% 를 받게 됩니다.
...
t("#PURPLE#As %s falls down you see %s reach to it, devour its essence and raise it back as a demonic husk.", "#PURPLE#%s 쓰러지자 %s에게 접근하여, 정수를 먹어치우고 악마의 하수인으로 되살렸다.", "logSeen", nil, {"가"})
...
t([[You unleash the fury of the Spellblaze, constantly draining your vim.
		...
		This spell disabled automatically on rest or run.
		The effects increase with spellpower.]], [[마법폭발의 분노를 해방합니다. 활성화 중에는 지속적으로 원기를 소모합니다.
		이 주문이 활성화되면 매 턴 2 개의 운석이 시전자 근처로 떨어져, 반경 2 칸 범위에 %0.2f 물리 피해와 %0.2f 화염 피해를 가합니다.
		이 주문은 휴식 중이거나 탐험 중일 때 자동으로 비활성화됩니다.
		이 효과는 주문력에 비례하여 증가합니다.]], "tformat")
...
t([[When you block an attack the shock ripples through your attacker, spreading the force of the Spellblaze in its mind for 5 turns %s.
		While affected the creature will suffer %d%% chances to fail using talents and %d reduced physical, mental and spell saves.]], [[공격을 막으면 그 충격이 공격자를 파고들어, 5 턴 동안 마법폭발의 힘이 공격자의 정신에 침투합니다 %s.
		지속시간 동안 대상은 %d%% 확률로 주문 시전에 실패하고, 물리/마법/정신 내성이 %d 감소합니다.]], "tformat")
...
t([[You chant the destruction of Mal'Rok, the demon's homeworld.
		...
		Damage increases with your spellpower.]], [[악마들의 모성인 말'록의 파괴를 노래합니다.
		적을 쓰러뜨릴 때마다 반경 %d 칸에 마법의 파문을 발산하여 %d 턴 동안 지속되는 실명의 파멸이나 혼란의 파멸을 겁니다 %s.
		파멸한 적은 매 턴마다 %0.2f 어둠 피해를 받습니다.
		피해량은 주문력에 비례하여 증가합니다.]], "tformat")
...
t([[The power of the Fearscape infuses your weapon: Your melee attacks will deal %0.2f fire damage, spread over 3 turns.
		...
		피해량은 주문력에 비례하여 증가합니다.]], "tformat", {1,2,4,5,3,6,7,8})
t("Abduction", "납치", "talent name")
t("You require a two handed weapon to use this talent.", "이 기술을 사용하려면 양손 무기를 장비해야 한다.", "logPlayer")
t("Hits the target doing %d%% weapon damage. If the attack hits, you pull the target in %s and strike them again, dealing another %d%% weapon damage.", "대상을 공격해 %d%% 무기 피해를 가합니다. 명중 시, 대상을 끌고 와 %s 한 번 더 공격하여 %d%% 무기 피해를 추가로 가합니다.", "tformat")
...
t("You must have an empty space to teleport to.", "순간이동을 하기 위해선 비어있는 위치를 대상으로 해야 한다.", "logPlayer")
t([[Hasten yourself out of phase, teleporting you to a specific location up to %d spaces away.
		...
		The bonus will increase with your Willpower.]], [[재빠르게 위상에서 이탈해 최대 %d 칸 내의 특정 지점으로 순간이동합니다.
		이 기술은 한 턴에 최대 두 번 사용할 수 있지만 두 번째 사용은 턴을 소모합니다.
...
t([[The tortures you had to endure on the Fearscape have increased your resilience.
		All detrimental status effects last %d%% less on you and all direct critical hits (physical, mental, spells) against you have a %d%% lower critical multiplier (but always do at least normal damage).]], [[공포의 영역에서 겪은 갖은 고문들은 신체와 정신을 더욱 강하게 단련시켜 주었습니다.
		모든 부정적인 효과의 지속시간이 %d%% 단축되고, 시전자가 받는 물리, 정신, 주문 치명타의 피해량이 %d%% 감소합니다 (기본 피해량 이하로 피해를 줄일 수는 없습니다)]], "tformat")
...
t([[Your original invisibility talent was corrupted and twisted.
		...
		- 영구적인 은신. (은신력 %d)
		- 어둠 피해량이 %d%% 증가합니다.
		- 피해량 %d 이상의 비정신적, 비물리적 피해를 가하면 반경 1 칸의 폭발을 일으켜, 폭발에 휩쓸린 적에게 절반의 피해를 줍니다. (이 효과는 한 턴에 한 번만 발동됩니다)
...
t("demonic", "악마의", "effect subtype")
t("Demon Blade", "악마의 칼날", "_t")
t("Each melee hit generates a radius 1 ball of fire dealing %0.2f damage.", "근접 공격이 반경 1 칸의 화염구를 생성해 %0.2f 피해를 가합니다.", "tformat")
t("#Target# imbues its weapon with demonic fire.", "#Target2# 무기에 악마 화염을 불어넣었다.", "_t")
t("+Demon Blade", "+악마의 칼날", "_t")
t("#Target#'s weapon looks less threatening.", "#Target#의 무기의 화염이 사라졌다.", "_t")
t("-Demon Blade", "-악마의 칼날", "_t")
t("curse", "저주", "effect subtype")
t("Fiery Torment", "불타는 고문", "_t")
t("The target's fire resistance is reduced by %d%%, and the target is highly vulnerable to the flames of the fearscape. When the effect ends, the target will take %d fire damage. This damage will increase by %d%% of all damage taken while under torment", "화염 저항 -%d%% / 공포의 영역의 화염에 매우 취약해짐 / 이 효과가 끝나면, %d 화염 피해를 받음 / 이 피해는 고문 동안 받은 모든 피해의 %d%% 만큼 증가", "tformat")
t("#Target# is surrounded by a vile flame!", "#Target2# 타락한 화염에 둘러싸였다!", "_t")
t("+Fiery Torment", "+불타는 고문", "_t")
t("The black flame around #Target# dies down", "#Target3# 둘러싸던 검은 화염이 가라앉았다.", "_t")
t("-Fiery Torment", "-불타는 고문", "_t")
...
t("Next %d melee attacks are certain to critically strike, and this unit has %d%% more critical power.", "다음 %d 번의 근접 공격은 반드시 치명타 / 치명타 피해량 +%d%%.", "tformat")
t("#Target#'s weapon glows with critical power!", "#Target#의 무기가 치명적인 힘으로 빛난다!", "_t")
...
t("-Unable to act", "-행동 불가", "_t")
t("Suffered", "고통받음", "_t")
t("The target has recently suffered, and cannot do so again yet.", "최근에 고통받음 / 지속시간 동안 고통받지 않음.", "_t")
...
t("This unit will not die until it has less than -%d HP.", "생명력이 -%d 에 도달할 때까지 죽지 않음.", "tformat")
...
t("+Armoured Leviathan", "+중무장한 괴수", "_t")
t("#Target# is no longer filled with power.", "가득 찼던 #Target#의 힘이 빠져나간다.", "_t")
t("-Armoured Leviathan", "-중무장한 괴수", "_t")
...
t("Demonic Cut", "악마의 상처", "_t")
t("Huge demonic that bleeds, doing %0.2f darkness damage per turn. Anytime you hit it you get healed for %d.", "거대한 악마의 출혈상: 매 턴 %0.2f 어둠 피해 받음 / 이 대상을 공격하는 공격자는 생명력이 %d 회복됨.", "tformat")
...
t("#Target# is linked through pain.", "#Target2# 고통으로 연결되었다.", "_t")
t("+Link of Pain", "+고통의 연결", "_t")
t("#Target# link of pain disappears.", "#Target#의 고통의 연결이 사라졌다.", "_t")
t("-Link of Pain", "-고통의 연결", "_t")
...
t("The target has %d%% chances to fail any talents use and suffers %d reduced physical, mental and spell saves.", "%d%% 확률로 기술 사용 실패 / 물리, 정신, 주문 내성 -%d.", "tformat")
t("The Spellblaze ripples through #target#!", "마법폭발의 힘이 #target3# 덮친다!", "_t")
t("+Shattered Mind", "+파괴된 정신", "_t")
t("#Target# is no longer influenced by the Spellblaze.", "#Target2# 마법폭발의 영향력에서 벗어났다.", "_t")
t("-Shattered Mind", "-파괴된 정신", "_t")
t("Dark Reign", "어둠의 지배", "_t")
t([[All damage affinity increased by %d%%.
Will not die until %d life]], [[모든 속성 친화 +%d%%
생명력이 %d 에 도달할 때까지 죽지 않음]], "tformat")
t("+Dark Reign", "+어둠의 지배", "_t")
t("-Dark Reign", "-어둠의 지배", "_t")
...
t("none", "없음", "_t")
t("Grim Future", "암울한 미래", "_t")
t("Spellpower increased by %d.", "주문력 +%d.", "tformat")
t("death", "죽음", "effect subtype")
t("Blood Drinker", "피를 마시는 자", "_t")
t("Triggers Blood Drinker if this creature dies.", "죽을 시, 피를 마시는 자가 발동됨.", "_t")
t("%d vim regen and %d%% evasion chance.", "매 턴 원기 %d 재생 / 피격 시 %d%% 확률로 피해 무효화.", "tformat")
t("#Target# is drunk with blood!", "#Target2# 피를 마셨다!", "_t")
t("The bloodlust of #target# subsides.", "#target#의 피를 향한 갈증이 가라앉았다.", "_t")
t("affinity", "친화", "effect subtype")
...
t("The target assumes the form of a dúathedlen.", "듀아세들렌의 형상을 취함.", "tformat")
t("#Target# turns into a dúathedlen!", "#Target2# 듀아세들렌으로 변신했다!", "_t")
t("+Corruption of the Doomed", "+몰락한 자의 타락", "_t")
t("-Corruption of the Doomed", "-몰락한 자의 타락", "_t")
...
특징:
* 새로운 직업, 파멸의 사도로 시작하세요!  이들은 악마와 같은 파괴의 화신으로 거대한 양손 무기를 들고 전장으로 뛰어들어, 적들을 베어버리고 불타는 상흔을 남깁니다.  화염의 마법과 악마의 힘으로 무장한 파멸의 사도들은 압도적인 전력차에 맞서 싸우는 걸 즐기며, 적들을 화염의 파도로 휘어잡고 주변의 고통과 불길을 양식으로 삼아, 상대가 누구든간에 순식간에 피로 물든 잿더미로 만들어 버립니다.
