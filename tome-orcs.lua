...
t("Their most important stats are: Magic and Constitution", "그들에게 가장 중요한 능력치는 마법과 체격입니다.", "_t")
...
t("A formidable behemoth of war using steamsaws to improve his deadliness.", "가공할 전쟁의 거수로, 증기톱을 사용해 적들을 베어넘깁니다.", "_t")
...
t("Their most important stats are: Cunning and Dexterity", "그들에게 가장 중요한 능력치는 민첩과 교활입니다.", "_t")
...
t("Their most important stats are: Cunning, Willpower and Dexterity", "그들에게 가장 중요한 능력치는 교활, 의지, 그리고 민첩입니다.", "_t")
...
t("They now seek to help their orc allies, in hope they will help them back.", "이제 화이트후프는 동맹인 오크들을 도울 방법을 찾고 있습니다. 오크들이 보답하리라고 확신한 채로.", "_t")
...
t("A few orcs of the Kruk pride have mastered techno-psionics, allowing them to literally hijack a yeti's mind and transfer their own mind inside.", "크룩 긍지의 몇몇 오크들은 염동공학을 익혀, 문자 그대로 예티의 정신을 납치하고 그들의 정신을 그 안에 불어넣는 데 성공했습니다.", "_t")
...
t("Orcs in all Var'Eyal are in dismay, hunted by the Sunwall and their newfound allies from the west.", "바르'에이알의 오크들은 모두 경악에 빠진 채로, 태양의 장벽과 그들의 서쪽에서 온 새로운 동료들에게 사냥당했습니다.", "_t")
...
t("Yet not all is great there either, the Sunwall offensive has set up an outpost blocking the way to the mainland.", "그렇다고 상황이 그렇게 희망적인 것은 아닙니다. 태양의 장벽이 공세를 펼쳤을 때, 그들은 전초기지를 세워 본토로 향하는 길을 막아버렸습니다.", "_t")
...
t("Play an orc, prove your worth! Use steamtech against the giants, reclaim the far east and free it from Sunwall scum!", "오크로 게임을 진행하여, 스스로의 가치를 증명하세요! 증기 공학 기술을 사용하여 거인들에게 맞서고, 동쪽의 대륙을 태양의 장벽 쓰레기들에게서 해방시키세요!", "_t")
