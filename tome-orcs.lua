...
이 기술에 기술 점수를 1 점 투자하면, 근처의 무작위한 적에게 %d%% 총기 피해를 가하는 총기 포탑을 설치할 수 있게 됩니다. 총기 포탑의 사격은 아군에게 영향을 주지 않습니다.
이 기술에 기술 점수를 3 점 투자하면, 반경 3 칸의 원뿔 범위에 화염 피해를 주는 화염 포탑을 설치할 수 있게 됩니다. 화염 포탑은 추가 방어력 %d 과 모든 피해 저항 30%% 를 갖습니다.
이 기술에 기술 점수를 4 점 투자하면, 아군에게 회복 안개를 내뿜어 생명력을 %d 회복시키고, 새로 적용된 부정적인 효과의 지속시간을 %d%% 줄여주는 의료 포탑을 설치할 수 있게 됩니다.
