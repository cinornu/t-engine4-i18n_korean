...
t("We weren't kidding!", "농담 아니야!", "achievement name")
...
t("Radiant Horrorc", "눈부신 공포오-크", "achievement name")
...
t("Once Upon A Time, In the West...", "옛날 옛적에, 서쪽에서...", "achievement name")
...
t("Empyreal", "엠피리알", "birth descriptor name")
t("Their most important stats are: Magic and Constitution", "가장 중요한 능력치는 마법과 체격입니다.", "_t")
t("#GOLD#Stat modifiers:", "#GOLD#능력치 변경:", "_t")
t("#LIGHT_BLUE# * +0 Strength, +0 Dexterity, +3 Constitution", "#LIGHT_BLUE# * +0 힘, +0 민첩, +3 체격", "_t")
t("#LIGHT_BLUE# * +6 Magic, +0 Willpower, +0 Cunning", "#LIGHT_BLUE# * +6 마법, +0 의지, +0 교활", "_t")
t("#GOLD#Life per level:#LIGHT_BLUE# +0", "#GOLD#레벨 당 생명력:#LIGHT_BLUE# +0", "_t")

------------------------------------------------
section "tome-orcs/data/birth/classes/tinker.lua"

t("Tinker", "발명가", "birth descriptor name")
t("Tinkers use steamtech to power their attacks, defenses, ...", "발명가들은 증기 공학을 통해 그들의 공격과 방어 수단에 동력을 공급합니다.", "_t")
t("Build, experiment, discover. The path of inventions is never over!", "만들고, 실험하고, 발견한다. 발명의 길은 결코 끝나지 않는다!", "_t")
t("%s healing salve", "%s 회복 연고", "tformat")
t("simple", "단순한", "_t")
t("%s frost salve", "%s 서리 연고", "tformat")
t("Sawbutcher", "톱 도살자", "birth descriptor name")
t("A formidable behemoth of war using steamsaws to improve his deadliness.", "가공할 전쟁의 거수로, 증기톱을 들고 적들을 베어넘깁니다.", "_t")
t("Their most important stats are: Strength and Cunning", "가장 중요한 능력치는 힘과 교활입니다.", "_t")
t("#GOLD#Stat modifiers:", "#GOLD#능력치 변경:", "_t")
...
t("A tinker who dual-wields steamguns to great effect.", "총기를 두 자루 사용하여 강력한 힘을 발휘하는 발명가입니다.", "_t")
t("Their most important stats are: Cunning and Dexterity", "가장 중요한 능력치는 민첩과 교활입니다.", "_t")
...
t("The Psyshot combines this ability to gestalt to enhance his mindstar all the while shooting her steamgun to devastate the enemy lines.", "염동사수는 게슈탈트를 통해 장착한 마석을 강화시키고, 총을 쏘아 적들의 전선을 무너뜨립니다.", "_t")
t("Their most important stats are: Cunning, Willpower and Dexterity", "가장 중요한 능력치는 교활, 의지, 민첩입니다.", "_t")
...
t("While normally wielding a steamgun loaded with experimental ammunition and an electrically charged shield, they can equip heavy weapons such as flamethrowers.", "실험적인 탄환을 장전한 일반 총기와 전류로 충전된 방패, 그리고 화염방사기와 같은 중화기를 사용할 수 있습니다.", "_t")
t("More adept at technology than most other tinkers, they supplement their weapons with automated turrets, mechanical minions and other such devices.", "다른 발명가 직업들보다 첨단 기술에 더 능숙한 이들은 무시무시한 무기와 함께 자동 포탑과 기계 하수인, 그 밖의 여러 장치들을 사용합니다.", "_t")
...
t("But one year ago the Scourge from the West came and wiped four of the five Prides. And a hundred years ago King Toknor wiped all traces of orcs from Maj'Eyal.", "하지만 일 년 전에 서쪽에서 온 재앙이 다섯 긍지 중 네 곳을 쓸어버렸습니다. 그리고 백여 년 전에, 토크놀 왕이 마즈'에이알에서 모든 오크들을 쓸어버렸고요.", "_t")
t("The orc race is dangerously on the brink of destruction. One wrong move is all that is needed.", "오크 종족은 현재 몰락 직전의 상태입니다. 한 번의 실수로 멸망의 구렁텅이에 빠지게 됩니다.", "_t")
t("But they are strong and will face whatever is needed to ensure a future of their own!", "하지만 오크들은 강인하고, 스스로의 미래를 위해 필요한 것이라면 그게 어떤 것이든지 마주할 준비가 되어 있습니다!", "_t")
...
t("Monocle Left 2", "단안경 왼쪽 2", "_t")
t("Monocle Right 1", "단안경 오른쪽 1", "_t")
t("Monocle Right 2", "단안경 오른쪽 2", "_t")
t("Tatoos 1", "문신 1", "_t")
t("Tatoos 2", "문신 2", "_t")
t("Tatoos 3", "문신 3", "_t")
...
t("Special", "특별", "birth facial category")
t("Undead", "언데드", "_t")
t("Grave strength, dread will, this flesh cannot stay still. Kings die, masters fall, we will outlast them all.", "막대한 힘, 무시무시한 의지, 이 육체는 멈추지 않는다. 왕은 죽고, 주인들은 스러지지만, 우리는 그들 모두보다 더 오랫동안 존재하리라.", "_t")
...
t("A clan of minotaurs turned to necromancy when faced with imminent destruction.", "한 미노타우르스 부족이 임박한 파멸을 마주하게 되자, 강령술로 돌아섰습니다.", "_t")
t("Whitehooves are resilient and magic imbued undead, hardened by their trials and made stronger by their undeath.", "화이트후프는 강인하고, 마법의 힘이 깃든 언데드입니다. 시련에 의해 단련되고, 불사로 인해 더욱 강해졌습니다.", "_t")
t("They now seek to help their orc allies, in hope they will help them back.", "이제 화이트후프는 동맹인 오크들을 도울 방법을 찾고 있습니다. 오크들이 보답하리라고 확신하면서요.", "_t")
...
t("Infuse the mind, sacrifice the body but the Pride remains.", "정신을 주입하고, 육체를 희생하지만 긍지는 남으리라.", "_t")
t("Yetis are a towering mass of muscle.", "예티들은 거대한 근육질 생명체입니다.", "_t")
t("Skin Color 1", "피부 색 1", "_t")
t("Skin Color 2", "피부 색 2", "_t")
t("Skin Color 3", "피부 색 3", "_t")
t("Skin Color 4", "피부 색 4", "_t")
...
t("Yetis are a towering mass of muscle. While normal yetis are non-sentient beasts this kind is special.", "예티들은 거대한 근육질 생명체입니다. 일반적인 예티는 지성이 없는 짐승인 반면, 크룩 예티들은 특별합니다.", "_t")
t("A few orcs of the Kruk pride have mastered techno-psionics, allowing them to literally hijack a yeti's mind and transfer their own mind inside.", "크룩 긍지의 몇몇 오크들은 염동공학을 익혀, 문자 그대로 예티의 정신을 납치하고 자신들의 정신을 그 안에 불어넣는 데 성공했습니다.", "_t")
t("Doing so drains their old knowledge and they need to start afresh, gaining considerable strength in the process; for the good of the Prides.", "정신을 옮기면 쌓아 두었던 모든 지식이 일순간에 사라져, 처음부터 다시 시작해야만 했습니다. 하지만 어쨌든 꽤 강력한 근력을 얻게 되었습니다. 긍지를 위해서라면 이 정도는 아무것도 아니죠.", "_t")
...
t("The Prides lie in ruins!", "긍지들은 폐허가 되었습니다!", "_t")
t("The Sorcerers have been defeated!", "최고봉의 주술사들은 패배했습니다!", "_t")
t("Orcs in all Var'Eyal are in dismay, hunted by the Sunwall and their newfound allies from the west.", "바르'에이알의 오크들은 모두 경악에 빠진 채로, 태양의 장벽과 서쪽에서 온 놈들의 새로운 동료들에게 사냥당했습니다.", "_t")
t("The Scourge from the West is back in the west, but her legacy stays strong: the orc race is once again upon the brink of destruction!", "서쪽에서 온 재앙은 서쪽으로 돌아갔지만, 그 유산은 아직 굳건합니다. 오크 종족은 다시 한 번 파멸의 위기에 처하게 되었습니다!", "_t")
t("But not all hope is lost.", "하지만 희망이 없는 것은 아닙니다.", "_t")
t("On the isolated Clork Peninsula lies the fifth pride: Kruk's Pride; unseen and unharmed by the Scourge.", "고립되어 있던 클로크 반도에는 다섯 번째 긍지가 있었습니다. 바로 크룩 긍지죠. 재앙이 찾아내지 못했고, 그 손에 피해를 받지 않은 유일한 긍지입니다.", "_t")
t("Yet not all is great there either, the Sunwall offensive has set up an outpost blocking the way to the mainland.", "그렇다고 상황이 그렇게 희망적인 것은 아닙니다. 태양의 장벽이 공세를 펼쳤을 때, 놈들은 전초기지를 세워 본토로 향하는 길을 막아버렸습니다.", "_t")
t("But the worst threat comes from the peninsula itself, the main inhabitants are not the orcs, but the Atmos Tribe.", "하지만 최악의 위협은 반도 안에 존재합니다. 클로크 반도의 주요 거주민들은 오크가 아닌 아트모스 부족입니다.", "_t")
t("A civilization of steam giants whose mastery of steamtech makes them incredible foes.", "증기 공학에 통달한 증기 거인들의 문명은 그들을 극히 위험한 적으로 만들었습니다.", "_t")
t("Play an orc, prove your worth! Use steamtech against the giants, reclaim the far east and free it from Sunwall scum!", "오크로 게임을 진행하여, 자신의 가치를 증명하세요! 증기 공학 기술을 사용하여 거인들에게 맞서고, 동쪽의 대륙을 태양의 장벽 쓰레기들에게서 해방시키세요!", "_t")
t("Craft your own steamsaws, rocket boots, steam powered armours, and all kind of steamy technology!", "증기톱, 로켓 장화, 증기력 갑옷, 그 외 다양한 증기 공학 발명품들을 만들어내세요!", "_t")
t("This is your destiny! For Garkul's Legacy, for the Glory of the Pride!", "이것이 당신의 운명입니다! 가르쿨의 유산을 위하여, 긍지의 영광을 위하여!", "_t")
...
t("REGRET!", "후회!!", "_t")
t("My love...", "내 사랑...", "_t")
t("I feel so lost.", "공허하구나.", "_t")
t("Please let me die!", "죽게 해 줘!", "_t")
t("RAAAAARGGGG!", "으랴아아아아!!", "_t")
t("Someday you will pay!", "대가를 치르게 될 거다!", "_t")
t("DEATH!", "죽어라!!", "_t")
t("*Sobs*", "*훌쩍*", "_t")
...
t("Whatever.", "덤벼라.", "chat_john-worldmap")
t("What?", "뭐라고?", "_t")
...
------------------------------------------------
section "tome-orcs/data/chats/kruk-tinker-shop.lua"
...
t("Sorry, I have to go!", "미안, 가 봐야겠어!", "chat_kruk-tinker-shop")
...
t("incendiary grenade", "소이 수류탄", "damage type")
...
------------------------------------------------
section "tome-orcs/data/general/events/drills.lua"
...
------------------------------------------------
section "tome-orcs/data/general/events/herbs.lua"
...
------------------------------------------------
section "tome-orcs/data/general/grids/manacave.lua"
...
------------------------------------------------
section "tome-orcs/data/general/grids/mechstone.lua"
...
------------------------------------------------
section "tome-orcs/data/general/npcs/alligator.lua"
...
------------------------------------------------
section "tome-orcs/data/general/npcs/horror.lua"

t("saw horror", "톱날의 공포", "entity name")
t("Oh. Oh no. Where did it get those?", "오, 오 안 돼. 저런 것들은 또 어디서 났답니까?", "_t")

------------------------------------------------
section "tome-orcs/data/general/npcs/plant-add.lua"

t("Sawtree", "톱나무", "entity name")
t([[#{italic}##ANTIQUE_WHITE#Is that... a tree that cuts down trees?
Oh no don't worry. Only adventurers!#LAST##{normal}#]], [[#{italic}##ANTIQUE_WHITE#저거... 나무를 베어내는 나무인가요?
오 안 돼, 모험가들만 베네요! 거 참 다행이다!#LAST##{normal}#]], "_t")
...
------------------------------------------------
section "tome-orcs/data/general/npcs/steam-giant-gunner.lua"
...
------------------------------------------------
section "tome-orcs/data/general/npcs/steam-giant-warrior.lua"
...
------------------------------------------------
section "tome-orcs/data/general/npcs/steam-spiders.lua"
...
------------------------------------------------
section "tome-orcs/data/general/npcs/titan.lua"
...
t("This troll is holding a tall staff in one hand. Tendrils of water circle around it.", "한 손에 기다란 지팡이를 들고 있는 트롤입니다. 여러 개의 물줄기가 주변을 돌고 있습니다.", "_t")
...
------------------------------------------------
section "tome-orcs/data/general/npcs/yeti.lua"
...
t("draining", "생명 흡수", "entity keyword")
...
t("potion", "물약", "entity type")
t("potion", "물약", "entity subtype")
t("Blood of Undeath", "불사의 피", "entity name")
...
t("quaff the Blood of Undeath to prepare your body for undeath", "불사의 피를 마셔, 육체를 불사에 준비시킵니다", "_t")
...
t("implant", "이식물", "entity subtype")
t("implant", "이식물", "_t")
t("Steamtech implants can be grafted on the users skin..", "증기 공학 이식물은 피부에 이식할 수 있습니다..", "_t")
...
t("A hat made of leather. Very stylish.", "가죽으로 만든 모자입니다. 아주 멋집니다.", "_t")
...
t("scroll", "두루마리", "entity type")
t("schematic", "설계도", "entity subtype")
t("schematic", "설계도", "_t")
...
t("learn how to build this tinker", "이 발명품을 만드는 법을 배웁니다", "_t")
...
t("A stylish kruk-style cloak, to look awesome.", "유행하는 크룩 양식의 망토입니다. 끝내주네요.", "_t")
...
t("teleport.", "순간이동", "_t")
t("The teleporter's delicate systems are perturbed by foes on this level. You must have no foes left to be able to use it.", "순간이동 장치의 약한 신호가 현재 구역의 적들에 의해 방해되었다. 순간이동 장치를 사용하기 위해서는 남은 적이 없어야 한다.", "logPlayer")

------------------------------------------------
section "tome-orcs/data/general/objects/steamgun.lua"

t("weapon", "무기", "entity type")
t("steamgun", "총기", "entity subtype")
...
t("On falling below 20% of your max life, releases a cloud of smoke, confusing nearby enemies and giving you stealth and a chance to avoid incoming damage for 5 turns.", "생명력이 최대 생명력의 20% 이하로 떨어지면 5 턴 동안 연막을 풀어 근처의 적을 혼란시키고, 착용자는 은신하며 일정 확률로 받는 피해를 무효화합니다.", "_t")
...
t("Allows the use of Technomancy spells.", "마도공학 주문을 사용할 수 있게 됩니다.", "_t")
t("HANDS", "장갑", "entity on slot")
t("%s shocking touch", "%s 충격의 손길", "tformat")
t("BELT", "허리띠", "entity on slot")
t("%s deflection field", "%s 편향막", "tformat")
t("%s galvanic retributor", "%s 전열 보복기", "tformat")
t("Unleash a lightning nova of radius equal to the tinker tier.", "발명품 등급과 같은 범위의 정전기 폭발을 해방합니다.", "_t")
...
t("\"Great for combat, cooking, and shaving! We accept no responsibility for ruined follicles.\"", "\"전투, 요리, 그리고 면도에 아주 좋아요! 저희는 파괴된 모낭에 대한 책임은 지지 않습니다.\"", "_t")
...
t("steamgun", "총기", "entity combat talented")
t("absurdly large gun", "말도 안 되게 거대한 총기", "_t")
t("\"I never really liked that village anyway.\" - Charlta, Mad Inventor", "\"난 항상 저 마을이 맘에 안 들었어.\" - 미친 발명가 샤를타", "_t")
t("Boom.", "쾅.", "_t")
...
t("Hands of Creation", "창조의 손", "entity name")
t("plated gauntlets", "철판이 덧대어진 전투장갑", "_t")
t("From your hands have been wrought incredible works. Your works have been forged in fire, and so have you.", "당신의 손에서 믿을 수 없는 걸작들이 탄생합니다. 당신의 작품들은 화염으로 단련되었고, 그건 당신도 마찬가지지요.", "_t")
t("On landing any melee attack, release a fiery shockwave, dealing fire and physical damage each equal to your steampower in a cone from the target of radius 3.", "근접 공격 시, 불타는 충격파를 내보내 반경 3 칸의 원뿔 범위 안의 모든 적에게 증기력과 같은 수치의 화염과 물리 피해를 가합니다.", "_t")
...
t("remove %d mental effects and grants a water aura (%s blight, mind and acid affinity).", "%d 개의 정신 효과를 제거하고 물의 기운을 부여합니다 (%s 황폐, 정신, 산성 속성 친화).", "tformat")
...
t([[You cannot bleed.
When you take damage, if your life is under 20%%, heal for 30%% of your max life. %s]], [[피를 흘리지 않게 됩니다.
...
t("BODY", "가슴 방어구", "entity on slot")
t("%s second skin", "%s 두 번째 피부", "tformat")
t("HEAD", "머리", "entity on slot")
...
t("Heals you for %d life when you use a salve.", "연고를 사용할 때마다 생명력을 %d 회복합니다.", "tformat")
...
t("Boots. But with steam power!", "장화입니다. 하지만 증기의 힘이 함께하죠!", "_t")
t("Generate %d steam each time you walk.", "발걸음을 내딜 때마다 증기를 %d 회복합니다.", "tformat")
t("The more steam the better!", "더 많은 증기! 더 강력한 힘!", "_t")
t("Steam Powered Helm", "증기력 투구", "entity name")
t("A Helmet. But with steam power!", "투구입니다. 하지만 증기의 힘이 함께하죠!", "_t")
t("Steam Powered Gauntlets", "증기력 전투장갑", "entity name")
t("Gauntlets. But with steam power!", "전투장갑입니다. 하지만 증기의 힘이 함께하죠!", "_t")
...
t("Nacrush was known for a tendency towards overkill.", "나크루쉬는 대량 학살을 선호하는 경향이 있는 것으로 유명합니다.", "_t")
...
t("An odd, stubby gun with a large, red barrel.", "이상하고 뭉툭한 총입니다. 붉은색의 커다란 총열이 달려 있습니다.", "_t")
t("Glacia", "글라시아", "entity name")
t("frozen gun", "얼어붙은 총", "_t")
t("Strange coils encircle this extremely cold gun.", "기이한 코일이 둘러져 있는 말도 안 되게 차가운 총입니다.", "_t")
...
The design is somewhat rudimentary, but it seems to work.]], [[이 총은 여러 발의 탄환을 한 번에 발사하는 실험적인 총기 같습니다.
...
t("throw the gun and cause it to explode, dealing by %d mind damage (based on Cunning and Willpower) to all targets in an area, attempting to put them to sleep, and disarming yourself for 3 turns", "총을 던져 폭발시킵니다. 범위 내의 모든 적에게 %d 정신 피해 (교활과 의지 능력치에 비례) 를 주고, 일정 확률로 재워버립니다. 시전자는 3 턴 동안 무장해제됩니다", "tformat")
...
t("deal %0.2f mind damage (based on Mindpower) in a radius 1 around the target", "대상을 기준으로 반경 1 칸 범위에 %0.2f 정신 피해 (정신력에 비례) 를 가합니다", "tformat")
t("On hitting with a mindstar, deal physical damage equal to your steampower in radius 1 around the target.", "마석으로 공격 시, 착용자의 증기력과 같은 수치의 물리 피해를 대상 기준 반경 1 칸 범위에 가합니다.", "_t")
t("Spider's Fangs", "거미의 송곳니", "entity name")
t("pouch of envenomed shots", "독이 든 탄환 주머니", "_t")
t("A dedicated technician seems to have built pockets of spider venom into these rounds. It's not clear how happy the spiders were about this.", "어떤 헌신적인 기술자가 탄환에다가 거미의 맹독낭을 집어넣은 것 같습니다. 거미들이 얼마나 기뻐했을지 참 뻔하네요.", "_t")
...
t("shattered mindstar", "조각난 마석", "_t")
t("A linen pouch of jagged mindstar fragments, each radiating a palpable sense of confusion and pain. They must have made up an impressive whole originally, before some cretin turned it to bits.", "날카로운 마석 조각들이 담긴 리넨 주머니로, 모든 조각들이 뚜렷한 혼란과 공포를 뿜어내고 있습니다. 어떤 멍청이가 산산조각내기 전까지는 굉장히 인상적인 마석이였을 겁니다.", "_t")
...
t("Through a combination of magic and airborne probes, these shots incite powerful bolts of lightning to strike your target from above, frying them and those around them!", "마법과 대기 관측 장비들의 조합으로, 탄을 쏘면 머리 위로 번개를 내려쳐 적을 튀겨버리고 주변의 적들까지 구워버립니다!", "_t")
t("a bolt of lightning strikes your target, dealing lightning damage to them and fire damage to those around them.", "대상에게 번개 화살을 날려 전기 피해를 주고, 대상 주변에 화염 피해를 줍니다.", "_t")
t("Vindicator", "수호자", "entity name")
t("engraved gun", "각인된 총", "_t")
t("\"Pesky undead plaguing your village? Necromancers ransacking your burial grounds? The Vindicator is the solution to all your woes!\"", "\"귀찮은 언데드 놈들이 여러분의 마을에 전염병을 풀어놓고 있다고요? 또, 강령술사들이 무덤을 파헤치고 있다고요? 수호자가 그 고민을 말끔히 해결해 드립니다!\"", "_t")
...
t("\"Have you ever fired a shot into a group of monsters and thought 'there must be a better way?' Well now, there is!\"", "\"괴물들한테 총을 쏘고, '더 괜찮은 방법이 있을 텐데?'라고 생각하신 적이 있나요? 자, 바로 여기 있네요!\"", "_t")
...
-Pizurk, Master Tinker]], [["살인송곳니가 어제 갑자기 찾아와서는, 이 총에 대한 설명을 미친 듯이 하기 시작했지. 아주 세심한 것까지 묘사했어, 거의 전부를! 정확하게 어떻게 작동하는지만 빼고 말이야.
...
t("This gun has an absurdly long barrel. You wonder for whom it may have been designed.", "이 총은 말도 안 되게 긴 총열을 갖고 있습니다. 과연 누구를 위해 만든 것일까요?", "_t")
t("Focus your aim on a target, marking them for death - reducing their ranged defense by %d and their resistances by %d%%", "대상을 조준하는 데 정신을 집중하고, 죽음의 낙인을 찍습니다 - 원거리 회피도를 %d, 모든 저항을 %d%% 감소시킵니다", "tformat")
t("#Source# takes aim at #target# using %s!", "#Source1# #target3# %s 조준했다!", "logCombat", nil, {"으로"})
t("Annihilator", "섬멸자", "entity name")
t("gigantic many barreled gun", "거대한 다중 총열 총기", "_t")
t("This gun features a wheel with several barrels attached and seems to be powered by an engine. It looks... impressive.", "여러 개의 총열이 바퀴에 연결되어 있고, 증기 기관을 통해 동력을 공급받는 것 같습니다. 이 총은... 그저... 엄청나군요.", "_t")
...
It also seems to have been carefully balanced to work like a dual gun set.]], [[이 거대한 증기총은 여러 발을 장전할 수 있어, 죽음의 화망을 형성할 수 있습니다.
또한 양 손에 각각 총기를 쥘 수 있게끔 섬세하게 조정된 것 같습니다.]], "_t")
...
t("This cloak seems to incorporate a series of blades attached to various spring mechanisms.  Apparently the designer believed that the best defense was an active one.", "이 망토는 용수철을 이용한 어떤 장치에 붙인 칼날들로 이루어진 것 같습니다.  보아하니 이걸 만든 사람은 최고의 방어란 용수철 하나를 작동시키는 것이라고 믿었던 모양입니다.", "_t")
t("Has a 50%% chance each turn to slash an adjacent enemy for %d physical damage (based on Cunning), making them bleed.", "매 턴 50%% 확률로 인접한 적을 베어 %d 물리 피해 (교활 능력치에 비례) 를 주고, 출혈을 일으킵니다.", "tformat")
...
t("A gun sure to turn all to ash. As long as its nearby.", "모든 것을 잿더미로 만드는 총입니다. 근처에 있는 모든 것만요.", "_t")
...
t("This injecting unit is complemented by a belt of tiny vials, containing some sickly yellow liquid. The papers describe the contents as 'invigorating' and 'increasing the combat potency.'", "모종의 주입 장치입니다. 허리띠에 달린 역겨운 노란색 액체가 담긴 조그마한 유리병과 함께 사용합니다. 설명서에는 이 내용물이 '활력을 되찾아주고, 전투력을 강화한다'고 쓰여 있습니다.", "_t")
...
t("The front plate of this shield vibrates at all times, covering some strange assembly you can't quite make sense of.", "이 방패의 전면부는 항상 진동하고 있습니다. 내부 기계 부품들은 작동 원리가 잘 이해가 안 됩니다.", "_t")
...
t("The discovery of rockets has proved incredibly dangerous. It is not always clear for whom.", "로켓의 발명은 엄청나게 위험한 것으로 여겨졌습니다. 누구한테 위험한지는 그때그때 다르지만요.", "_t")
...
t("This belt utilizes an enchanted gem to focus a burst of steam into a powerful barrier.", "이 허리띠는 마법에 걸린 보석을 통해 집중하여, 뿜어져 나오는 증기를 튼튼한 방어벽으로 만듭니다.", "_t")
t("generate a personal shield that absorbs up to %d damage and damages attackers striking the wearer for %d fire damage while it lasts (based on Cunning)", "개인 보호막을 만들어 최대 %d 피해를 흡수하고, 공격자에게 보복 공격을 가해 %d 화염 피해를 입힙니다 (교활 능력치에 비례)", "tformat")
...
They sure seem sharp though.]], [[이 복잡한 장치로 구성된 증기톱은 당최 이해할 수가 없는 체계로 하나로 묶여 있습니다.
...
t("Moving builds up a stacking movement speed (caps at 25%) and damage bonus (caps at double). Hitting removes the bonus.", "발걸음을 옮길 때마다 이동 속도가 상승하고 (최대 25%까지 중첩) 피해량 상승량도 증가합니다. (최대 2배까지 중첩). 공격을 가하면, 이 효과는 즉시 사라집니다.", "_t")
t("Overcutter", "과잉절단기", "entity name")
t("enormous steamsaw", "거대한 증기톱", "_t")
t("Earlier steamsaws were notably not meant to be used with one hand.", "초창기 증기톱들은 한 손으로 들고 사용할 물건들이 아니었습니다.", "_t")
t("Turbocutter", "고속절단기", "entity name")
t("red striped steamsaw", "붉은 줄무늬 증기톱", "_t")
t("\"Have you ever thought your steamsaws were just too slow? Well, have I got the thing for you...\"", "\"증기톱이 너무 느리다고 생각한 적 있으십니까? 저희에게 좋은 물건이 있는데요...\"", "_t")
...
t("Originally a kitchen implement used by the giants to saw through tough, frozen carcasses. Something is especially sinister about this example though.", "원래 거인들이 얼어붙은 동물 시체를 절단할 때 사용하던 주방 도구였습니다. 지금은 훨씬 더 사악한 용도로 사용됩니다.", "_t")
...
There were ...side effects.]], [[고전 물리학의 벽을 넘기 위해, 몇몇 정신 나간 발명가들은 톱날에 팽창한 시간 자체를 씌워 속력을 최대한 끌어올리려 했습니다.
...
Some people just can't let go until they've bled dry.']], [[쪽지가 하나 붙어 있습니다.
 
'나는 작품을 위해 심장의 피를 흩뿌렸고, 작품은 내 손 안에서 심장처럼 뛰었도다.
피가 모두 쥐어짜일 때까지 놓지 못하는 이들도 있을 것이니.']], "_t")
...
While you are bleeding, Heartrend's damage increases and it gains lifesteal.]], [[착용자가 공격 시, 또는 피격 시 최대 체력의 1% 이상의 피해가 일어나면, 출혈이 발생해 피해량의 20%를 물리 피해로 가합니다 (대부분의 상태 저항 효과를 무시합니다).
착용자가 출혈 상태일 때, 심장파열의 피해량은 증가하고 생명력을 흡수합니다.]], "_t")
t("If bleed damage per turn is greater than 5% of max life, attacks cleave.", "매 턴 받는 출혈 피해가 최대 생명력의 5% 를 초과하면, 주변의 적을 함께 공격합니다.", "_t")
...
#AQUAMARINE#증기가 20 이하일 경우#LAST#: 비전 발전기를 강화하여 5 턴 동안 마나 10 소모 당 증기 생성량을 4 증가시킵니다.
...
t("aether-infused steamsaw", "에테르가 깃든 증기톱", "_t")
t("Saws made of metal? That is no good for a discerning Technomancer so Galen made a saw out of pure arcane forces!", "금속으로 만든 톱? 그런 건 안목 있는 마도공학자에게는 어울리지 않습니다. 그래서 갈렌은 순수한 마법의 힘으로 톱을 만들어냈습니다!", "_t")
t("Increases the steam your arcane dynamo generate per 10 points of mana by 2.", "비전 발전기를 강화해, 마나 10 소모 당 증기 생성량을 2 증가시킵니다.", "_t")
t("Eye of the Lost", "길 잃은 자의 눈", "entity name")
t("pale mindstar", "창백한 마석", "_t")
t("A strange aura surrounds this mindstar. You feel a presence, but it is obscured, as if it refuses to be found.", "기이한 기운이 이 마석을 둘러싸고 있습니다. 어떤 존재가 느껴지지만, 발견되는 것을 거부하는 듯 가려져 있습니다.", "_t")
t("reduces mental save", "정신 내성 감소", "_t")
...
t("No self respecting craftsman would be caught without them!", "한 가닥 하는 장인들은 전부 다 끼고 있습니다!", "_t")
t("X-Ray Goggles", "X선 보안경", "entity name")
t("pitch black goggles", "칠흑의 보안경", "_t")
t("How do these even work?", "이건 또 어떻게 작동하는 거죠?", "_t")
...
경고: 보건 당국 평의회에서는 이 상품이 다음과 같은 현상들과 관계가 있다는 결론을 내렸습니다 - 강렬한 현기증, 모발의 가연성 증가, 비기화성 발한, 밤 공포증, 간 이상, 두통, 탄폐증, 사고 정지, 낮 공포증, 체세포 이상 분열, 토막난 위대한 존재가 보이는 환각, 팔꿈치 염증, 뼈 이탈증, 소화기질환, 신장질환, 목록 공포증, 전체속도 감소, 의도하지 않은 순간이동, 혀 탄화증, 콧구멍 결합증, 고대의 역겨운 저주, 증기압 감소, 지방 연소(문자 그대로), 눈 주위 털 증가, 오크체취증, 마법 방해, 중력 저하, 혈류 정지, 부정행위, 창자 코팅, 허무주의, 저녁 공포증, 무릎 골병, 그리고 증기구 막힘.]], "_t")
...
"그래, 그래, 좋은 생각이다. 오늘은 중요한 날이다. 우리 둘 모두에게 - 아니, 에이알에게... 그럼, 내가 오래전에 말했던 것을 가져온 것인가?"
...
------------------------------------------------
section "tome-orcs/data/lore/internment-camp.lua"
...
------------------------------------------------
section "tome-orcs/data/lore/krimbul.lua"
...
그때, 우리가 그 마법으로부터 느꼈던 게 활력이 아니었다는 걸 깨달았으면 좋았을 텐데.
...
우린 스스로의 몸을 살펴 보았고, 우리 모두의 안에서는 아주 조그만, 황폐의 마법의 흔적이 느껴졌다. 네크토쉬는 급조한 천막에다가 카르바사를 데려다 놓았지만, 그녀는... 그녀는 세상을 떠났다.  소란이 진정된 뒤에, 네크토쉬는 천막에서 뛰쳐나와서 굉장히 명료하게, 자신의 생각을 이야기했다. "그 마법은 살아 있는 것에게만 통하는 것 같다. 카르바사의 증상이 심장과 함께 멎었으니... 극단적인 방법인 건 알고 있지만, 만약 우리가 다른 방법들로 이 저주를 없애지 못한다면, 그 저주가 우리를 갉아먹기 전에 한 발 앞서서 우리의 생명을 없애는 걸 진지하게 고려해봐야 한다."
...
다행스럽게도, 그대들의 어리석음이 도움이 되었다.  옛 전설의 유니콘이 그동안 모습을 드러내지 못했던 건 내가 그대들과 너무 가까이 있어서였다. 내가 그대들 같은 게으름뱅이들과 떨어지게 되자, 마침내 그것이 비밀스럽게 나타나 나에게 축복을 내렸던 것이다.  그들이 자신들의 모습을 직접 보여주었던 것은 아니었지만, 어찌되었든 그들은 언제나 내 안에 잠들어 있던 힘을, 내가 이제껏 마땅히 휘둘러 왔어야 했던 힘을 일깨워 주었다.  그 힘은 내 안에 너무 오래 잠들어 있었지만, 이제, 깨어났다!!
...
...  좋아.  다섯 번에서 열 번 정도 남았다는 건가...  이제 어떻게 사용할지 생각해봐야 해.  다시 돌아가서 아무 일도 없었다는 듯이 행동하기엔 너무 멀리 와 버렸어 - 히 히 상상도 안 돼...  뭘 해야 하지 뭘 해야 하지 전쟁을 이 이상 늦출 순 없어 모든 걸 밝힐 수도 없어 증기 거인들에게 이길 수도 없어 못해 못해 못해 못해
...
[i](The letter is signed with an unreadable but formal-looking demonic seal.)[/i] ]], [[솔직히 말하겠다, 상황이 좋지 않다.  둠엘프들의 탈주 사건 때문에 쿨마나르를 포함한 우리 귀중한 병력의 대부분이 '비정상' 의 손에 죽었다. 게다가 최초의 듀아세들렌도 실종되어, 이번 년도에 우린 손해를 상당히 많이 본 상태다.  그렇기 때문에 너희들에게 내릴 명령은 간단하다 - 죽은 듯이 있어라.  눈에 띄는 행동을 하지 말고, 우리가 적당한 발판과 새 계획을 얻어낼 때까지 정보 수집은 최소한으로 제한하라.
...
[i](You assume the elaborate, glowing shape below is an Ogric equivalent to a signature.)[/i] ]], [[당신네가 이곳에 설치한 항-감시 시스템은 정말 존나게 끝내주는군. 그걸 이용하는 시한식 유사 룬도 마찬가지고. 내 피부에다가 새길 자리를 마련하느라 좀 고생했지만, 마즈'에이알로 돌아가고 나서도 며칠간 잘 작동하는 게 느껴졌었다.  이게 있으면 서쪽의 차원문을 통과하더라도, 자주 쓰이는 집합 지점이 왕.연. 에 발각되거나 추적당할 일은 없을 거다.

그래도, 하나 제안하고 싶다.  그걸 살짝 뜯어고치면, 룬 소유자의 의사와 상관없이 작동하는 걸 만들 수 있다.  나한테서 노예를 사가는 녀석은 당신네들 말고도 많이 있고, 어떤 고객이 그 노예들을 바로 서쪽으로 데리고 가고 싶다고 하면, 우리가 직접 항-감시 마법을 걸어야 하지.  알고 있을지는 모르겠지만, 그런 마법을 쓸 수 있는 마법사를 구하는 건 여전히 쉬운 일이 아니다. 지난번엔 간신히 손해만 안 났지 이익도 거의 없었다.
...
증기 고갈이 가속화되고 있는 현재, '손쉬운 해결책' 이란 것은 당연히 구미가 당기는 말입니다.  저 또한 현시점에선, 제겐 우리의 새로운 평의원장의 계획 - 크룩 오크들의 발밑에 있는 유망한 지열관들을 탈취하는 계획을 막을 힘이 없다는 것을 잘 알고 있습니다. 그러나 만약 우리가 실패한다면, 여러분은 자신을 "충신" 이라 칭하는 그... '존재' 와 거래를 하고 싶어질 수도 있을 것입니다.  저는 그러한 결정을 내리는 것은 굉장히 어리석은 짓이라고 생각합니다.
...
최근 몇 년 들어 정치 담론이 다소... 저급해진 것 같습니다.  언쟁과 비난이 난무하는 근래의 토론들을 생각하면 과거의 평의원들께선 자신들의 경력만 생각하지 않으셨다는 걸, 격렬하게 감정을 표출하는 게 정치적인 가식이 아니었다는 걸 믿기 힘드실 수도 있습니다.  하지만 설령 그 평의원들께서 우리와 똑같이 이기적인 속물들이었다고 해도, 그분들께선 공식 기록에는 그런 사사로운 감정을 표출하지 않으셨습니다. 결코.
...
평의원 토르막의 로브에선 압생트 냄새와 부랑자 같은 냄새가 난다는 요지의 발언을 기록하자는 동의안이 발의됨, 투표 결과 3대 1로 가결됨, 평의원 탄탈로스는 기권함.
...
탄탈로스: "그러니까, 상업지구에 있던 게으름뱅이 몇 명이 죽었고, 크룩 놈들이 본토로 진출했다는 것이군요.  내 생각엔, 당장은 우리가 신경쓰지 않아도 될 것 같습니다 - 그 '왕국연합' 과 '태양의 장벽' 친구들이 놈들을 상대할 테니.  펜도르의 정찰대 덕분에, 우린 크룩 긍지 놈들의 본거지를 공격할 수 있는 무기를 손에 넣을 수 있었습니다. 이건 억지력으로 작용하여, 우리에게 시간을 좀 더 벌어주겠지요.  그 시간 동안 우리의 방어를 더 견고히 해야 합니다... 다른 선택지도 고려해 봐야겠고요.  폐회를 선언합니다."
...
탄탈로스: "하려는 의지가 있다면, 길 또한 있는 법입니다, 팔라퀴.  레비아탄 호는 어떻게 되었습니까?  나샬, 혹시 짐작 가는 곳이 있--"
...
t("a telepathic message <Rough Drafts>", "텔레파시 메시지 <초고>", "_t")
...
Once upon a time, a great spirit put down its pen and closed its notebook, sighing in frustration.]], [[<? Lore.init_pocket_time_data() ?>옛날 옛적에, <?=Lore.pocket_time_winner.name?>라는 하플링 연금술사가 있었다.  그녀는 믿음직한 골렘과 함께 트롤 늪으로 나아가, 앞길을 막는 적들을 모두 치워버렸다. 하지만 프록스가 나타나 그녀의 얼굴에 대고 소리를 질렀고, 당황한 그녀는 벨트에서 약병을 뽑았지만 폭탄의 폭발 범위 안쪽이었기 때문에--

옛날 옛적에, <?=Lore.pocket_time_winner.name?>라는 드워프 광전사가 있었다.  레크놀의 통로를 따라 도망치던 중 그의 친구가 오크 전사들에게 쓰러지자, 그 또한 전사들에게 달려들었고--

옛날 옛적에, <?=Lore.pocket_time_winner.name?>라는 코르낙 도적이 있었다.  그가 만든 함정은 프록스한테는 효과가 좋았지만, 바위 트롤 빌이 그를 자신의 거처에다 던져버리자 그는 이성을 잃고 달려들어--

옛날 옛적에--

옛날 옛적에, 위대한 영웅이었던 <?=Lore.pocket_time_winner.name?>라는 드워프 바위 감시자가 있었다. 그녀는 자신에게 일어나는 불공평한 일들에 대해 욕지거리를 중얼거리며 모험을 시작했지만, 이내 어깨를 으쓱하며 나아갔다.  그녀는 절친한 동료와 함께 레크놀에서 탈출하였고, 자신의 힘을 사용하여 깊은 포효와 미궁에 자리잡고 있던 타락한 힘을 몰아냈으며, 사악한 실험체 Z의 손아귀에서 "이크" 라는 생전 처음 보는 기묘한 생명체를 구해냈고, 다이카라의 거인들이 던져대는 바위들도 그녀의 거침없는 전진을 막지 못하였다.  그녀는 오래전에 잊혀진 비밀 실험장을 찾아내어 그곳에 있던 최초의 오우거들을 안식에 들게 했고, 키릴-페이얀의 사교도들의 손아귀에서 한 소녀를 구출해냈으며, 마침내 시련으로 갈고닦인 기술들과 모험 중에 얻은 이국적인 장비들로 무장한 채로, 두려움의 영역의 입구에 당도했다.  몰려오는 언데드 군단을 뚫어낸 그녀는 마침내 탑의 주인을 마주했고, 곧바로 스켈레톤 전사 하나가 그녀의 뒤쪽에서 기습을 가했다.  놈의 일격은 그녀가 단 하나뿐이었던 자연 주입물을 새겼던 부위에 작렬하였다.  그녀는 어질어질하고 멍한 상태에서 그 주입물을 사용하려 애를 썼지만, 끔찍한 냉기가 팔다리를 타고 올라왔고, 얼음 속에 갇히고 나서야 정신이 맑아졌다--

옛날 옛적에, <?=Lore.pocket_time_winner.name?>라는 탈로레 소환사가 있었다. 그녀가 모험을 시작했을 때, 바로 옆에는 이상하게 시공 마법에 능숙한 뱀이 한 마리 있었고--

옛날 옛적에, 끔찍한 악당이었던 <?=Lore.pocket_time_winner.name?>라는 오우거 약탈자가 있었다. 그는 마법폭발 동굴의 오염된 수정체들에게서 매력을 느꼈다.  그는 가장 먼저 한밤중에 마지막 희망의 경비병 한 명을 익사시키고 그녀의 마법 반지를 훔쳤고, 그러고는 대륙을 종횡무진하며 보이는 모든 것들을 파괴했으며 희생자들을 도끼로 토막내거나 검으로 꿰뚫고 그들의 힘을 빼앗아, 생명을 하나하나 죽일 때마다 점점 더 강해졌다.  그는 위대한 타락자의 편에 가담하여 지구르를 습격해 그 누구도 자신이 타락의 힘을 퍼뜨리는 것을 방해할 수 없도록 했으며, 샌드웜 여왕의 심장을 마법폭발로 인해 오염된 땅으로 가져가 그것에 담긴 자연의 축복을 황폐화된 고통의 원천으로 타락시켰다.  그는 광신도들이 자신들의 주인 되는 악마를 소환하기 위해 소녀를 희생시키는 걸 구경만 하고 있었으며, 그 이유는 자신이 직접 그 악마를 죽이기 위해서였다. 또한 그는 동쪽의 대륙으로 여행을 떠난다는 걸 알게 되자 군침을 흘렸고, 4개 사단에 가까운 수의 오크들이 그의 손에 피를 흘리며 쓰러졌으며 그들의 피부에 종양과 종기가 들끓기 시작하자 눈동자에 비치는 생명의 빛도 꺼져갔다.  보르 긍지의 가장 우수한 병사들도 그가 자신들의 무기고를 약탈하는 것을 막지 못했지만, 질병과 상처 때문에 다 죽어가던 오크 하나는 봉인되어 있는 문 앞에 버티고 서서, 제발 이 문을 열지 말라고 빌었다. 그는 그저 웃어제끼며 그 오크의 두개골을 박살내곤 봉인된 문으로 다가가 그 문짝을 발로 차 열었다. 그러자 그의 뼈 갑옷이 폭풍의 숨결에 순식간에 가루가 되었고, 그의 눈앞엔 말로 표현하기 힘들 정도로 막강한 다색 용들이 있었다.  아무리 <?=Lore.pocket_time_winner.name?>라도 싸움에서 도망쳐야 할 때가 있다는 걸 알고 있었고, 주먹을 꽉 쥐면서 위상 관문 룬을 충전했다. 눈부신 섬광이 사라지자, 그의 코앞에는--

옛날 옛적에, <?=Lore.pocket_time_winner.name?>라는 둠엘프가 있었다. 그녀는 운석 충돌 덕분에 운 좋게 악마들의 정신 지배에서 해방되었고, 이제 새롭게 얻은 힘으로 지금 갇혀 있는 공중 지옥에서 탈출하려 했다.  포로들을 고문하는 게 특기지만 직접 싸우기엔 너무 연약한 악마들이었던 조사관과 훼손자들은, 그녀의 지옥불 검 앞에 의식 지내는 법이나 조금 아는 루비의 아이들만큼이나 손쉽게 쓰러졌다. 그리고 그녀는 자신에게 깃든 악마의 마법만 있으면 아무도 자신을 막을 수 없다는 생각을 하기 시작했다.  악마상이 그녀를 부르고 있을 때도 그녀는 그것의 힘을 흡수하겠다는 생각은 추호도 하지 않았고, 마침내 그런 생각이 들었을 땐 이미 그 악마상이 울흐'록의 대전사를 불러냈을 때였다--

옛날 옛적에, <?=Lore.pocket_time_winner.name?>라는 샬로레 모험가가 있었다. 그는 자신감이 넘치는 남자였다.  그는 굉장히 안 어울리는 능력들을 함께 익혔는데, 강력한 무술을 익혔음에도 염동력을 이용하여 양 손을 쓰지 않고도 지팡이를 휘두를 수 있는 기술을 배웠고, 주먹질을 통해 돌덩어리들을 우박폭풍처럼 쏘아낼 수 있는 대지 마법을 익히는 식이었다. 그리고 이런 능력들을 능숙하게 다룰 수 있게 되자, 그는 눈앞의 적들을 손쉽게 찢어발길 수 있었다... 기이한 짐승을 마주하기 전까진.  전투는 격렬했고, 얼마 지나지 않아서 양쪽 모두 죽음의 문턱에 다다랐다. 모험가는 요새의 입구를 등지고 서서, 뛰어들어 공격하면 저 짐승을 끝장낼 수 없다는 것을 깨닫고 그러는 대신 돌덩어리들을 쏘았다.  그러나, 그 돌덩어리가 그의 손에서 떠나자마자, 딱딱한 뼈들이 그의 허리와 다리, 등을 붙잡고 어처구니없는 속도로 그를 기이한 짐승 쪽으로 끌고 왔다.  만약 <?=Lore.pocket_time_winner.name?>가 주먹다짐을 선택했다면 살아남았을 수도 있었겠지만, 그는 그가 쏘아낸 돌덩이들보다도 빠르게 끌려갔고, 이제 그는 날아오는 돌덩이들로부터 원래 목표를 감싸는 꼴이 되어--

옛날 옛적에, 어떤 위대한 영혼이 좌절감에 한숨을 내쉬며, 펜을 내려놓고 노트를 덮었다.]], "_t")
t("a telepathic message <The Tale of Maj'Eyal>", "텔레파시 메시지 <마즈'에이알의 이야기>", "_t")
...
]], [[<? Lore.init_pocket_time_data() ?>옛날 옛적에, <?=Lore.pocket_time_winner.name?>라는 <?=Lore.pocket_time_winner.race?> <?=Lore.pocket_time_winner.class?>가 있었다.  그 시작은 미약하여 <?=Lore.pocket_time_winner.HeShe?>는 처음에는 미쳐버린 자연의 수호자 노르고스나 코르'풀의 또 다른 환생체 같은 사소한 위협들을 처리했었으나, 대륙을 여행하면서 <?=Lore.pocket_time_winner.heshe?>는 더욱 강해졌고 <?=Lore.pocket_time_winner.heshe?>의 기술 또한 나날이 발전하여, 훨씬 더 공포스러운 것들 또한 상대하게 되었다.  <?=Lore.pocket_time_winner.HeShe?>는 일크구르의 타락한 공포를 몰아내고 오래전에 잊혀진 요새를 <?=Lore.pocket_time_winner.himher?>의 것으로 만들었다. 그러나 그것조차도 두려움의 영역에 우뚝 솟은 탑으로 가는 디딤돌 정도일 뿐이었다.  탑의 주인 - 끔찍하기 짝이 없는 힘을 휘두르고, 그것보다도 더 끔찍할 정도로 잔혹한 강령술사가 어처구니없는 힘을 품은 고대의 무기를 들고, 자신의 언데드 군단을 대동한 채 <?=Lore.pocket_time_winner.himher?>를 기다리고 있었던 것이다...  하지만 <?=Lore.pocket_time_winner.name?>는 용감하게 뛰어들어 스켈레톤과 구울의 군단을 도륙내고, 수많은 이들이 패배하였던 탑을 제패하였다.  마침내 <?=Lore.pocket_time_winner.heshe?>는 그 흡혈귀에게서 승리를 거두었고, <?=Lore.pocket_time_winner.heshe?>는 흡수의 지팡이를 그 언데드의 손아귀에서 빼내었다.  마즈'에이알은 다시 한 번 안전해졌다.

불행하게도, 훨씬 더 위험한 임무가 <?=Lore.pocket_time_winner.himher?>를 기다리고 있었다.  과거에 이미 사라진 줄 알았던 오크들이 마즈'에이알에 다시 나타났던 것이다!  <?=Lore.pocket_time_winner.name?>가 지팡이를 안전한 장소에 보관하기 위해 애를 썼음에도 불구하고, 오크들은 그걸 훔쳐가 버렸고 <?=Lore.pocket_time_winner.name?>는 그 지팡이를 되찾기 위해, 믿기지 않을 정도로 진보된 고대의 장거리 차원문을 통해서 놈들을 쫓을 수밖에 없었다.  <?=Lore.pocket_time_winner.name?>가 여러 장소로의 오브로 차원문을 작동시키자 차원문은 탁탁거리는 소리를 내며 소용돌이쳤고, <?=Lore.pocket_time_winner.heshe?>는 심호흡을 한 뒤에 눈을 감았다. 그러자 눈 깜박할 새에, <?=Lore.pocket_time_winner.hisher?>는 머나먼 동쪽 대륙으로 날아갔다.  마즈'에이알에서 동쪽의 대륙 - 바르'에이알로 넘어갈 수 있었던 사람은, 지난 몇 세기 동안은 <?=Lore.pocket_time_winner.heshe?>가 처음이었다.

오래전에 잊혀진 동맹인 태양의 장벽의 사람들이 <?=Lore.pocket_time_winner.himher?>를 기다리고 있었다. 그리고 그건 네 종류의 오크 군대들도 마찬가지였다!  하지만, <?=Lore.pocket_time_winner.name?>는 이 세계의 운명이 <?=Lore.pocket_time_winner.hisher?>의 손에 달려 있게 되었음에도, 이전과 변함없이 물러서지 않았다.  고위 태양의 기사 아에린의 축복을 받아, <?=Lore.pocket_time_winner.heshe?>는 오크 긍지들에게서 흡수의 지팡이를 되찾기로 했다.  <?=Lore.pocket_time_winner.himher?>는 가장 먼저 위대한 마도사 보르에게 도전하였다. 보르는 천상의 힘 그 자체를 불러내어 <?=Lore.pocket_time_winner.himher?>를 가루로 만드려 했고, 화염과 얼음의 폭풍이 <?=Lore.pocket_time_winner.hisher?>에게 쏟아졌지만 그의 운석들조차도 <?=Lore.pocket_time_winner.himher?>를 막을 순 없었다. 고르뱃 긍지의 용 조련사들, 비할 바 없는 자연의 힘을 다루는 최고의 용인들은 <?=Lore.pocket_time_winner.name?>가 이 세상에서 가장 뛰어난 용살자가 될 기회를 선사했을 뿐이었다.  락'쇼르 긍지의 뼈 요새는 <?=Lore.pocket_time_winner.heshe?>가 그곳에 '살아 있던' 것들을 안식에 들게 하자 함께 무너졌다. 마지막으로 그루쉬낙 긍지의 가장 오크다운 오크들이 앞을 막아섰지만, 그들의 검과 도끼, 그리고 난폭한 힘마저 <?=Lore.pocket_time_winner.hisher?>에겐 그저 역부족이었다.
<? if not Lore.pocket_time_winner.sacrifice then ?>
하지만 <?=Lore.pocket_time_winner.heshe?>가 탑을 오르려 할 때, 고위 태양의 기사 아에린이 <?=Lore.pocket_time_winner.heshe?>에게 다급한 소식을 전했다!  <?=Lore.pocket_time_winner.HeShe?>는 신속하게 에류안의 황무지로 떠나, 또 다른 장거리 차원문을 찾아냈다.  그게 어디로 통하는 건지도 모르는 채로, <?=Lore.pocket_time_winner.name?>는 아에린의 요청을 따라 차원문으로 뛰어들었다. <?=Lore.pocket_time_winner.heshe?>가 다시 눈을 떴을 땐, <?=Lore.pocket_time_winner.himher?>는 불꽃과 마그마로 가득 차 있고, 좁은 길목이 아주 멀리까지 이어져 있는 광활한 땅에 서 있었다.  <?=Lore.pocket_time_winner.himher?>의 등 뒤쪽에선 챙챙거리는 소리와 뭔가 박살나는 소리가 들렸고, <?=Lore.pocket_time_winner.heshe?>가 돌아보자, 웬 오크들이 태양의 기사들과 대치하고 있었다. 오크들이 여기까지 <?=Lore.pocket_time_winner.himher?>를 쫓아왔고, 태양의 기사들은 용감하게 맞서서 그들을 막고 있었던 것이다.  기사들은 <?=Lore.pocket_time_winner.himher?>에게 딱 한 마디만 했다. 뛰세요!  그 말대로 <?=Lore.pocket_time_winner.heshe?>는 뛰었다. 시뻘건 마그마가 양 옆에서 부글거리는 위험한 돌다리를 따라, 거대하고 새빨간 용들을 도륙내고 피해 가면서.  마침내, <?=Lore.pocket_time_winner.heshe?>는 찾던 지팡이를 동쪽 대륙에 와서 처음으로 눈으로 볼 수 있었다 - 그리고 그 지팡이를 갖고 있던 범인들은, 놀랍게도 오크가 아니라 어떤 인간과 엘프였다!  그 두 주술사들의 의도는 분명히 선량했지만, 도중에 순수한 광기가 섞여 버리고 거기에 비극적인 사랑이 더해진 탓에 - 오크 긍지들을 조종하여 그 지팡이를 훔치도록 만든 것이었다. <?=Lore.pocket_time_winner.heshe?>는 그들이 무엇 때문에 이런 일을 벌였는지는 여전히 모르고 있었다.  어떻든 간에 그들의 주문 의식은 저지되었고, 주술사들에게 이긴 <?=Lore.pocket_time_winner.heshe?>는 동쪽으로 돌아와 최고봉에 있는 그들의 거처를 습격할 준비를 했다.

<?=Lore.pocket_time_winner.heshe?>를 기다리고 있던 것은, 이때까지 <?=Lore.pocket_time_winner.himher?>가 마주했던 그 어떤 위협보다도 더 강대한 것이었다.  최고봉의 탑은 각 층마다 온갖 적들을 동원하여, <?=Lore.pocket_time_winner.himher?>의 방어를 각기 다른 방식으로 무너뜨리려 하며 <?=Lore.pocket_time_winner.hisher?>를 막으려 했지만, <?=Lore.pocket_time_winner.heshe?>는 그것에 굴하지 않고 <?=Lore.pocket_time_winner.hisher?>의 앞길을 막는 것은 그게 무엇이든지 뛰어넘으며 전진했다.  마침내 <?=Lore.pocket_time_winner.heshe?>는 탑의 최상층에서 주술사들, 엘란다르와 아르고니엘을 마주하게 되었다.  그들은 <?=Lore.pocket_time_winner.himher?>에게 흡수의 지팡이의 용도와 자신들의 계획을 밝혔다. 그건 단순히 세계를 지배하는 것 따위보다 훨씬 더 위험한 계획이었다. 그들은 오래전에 사라진 쉐르'툴만이 해결할 수 있는 존재를 불러오려 했던 것이다 - 오래전에 잊혀져, 별들 사이의 공허에 유폐되어 있는, 고독함에 미쳐버린 신 게를릭을.  무슨 수를 써서든 막아야만 했다!

다행히, <?=Lore.pocket_time_winner.name?>는 홀로 싸우지 않았다.  고위 태양의 기사 아에린이 <?=Lore.pocket_time_winner.hisher?>를 도우려 나타났고, 그렇게 그 넷은 에이알의 운명을 건 싸움을 시작했다.  아르고니엘의 주변에서 소용돌이치는 무시무시한 뼈 갑옷, 허공을 가르는 엘란다르의 놀라운 주문들, 차원문을 통해 소환되어 전투에 뛰어드는 수많은 적들...  하지만 최후엔, 정의가 승리했다.  주술사들은 패배했고, 차원문은 봉인되었다. 영원히.

<?=Lore.pocket_time_winner.name?> 덕분에, 에이알은 구원받았다.  세상은 최고봉의 꼭대기에서 무슨 일이 일어났는지 알지 못하겠지만, 그들은 파멸의 손아귀에 붙잡혀 있었고, 이제 풀려난 것이다.  우리의 영웅이 그 뒤에 어떤 일을 했는지는 아무도 모른다...  하지만 뭐가 어떻든 간에, <?=Lore.pocket_time_winner.heshe?>와, 에이알의 모든 생명들은, 오래오래 행복하게 살았답니다.
<? else ?>
<?=Lore.pocket_time_winner.heshe?>를 기다리고 있던 것은, 이때까지 <?=Lore.pocket_time_winner.himher?>가 마주했던 그 어떤 위협보다도 더 강대한 것이었다.  최고봉의 탑은 각 층마다 온갖 적들을 동원하여, <?=Lore.pocket_time_winner.himher?>의 방어를 각기 다른 방식으로 무너뜨리려 하며 <?=Lore.pocket_time_winner.hisher?>를 막으려 했지만, <?=Lore.pocket_time_winner.heshe?>는 그것에 굴하지 않고 <?=Lore.pocket_time_winner.hisher?>의 앞길을 막는 것은 그게 무엇이든지 뛰어넘으며 전진했다.  아아, 가장 힘겨웠던 것은 최상층 직전에 기다리고 있었던 - 고위 태양의 기사 아에린이었다.  <?=Lore.pocket_time_winner.name?>가 검게 탄 상처에서 의식을 저지하지 못했기 때문에 아침의 문이 산산조각나고 말았고, 아에린이 <?=Lore.pocket_time_winner.heshe?>에게 도움을 요청했음에도 무시했다는 것이었다.  그녀는 이 이야기를 하며 <?=Lore.pocket_time_winner.name?>를 비난했고, 그렇게 둘은 싸우게 되었다... 하지만 <?=Lore.pocket_time_winner.heshe?>가 싸움 끝에 <?=Lore.pocket_time_winner.heshe?>의 괴로움을 토로하자 아에린의 화는 누그러졌다.

마침내 <?=Lore.pocket_time_winner.heshe?>는 탑의 최상층에서 주술사들, 엘란다르와 아르고니엘을 마주하게 되었다.  그들은 <?=Lore.pocket_time_winner.himher?>에게 흡수의 지팡이의 용도와 자신들의 계획을 밝혔다. 그건 단순히 세계를 지배하는 것 따위보다 훨씬 더 위험한 계획이었다. 그들은 오래전에 사라진 쉐르'툴만이 해결할 수 있는 존재를 불러오려 했던 것이다 - 오래전에 잊혀져, 별들 사이의 공허에 유폐되어 있는, 고독함에 미쳐버린 신 게를릭을.  무슨 수를 써서든 막아야만 했다!

셋은 에이알의 운명을 건 싸움을 시작했다.  아르고니엘의 주변에서 소용돌이치는 무시무시한 뼈 갑옷, 허공을 가르는 엘란다르의 놀라운 주문들, 차원문을 통해 소환되어 전투에 뛰어드는 수많은 적들...  하지만 최후엔, 정의가 승리했다.  주술사들은 패배했고, 차원문은 봉인되었다. 영원히...  하지만 그 대가는 실로 끔찍했다.  <?=Lore.pocket_time_winner.name?>는 장거리 차원문을 살펴보았다 - 주술사들이 이미 차원문에 너무 많은 에너지를 충전해 놓은 상태였고, 지팡이 하나만으로는 멈출 수가 없었다.  <?=Lore.pocket_time_winner.HeShe?>는 지극히 이타적인 마음으로 위대한 희생을 치렀다. <?=Lore.pocket_time_winner.hisher?> 자신의 생명을 바쳐 차원문을 파괴한 것이다.

에이알의 그 어떤 이도 <?=Lore.pocket_time_winner.hisher?>의 희생이나, 자신들이 위험에 처했었다는 것을 알지 못할 것이다... 하지만 우리의 영웅 덕분에, 그들은 오래오래 행복하게 살았답니다.
<? end ?>
<? if Lore.pocket_time_winner.is_yeek then ?>[i]...음, 아무튼 그냥 이렇게 됐다고 치자.  다른 결말에선, 그다음 이야기로 잇기가 꽤 어려울 테니까.[/i]<? end ?>
]], "_t")
t("a telepathic message <The Eidolon>", "텔레파시 메시지 <에이돌론>", "_t")
...
t("a pamphlet 'Eyal Needs You!'", "'에이알은 당신이 필요합니다!' 팸플릿", "_t")
t([[EYAL NEEDS YOU!
...
번뜩이는 동굴과 노르고스의 거처, 그리고 다른 수많은 지역에 남아 있던 상처들은 마즈'에이알의 영웅이 그 지역들을 다시 안전하게 만들고 나서야 확인될 수 있었습니다.  이제 그 지역에 평화가 돌아오자, 에이알은 서서히 회복되고 있습니다 - 하지만 마법을 사용하는 동쪽 대륙의 주민들이 도착하고 왕국연합이 마법을 차츰 허용하게 되면서, 이 균형이 다시 한 번 파국으로 치닫게 될지도 모릅니다 - 하지만 바로 당신의 도움으로 에이알을 건강하게 만들 수 있습니다!  멘더에 합류하세요, 그리고 바로 오늘부터 이 행성을 도우세요!

[배우고 관찰하기]

원래 샤툴의 수호자들이었던 우리의 설립자들은 생태계의 균형을 유지하는 것이 얼마나 중요한 일인지 언제나 알고 있었습니다.  혹시 당신의 취미 중 새들을 지켜보기, 야생을 탐험하기, 자연의 식물들을 관찰하기 같은 것들이 있으십니까?  우린 당신에게 흥미로운 동식물들과 미생물들의 목록을 제공할 수 있습니다. 그냥 밖으로 나가, 당신이 탐험한 장소와 일자, 그리고 거기서 목록에 적힌 생물들을 얼마나 많이 보았는지 기록하시면 됩니다.  그러면 우리 측 숙련된 박물학자들이 그 정보를 이용해 해당 생물종의 이동 패턴을 추적하고 분포나 개체 감소 추이 같은 것들을 감시할 수 있습니다. 이로써 우린 어떤 생물종이 멸종 위기에 처하거나 지나치게 많아졌을 때 대처할 수 있게 되는 것입니다. 또한 우리 학자들은 마즈'에이알의 영웅이 각지의 야생 생물들을 도륙하고 다닌 덕분에 어지럽혀진 자연의 균형을 바로잡으려 노력하고 있습니다.  변화란 자연의 질서의 일부이고, 우리 전문가들은 그 변화가 너무 과도하거나 파괴적이어서 생태계를 손상시킬 수 있을 때만 개입해야 한다는 것을 알고 있습니다.  대자연은 자신에게 문제가 일어나면 대부분 알아서 해결하지만, 가끔씩 우리가 도움을 주어야 할 때도 있습니다 (특히나 무분별하게 사용된 비전 마법으로 일어난 변이 같은 것에 대처할 때에).  자연의 질서에 대해 더 자세히 알고 싶으시다면, 우리 측에는 다양한 분야에 해박한 박물학자들이 있습니다. 질의응답이나 다른 이들을 가르치는 것을 매우 좋아하는 사람들이랍니다.

[바로잡고 치유하기]

좀 더 적극적으로 기여하길 원하신다면, 곧바로 성과를 볼 수 있는 활동들도 있습니다. 우리의 교정, 정화 활동에 참여하는 것이지요.  마즈'에이알의 영웅이 치른 전투들에서 안타까운 피해 역시 발생했다는 건 잘 알려져 있는 사실입니다. 수많은 지역들에는 여전히 마법에 오염된 물체나 시체들이 방치되어 있고, 어떤 곳들은 땅 자체가 그런 마법들의 잔류 효과로 인해 오염되어 있습니다.  (물론, 짐승들이나 아무 짝에도 쓸모없는 악당들이 우리의 영웅을 막기 위해 불태운 나무 같은 것들은 예외입니다!)  당신은 위험한 마법 물체들을 파괴하거나, 나무를 심거나, 생태계를 교란시키는 짐승들 (노르고스 같은 것들) 을 처리하거나, 자연의 회복력을 높이기 위한 정화 의식에 참여하거나 하여 도움을 줄 수 있습니다.

[능력, 책임, 그리고 수용]

에이알의 야생은 위험한 곳입니다. 우리 학자 분들을 그곳에 무방비한 상태로 보내진 않을 겁니다!  우린 '살아있는 화석' 과의 협력을 통해 마법을 안전하고 책임감 있게 사용하는 방법에 대해 파악했고, 그래서 마법을 사용하는 것에 익숙하신 분들에겐 그 방법과 함께 자연의 방식에 대해서 안내를 드리고 있으며 이미 자연의 힘을 능숙하게 다룰 수 있는 분들은 우리의 베테랑들과 함께 기술을 갈고닦을 수 있도록 하고 있습니다.  만약에 마법도, 자연의 힘도 다루지 못하신다면, 정말 운이 좋으신 겁니다!  우린 어떻게 하면 자연의 힘을 받아들여 스스로를 지킬 수 있는지 기쁘게 보여드릴 겁니다.  하려는 마음만 있다면, 누구든지 충성스러운 짐승들을 소환하는 법이나 용의 힘을 이끌어내는 법을 배울 수 있답니다!  이런 능력들은 마법의 힘을 포기하지 않아도 사용할 수 있지만, 대자연의 힘이 얼마나 강력한지 보게 된다면 주문이 더 이상 필요하지 않다는 걸 깨닫게 되실 겁니다. 우린 결코 마법을 포기하라고 강요하진 않을 겁니다. 하지만 좀 더 큰 사명에 헌신하고자 하신다면, 당신의 강사와 점액술사의 길에 대해서 이야기해 보세요.
]], "_t")
t("'On Tolerance'", "'관용에 대하여'", "_t")
...
]], [[우린 시대가 변하고 있다는 걸 알고 있습니다.  다시 되찾게 된 동쪽 대륙의 동포들의 영향으로, 마법을 떨떠름하게 받아들였던 왕국연합은 일 년도 채 되지 않아 마법을 공공연하게 받아들이게 되었습니다.  게다가, 보고받은 내용에 따르면 바르'에이알의 생태계는 아주 건강하며 또 온전한 상태라고 합니다. 그 주민들은 수천 년간 마법을 사용해왔음에도 말입니다.  그러므로, 우리의 관점과 접근방식도 시대에 맞춰 변화해야 합니다. 우린 시대에 뒤떨어진 무지렁이들이 아니니까요.

오늘날, 무분별하게 마법을 사용하는 것이... 그 정도에 다소 차이는 있을지언정 모든 것에 심각한 위협이 된다는 것은, 아주 잘 알려진 사실입니다.  에이알은 황혼의 시대 당시의 무분별한 강령술 사용의 여파로부터 아직까지도 완전히 회복되지 않았습니다. 마법폭발에 대해선 말할 것도 없고요.  이런 일이 반복되는 걸 막을 수 있는 유일한 방법은, 마법 사용을 완전히 중단하는 것뿐입니다...  하지만 태양의 기사들과 아노리실들로 미루어 봤을 때, 마법을 적당히 사용한다면 그 어떤 오염이나 부작용도 일으키지 않을 수도 있습니다.  우리가 오랫동안 믿어 왔던 것과는 달리, 그들은 마법을 안전하게, 또 책임감 있게 사용할 수 있었던 것 같습니다.  우리도 이걸 말도 안 되는 소리라고 치부할 만큼 꽉 막힌 사람들은 아닙니다.  그렇긴 하지만, 마법의 잠재력이 끔찍하다는 것은 변함이 없습니다.  황혼의 시대에 살던 주술사들처럼 타락의 구렁텅이에 빠진 태양의 기사나 아노리실은 이제까지는 한 명도 없었던 것 같지만, 그렇다고 해서 "그들의 마법은 남용될 가능성이 없다" 고 단언할 수는 없습니다.  

다행히, 마법을 대신할 수 있는 것이 있습니다!  대자연에 대한 적절한 관심과 존경심을 갖고 집중을 하면, 누구나 마법과 동등한, 또는 그 이상의 힘을 얻을 수 있습니다.  일상생활 수준에선 마법의 등불 대신에 반딧불이를 소환해 불을 밝힐 수 있고, 회복 주문 대신에 재생 연고를 사용할 수 있으며, 마법으로 만들어낸 음식 대신에 작물들의 성장을 촉진시켜, 영양가 넘치는 식사를 할 수 있습니다.  군사적으로도, 대자연의 힘에 맞설 수 있는 자는 거의 없습니다.  충분한 경험을 쌓은 에이알의 사도는 마법사들의 공격보다 빠르게 충성스러운 짐승들을 소환할 수 있고, 용의 힘을 이끌어내 그 어떤 주문이든 타파할 수 있으며, 파도치는 산성 점액으로 강령술사의 언데드 군단을 녹여버릴 수도 있습니다.  그리고 만약 그 사도가 지구랏의 기술에 능통하다면...  우린 지구랏이 자연을 지키던 방식을 용납할 수는 없지만, 적대적인 마법사를 상대할 수 있는 그들의 기술은 인정하지 않을 수가 없습니다.  하지만 가장 중요한 건, 이런 자연의 힘은 스스로 한계를 정해 둔다는 겁니다!  제멋대로 연쇄 작용이 일어날 일도, 어떤 과대망상증 환자가 에이알을 날려버릴 일도 없습니다.  자연의 힘은 이 행성의 의지가 우리에게 선사하는 것이고, 우리가 힘을 남용하기 시작하면 에이알은 그 힘을 다시 회수할 것입니다.  가장 강력한 자연의 추종자들조차, 자신들의 힘을 잘못된 방향으로 남용할 수는 없습니다. 강령술사들과는 다르게 말입니다.
...
놈들의 헌신은 인정한다.  놈들이 느끼던 좌절감과, 마법 사용자들을 평범하게 대하는 이 세상을 바라보면서 놈들 안에 쌓여갔던 분노도 이해할 수 있다 - 하지만 현실은, 지구르 습격은 그야말로 안락사였다. 세간이 우릴 바라보는 시선이 더 나빠지기 전에 그 광신도들을 죽여준 것이다.  겁주는 걸로 만사를 해결할 수 있는 시대는 이미 지났다 - 그래서, 새로운 접근법을 시도해야 했다.  마법의 공포를 상기시켜주는 게 더 이상 안 통한다면, 마법폭발과 황혼의 시대가 대중들의 기억 속에서 너무 희미해졌다면, 우린 그런 것들 대신에 오늘날에도 직접 볼 수 있는 대자연의 경이로움을 상기시켜 주어야 한다.  대중들이 마법이 사악하다고 믿지 않는다면, 대자연이 더 좋다고 믿게 만들면 된다.  마법을 금기로 만들 수 없다면, 대신 구닥다리로 만들면 되는 것이다...  그리고 이런 식으로 나섰기 때문에 우리가 이전에는 받지 못했던 지지를 받을 수 있었다. 대자연의 아름다움과 마법의 위험성을 배우고 싶어 하는 호기심 많은 사람들 말이다.

그래서 이제 설립 당시에 있던 사람들보다 탈로레들과 젊은이들, 그리고 마법을 증오하는 것보다 자연을 아끼는 게 더 중요한 사람들이 더 많아진 거겠지.  난 이게 뭐가 문제인지 모르겠다. 대자연의 힘이 강해지면, 마법이 끼칠 수 있는 해악에 저항할 수 있는 힘도 강해지는 것 아닌가.  왕국연합과 아침의 문이 맺은 조약, 지구르 습격, 그리고 공격받는 지구랏 순찰대 - 우린 이런 상황에서 살아남기 위해 대자연을 마법 이상으로 강하게 만든다는 발상을 떠올렸고, 실행에 옮겼다.  멘더는 만인을 위해 일하는 이타적인 자선단체고, 그렇게 얻은 평판이 있으면 예전에 미친 광신도 무리의 이미지였을 때와는 비교도 되지 않을 정도의 신뢰 또한 얻을 수 있을 것이다.
...
Firing one as an example didn't work, and I have neither the time nor the inclination to get a bunch of layabouts to do their jobs.  I'm bringing in a yeti handler and excavating the whole area.]], [[진짜 짜증나네.  굴착은 잘 진행되고 있었고 (딱히 성과는 없긴 했지만), 지열 측량 기구의 동료들도 지금 터널 근처에서 우리가 이용할 수 있는 열원을 찾아냈다고 말했다. 그런데 굴착꾼들이 거기로 가길 거부하기 시작했다.  모두가 온갖 잔질병들 - 코피, 떨림, 두려움과 불안함 같은 것들을 격하게 호소했다.  저 밑의 증기가 자기들의 증기구를 뻥 뚫어줬다고 주장하는 사람도 두 명 있긴 했는데.
...
]], [[난 자동기계들을 좋아하지 않는다.  별도의 입력을 받지 않고, 알아서 작동하는 기계들 말이다...  왜냐면, 그것들을 가동하는 데에는 뭔가 기술이나 능력 같은 게 필요 없기 때문이다!  그냥 누군가가 발명해낸 거에 의존하기만 하면 된다고!  장담하는데, 이런 것들에 의존하게 되면 우린 다 망하게 될 거다. 우리의 육체와 정신을 약하게 만들 거라고...  하지만 인정할 건 인정해야겠다 - 일은 잘한다.  이 거미처럼 생긴 기계들을 투입하고 며칠도 안 되어서, 문제의 동굴을 충분히 파낼 수 있었고 (그리고 저 아래에 있던 오염물인지 뭔지도 충분히 제거했을 거고) 덕분에 일꾼들이 다시 그 근처 지역에서 일을 하게 되었다.  이 소동이 전부 무슨 미신이었는지 뭐였는지는 이제 상관없다. 왜냐면 이제 이번 달 할당량을 채울 수 있게 되었으니까. 저 동굴들엔 유망한 지열관들이 아주 많다!
...
t("Sun Paladin report", "태양의 기사의 보고서", "_t")
t([[Lady Aeryn,
...
Anyway, my advice is to request permission to send a few Shining Inquisitors to King Tolak to assist in the investigations on his end.  However they're evading detection here in the East, they either can't use it in the West or simply let their guard down once they're back home, judging from the rising arrest rates - we can help the Allied Kingdoms hit the weak link of this chain, and have the Inquisitors keep an eye on things in Maj'Eyal while they're at it.  Not that I don't trust that King Tolak intends to honor his commitment to keep those foul Ziguranth from ever pulling off anything like the Sunset Massacre again, but...  well, if a farportal altar made it onto the black market under the Allied Kingdoms' watch, possibly courtesy of a mad alchemist who lived practically next door to the King, I don't have too much faith in their ability to drag a bunch of clandestine fanatics into the light, out from the cover of that supposedly-benign Menders group.  I'm sure they're trying their hardest; all I'm suggesting is that we do the same.]], [[아에린 님,

정말 죄송합니다만, 톨락 왕에게는 성과가 없었다고 말씀드려야 하실 겁니다. 저희는 여전히 밀수꾼들이 어떻게 감시망을 피해 밀수를 하고 있는지 알아내지 못했습니다.  가장 확실한 증거는 자치령 항구 (변함없이 병력들이 너무 잘 무장되어 있어서 왕국연합의 전폭적인 지원 없이는 공격할 수 없습니다) 근처 사막에서 지진이 몇 번 일어났던 것인데, 저희는 마법을 써서 굴을 팠다고 생각하고 있지만, 문제는 이게 그냥 마즈'에이알의 영웅께서 미처 처리하지 못하셨던 브리아그흐의 새끼들 몇 마리가 일으킨 것일지도 모른다는 겁니다.  감시 마법도 별 도움이 안 됩니다. 모종의 항-감시 수단이 작동하고 있는 것 같긴 한데, 그게 너무 잘 은폐되어 있어서 이 대륙의 어디에 있는 것인지, 그 대상이 얼마나 많이 있는지 정확히 알 수가 없습니다.  그나마 유일하게 확실해 보이는 건, 밀수꾼 놈들이 또 다른 장거리 차원문을 구해서 조정했다는 것입니다. 왜냐면 우리가 아는 장거리 차원문은 딱 하나, 아침의 문 한복판에 있는 그것뿐이고, 우리 중 70%가 우리 집에 정기적으로 드나드는 노예상과 밀수꾼들을 못 볼 정도로 눈이 나쁘진 않다고 생각하니까 말입니다.  만약 놈들이 그 차원문을 이용했다면, 밀수꾼 패거리 주제에 우리가 아는 것들 중 최고의 투명화 마법을 사용하고 있다는 말이 되겠죠.

...우리가 모르는 마법을 썼을 수도 있습니다만.  뭐, 어느 쪽이든 별 차이는 없겠죠.

아무튼, 전 톨락 왕에게 광휘의 심문관 몇 명을 그쪽으로 보내서 조사를 하게 해 달라고 요청하시는 걸 추천드립니다.  체포율이 상승하고 있는 걸 보니, 놈들이 여기 동쪽 대륙에선 감시를 피하고 있을지 몰라도 서쪽 대륙에선 그 수단을 사용하지 못하는 것 같습니다. 뭐, 고향 땅을 밟고 방심하게 된 걸 수도 있겠습니다만. 우린 왕국연합이 이 연결고리의 취약점을 노리는 것을 도울 수 있습니다. 또, 심문관들이 마즈'에이알에 머물게 되면 사방을 주시하라고 당부해 주십시오.  톨락 왕이 역겨운 지구랏 추종자 놈들이 해질녘의 대학살 같은 짓을 두 번 다시는 벌이지 못하게 하겠다는 약속을 어길 거라고 생각하는 건 아닙니다만, 그래도...  음, 가령 암시장 측에서 왕국연합의 감시망을 피해 장거리 차원문을 확보하고 있다고 쳐 보죠. 그럼 그 차원문에는 분명히, 문자 그대로 왕의 이웃집에 살던 미친 연금술사가 관여했을 테고, 이러면 과연 왕국연합의 사람들이 '온건해 보이는' 멘더의 뒤쪽에 몰래 숨어 있는 광신도들을 적발해낼 수 있을지 의문부호가 찍히는 겁니다.  전 그 사람들이 최선을 다하고 있다고 확신합니다. 그리고 우리도 그 사람들처럼 최선을 다해야 합니다.]], "_t")
t("journal of High Sun Paladin Aeryn", "고위 태양의 기사 아에린의 일지", "_t")
...
All I can hope is that King Tolak has learned something about the Orcs, before his kingdom falls as well.  I do not begrudge him, everything he did was rooted in wisdom and kindness...  and would have worked for any species but the Orcs.  They are the sole exception that deserves no mercy.]], [[그 날이 와 버렸다...  내가 평생 동안 두려워했던 그 날이 왔고, 지금도 충격적이다.  이때까지 살아오며 거의 매일매일 이런 날이 오리라 예상해 왔었지...  작년까지는.  서쪽에서 온 재앙은 긍지들을 굴복시켰고, 검게 탄 상처를 가로질러 달려가, 최고봉의 탑을 휩쓸고 내 곁에서 서서, 내가 감히 상상할 수 있었던 것보다 훨씬 더 강대한 악에 맞서 싸웠다.  그리고 우리는 서쪽의 마즈'에이알과 다시 손을 잡게 되었다. 거의 모든 사람들이 하나의 국가 아래에 모여 기꺼이 협력하고, 오크들을 완전히 통제할 수 있는 계획을 준비한 채로 우릴 어떻게든 도우려는 왕이 이끄는 대륙과...  그건 마치 달이 떠오르며 모든 것이 어둠에 집어삼켜지기 직전에, 지평선 너머로 태양이 떠오르면서 바르'에이알에 평화로운 새 시대가 열리는 것 같았다.  하지만 내 평생의 사랑은 죽은 것 같고, 이제 지난 몇 년간 깜깜한 밤을 밝혀 주던 촛불은 완전히 꺼져 버렸다.  계획은 전부 산산조각났고, 열정은 모두 사그라들었고, 희망은 전부 절망으로 변해버렸다. 이제 아무것도 남아있지 않다... 이제 날 이끌어줄 만한 건 아무것도... 없다.

날 따르는 사람들을 위해서, 난 그들의 빛이 되어야 한다.  난 강인하게, 망설임 없이, 사람들에게 아주 조그만 희망이라도 선사해야 한다.  사람들의 사기를 끌어올리고 태양의 장벽이 몇 세기 동안 맞서 싸워왔던 위협에 승리할 수 있는 기회를 주어야 한다...  그리고 그들이 죽어가면서 최후에, 자신들의 희생이 우리 모두를 구했다고 생각할 수 있도록 해야 한다.  이것들 중 하나 정도는 할 수 있을 것이다.

난 그저, 톨락 왕께서 그분의 왕국도 우리처럼 무너지기 전에, 오크들에 대해서 뭔갈 배우셨길 바랄 뿐이다.  그분을 시기하거나 하진 않는다. 왜냐하면 그분께서 이룩하신 것들은 모두 지혜와 친절로부터 나온 것이니까...  오크가 아니라 다른 종족이었으면 이번에도 성공했을 것이다.  오크들은 자비를 보일 가치가 없는 유일한 예외다.]], "_t")
t("kindness", "친절", "_t")
...
Now I see where kindness and mercy get me.]], [[난 널 감싸 주었다. 난 널 용서하고 싶었고, 우리가 널 해치고 싶지 않다는 걸 알 수 있도록 시간을 주고 싶었다.  우리가 그동안 공포에 떨며 보냈던 시간들과, 우리가 잃은 생명들에 대해서도 용서했다. 내가 네 입장이었다면, 나 역시 똑같은 짓을 저질렀을 테니.

이제 난 그 친절과 자비가 내게 어떻게 돌아왔는지 안다.]], "_t")
t("hope", "희망", "_t")
...
Then, and only then, will you fully understand what you did to me.]], [[쓰러져라.  고통받아라.  널 이끄는 희망을, 네 흉측한 정신 속의 야만스러운 본성을 부숴주마.  나와 똑같은 고통을 느껴라. 그리고 그 고통은 결코, 결코 사라지지 않는다는 걸 깨달아라...  그 고통이, 계속 나아가고자 하는 네 의지를 갉아먹는 게 느껴지지 않나?

나와 똑같은 고통에 네 정신이 산산조각나면, 난 너의 정신을 내 것으로 만들 것이다.  그리고 난 내가 가져간 조그만 희망과 사랑을 다시 네 몸뚱이에 돌려주겠다. 그렇게 네가 몸뚱이에 그저 붙어 있기만 한 상태가 되면, 너의 몸뚱이는 네가 사랑하는 자들을 남김없이 찾아내, 천천히, 고통스럽게 죽이게 될 거다. 그리고 난 그걸 바라보는 너의 눈에서 빛이 사그라드는 걸 볼 수 있겠지.  그들은 널 저주하며 죽어갈 것이고, 힘없는 넌 그걸 멈추지 못할 것이다. 그리고 이런 일이 일어나게 된 건 모두 네 잘못이라는 걸 깨닫게 될 것이다.

그렇게 되고 나서야만, 네가 내게 무슨 짓을 저지른 건지 이해하게 될 거다.]], "_t")

------------------------------------------------
section "tome-orcs/data/lore/weissi.lua"

t("lost city", "잃어버린 도시", "newLore category")
t("telepathic message (1)", "텔레파시 메시지 (1)", "_t")
...
]], [[계단을 내려가자, 돌벽이 나왔습니다. 동굴은 여기서 막혔습니다.  뒤돌아 다시 올라가려는 순간, 등 뒤에서 뭔가 갈라지고 흔들리는 소리가 들렸습니다. 다시 뒤돌아보니 돌이 무너지고 그 뒤에 있던 매끄럽고, 새하얀 문이 드러났습니다.  문은 곧바로 바닥으로 미끄러져 들어갔고, 그 너머에는 처음 보는 구조의 새하얀 복도가 있었습니다. 복도에는 빛을 내는 것이 따로 설치되어 있지 않고, 벽과 바닥과 천장의 작은 조각 하나하나가 전부 (약간 청록색이긴 하지만) 편안한 빛을 내뿜고 있습니다.  분명히 아름답고, 깨끗하고, 평화롭고, 고요하지만...  그럼에도 당신의 본능은 당장 이곳을 빠져나가서 여기서 봤던 것들을 죄다 잊어버려야 한다고 비명을 지르고 있습니다.  벽의 열려 있는 패널 몇 개 너머로 당신의 이해를 넘어서는 온갖 기계들이 보였고, 그중에는 정확히 알아볼 수는 없지만 마법과 초능력으로 작동하는 유물들도 보였습니다. 증기 기술을 사용하는 분쇄기 같은 것도 하나 있었는데, 이 유적과는 안 어울리는 최신 기술이라는 생각이 들었습니다...  당신이 그 분쇄기에 대해서 곰곰이 생각하고 있을 때, 그것은 갑자기 작동하면서 광물을 압착해 마치 마석처럼 생긴 결정을 만들어냈습니다.  그 결정이 깜박거리자 당신을 진정시키는, 하지만 당신의 의식 깊은 곳의 본능을 불안하게 만드는 목소리가 당신의 정신에 울려 퍼집니다.

"환영한다, %s.  우린 네가 오리라 알고 있었다.  안타깝지만, 우린 널 도울 수 없다. 그러나 이 앞에 있는 것은 너의 여정에 도움이 되리라 단언하겠다.  네 안전을 위해 뒤의 문은 봉인하겠다. 네가 떠나고자 할 때 다시 열어 주겠다.  어서 오라.  와서 배우고, 발견하고, 우리의 계획이 서로에게 얼마나 큰 도움이 되는지 깨닫도록 하라."

그것 참...  믿음이 안 가는군.  당신은 함정이 있으리라 예상하며, 조심조심 앞으로 걸어 나갔습니다. 곧장 뒤돌아 달려 나갈 수 있도록--
...
]], [[쉐르'툴에게 형제가 있었다는 것을 알고 있었는가?  그들이 창조되기 훨씬 전, 신들이 아직 어리고 활기찼을 때, 쿠에코르자가 신들에게 함께 에이알에 생명을 불러오자고 설득했었다.  신들이 조금 더 성숙했더라면, 성공했을지도 모른다...  취향과 창조의 방향성 차이로 인해 협력하고자 하는 열정은 식었고, 우리 창조자들의 우정은 미움으로 변해버렸다. 그럼에도 우린 창조되었다.
...
t("telepathic message (3)", "텔레파시 메시지 (3)", "_t")
...
We don't advise learning psychic prognostication with such commitment as we did.  To see this many possibilities, to gaze into infinity with such detail without infinity gazing back...  you have to feel it.  Every spear through our hearts, every limb burned off...  and we all did it together, linking our minds to accomplish this, so all of us have suffered through this.  And after all that, we still can't be 100% sure it's accurate, although we've gotten to more 9s after 99.9% than we can actually count.]], [[네가 우릴 죽였었다는 것을 알고 있었는가? 어떤 미래에서, 강철 드레이크 위에 서서 우리 종족을 절멸하라 명령했었다.  다른 미래들에선 자치령이, 왕국연합이, 불꽃장이회가, 지구르-탈로레 동맹이, 그 외 수많은 필멸자들의 도시와 국가들이 우릴 죽였었다.  우린 게를릭에게 갈가리 찢기기도 했고, 지도자 아르고니엘이나 수석 천재 탄넨 (그래, 그 오만한 얼간이가 자길 그렇게 불렀다) 의 주도로 앙골웬에서 해부되기도 했다.  아스텔리드 수녀를 따르는 새로운 최고 의회에게 잡아먹히기도 했고 (문자 그대로도, 비유적으로도), 위대한 타락자가 퍼뜨린 역병 때문에 전멸하기도 했으며, 날로레들이 일으킨 홍수에 휩쓸려 익사하기도 했고, 다시 태어난 진홍의 용족들에게 잿더미가 되기도 했다.  악마들과 탑의 주인의 언데드 하수인들에게 붙잡혀 고문 노리개가 된 적도 있고, 레크놀 연맹에게 사냥당해 마법 시약이 된 적도 있으며, 위대한 증기 공화국의 계산 기계가 되기도 했다.
...
]], [[네가 크룩 긍지를 지키기 위해 나서지 않았다면 어떻게 되었을지 알고 있는가?  왕국연합이 이 세계 전체를 손에 넣기 위해 나섰을 수도 있다.  하나로 통합된 군대가, 하나의 깃발 아래에서 진격하며, 우리가 부활했을 때 우리를 없애버렸을 것이다...  더 큰 위협이 없었더라면 그렇게 되었을 것이다.  우린 그것을 원하지 않고, 너 또한 마찬가지다.

우린 널 속일 작정이다. 우리가 태어난 과정에서 한 가지 배운 것이 있다면, 서로가 급박한 상태에서 이해관계가 맞아떨어진다면 협력하는 데에 존중과 동맹 같은 것은 필요치 않다는 것이다.  우린 너의 능력을 강화하고, 네게 새로운 지식을 선사할 수 있는 기계를 준비했다...  이것은 당장 에이알의 멸망을 막는 데에 도움이 될 것이고, 오크들이 영토를 얻을 수 있게 해 줄 것이다.  그 영토를 지키려면 싸워야 할 것이다. 자치령, 왕국연합, 스스로를 악마라 부르는 말'록인들, 그리고 날로레 생존자들에게 맞서서...  몇몇 아주 특별한 손님들도 오게 될 테지만, 그건 그때 직접 보는 게 즐거울 것이니 굳이 미리 알려주진 않겠다.  걱정하지 마라, 우린 그런 자들을 도울 생각은 없으니. 그리고 너도, 그들도, 결국에는 우리의 등에 칼을 꽂으려 들 것이다.
...
t("telepathic message (5)", "텔레파시 메시지 (5)", "_t")
...
t("telepathic message (6)", "텔레파시 메시지 (6)", "_t")
...
DO YOU KNOW OUR NAME?#{normal}#]], [[#{bold}#웨이시

우리의 이름을 알겠는가?#{normal}#]], "_t")
t([[#{italic}#(Somehow the name seems to have faded from your memory!)#{normal}#

DO YOU KNOW OUR NAME?#{normal}#]], [[#{italic}#(어찌된 일인지 그 이름이 기억 속에서 사라진 것 같습니다!)#{normal}#

우리의 이름을 알겠는가?#{normal}#]], "_t")

------------------------------------------------
section "tome-orcs/data/lore/yeti.lua"

t("yeti's cave", "예티 동굴", "newLore category")
t("crude cave painting (1)", "조악한 동굴 벽화 (1)", "_t")
t("You see here a crude cave painting, depicting a drake attacking a group of yetis, as an indistinct figure watches over them.  To the right, you see a drawing of the figure attacking the drake, and the yetis cheering.", "조악한 벽화입니다. 예티 무리를 공격하고 있는 드레이크와, 잘 알아볼 수 없는 형체가 그것들을 지켜보고 있는 장면이 그려져 있습니다.  오른쪽에는 그 형체가 드레이크를 공격하고 있고, 예티들이 환호하고 있는 장면이 있습니다.", "_t")
t("crude cave painting (2)", "조악한 동굴 벽화 (2)", "_t")
t("You see here a cave painting, depicting a giant attempting to lead some yetis away in chains, but being pulled down and mauled by other yetis.", "조악한 벽화입니다. 한 거인이 예티 몇 마리를 사슬로 묶어 끌고 가려고 하고, 다른 예티들이 거인을 넘어뜨리고 쥐어패고 있는 장면이 그려져 있습니다.", "_t")
t("crude cave painting (3)", "조악한 동굴 벽화 (3)", "_t")
t("You see here a cave painting, depicting a giant holding an object, which is projecting some sort of beam at a yeti.  The affected yeti is walking toward the giant, while other yetis are looking on in horror.", "조악한 벽화입니다. 거인이 무언가를 들고 있고, 그것에서 광선 같은 것이 예티를 향해 뿜어져 나오고 있는 장면이 그려져 있습니다.  광선을 맞은 예티는 거인 쪽으로 걸어가고 있고, 다른 예티들은 겁을 먹고 그 모습을 바라보고 있습니다.", "_t")
...
t("The Dead God Awaits", "죽은 신이 기다린다", "_t")
...
t("Regardless...  You just killed a god and gave your people the first chance to relax in thousands of years.  It's been a pretty good day.", "아무튼... 당신은 방금 신을 죽였고, 당신의 동포들에게 수천 년의 역사 동안 처음으로 편안하게 쉴 기회를 준 겁니다. 오늘은 정말 멋진 날이네요.", "_t")
...
------------------------------------------------
section "tome-orcs/data/quests/annihilator.lua"
...
------------------------------------------------
section "tome-orcs/data/quests/destroy-sunwall.lua"
...
------------------------------------------------
section "tome-orcs/data/quests/kaltor-shop.lua"
...
------------------------------------------------
section "tome-orcs/data/quests/kill-dominion.lua"
...
------------------------------------------------
section "tome-orcs/data/quests/krimbul.lua"
...
------------------------------------------------
section "tome-orcs/data/quests/voyage.lua"
...
t("Fires out a bolt of cosmic energy in the target direction. The projectile continues until it hits a wall or the edge of the map, dealing %0.2f dark damage to enemies hit and restoring %d negative energy. The negative energy gained is reduced by 25%% per enemy hit, restoring a maximum of %d. Enemies hit will become aware of you.", "대상 방향으로 우주 에너지의 화살을 날립니다. 투사체는 벽에 닿거나, 맵의 끝에 닿을 때까지 계속 움직입니다. 화살은 %0.2f 어둠 피해를 주며, 시전자는 음기를 %d 회복합니다. 음기 회복량은 피격당한 적마다 25%% 씩 감소합니다. 최대 %d 음기를 회복할 수 있습니다. 공격받은 적은 시전자의 존재를 알아차리게 됩니다.", "tformat")
...
t([[Fire an orb of negative energy towards a spot within range %d.
		...
		The speed of the projectile (%d%%) increases with your movement speed]], [[음기의 구체를 반경 %d 칸 내의 위치로 날립니다.
		구체가 목적지에 닿으면 시전자는 해당 위치로 순간이동합니다.
...
t([[Sends out a slow-moving spiral of cosmic energy towards a target location within range 8.
		As the cosmic energy moves, it pulls in targets adjacent to it %s, dealing %0.2f darkness damage and granting you 1 negative energy per hit.]], [[느린 속도로 움직이는 우주 에너지의 나선을 반경 8 칸 내의 지점을 향해 방출합니다.
		우주 에너지는 나아가면서 인근의 적들을 끌어모으며 %s %0.2f 어둠 피해를 가하고 피격당한 대상당 음기를 1 회복합니다.]], "tformat")
...
t([[Expend all of your negative energy to create a massive burst of dark energy (radius %d) at a target location within range %d.
		...
		The damage increases with your spellpower, and the damage, radius and pin duration all increase with negative energy and talent level]], [[시전자의 음기를 전부 끌어모아 반경 %d 칸의 거대한 암흑 에너지 폭발을 일으킵니다. %d 칸 내의 위치를 폭발 진원지로 선택할 수 있습니다.
		폭발은 %0.2f 어둠 피해를 주고 피격당한 대상을 %d 턴 동안 속박합니다 %s.
		피해량은 주문력에 비례하고, 피해량과 범위, 속박 지속시간은 소모한 음기와 기술 레벨에 비례하여 증가합니다.]], "tformat")
...
t("Swap your current positive and negative energy levels. This spell takes no time to cast.", "시전자의 양기와 음기 수치를 맞바꿉니다. 이 주문은 턴을 소모하지 않습니다.", "_t")
t("Plasma Bolt", "플라스마 화살", "talent name")
t("Fires out a bolt of pure energy, dealing %0.2f light and %0.2f darkness damage in a radius of %d, and slowing targets hit %s. Their movement is reduced by %d%% and attacking, casting and mind attacks by %d%%. The bolt will attune to your current positive and negative energy amounts.", "순수한 에너지의 화살을 쏘아 %0.2f 빛 피해와 %0.2f 어둠 피해를 반경 %d 칸 내의 모든 적에게 가하고 감속시킵니다 %s. 이동 속도는 %d%% 감소하며, 공격, 시전, 사고 속도는 %d%% 감소합니다. 이 기술의 효과는 현재 시전자의 양기/음기에 비례하여 증가합니다.", "tformat")

------------------------------------------------
section "tome-orcs/data/talents/celestial/reflection.lua"

t("Diffraction Pulse", "회절 파동", "talent name")
t("Create a distortion at the target tile, knocking back all projectiles and changing their direction to face away if possible.", "대상 위치를 왜곡해, 모든 투사체를 뒤로 밀칩니다. 가능하다면 밀쳐낸 투사체들의 진행 방향을 뒤집어 공격자에게 돌려줍니다.", "_t")
...
t("Target a projectile in mid-flight to clone it and target that projectile independently. You gain ownership over the new projectile.", "비행 중인 투사체를 하나 복제하고 원하는 곳으로 날립니다. 복제된 투사체는 시전자의 능력치에 영향을 받습니다.", "_t")
...
t("Fire out an orb of light that deals %0.2f light damage and then returns, dealing the same amount of damage again and reducing the cooldown by half (%d) when it reaches you. The damage will increase with your spellpower. The ball will travel at most %d distance to return to you.", "빛의 구체를 날려 %0.2f 빛 피해를 주고 다시 시전자에게 돌아오게 합니다. 돌아올 때도 같은 피해를 가하며, 완전히 돌아오면 이 기술의 재사용 대기시간이 절반으로 줄어듭니다 (%d 턴). 피해량은 주문력에 비례하여 증가합니다. 돌아올 때 태양의 구체가 %d 칸 이상 이동하게 되면 소멸합니다.", "tformat")
t("Solar Wind", "태양풍", "talent name")
t("While sustained, this ability speeds up outgoing projectiles by %d%% while slowing incoming projectiles by %d%%. The increase and decrease improve with your spellpower", "활성화되면 시전자가 쏘는 투사체가 %d%% 빨라지고, 시전자에게 다가오는 투사체가 %d%% 느려집니다. 증감량은 주문력에 비례하여 증가합니다.", "tformat")
t("Lucent Wrath", "번쩍이는 분노", "talent name")
t("After %d turns, the target area in (radius %d) is blasted with a beam of light, dealing %0.2f damage and lighting the area", "%d 턴 후에, 반경 %d 칸 범위를 빛의 광선으로 쓸어버립니다. 광선은 %0.2f 빛 피해를 주고 해당 지역을 밝힙니다.", "tformat")
t("Lightspeed", "빛의 속도", "talent name")
t("%s moves at light speed!", "%s 빛의 속도로 움직인다!", "logSeen", nil, {"는"})
t("Instantly gain %d%% percent of a turn.", "즉시 한 턴의 %d%% 를 얻습니다.", "tformat")

------------------------------------------------
section "tome-orcs/data/talents/celestial/void.lua"

t("Nebula Spear", "성운의 창", "talent name")
t("Fire out a spear of cosmic energies. If it hits an enemy it deals %0.2f damage, otherwise it explodes in a thin cone of radius %d at the end of its range, blocked by enemies, which deals %0.2f to %0.2f damage depending on how much the enemies block.", "우주 에너지의 창을 날립니다. 명중하면 %0.2f 피해를 가합니다. 명중하지 못하면 사거리 끝에서 반경 %d 칸의 가늘고 긴 원뿔 범위의 폭발을 일으켜 %0.2f - %0.2f 피해를 가합니다. 폭발의 피해량은 적이 폭발점에 가까울수록 증가합니다.", "tformat")
t("Crescent Wave", "초승달의 파도", "talent name")
t("Fires out a projectile in a clockwise arc. If it hits an enemy it deals %0.2f damage and roots them for one turn. If another projectile damages them within %d turns, they take half that damage and are rooted again.", "시계 방향으로 호를 그리며 나아가는 투사체를 쏩니다. 명중하면 %0.2f 피해를 주고 1 턴 동안 속박합니다. 이후 %d 턴 동안 또다른 투사체에 의해 피해를 받게 되면, 그 피해량의 절반을 추가로 받고 다시 속박됩니다.", "_t")
t("Twilit Echoes", "황혼의 반향", "talent name")
...
빛 피해는 대상을 %d 턴 동안, 피해 1 당 %0.2f%% 감속시킵니다. 최대 %d 피해에서 %d%% 감속됩니다.
어둠 피해는 %d 턴 동안 대상이 마지막으로 받은 어둠 피해의 %d%% 만큼 피해를 주는 장막을 해당 위치에 만듭니다. 이 장막은 황혼의 반향이 활성화되어 있다면 대상이 각종 어둠 피해를 받을 때마다 장막의 남은 피해량과 새로 받은 피해량을 합하여 지속시간과 피해량을 갱신합니다.]], "tformat", {1,3,2,5,4,6,7})
t("Starscape", "우주", "talent name")
t("This spell cannot be cast here.", "이 주문은 이곳에서 시전할 수 없다.", "logPlayer")
t("Summons the starscape in the surrounding area in a radius of %d. For %d turns, this area exists outside normal time, and in zero gravity. In addition to the effects of zero gravity, Movement of projectiles and other creatures is three times as slow. Spells and attacks cannot escape the radius until the effect ends.", "주변 반경 %d 칸에 우주 그 자체를 %d 턴 동안 소환합니다. 해당 장소는 정상적인 시간의 흐름에서 이탈하게 되고, 무중력 상태가 됩니다. 무중력 상태는 투사체 속도와 이동 속도를 3 배 느리게 합니다. 각종 주문과 공격들은 우주가 사라질 때까지 그 범위 밖으로 벗어날 수 없습니다.", "tformat")

------------------------------------------------
section "tome-orcs/data/talents/misc/npcs.lua"

t("Petrifying Gaze", "석화의 응시", "talent name")
t([[Gaze at your foes and turn them to stone for %d turns %s.
		...
		This spell may fail against creatures resistant to being stunned, that are specifically immune to stoning, or certain bosses.]], [[적을 응시해 %d 턴 동안 돌로 변하게 합니다 %s.
		석화된 대상은 움직일 수 없고 생명력을 재생할 수도 없으며 매우 연약해집니다.
		석화된 대상은 최대 생명력의 30%% 이상의 피해를 단번에 받으면 부서져 산산조각납니다.
		석화된 대상은 화염과 전기에 대한 높은 저항력을 갖게 되고, 물리 공격에도 어느 정도 잘 버티게 됩니다.
		이 기술은 기절 면역력을 갖고 있는 개체에게는 실패할 수도 있습니다. 특히 석화 면역력을 가진 적이나, 몇몇 보스들에게는 통하지 않습니다.]], "tformat")
t("Gnashing Maw", "악무는 아가리", "talent name")
t("Hits the target with your weapon, doing %d%% damage. If the attack hits, the target's Accuracy is reduced by %d for %d turns %s.", "무기로 대상을 공격해 %d%% 피해를 줍니다. 공격이 명중하면 대상의 정확도가 %d 턴 동안 %d 감소합니다 %s.", "tformat", {1,3,2,4})
...
t([[Dive into the sand and rush towards your target at up to range %d, gaining a free attack if you reach it.
		...
		You must rush from at least 2 tiles away.]], [[모래 속으로 파고든 다음 반경 %d 칸 내의 적에게 돌진합니다. 적에게 닿으면 턴을 소모하지 않고 공격을 가합니다.
		빠져나온 지점 근처에 모래 구덩이가 최대 9 개까지 생기고, %d 턴 동안 유지됩니다 (힘 능력치에 비례).
...
t([[Sting the target with your ovipositor, injecting %d larvae into it to finish their hatching process %s.
		...
		]], [[대상을 산란관으로 찔러 애벌레 %d 마리를 주입하고 부화 과정을 끝냅니다 %s.
		잉태 기간 5 턴 동안 애벌레가 숙주의 내부를 파먹어 %0.2f - %0.2f 물리 피해를 매 턴 가합니다 (벌레가 자랄수록 피해량이 증가합니다.).
...
t("The Dead God slumbers. For now.", "죽은 신은 깊은 잠에 들었습니다. 지금은요.", "_t")
...
t([[Create a circle of cursed ground (radius %d) for %d turns. Any foes inside will be cursed, all new negative effects on them will have their duration doubled.
		]], [[반경 %d 칸의 저주의 마법진을 %d 턴 동안 만듭니다. 안쪽의 적들은 저주를 받아, 새로 받는 부정적 효과들의 지속시간이 2 배로 늘어납니다.
		]], "tformat")
...
t([[Creates a circle of radius %d of altered time for %d turns. Any damage your foes take while standing in it will heal the attacker for 200%% of the damage dealt.
		]], [[반경 %d 칸의 대체 시간의 마법진을 %d 턴 동안 만듭니다. 안쪽의 적들이 받는 피해의 2 배만큼 공격자의 생명력이 회복됩니다.
		]], "tformat")
...
t([[Summon a storm of swirling sawblades to slice your foes, inflicting %d physical damage and bleeding to anyone who approaches for %d turns.
		The damage and duration will increase with your Mindpower.]], [[소용돌이치는 톱날의 폭풍을 일으켜 적들을 찢습니다. %d 물리 피해를 가하고, 안쪽의 모든 대상에게 %d 턴 동안 지속되는 출혈을 일으킵니다.
...
t([[Launches a sawblade with intense power doing %0.2f physical damage to all targets in line.
		The damage will increase with Mindpower]], [[톱날을 발사해 경로 상의 모든 적에게 %0.2f 물리 피해를 가합니다.
...
t([[Dash forward using rockets.
		...
		해당 위치에 적이 있다면 턴을 소모하지 않고 근접 공격을 가합니다.
		이 공격은 130% 무기 피해를 가합니다.
		돌진하려면 목표 지점과 적어도 2 칸 이상 떨어져 있어야 합니다.]], "_t")
...
t("Steam powers of the various objects of the world.", "세상의 다양한 물체의 증기 능력들입니다.", "_t")
...
t([[Instantly grow a moss circle of radius %d at target area.
		...
		The damage will increase with your Mindpower.]], [[시전자 기준 반경 %d 칸 내에 이끼들을 급성장시킵니다.
		매 턴, 이끼는 %0.2f 자연 피해를 범위 내의 모든 적에게 가합니다.
		이 이끼는 두껍고 끈적이기 때문에, 이끼 위의 적들은 이동 속도가 %d%% 감소하고 %s, %d%% 확률로 4 턴 동안 속박됩니다 %s.
		이끼는 %d 턴 동안 지속됩니다.
		이끼 계열 기술들은 턴을 소모하지 않지만 다른 모든 이끼 기술이 3 턴간 재사용 대기 상태가 됩니다.
		피해량은 정신력에 비례하여 증가합니다.]], "tformat")
...
Damage dealt by this talent is increased by half your critical multiplier, if doing so would kill the target.]], [[적에게 매우 치명적인 사격을 가해 %d%% 피해를 줍니다.
...
t([[Dash forward using rockets.
		...
		돌진하려면 목표 지점과 적어도 2 칸 이상 떨어져 있어야 합니다.]], "tformat")
...
t([[Unleash the ultimate power of the Gloryhammer to all foes around in radius 1.
		This attack creates an explosion of radius 1 around every affected target, dealing 50%% weapon damage and blinding them for 4 turns %s.]], [[시전자와 인접한 모든 적에게 글로리해머의 절대적인 힘을 해방합니다.
		이 공격은 적들마다 반경 1 칸의 폭발을 일으켜 50%% 무기 피해를 가하고 4 턴 동안 실명시킵니다 %s.]], "tformat")
...
t([[Your yeti is attuned to the cold climates.
		...
		지속시간 중에는 손쉽게 얼음을 관통할 수 있습니다. 얼음덩어리의 피해 흡수량이 50%% 감소합니다.
		이 효과는 의지 능력치에 비례하여 증가합니다.]], "tformat")
t("Thick Fur", "두꺼운 털", "talent name")
t("Your yeti's fur acts like a shield, providing %d%% cold resistance, %d%% physical resistance and %d magical save.", "예티의 털이 방패 역할을 합니다. 냉기 저항이 %d%%, 물리 저항이 %d%%, 주문 내성이 %d 증가합니다.", "tformat")
...
t([[Your yeti's body is very resilient to detrimental effects.
		...
		이 효과는 생명력을 %d 회복시키고, 한 턴에 최대 3 번까지만 일어납니다.
...
t([[You willingly fry a few parts of your yeti's brain to trigger a huge psionic blast in cone of radius %d.
		...
		The damage will increase with your Constitution.]], [[예티 육체의 뇌 일부분을 튀겨, 강력한 정신파를 반경 %d 칸의 원뿔 범위에 방출합니다.
		범위 내의 적은 %0.2f 정신 피해를 받고 %d 턴 동안 35%% 위력의 혼란에 걸립니다 %s.
		피해량은 체격 능력치에 비례하여 증가합니다.]], "tformat")
...
t([[Improves your undead body, increasing Strength and Magic by %d.
		...
		또한 이동할 때마다 최대 %d 번까지 중첩되는 죽음의 기세 중첩을 얻어, 중첩당 이동 속도가 20%% 증가합니다.
		이동을 하지 않으면 중첩을 하나씩 잃게 됩니다.]], "tformat")
t("Dead Hide", "죽은 가죽", "talent name")
t("Your undead skin hardens under stress. Each charge of death momentum also increases all flat damage resistance by %d.", "언데드 가죽이 자극을 받아 경화됩니다. 죽음의 기세 중첩당 모든 속성에 대한 고정 피해 감소 %d 를 얻습니다.", "tformat")
...
t([[You summon your undead energies to instantly build up death momentum to its maximum possible charges.
		...
		이 효과로 얻은 중첩은 %d 턴이 지나야 사라지기 시작합니다.
		추가로, 죽음의 기세 중첩당 가하는 모든 피해가 %d%% 증가합니다.]], "tformat")
...
t([[You send a wave of darkness at your foe, dealing %0.2f darkness damage.
		...
		The damage scales with your Magic stat.]], [[어둠의 파장을 적에게 날려 %0.2f 어둠 피해를 줍니다.
		이 어둠은 적의 생명 정수를 조금 흡수하여 죽음의 기세 중첩이 감소할 때까지의 시간을 %d 턴 늘립니다 (이 효과는 살아있는 생명체가 대상일 때만 일어납니다).
		이 기술은 죽음의 기세 중첩이 있을 때만 사용 가능합니다.
...
t([[Condensate hot steam around your foes in radius %d, burning them for %0.2f fire damage and applying the wet effect for 4 turns %s, halving their stun resistances.
		The damage will increase with your Mindpower.]], [[뜨거운 증기를 반경 %d 칸 내의 적들에게 응축시킵니다. 적들에게 화상을 입혀 %0.2f 화염 피해를 주고, 4 턴간 유지되는 젖음 효과를 겁니다 %s. 젖음은 기절 면역력을 반으로 줄입니다.
		피해량은 정신력에 비례하여 증가합니다.]], "tformat")
t("Solidify Air", "공기 응고", "talent name")
t("solid air", "응고된 공기", "_t")
t("a piece of solidified air", "응고된 공기의 파편", "_t")
...
t([[Call a streak of lightning on your target, dealing %0.2f to %0.2f lightning damage.
		...
		대상이 젖은 상태라면 반경 %d 칸 내의 모든 적에게 전류가 퍼져 같은 피해를 가합니다.
		영향을 받은 적은 그을리게 되어 %s 4 턴 동안 화염 저항이 %d%%, 정신 내성이 %d 감소합니다.
		피해량은 정신력에 비례하여 증가합니다.]], "tformat")
...
t([[You let your mind tap into your steam generators for energy, increasing your Mindpower in proportion to your steam level: %d when at full steam and 0 when at 0 steam.
		...
		The effects increase with your Willpower.]], [[증기 발생기에 정신을 연결하여 그 에너지를 이용합니다. 남아있는 증기 수치에 비례하여 정신력이 증가합니다 (증기가 최대치일 때 %d / 증기가 0 일 때 0).
		초능력 계열 기술을 사용할 때마다 증기 발생기가 영향을 받아, 다음 번에 증기 공학 계열 기술을 사용할 때 증기력이 %d 추가됩니다.
		증기 공학 계열 기술을 사용할 때마다 초능력 집중이 영향을 받아, 염력을 %d 회복합니다.
		이 효과는 의지 능력치에 비례하여 증가합니다.]], "tformat")
...
t([[When you use a steamtech talent while Gestalt is active you drain some residual power to form a psionic shield.
		...
		The effects increase with your Mindpower.]], [[게슈탈트가 활성화된 동안, 증기 공학 계열 기술을 쓸 때마다 남은 힘을 약간 흡수해 초능력 보호막을 만듭니다.
		보호막은 3 턴 동안 지속되며, %d 피해를 흡수합니다.
		효과는 정신력에 비례하여 증가합니다.]], "tformat")
t("Instant Channeling", "순간 집중", "talent name")
t("You must have either a psionic damage shield active or Improved Gestalt available to use this talent.", "초능력 피해 보호막이 있거나, 향상된 게슈탈트를 쓸 수 있어야 이 기술을 사용할 수 있다.", "logPlayer")
t([[Instantly channel all of your remaining steam to replenish your psi energies and either enhance your active psionic damage shield or trigger a new one.
		...
		This talent requires Gestalt to be active and either an active psionic damage shield or Improved Gestalt off cooldown.]], [[순간적으로 남아있는 증기를 전부 배출하여 염력을 보충하고, 초능력 보호막을 강화하거나 새로 만들어냅니다.
		이 효과로 강화되거나 만들어진 보호막의 지속시간은 3 턴 늘어나고, 보호막의 강도는 소모한 증기의 %d%% 만큼 강화됩니다.
		시전자는 사용된 증기의 %d%% 에 해당하는 염력을 회복합니다.
		이 기술을 사용하려면 게슈탈트가 활성화되어 있어야 하고, 초능력 피해 보호막이 있거나 향상된 게슈탈트를 쓸 수 있어야 합니다.]], "tformat")
...
t([[Temporarily expand your mind to force your Gestalt upon your foes in a radius of 5. Up to %d foe(s) will be affected.
		...
		게슈탈트는 5 턴 동안 영향을 받은 적의 물리력/주문력/정신력/증기력을 %d 만큼 흡수합니다 %s.
		시전자의 물리, 주문, 정신, 증기력은 흡수한 만큼 상승합니다 (흡수한 적이 많아질수록 추가 상승량이 적어집니다).
		더해서 5 턴 동안 시전자는 반경 %d 칸 내의 모든 존재들을 감지할 수 있게 됩니다.
		이 효과는 정신력에 비례하여 증가합니다.]], "tformat")

------------------------------------------------
section "tome-orcs/data/talents/psionic/psionic-fog.lua"

t("Vaporous Step", "증기 걸음", "talent name")
t([[You concentrate your will to psychoport some of the steam of your generator to a remote location. Each turn steam accumulates there, up to %d charges.
		...
		The damage will increase with your Steampower.]], [[의지를 집중해 증기 발생기의 증기 일부를 순간이동시킵니다. 매 턴 증기가 해당 위치에 쌓이고, 최대 %d 번까지 중첩됩니다.
		이 기술을 비활성화하면 시전자는 모아둔 초능력과 증기 에너지를 해방하여, 쌓인 증기와 즉시 위치를 맞바꾼 다음 폭발시켜 반경 4 칸의 뜨거운 수증기 폭발을 일으킵니다.
		폭발은 %0.2f 화염 피해를 주고 중첩마다 피해량이 33%%씩 상승합니다 (상승량은 중첩마다 점점 감소함). 폭발에 휘말린 적은 젖음 상태가 됩니다 %s.
		비활성화했을 때 쌓인 증기의 위치에 누군가 있거나, 증기가 시야 밖에 있다면 기술이 실패합니다.
...
t([[When you deactivate Vaporous Step, if the psychoport succeeds you inhale some of the vapours, regenerating %d steam and %d life.
		...
		The healing done will increase with your Mindpower.]], [[증기 걸음을 비활성화하여 순간이동에 성공하면 폭발한 증기를 약간 들이마셔 증기를 %d, 생명력을 %d 회복합니다.
		중첩마다 회복량이 33%%씩 상승합니다 (상승량은 중첩마다 점점 감소함).
...
t([[While inside a psionic fog the quantum state of space is warped by your powerful tech-augmented psionic powers.
		...
		공격을 받으면 시전자는 인접한 칸으로 이동해 있게 됩니다.
...
t("Galvanic Rod", "전열 막대", "talent name")
t("You need an arcane dynamo to cast this spell.", "이 기술을 사용하려면 비전 발전기가 필요하다.", "logPlayer")
t([[You summon a galvanic rod at a location. Upon arrival the rod releases a shock in radius %d dealing %0.2f galvanic damage (fire and lightning) to all creatures.
		...
		The damage will increase with your Spellpower.]], [[전열 막대를 해당 위치에 소환합니다. 전열 막대는 소환 즉시 반경 %d 칸에 %0.2f 전열 피해 (화염/전기 피해) 를 가합니다.
...
t([[Using your arcane power you force galvanic rods to linger for %d turns. While lingering they are inert, but can link up to other rods.
		...
		The damage will increase with your Spellpower.]], [[마법의 힘으로 전열 막대의 지속시간을 강제로 %d 턴 늘립니다. 강제로 연장된 시간 동안 전열 막대는 비활성화되지만, 변함없이 다른 막대들과 연결될 수 있습니다.
		2 개의 전열 막대가 서로의 반경 %d 칸 안에 있다면 막대들은 전열 전류로 연결됩니다.
		3 개의 전열 막대가 서로의 반경 %d 칸 안에 있다면 막대들은 삼각형의 전열 지대를 형성합니다.
		전열 전류나 전열 지대 안쪽의 모든 개체는 턴마다 %0.2f 전열 피해를 받습니다.
		유지할 수 있는 전열 막대는 최대 3 개까지입니다.
		기술 레벨 3 부터, 영향을 받은 모든 개체에 전기 충격 효과를 일으켜 기절 면역력과 속박 면역력을 절반으로 낮춥니다 %s.
		기술 레벨 5 부터, 시전자의 무기는 (금속 재질이거나, 금속제 발명품을 장착하면) 전열 막대처럼 작동하며, 이는 막대 개수 제한에 포함되지 않습니다.
		태풍이 눈이 활성화 중이라면 이 주문은 15%% 확률로 태풍을 일으킵니다.
		피해량은 주문력에 비례하여 증가합니다.]], "tformat")
...
t([[Reaching through the aether you temporarily destabilize a galvanic rod's control systems. (Using your weapon as a rod does not count as a valid target)
		...
		This spell works with Burning Wake.
		The damage will increase with your Spellpower.]], [[에테르의 힘을 이용하여 전열 막대의 제어 시스템을 일시적으로 폭주시킵니다 (전열 막대로 취급되는 시전자의 무기는 대상이 되지 않습니다).
		지정한 막대에 반경 1 칸의 폭발이 일어나고, 연결되어 있는 막대들에도 폭발이 일어납니다. 폭발은 %0.2f 전열 피해를 가하며, %d 턴 동안 기절시킵니다 %s.
		이 주문은 타오르는 궤적의 효과를 받습니다.
		피해량은 주문력에 비례하여 증가합니다.]], "tformat")
t("Energy Mass Conversion", "에너지 질량 전환", "talent name")
t("You need Galvanic Arcing active and three rods to cast this spell.", "이 기술을 사용하기 위해서는 전열 지대가 형성되어 있어야 한다.", "logPlayer")
t([[Using large amounts of arcane power you create a supercharged Unstable Blast in your rods.
		...
		Can only be used with a triangular field is setup.]], [[엄청난 양의 마법력을 쏟아부어 전열 막대들에 더욱 강한 불안정한 폭발을 일으킵니다.
		폭발 이후 남은 에너지는 막대한 질량으로 전환되어, 각 막대들의 반경 %d 칸 내의 모든 개체를 전열 지대 한가운데로 끌어당깁니다 (시전자 제외) %s.
		이 기술은 전열 지대가 형성되어 있어야 사용 가능합니다.]], "tformat", {2,1})
...
t([[You imbue a steamsaw with arcane and temporal forces, making it spin very fast around your waist (ignoring requirements).
		...
		]], [[증기톱에 비전과 시간의 힘을 채워, 허리 주변에서 엄청난 속도로 회전하게 합니다 (장착 요구 조건을 무시합니다).
		톱은 주변의 시공간을 불안정하게 만들 정도로 빠르게 회전합니다. 시전자의 주문력이 최대 %d, 치명타 확률이 %d, 마나 재생이 %0.1f 증가합니다 (증기톱의 등급에 비례해 증가합니다).
		근접 공격에 맞게 되면 증기톱이 즉시 반격해 %d%% 무기 피해를 비술 속성 (비전/시간 피해) 으로 줍니다. 반격은 빗나가지 않습니다.
		증기톱이 가진 각종 효과들은 장비한 것처럼 적용되지만, 방패 막기를 사용할 수는 없습니다.
		또한 증기톱 공격의 피해량이 %d%% 상승하고 피해량을 계산할 때 힘 대신 마법을 이용합니다.
		에테르의 화신이 발동 중이라면 비술 마도공학 계열의 모든 주문을 지원하게 되고, 비술 피해가 순수 비전 피해로 전환됩니다.
...
t([[Spin your saw at incredible speeds for an instant, fully breaking reality in a 3-wide beam in front of you.
		...
		The damage will increase with your Spellpower.]], [[잠깐 동안 톱을 믿을 수 없을 정도로 빠르게 회전시켜, 현실의 구조를 완전히 파괴하고 3 칸 두께의 광선을 쏘아냅니다.
		광선에 맞은 개체는 %0.2f 비술 피해를 받고, 현실에서 단절되어 %s 4 턴 동안 전체 속도가 %d%% 감소합니다. 영향을 받은 적이 발사하는 투사체 속도도 %d%% 감소합니다.
		기술 레벨 3 부터, 광선에 맞은 투사체는 즉시 소멸합니다.
		기술 레벨 5 부터, 광선이 무지막지한 힘을 발휘하게 되어 모든 개체를 3 칸 밀칩니다 %s.
		현실에 발생한 균열은 너무나도 깊어, 광선은 언제나 최대 사거리까지 발사됩니다.
		피해량은 주문력에 비례하여 증가합니다.]], "tformat")
...
t([[You reach out through the aether to all creatures in sight that were slowed by Reality Breach or Congeal Time.
		...
		시전자는 각 대상과 비전의 힘이 주입된 증기로 %d 턴 동안 연결됩니다 %s.
		대상이 기술을 사용할 때마다 시전자가 가진 주문 하나의 재사용 대기시간이 1 턴 단축됩니다. 이 효과는 마도공학 계열 주문이 우선됩니다.
		매 턴, 연결된 대상과 연결 경로 상의 모든 적은 %0.2f 비술 피해를 받습니다.
		연결이 존재하는 동안에는 위상 초월 회전의 재사용 대기시간이 30 턴이 아니라 6 턴이 됩니다.
		피해량은 주문력에 비례하여 증가합니다.]], "tformat")
t("Metaphasic Echoes", "위상 초월 반향", "talent name")
t("You can only cast this spell on the turn after Reality Breach.", "이 기술은 현실 균열을 시전한 직후에만 사용할 수 있다.", "logPlayer")
t([[Using your sheer arcane power you keep breaches in spacetime open for %d turns.
		...
		This spell is only usable for one turn after casting Reality Breach but any Reality Breach cast during its duration is also recorded inside.]], [[순수한 비전의 힘으로 시공간에 난 균열을 %d 턴 동안 유지합니다.
		매 턴마다 시전자가 장착한 톱의 비술 복제품을 열려 있는 현실의 균열을 통해 발사합니다. 톱은 균열 안의 모든 대상에게 %d%% 비술 무기 피해를 줍니다.
		비술의 톱날은 대상을 물리적으로도, 마법적으로도 절단하여 대상이 가진 무작위 이로운 효과의 지속시간을 매번 %d 턴씩 줄입니다.
		이 효과는 각 대상마다 한 턴에 한 번씩만 영향을 줍니다.
		이 주문은 현실 균열을 시전한 직후에만 사용할 수 있습니다. 이 주문의 지속시간 중에 현실 균열을 시전하면 새로 열린 균열에도 효과가 적용됩니다.]], "tformat")
...
t("You need an arcane dynamo to cast this spell.", "이 기술을 사용하려면 비전 발전기가 필요하다.", "logPlayer")
t("You can only cast this spell after casting an other technomancy spell.", "이 기술은 마도공학 기술을 사용한 다음에 사용할 수 있다.", "logPlayer")
t([[After casting a technomancy spell you store some of its energies that you can then use to overload your arcane dynamo, increasing the steam it generates per 10 mana spent by 4 for 4 turns.
		...
		The damage will increase with your Spellpower.]], [[마도공학 계열 주문을 시전하면 그 에너지 일부를 모아 비전 발전기를 과부하시킵니다. 다음 4 턴 동안 비전 발전기의 효율이 올라, 마나를 10 소모할 때마다 증기를 4 추가로 얻습니다.
		또한 시전자를 중심으로 반경 3 칸에 에너지가 흘러넘쳐 %0.2f 피해를 줍니다 (피해 속성은 사용한 마도공학 주문에 따라 달라집니다).
		이 주문은 마도공학 계열 주문을 시전한 다음에 사용할 수 있고, 다른 주문이나 기술을 사용하면 그 즉시 사용이 불가능해집니다.
		피해량은 주문력에 비례하여 증가합니다.]], "tformat")
...
t("Micro Spiderbot", "초소형 거미봇", "talent name")
t("You need an arcane dynamo to cast this spell.", "이 기술을 사용하려면 비전 발전기가 필요하다.", "logPlayer")
t([[You build %d micro spiderbot(s) from the earthly elements around you. Spiderbots are powered by an arcane cryogenic power unit directly linked to your own power.
		...
		You have currently %d spiderbot(s) up.]], [[주위의 대지 원소로부터 초소형 거미봇을 %d 개 만들어냅니다. 거미봇은 시전자와 연결된 극저온 비전 동력 장치를 통해 움직입니다.
		거미봇은 매 턴마다 대상에게 %0.2f 극지 피해 (물리/냉기 피해) 를 줍니다. 거미봇의 공격은 소스라치게 차가워, 25%% 확률로 대상의 발을 얼려서 5 턴 동안 속박합니다 %s.
		공격 대상이 죽으면 거미봇은 시전자 주변 %d 칸 내의 다른 적에게 뛰어듭니다.
		여러 거미봇이 대상 하나를 공격하고 있을 때, 범위 내에 공격받지 않는 적이 보이면 거미봇들은 최대한 산개합니다.
		여러 거미봇이 대상 하나를 공격하고 있다면 피해량이 중첩됩니다 (거미봇이 많을수록 피해 상승량은 점점 줄어듭니다). 또한 거미봇의 수와 상관없이 각 대상의 발은 매 턴 한 번씩만 얼어붙습니다.
		동시에 유지할 수 있는 거미봇은 최대 %d 개까지입니다. 거미봇들은 %d 턴 동안 유지되지만, 거미봇이 작동하려면 시전자의 시야 안에 있어야 합니다.
...
t([[Each time a spiderbot expires it digs around, producing either a Glacial Vapour (%0.2f cold damage and doing 30%% more damage to wet targets) or Earthquake (%0.2f physical damage and 25%% chances to stun for 2 turns) of radius 1 that last for %d turns.
		...
		The damage will increase with your Spellpower.]], [[거미봇들이 사라질 때 바닥을 파고들어, %d 턴 동안 반경 1 칸에 얼음 증기를 뿜거나 지진을 일으킵니다. 얼음 증기는 %0.2f 냉기 피해를 주고, 젖은 적에게는 피해량이 30%% 증가합니다. 지진은 %0.2f 물리 피해를 가하며 25%% 확률로 2 턴 동안 기절시킵니다.
		얼음 증기와 지진은 시전자에게 영향을 주지 않습니다.
		피해량은 주문력에 비례하여 증가합니다.]], "tformat", {3,1,2})
t("Ramming Bot", "거미봇 돌진", "talent name")
t("You need an arcane dynamo and an active spiderbot to cast this spell.", "이 주문을 사용하기 위해서는 비전 발전기와 활성화된 거미봇이 필요하다.", "logPlayer")
t([[Command a random spiderbot to jump onto your target at ramming speed. The impact destroys the bot (possibly triggering Cryogenic Digs).
		...
		The cooldown of this spell is affected by Body of Stone.
		The damage will increase with your Spellpower.]], [[무작위 거미봇 하나에게 대상을 들이받도록 명령합니다. 충돌하면서 해당 거미봇은 파괴됩니다 (극저온 굴착이 발동합니다).
		파괴된 거미봇은 폭발하면서 반경 %d 칸에 %0.2f 극지 피해를 주고 %d 턴 동안 얼려버리며 %s, %d 턴 동안 젖게 만듭니다 %s.
		이 주문은 암석의 신체 주문의 재사용 대기시간 감소 효과에 영향을 받습니다.
		피해량은 주문력에 비례하여 증가합니다.]], "tformat")
...
t([[You call back up to %d spiderbots to you to create protective barrier for %d turns.
		...
		The cooldown of this spell is affected by Body of Stone.
		]], [[거미봇 %d 개를 불러모아 %d 턴 동안 유지되는 방패를 만듭니다.
		각 거미봇들의 생명력은 %d 이며, 차례대로 피해량을 흡수합니다. 각 거미봇들은 생명력을 넘는 피해를 받아도 완전히 흡수하고 파괴됩니다.
		극저온 굴착이 활성화되어 있다면, 이번에 파괴될 거미봇은 공격자에게 돌진하고 극저온 굴착 효과를 발동합니다.
		이 주문은 암석의 신체 주문의 재사용 대기시간 감소 효과에 영향을 받습니다.
		]], "tformat")
...
t([[You revel in death, devouring the souls of your victims. Whenever you inflict damage to a target, you deal an additional %0.2f darkness damage.
		...
		The damage will scale with the highest of your spell or mind power and can only occur up to 25 times per turn.]], [[죽음을 즐기며 희생자의 영혼을 삼킵니다. 적에게 피해를 줄 때마다 %0.2f 어둠 피해를 추가로 줍니다.
		더해서 적을 살해하면 시전자는 원혼을 %d 획득합니다.
		피해량은 주문력과 정신력 중 높은 값에 비례하고, 이 효과는 한 턴에 최대 25 번까지 일어납니다.]], "tformat")
...
t([[Release a cloud of deadly miasma over a targeted area, dealing %0.2f darkness damage to all units inside it with a 20%% chance of inflicting a disease %s that will do blight damage and weaken either Constitution, Strength or Dexterity for %d turns.
		The damage will scale with the highest of your spell or mind power.]], [[대상 지역에 죽음의 독기를 풀어놓아 %0.2f 어둠 피해를 줍니다. 독기는 20%% 확률로 %d 턴 동안 지속되는 질병에 감염시켜 %s 매 턴 황폐 피해를 가하고, 체격, 힘, 민첩 중 하나를 감소시킵니다.
...
t([[You surge with a life draining energy for %d turns.
		While the effect lasts, you heal yourself for %d%% of all damage you deal.]], [[생명력을 흡수하는 에너지가 %d 턴 동안 쇄도합니다.
		지속시간 동안 가하는 피해량의 %d%% 만큼 생명력을 회복합니다.]], "tformat")
...
t([[You breathe a wave of deathly miasma in a cone of radius %d. Any target caught in the area will take %0.2f darkness damage over 4 turns and receive either a bane of confusion or a bane of blindness for 4 turns %s.
		The damage will increase with your Magic, and the critical chance is based on your Spell crit rate.]], [[반경 %d 칸의 원뿔 범위에 죽음의 독기를 내뿜습니다. 범위 내의 모든 대상은 %0.2f 어둠 피해를 4 턴에 걸쳐 받고, 4 턴 동안 혼란의 파멸이나 실명의 파멸에 걸립니다 %s.
		피해량은 마법 능력치에 비례하여 증가하고, 주문 치명타 확률을 사용합니다.]], "tformat")

------------------------------------------------
section "tome-orcs/data/talents/steam/artillery.lua"

t("Rocket Pod", "로켓 발사관", "talent name")
t([[You equip an automated, shoulder mounted rocket launcher. Each turn it will launch rockets at up to %d enemies in weapon range, dealing %d%% steamgun damage as fire.
		The rockets will pass harmlessly through allies, but on-hit effects triggered by them only deal 50%% of their usual damage.]], [[자동으로 작동하는 로켓 발사기를 어깨에 장착합니다. 로켓 발사기는 매 턴마다 무기 사거리 내의 최대 %d 체의 적에게 로켓을 발사해 %d%% 총기 피해를 화염 속성으로 가합니다.
		로켓은 우호적인 대상을 무시하고 지나가지만, 명중 시 발생하는 효과는 피해량이 50%% 감소합니다.]], "tformat")
...
The fire damage will increase with your Steampower.]], [[로켓을 발화성 물질로 강화합니다. 로켓이 적을 불태워 3 턴에 걸쳐 %0.2f 화염 피해를 가합니다. 불타는 적을 대상으로 하는 로켓 공격은 화상의 지속시간을 갱신하며 (중첩되지는 않습니다) %0.2f 화염 피해를 추가로 가합니다.
이 화상 효과를 받고 있는 생명력 25%% 이하의 적은 당황하여, 매 턴 %d%% 확률로 시전자에게서 도망치려 합니다 %s.
...
The defense loss will increase with your Steampower.]], [[5 턴 동안 대상을 로켓 발사관의 목표로 고정합니다.
목표가 고정된 동안 일반적인 로켓 공격은 비활성화되고, 매 턴 대상을 향해 로켓을 퍼부어 %d%% 더 강한 피해를 가합니다.
목표가 된 대상은 회피도가 %d 감소하고 은신, 투명, 회피 효과를 받지 못하게 됩니다 %s.
회피도 감소량은 증기력에 비례하여 증가합니다.]], "tformat")
t("Death From Above", "하늘에서 내리는 죽음", "talent name")
t([[You use your rocket pods to launch yourself into the air for 3 turns, firing a radius 2 barrage of rockets that deal %d%% steamgun damage as fire in radius 2. 
		...
		Using any talent other than Rocket Barrage will end this effect immediately.]], [[로켓 발사관을 이용하여 시전자 자신을 공중으로 쏘아올린 다음 로켓을 퍼붓습니다. 로켓 세례는 반경 2 칸에 %d%% 화염 총기 피해를 가하고, 시전자는 다음 3 턴 동안 체공합니다.
		체공 중에는 이동 속도가 %d%% 증가하고, %d%% 확률로 근접/원거리 공격을 완전히 무효화합니다. 그리고 이 기술이 로켓 세례 기술로 변하게 됩니다.
		로켓 세례를 제외한 다른 기술을 사용하면 체공이 즉시 중단됩니다.]], "tformat")
t("Rocket Barrage", "로켓 세례", "talent name")
t("Fires a barrage of rockets in radius 2, dealing %d%% steamgun damage as fire.", "반경 2 칸에 로켓을 퍼부어 %d%% 총기 피해를 화염 속성으로 가합니다.", "tformat")

------------------------------------------------
section "tome-orcs/data/talents/steam/automated-butchery.lua"

t("Continuous Butchery", "끝나지 않는 도살", "talent name")
t("You require a steamsaw for this talent.", "이 기술을 사용하기 위해서는 증기톱이 필요하다.", "logPlayer")
t([[You attune your saws to a specific target for 5 turns.
		...
		#{italic}#Metal your foes to death!#{normal}#]], [[5 턴 동안 특정 대상만을 위해서 톱의 성능을 조정합니다.
...
t([[You send a saw mounted on an automated steam propulsor to assault a foe %s, dealing %0.2f physical damage each turn for 4 turns and silencing it.
		...
		The damage will increase with your Steampower.]], [[자동 추진 장치에 톱날을 장착해 적에게 날립니다 %s. 이것에 맞은 적은 4 턴 동안 %0.2f 물리 피해를 턴마다 받으며, 침묵당합니다.
		지속시간이 끝나면 톱날은 폭발하여 %0.2f 화염 피해를 가하고 시전자에게 돌아옵니다. 이때 대상을 최대 %d 칸까지 끌고 옵니다.
		피해량은 증기력에 비례하여 증가합니다.]], "tformat")
...
t([[When you kill a foe with a melee strike you quickly throw some of their remains in your steam engine, instantly regenerating %d steam.
		...
		#{italic}#To the meat grinder!#{normal}#]], [[근접 공격으로 적을 살해하면 남은 유해를 증기 엔진에 던져넣어 즉시 증기를 %d 회복합니다.
		또한 근접 치명타를 가하게 되면 %d%% 확률로 적의 일부를 절단해 증기 엔진에 집어넣습니다.
		효과가 일어나면 희생양을 중심으로 반경 4 칸 이내의 모든 적들이 겁에 질려 %d 턴 동안 사고 정지에 걸립니다 %s.
...
t([[You override all security measures of your tinkers, allowing you to reset the cooldown of %d of most of your steamtech talents of tier %d or less and instantly increases your steam level by %d%% of the maximum.
		...
		#{italic}#Master of Tech, Master of Death!#{normal}#]], [[발명품들의 안전 장치를 해제하여 증기 공학 기술 %d 개의 재사용 대기시간을 초기화합니다. 등급이 %d 이하인 기술들이 영향을 받습니다. 이 기술을 사용하면 즉시 증기를 최대치의 %d%% 만큼 회복합니다.
		추가로 6 턴 동안 최대 증기량이 2 배가 되지만, 증기 회복량은 절반으로 감소합니다.
		#{italic}#기술의 지배자가 곧 죽음의 지배자라!#{normal}#]], "tformat")
...
t([[Sends a pulse detonator to the target. Upon arrival it explodes in radius 4 cone, dealing %0.2f physical damage, knocking back %s foes by 3 and dazing %s them for %d turns.
		Damage increases with your steampower.]], [[진동 기폭 장치를 던져 폭발시킵니다. 장치는 목표에 도달하게 되면 반경 4 칸의 원뿔 범위 내에 폭발을 일으켜 %0.2f 물리 피해를 주고, 적들을 3 칸 밀치고 %s %d 턴 동안 혼절시킵니다 %s.
		피해량은 증기력에 비례하여 증가합니다.]], "tformat", {1,2,4,3})
t("Flying Grapple", "비행 갈고리", "talent name")
t("Flying Grapple", "비행 갈고리", "_t")
t("A flying grapple pull %s into %s!", "비행 갈고리가 %s %s에게로 끌고 왔다!", "logSeen", nil, {"을"})
t([[You send a small steam-powered flying grapple to a target. The drone is homing so if the target moves it will follow.
		...
		]], [[조그만 증기 동력 비행 드론을 적에게 보내 붙잡게 합니다. 드론은 대상이 움직이면 대상을 따라 움직입니다.
		드론이 대상을 붙잡게 되면 반경 4 칸에 갈고리를 전방위로 발사합니다.
		갈고리는 범위 내의 모든 적들을 대상에게로 끌어당깁니다. 끌려온 적들이 다른 적이나 대상과 부딪히면 서로 %0.2f 물리 피해를 받습니다.
		]], "tformat")
t("Net Projector", "그물 발사기", "talent name")
t("%s resists the net.", "%s 그물에 저항했다.", "logSeen", nil, {"은"})
t([[Sends a lightly electrified net of radius 2 toward a target, all creatures caught inside will be pinned in place for 5 turns %s.
		While the electricity is not enough to do damage it does shock their body, reducing all resistances by %d%%.]], [[약한 전류가 흐르는 반경 2 칸 범위의 그물을 대상에게 발사합니다. 그물에 걸린 적들은 5 턴 동안 속박됩니다 %s.
		전류는 적에게 피해를 줄 정도로 강하지는 않지만, 전기 충격을 가해 모든 저항을 %d%% 감소시킵니다.]], "tformat")
t("Sawfield", "톱날 지대", "talent name")
t([[For 4 turns many small saws circle around the target in radius %d, making any creature caught inside bleed for %0.2f physical damage.
		Damage increases with your steampower.]], [[4 턴 동안 대상을 기준으로 반경 %d 칸 내에 작은 톱날들이 소용돌이칩니다. 톱날에 맞은 적은 출혈이 일어나 %0.2f 물리 피해를 받습니다.
		피해량은 증기력에 비례하여 증가합니다.]], "tformat")

------------------------------------------------
section "tome-orcs/data/talents/steam/avoidance.lua"

t("Automated Cloak Tessellation", "자동 망토 채움", "talent name")
t("@Source@ tessellates @hisher@ cloak!", "@Source2@ @hisher@ 망토의 표면을 금속으로 채운다!", "_t")
...
t([[You tessellate your cloak with small pieces of metal, providing %d damage reduction against all attacks.
		The myriad metal scraps also help against incoming projectiles, providing a %d%% chance of deflecting them to a nearby spot.]], [[망토를 수많은 금속 조각으로 빈틈없이 채워 모든 공격에 대한 %d 고정 피해 감소를 얻습니다.
		무수한 금속 조각들은 다가오는 투사체를 피하는 데 도움을 줍니다. %d%% 확률로 다가오는 투사체를 인접한 칸으로 꺾습니다.]], "tformat")
t("Cloak Gesture", "증기 은폐", "talent name")
t("@Source@ weaves @hisher@ cloak!", "@Source2@ @hisher@ 망토를 흔든다!", "_t")
t([[With a gesture of your cloak, you drop a small incendiary device in front of you, creating a wall of thick steam of %d length that burns creatures passing it for %0.2f fire damage and blocks sight for 5 turns.
		...
		Damage increases with your steampower.]], [[망토를 조금 흔들어, 시전자 앞에 조그마한 증기 발생 장치를 떨어뜨립니다. 이 장치는 %d 칸 길이의 두꺼운 증기를 만들어내 시야를 가로막고, 증기는 5 턴 동안 안쪽의 모든 적을 불태워 %0.2f 화염 피해를 줍니다.
		기술 레벨 5 부터, 이 기술은 너무나 완벽해져 적들이 시전자의 위치를 완전히 놓치게 됩니다.
		피해량은 증기력에 비례하여 증가합니다.]], "tformat")
...
t([[Your cloak is lined with an automated health system that activate when no enemies are visible.
		...
		The system can only trigger once every %d turns.]], [[망토가 자동 생명 유지 시스템에 연결되고, 적이 보이지 않을 때 시스템을 활성화합니다.
		발동하면 시전자의 생명력이 %d 회복됩니다.
		기술 레벨 3 부터, 부정적인 물리 효과를 하나 제거합니다.
		시스템은 %d 턴마다 한 번씩만 활성화됩니다.]], "tformat")
...
t([[Trigger an array of small mirrors to appear all over your cloak.
		...
		Stealth power increases with your steampower.]], [[장치를 가동하여 수많은 작은 거울들을 망토 위에 배열합니다.
...
t("Explosive Steam Engine", "폭발성 증기 엔진", "talent name")
t("critical steam engine", "치명적인 증기 엔진", "_t")
t("trap", "함정", "_t")
t([[Throw a small, unstable steam engine on the battlefield that will go critical after 2 turns.
		...
		#{italic}#Tick Tock Tick BOOM!#{normal}#]], [[작고 불안정한 증기 엔진을 전장에 던집니다.
		증기 엔진은 2 턴 뒤 반경 %d 칸의 뜨거운 증기 폭발을 일으켜 모든 적에게 %0.2f 화염 피해를 가합니다.
		출혈 상태의 적에게는 폭발의 피해량이 40%% 증가합니다.
...
t([[Explosive Steam Engine vapour now lingers for 5 turns.
		...
		증기 공학을 사용하는 개체는 증기 속에서 매 턴마다 증기를 %d 회복합니다.
		피해량은 증기력에 비례하여 증가합니다.
		#{italic}#현대 기술이 제공하는 쑥대밭 재배 솜씨란!#{normal}#]], "tformat")
t("Tremor Engine", "진동 엔진", "talent name")
t("tremor engine", "진동 엔진", "_t")
t([[Throw a tremor engine on the battlefield that will trigger after 2 turns.
		...
		작동하고 나서 5 턴 동안 엔진은 지축을 끊임없이 흔들어, 반경 %d 칸 안의 모든 대상에게 %d 턴 동안 지속되는 기절/속박/무장해제 중 하나를 겁니다 %s.
		#{italic}#너한테 땅은 그저 종잇조각일 뿐이야!#{normal}#]], "tformat")
...
t([[On its last pulse, your Tremor Engine shakes violently, raising a volcano for %d turns.
		...
		Damage scales with your Steampower.
		#{italic}#All the fury of fire at your disposal!#{normal}#]], [[진동 엔진의 마지막 진동이 대지를 거칠게 흔들어 %d 턴 동안 유지되는 화산을 일으킵니다.
		화산은 매 턴 불타는 암석을 분출하여 %0.2f 화염 피해와 %0.2f 물리 피해를 줍니다.
		피해량은 증기력에 비례합니다.
		#{italic}#널 묻어버리기 위한 화염의 분노다!#{normal}#]], "tformat")

------------------------------------------------
section "tome-orcs/data/talents/steam/battlefield-management.lua"

t("Saw Wheels", "톱날바퀴", "talent name")
t("You require a steamsaw for this talent.", "이 기술을 사용하기 위해서는 증기톱이 필요하다.", "logPlayer")
t([[Firmly plant your steamsaws in the ground, using them to propel yourself very quickly (+%d%% movement speed).
		...
		#{italic}#The wheels of death! Amazing!#{normal}#]], [[증기톱을 지면에 단단히 고정하고, 그대로 작동시켜 엄청난 속도로 이동합니다 (이동 속도 +%d%%).
		진행방향 양쪽의 적들은 톱날에 갈리고 바깥쪽으로 3 칸 밀려납니다.
		공격이나 기술을 사용하면 톱날바퀴를 즉시 중단합니다.
		효과가 끝나거나 시전자에 의해 중단되면, 자세를 급격하게 바꿔 인접한 모든 적에게 최대 %d%% 무기 피해를 줍니다. 이동한 거리에 비례해 피해량이 증가하며, 5 칸 이상일 때 최대가 됩니다. 한 칸도 이동하지 않았다면 피해를 줄 수 없습니다.
...
t([[Spin your saws wildly around you to create a wall of steamy sawteeth.
		...
		#{italic}#Split their bones on the saws of death!#{normal}#]], [[주변에 증기톱을 거칠게 회전시켜 증기의 톱니벽을 만듭니다.
		시전자를 향한 모든 근접 공격의 피해량이 %d%% 줄어들며, 투사체에 맞으면 %d%% 확률로 완벽히 비껴냅니다. 또한 단번에 받은 피해가 최대 생명력의 %d%% 를 넘게 되면 초과된 피해량을 무시합니다.
...
t([[Slam your saws into your target, dealing 100%% weapon damage + %d%% per physical, magical, or mental effect on them (up to 7 effects).
		...
		#{italic}#The Metal Punisher!#{normal}#]], [[톱으로 적을 내려쳐 100%% 무기 피해를 주고, 대상의 물리/마법/정신적 효과 하나마다 %d%% 추가 피해를 줍니다 (최대 7 개까지 계산).
...
t([[Working iron has honed your body into an amazing shape, granting %d strength and constitution.
		At talent level 5, you are so incredibly built that you gain one size category.]], [[대장일로 몸이 굉장히 단련되었습니다. 힘과 체격이 %d 증가합니다.
		기술 레벨 5 부터, 믿을 수 없을 정도로 뛰어난 체격을 갖게 되어 몸집 크기가 1 증가합니다.]], "tformat")
...
t([[Working long hours at a forge has made you incredibly slow to tire and given you endless vitality.
		...
		Stopping you is nearly impossible; your pinning resistance is increased by %d%%.]], [[대장간에서 오랜 시간 동안 노동을 한 결과, 피로에 믿을 수 없이 강해졌고 끝없는 활기를 갖게 되었습니다.
		회복 효율이 %d%% 증가하고 생명력 재생이 %0.2f 증가합니다.
		이제 그 누구도 막을 수 없습니다. 속박 저항이 %d%% 증가합니다.]], "tformat")
t("Life in the Flames", "화염 속의 삶", "talent name")
t([[Slaving for many years at the forge has made you more resilient to physical pain and fire burns.
		...
		At talent level 5, you are so accustomed to the flames that you become immune to the fireburn effect.]], [[대장간에서 노예처럼 일한 세월들 덕분에 물리적 고통과 화상에 훨씬 더 강해졌습니다.
		화염 저항이 %d%%, 물리 저항이 %d%% 증가합니다.
		기술 레벨 5 부터, 불꽃에 너무나 익숙해져 화상 효과에 면역이 됩니다.]], "tformat")
...
t([[You can easily see the weak points in your enemy's defenses. After all, you know to look for the same flaws in your own work.
		...
		At talent level 5, you can also fight stealthed and invisible creatures without penalty.]], [[자신이 만들어낸 작품의 결함을 찾아내는 것처럼, 적의 취약점을 쉽게 파악할 수 있게 되었습니다. 
		방어력 관통이 %d, 치명타 피해량이 %d%% 상승합니다.
		기술 레벨 5 부터, 은신 중이거나 투명한 적을 상대로 불이익 없이 싸울 수 있게 됩니다.]], "tformat")

------------------------------------------------
section "tome-orcs/data/talents/steam/bullets-mastery.lua"

t("Overheat Bullets", "과열탄", "talent name")
t("You must dual wield steamguns for this talent.", "이 기술을 사용하기 위해서는 총을 두 자루 장착해야 한다.", "logPlayer")
t([[By sending a stream of hot steam over your bullets you overheat them. For the next %d turns, each bullet will set the target ablaze, making it burn for %0.2f fire damage over 5 turns (most of your shooting talents fire two bullets at once).
		Damage will increase with Steampower.
		Only one bullet enhancement can be used at once.]], [[뜨거운 증기를 탄환에 쐬여 과열시킵니다. 다음 %d 턴 동안 모든 탄이 대상을 불살라 5 턴에 걸쳐 %0.2f 화염 피해를 줍니다 (총잡이의 기술은 대부분 한 번에 두 발씩 쏩니다).
		피해량은 증기력에 비례하여 증가합니다.
		탄환 강화 효과들은 동시에 받을 수 없습니다.]], "tformat")
t("Supercharge Bullets", "관통탄", "talent name")
t([[You are able to polish your bullets so well they can go through multiple targets for %d turns.
		...
		Only one bullet enhancement can be used at once.]], [[탄환을 잘 다듬어서 %d 턴 동안 탄이 적들을 뚫고 지나가게 만듭니다.
		또한 이 탄들은 방어력 관통이 %d 더 높습니다.
		탄환 강화 효과들은 동시에 받을 수 없습니다.]], "tformat")
t("Percussive Bullets", "타격탄", "talent name")
t([[You swap your bullets for more massive ones for %d turns.
		...
		Only one bullet enhancement can be used at once.]], [[%d 턴 동안 육중한 탄환을 사용합니다.
		탄이 명중하면 %d%% 확률로 대상을 3 칸 밀치고 %s, %d%% 확률로 3 턴 동안 기절시킵니다 %s.
...
t([[You coat your bullets with flammable materials, for the next %d turns each bullet will explode when it hits its target, dealing %0.2f fire damage to all foes within radius 2 (most of your shooting talents fire two bullets at once).
		Damage will increase with Steampower.
		Only one bullet enhancement can be used at once.]], [[가연성 물질로 탄환을 감쌉니다. 다음 %d 턴 동안 모든 탄은 폭발을 일으켜 %0.2f 화염 피해를 대상과 반경 2 칸의 모든 적에게 가합니다 (총잡이의 기술은 대부분 한 번에 두 발씩 쏩니다).
		피해량은 증기력에 비례하여 증가합니다
		탄환 강화 효과들은 동시에 받을 수 없습니다.]], "tformat")
...
t("Steamsaw Mastery", "증기톱 숙련", "talent name")
...
t("You require two steamsaws for this talent.", "이 기술을 사용하기 위해서는 증기톱이 두 자루 필요하다.", "logPlayer")
t([[Channel hot steam around your saws, burning foes you strike in melee for %0.2f fire damage over 3 turns (which can stack)!
		#{italic}#Hot, steamy maiming!#{normal}#]], [[톱날에 뜨거운 증기를 흘려보내, 근접 공격에 피격당한 대상에게 3 턴에 걸쳐 %0.2f 화염 피해를 줍니다! (중첩 가능)
		#{italic}#뜨겁고, 김이 모락모락 나는 사지 절단기!#{normal}#]], "tformat")
...
t([[Continuously swing your steamsaws around you, dealing %d%% weapon damage to adjacent foes each time you attack.
		...
		#{italic}#Make the metal talk!#{normal}#]], [[증기톱을 끊임없이 휘둘러, 공격을 할 때마다 인접한 적들에게 %d%% 무기 피해를 가합니다.
		어지럽기 짝이 없는 움직임 때문에 적들이 시전자를 맞히기가 어렵게 되어, %d%% 확률로 받은 피해를 완전히 무효화합니다.
...
t([[You temporarily overcharge the saw motors, increasing the effective talent level of all saw talents by %d%% for %d turns.
		#{italic}#The pain shall never stop!#{normal}#]], [[톱의 전동기를 일시적으로 과부하시켜 모든 증기톱 기술의 실질 기술 레벨을 %d 턴 동안 %d%% 높입니다.
		#{italic}#고통은 절대 끝나지 않으리!#{normal}#]], "tformat", {2,1})

------------------------------------------------
section "tome-orcs/data/talents/steam/chemical-warfare.lua"

t("Miasma Engine", "독기 엔진", "talent name")
t([[You repurpose your steam engine to emit a cloud of toxic, corrosive chemicals around you.
		...
		턴을 소모하는 증기 공학 기술을 사용할 때마다 반경 3 칸의 독기 구름을 5 턴 동안 생성합니다. 독기 내부의 적의 회복 효율은 %d%% 낮아지고, %d%% 확률로 기술 사용에 실패하게 됩니다 %s.
		독기 효과를 받을 때마다 기술 실패 확률은 점점 상승합니다. 최대 5 번 중첩되고, %d%% 까지 상승합니다.
		독기의 효과를 받고 있는 적이 근접/원거리 공격에 맞게 되면 독기가 상처로 스며들어가 %0.2f 산성 피해를 추가로 받습니다.
		독기의 지속시간은 효과 중첩 시에도 연장되지 않습니다.
		독기 속에서 살아남은 개체는 9 턴 동안 독기에 면역이 됩니다.]], "tformat", {2,3,1,4,5})
t("Caustic Dispersal", "부식 확산", "talent name")
t("You require a steamgun for this talent.", "이 기술을 사용하기 위해서는 총기가 필요하다.", "logPlayer")
t("You fire a toxic shell that explodes in radius %d, dealing %d%% weapon damage as acid and leaving behind a cloud of miasma for %d turns that inherits all effects from your Miasma Engine.", "맹독성 포탄을 쏘아 반경 %d 칸의 폭발을 일으켜, %d%% 무기 피해를 산성 속성으로 가하고 독기 구름을 %d 턴 동안 생성합니다. 이 독기 구름에는 독기 엔진의 모든 효과가 그대로 적용됩니다.", "tformat")
t("Smogscreen", "매연 연막", "talent name")
t("You become difficult to target through the thick smog generated by your Miasma Engine. While surrounded by miasma you have a %d%% chance to entirely avoid damage, increased by %d%% per stack.", "독기 엔진의 두꺼운 매연으로 인해 시전자를 제대로 공격하는 것이 어려워졌습니다. 독기에 둘러싸인 동안 %d%% 확률로 피해를 완전히 무효화합니다. 확률은 중첩마다 %d%% 씩 상승합니다.", "tformat")
t("Fumigate", "박멸", "talent name")
...
t([[You consume all Miasma Engine stacks you have to fire a blast of corrosive death through your steamgun, dealing %d%% weapon damage as acid in a radius %d cone with a %d%% chance to remove a random beneficial physical or mental effect %s. For every stack beyond the first the damage dealt is increased by 50%% and there is a %d%% chance to remove an additional effect.
		This attack ignores all enemy armour, and you must have at least 1 stack of Miasma Engine to use this talent.]], [[독기 엔진 중첩을 전부 소모하고, 증기총을 통해 죽음의 산성 폭발을 일으켜 반경 %d 칸의 원뿔 범위에 %d%% 무기 피해를 산성 속성으로 가합니다. 영향을 받은 적은 %d%% 확률로 이로운 물리적 효과나 정신적 효과가 하나 해제됩니다 %s. 이 피해는 (중첩 수 - 1) × 50%% 만큼 증가하고, (중첩 수 - 1) × %d%% 확률로 효과가 추가로 해제됩니다.
		산성 폭발은 적의 방어력을 무시하며, 이 기술을 사용하기 위해서는 독기 엔진 중첩이 최소 1 필요합니다.]], "tformat", {2,1,3,4,5})

------------------------------------------------
section "tome-orcs/data/talents/steam/chemistry.lua"

t("Therapeutics", "치료학", "talent name")
t([[Allows you to create therapeutic tinkers of level %d.
		...
		%s]], [[치료학 레벨 %d 을 요구하는 발명품을 만들 수 있게 됩니다.
		이 기술을 습득하면 새로운 도안을 하나 배웁니다.
		이 기술에 기술 점수를 투자할 때마다 20%% 확률로 무작위한 도안을 하나 배웁니다. 기술 레벨이 5 가 될 때까지 이 효과가 일어나지 않았다면 도안 하나를 100%% 확률로 배웁니다. (도안을 전부 배웠다면 무효)
		%s]], "tformat")
t("Chemistry", "화학", "talent name")
t([[Allows you to create chemical tinkers of level %d.
		You will learn a new schematic at level 1.
		Each other talent level, you have a 20%% chance to learn one more random schematic, if you have not gained it by level 5 you are guaranteed it (unless all are known).
		%s]], [[화학 레벨 %d 을 요구하는 발명품을 만들 수 있게 됩니다.
		이 기술을 습득하면 새로운 도안을 하나 배웁니다.
		이 기술에 기술 점수를 투자할 때마다 20%% 확률로 무작위한 도안을 하나 배웁니다. 기술 레벨이 5 가 될 때까지 이 효과가 일어나지 않았다면 도안 하나를 100%% 확률로 배웁니다. (도안을 전부 배웠다면 무효)
		%s]], "tformat")
...
t([[Allows you to create explosive tinkers of level %d.
		You will learn a new schematic at level 1.
		Each other talent level, you have a 20%% chance to learn one more random schematic, if you have not gained it by level 5 you are guaranteed it (unless all are known).
		%s]], [[폭파학 레벨 %d 을 요구하는 발명품을 만들 수 있게 됩니다.
		이 기술을 습득하면 새로운 도안을 하나 배웁니다.
		이 기술에 기술 점수를 투자할 때마다 20%% 확률로 무작위한 도안을 하나 배웁니다. 기술 레벨이 5 가 될 때까지 이 효과가 일어나지 않았다면 도안 하나를 100%% 확률로 배웁니다. (도안을 전부 배웠다면 무효)
		%s]], "tformat")
t("Steam Power", "증기의 힘", "talent name")
t("Increases the efficiency of all steamtech you operate, granting %d steampower.", "모든 증기 공학 장치의 효율이 올라, 증기력이 %d 증가합니다.", "tformat")

------------------------------------------------
section "tome-orcs/data/talents/steam/demolition.lua"

t("Grenade Launcher", "수류탄 발사기", "talent name")
t([[You mount a grenade launcher on your steamgun that launches high explosive rounds. Each time you make a basic attack with your steamgun or a heavy weapon, you fire a grenade at the target that explodes for %d%% steamgun damage in radius %d.
		...
		You can only fire a single grenade once every 9 turns.]], [[고폭탄을 쏘는 수류탄 발사기를 총기에 장착합니다. 증기총이나 중화기로 공격하면 동시에 수류탄을 발사해, 반경 %d 칸 범위에 %d%% 총기 피해를 가합니다.
		또한 이 기술은 시전자와 그 하수인들의 방어구를 강화시켜, 아군이 쏜 수류탄에 피해를 받지 않게 합니다.
		9 턴마다 수류탄을 한 발 쏠 수 있습니다.]], "tformat", {2,1})
t("Reactive Armor", "반응 장갑", "talent name")
t([[You line your armor with explosive plating that detonates when struck. On taking a melee or ranged hit that deals more than 8%% of your maximum life a plate detonates, reducing the damage taken by %d%% and triggering a basic grenade attack in a radius %d cone projected at the target dealing %d%% of its usual damage.
		...
		You have up to 3 plates at a time, and regain one every %d turns.]], [[피해를 받았을 때 격발하는 폭파 장갑을 방어구에 연결합니다. 근접/원거리 공격으로 단번에 최대 생명력의 8%% 이상의 피해를 받으면 장갑이 폭발합니다. 폭발한 장갑은 받은 피해를 %d%% 줄이고, 반경 %d 칸의 원뿔 범위에 수류탄 기본 피해량의 %d%% 를 가합니다.
		이 효과는 한 턴에 한 번만 일어납니다.
		그 턴에 효과가 발동하지 않았다면, 방패로 공격을 막아내도 수류탄 보복을 발동시킵니다.
		반응 장갑은 최대 3 개까지 장착할 수 있고, %d 턴마다 하나 얻습니다.]], "tformat")
...
t([[You load advanced grenades into your launcher.
	...
	You can only choose a single type of grenade at a time.]], [[수류탄 발사기에 보다 강화된 수류탄을 장전합니다.
	소이 수류탄: 3 턴에 걸쳐 화염 피해를 주고, 받는 피해를 %d%% 증가시킵니다 %s.
	화학 수류탄: 산성 피해를 주고 3 턴 동안 %d%% 느려지게 합니다 %s.
	충격 수류탄: 전기 피해를 주고, 대상에게 %d 턴 동안 전기 충격 효과를 걸어 기절과 속박 면역력을 50%% 감소시킵니다 %s.
	추가로 시전자의 포탑은 이제 파괴될 때 폭발을 일으켜, 반경 3 칸 내 적들에게 %0.2f 물리 피해를 가합니다.
	강화 수류탄들은 동시에 장전할 수 없습니다.]], "tformat")
...
t([[You load a magazine of %d grenades into your launcher, causing your next %d shots to fire a random grenade type in place of your usual Grenade Launcher, dealing 50%% of the usual grenade damage.
		...
		Your Grenade Launcher talent must be on cooldown to use this talent, and the magazine will only last for 6 turns.]], [[%d 개 들이의 수류탄 다발을 장전합니다. 다음 %d 발의 사격에 시전자가 선택한 수류탄 대신, 무작위 강화 수류탄을 추가로 발사합니다. 이 수류탄들은 피해량이 50%% 낮습니다.
		수류탄 다발이 장전되어 있는 동안 공격 속도가 %d%% 증가합니다.
		이 기술을 사용하려면 시전자의 수류탄 발사기 기술이 재사용 대기 상태여야 합니다. 수류탄 다발은 최대 6 턴 동안 지속됩니다.]], "tformat")
t("Incendiary Grenade", "소이 수류탄", "talent name")
t("Enhance your grenade with an incendiary agent that burns through armor, dealing fire damage over 3 turns and increasing damage taken while burning by %d%% %s.", "장갑을 녹이고 화상을 입히는 가연성 물질로 수류탄을 강화합니다. 3 턴에 걸쳐 화염 피해를 주고, 화상 효과동안 대상이 받는 피해를 %d%% 늘립니다 %s.", "tformat")
...
t("Shock Grenade", "충격 수류탄", "talent name")
...
t("Mechanical Arms", "기계 팔", "talent name")
t([[Using psionic forces you maintain in place on your back two giant horrific mechanical arms.
		...
		Creatures harassed by the mechanical arms have their damage reduced by %d%% for 5 turns %s.]], [[초능력을 사용해 등 뒤의 거대한 공포의 기계 팔을 움직입니다.
		실질 턴마다 (속도가 100%% 인 상태에서) 반경 3 칸 내의 적 2 체를 마석으로 공격해 %d%% 무기 피해를 줍니다.
		기계 팔에 공격당한 적은 5 턴 동안 피해량이 %d%% 감소합니다 %s.]], "tformat")
t("Lucid Shot", "자각 사격", "talent name")
t("You require a steamgun for this talent.", "이 기술을 사용하기 위해서는 총기가 필요하다.", "logPlayer")
t([[Fire a powerful shot at a foe doing %d%% weapon damage.
		If the creature, or any creatures in radius 3, was affected by a fear or nightmare effect it violently wakes up, shaking it off only to find itself disoriented, unable to discern friends from foes for %d turns. %s]], [[적에게 강력한 사격을 날려 %d%% 무기 피해를 가합니다.
		대상이나 반경 3 칸 내의 개체들이 공포나 악몽 상태라면, 격렬하게 깨어나 몸을 마구 흔들며 자신의 자아를 되찾으려 하게 됩니다. %d 턴 동안 해당 적들은 피아를 구분하지 못하게 됩니다 %s.]], "tformat")
...
t([[Fire a psionic-enhanced shot at a foe doing %d%% mind weapon damage and infecting it with a psy worm for 8 turns %s.
		...
		When a creature infected by Psy Worm dies it spreads to all enemies in a radius of 3.]], [[초능력으로 강화된 사격을 가해 %d%% 무기 피해를 정신 속성으로 주고, 8 턴 동안 초능력 기생충에 감염시킵니다 %s.
		매 턴, 기생충은 %0.2f 정신 피해를 가하고 시전자의 염력을 %d 회복시킵니다. 대상이 기절 중이거나 공포 상태라면 염력 회복량이 2 배가 됩니다.
		또한 기생충은 매 턴 25%% 확률로 3 칸 이내의 적에게 전염됩니다.
		초능력 기생충이 감염된 적이 죽게 되면 반경 3 칸 내의 모든 적에게 기생충이 감염됩니다.]], "tformat")
t("No Hope", "스러지는 희망", "talent name")
t("Entering the mind of your foe you manipulate it to make it lose hope of defeating you %s, reducing all its damage by 40%% for %d turns.", "적의 정신에 침투하여 이길 수 있다는 희망을 산산조각냅니다 %s. %d 턴 동안 대상이 가하는 피해량을 40%% 낮춥니다.", "tformat")

------------------------------------------------
section "tome-orcs/data/talents/steam/elusiveness.lua"

t("Slip Away", "조용한 도주", "talent name")
t([[Using small steam motors to enhance your movements, you are able to slip past up to %d foes in a line.
		After passing the targets, you will quickly run %d tiles away.]], [[작은 증기 동력기를 사용하여 움직임을 날렵하게 만듭니다. 직선 상의 적 %d 체를 통과하여 이동할 수 있습니다.
		적들을 통과한 후, 시전자는 빠르게 %d 칸 밖으로 도망칩니다.]], "tformat")
t("Agile Gunner", "날렵한 사수", "talent name")
t([[The thrill of the hunt invigorates you. For each foe in radius %d around you, you gain 20%% movement speed (up to %d%%).
		Current bonus: %d%%.]], [[사냥의 스릴로 힘을 얻습니다. 시전자 기준 반경 %d 칸 내의 적 하나마다 이동 속도가 20%% 증가합니다 (최대 %d%% 증가합니다).
		현재 추가 속도: %d%%.]], "tformat")
t("Awesome Toss", "화려한 던지기", "talent name")
t("You require two steamguns for this talent.", "이 기술을 사용하기 위해서는 총기가 두 자루 필요하다.", "logPlayer")
t([[In an awesome feat of agility and technological prowess, you toss both of your steamguns in the air, causing them to spin madly for 3 turns.
		...
		The spectacle is so distracting that your foes have a hard time concentrating on you, increasing all of your resistances by %d%%.]], [[굉장한 민첩성과 현대 기술의 힘으로, 총기 두 자루를 공중에 던지고 3 턴 동안 미친 듯이 회전시킵니다.
		매 턴, 총기는 사거리 내의 무작위한 적에게 2 번 사격하여 %d%% 무기 피해를 가합니다.
		총이 공중에 떠 있는 동안 시전자는 무장해제 상태로 공격을 하지 못하게 됩니다.
		이 화려한 광경은 적들의 정신을 쏙 빼놓아 집중하기 어렵게 만듭니다. 시전자의 모든 저항이 %d%% 상승합니다.]], "tformat")
t("Dazzling Jump", "눈부신 도약", "talent name")
t("%s seems immune to the powerful kick.", "%s 강한 발차기에 면역인 것처럼 보인다.", "logSeen", nil, {"는"})
t([[While your foes are distracted by your Awesome Toss, you use powerful steam motors to jump into the air and kick a target %d tiles away %s.
		The impact is so great that it ripples outwards, slowing %s all creatures in radius 3 by %d%% for 4 turns while the reaction force propels you %d tiles backwards.]], [[화려한 던지기로 인해 적들이 집중을 하지 못할 때, 강력한 증기 동력기를 사용하여 공중으로 날아오른 뒤 대상에게 발차기를 꽂아 %d 칸 밀칩니다 %s.
		엄청난 힘 때문에 바깥쪽으로 충격파가 일어납니다. 반경 3 칸 내의 모든 개체는 4 턴 동안 %d%% 느려지며 %s, 시전자는 반동으로 %d 칸 뒤로 물러섭니다.]], "tformat", {1,2,4,3,5})
...
t([[You open all steam valves at once, releasing a radius %d wave of superheated steam around yourself which deals %0.2f fire damage (but can not be a critical hit).
		...
		The effects scale with your current steam value; at 1 steam they are only 15%% as effective as at 50 or more (current factor %d%%).]], [[모든 증기 밸브를 한꺼번에 열어, 반경 %d 칸의 초고열 증기파를 뿜어냅니다. 증기는 %0.2f 화염 피해를 가합니다 (하지만 치명타는 일어나지 않습니다).
		증기가 35 이상 있었다면, 증기가 너무나도 뜨거워서 적들은 감각기관에 화상을 입고 %d 턴 동안 실명합니다 %s.
		이 효과는 현재 증기 수치에 비례합니다. 증기가 1 이라면, 50 이상일 때의 15%%의 효율밖에 내지 못합니다 (현재 수치 %d%%).]], "tformat")
...
t([[Your knowledge of physical laws allows you to use and improve equipment in ways their creators never dreamed.
		Increases all stats, saves, armour, and defense bonuses by %d%% on equipment that is crafted by a master or powered by steamtech.]], [[물리 법칙에 대한 지식 덕분에 원 창조주들이 꿈도 못 꿨을 개량을 할 수 있게 되었습니다.
		장인이 제작했거나, 증기 공학으로 작동하는 장비들의 능력치, 내성, 방어력, 회피 상승량이 %d%% 증가합니다.]], "tformat")
t("Supercharge Tinkers", "발명품 폭주", "talent name")
t([[Using a huge amount of steam, you temporarily supercharge your tinkers and other steam-powered talents.
		For %d turns, you gain %d steampower and %d%% steamtech critical chance.]], [[대량의 증기를 소모하여 일시적으로 발명품과 다른 증기력 기술들을 강화합니다.
...
t([[You add a portable furnace to your steam generators.
		...
		용광로가 작동 중일 때는 시전자의 화염과 물리 피해가 %d%%, 화염과 물리 저항 관통이 %d%% 증가합니다.
		#{italic}#끝내주는 증기의 힘으로 쑥대밭을 만들어 주마!#{normal}#
		]], "tformat")
...
t([[While Furnace is on your armour is so hot from the furnace it dissipates parts of all energy based attacks against you.
		...
		]], [[장착된 용광로에 의해 방어구가 뜨겁게 달궈지면서, 날아오는 에너지 공격을 일부 상쇄합니다.
		모든 비 물리적, 비 정신적 피해가 %d 줄어듭니다 (현재 %d).
		매 턴 피해 감소 효과가 발동될 때마다 용해 점수를 얻습니다 (최대 10 점). 용해 점수마다 피해 감소량이 25%%씩 줄어듭니다.
		달리거나 휴식을 취하면 용해 점수는 초기화됩니다.
...
t([[Open the vents on your furnace, creating a conic blast dealing up to %0.2f fire damage at 10 molten points (currently %0.2f).
		...
		]], [[용광로의 환기구를 열어 원뿔 범위의 폭발을 일으킵니다. 용해 점수가 10 점일 때 최대 %0.2f 화염 피해를 줍니다 (현재 %0.2f).
		이 기술을 사용하면 용해 점수를 전부 소모합니다.
		피해량은 증기력에 비례하여 증가합니다.
		#{italic}#불의 세례를 받아라!#{normal}#
		]], "tformat")
t("Melting Point", "용해점", "talent name")
t([[When you reach 10 molten points your armour overheats, reaching temperatures so high that they cauterize up to %d detrimental physical effects on you.
		...
		]], [[용해 점수가 10 점에 도달하면 방어구가 과열됩니다. 너무나 뜨거워진 방어구는 시전자에게 걸린 부정적인 물리 효과를 최대 %d 개까지 열기로 '지져서' 제거합니다.
		이때는 특별한 주사기로 화염 면역 혈청을 투여해 화염과 화상의 영향을 받지 않습니다.
		이 효과가 발동하면 용해 점수를 전부 소모하며, 마지막으로 용해 점수를 누적시킨 적의 방향으로 환기구를 개방합니다.
		이 효과는 발동 시 증기를 15 소모하며, 증기가 부족하면 발동되지 않습니다.
		#{italic}#그냥 좀 탔을 뿐이다!!#{normal}#
		]], "tformat")

------------------------------------------------
section "tome-orcs/data/talents/steam/gadgets.lua"

t("Autoloader", "자동 장전 장치", "talent name")
t([[You link your weapons and shield to your steam generators, using them to load ammunition and improve the power of your weapons. 
		...
		In addition, your steamgun and heavy weapon shots now bypass friendly targets harmlessly.]], [[증기 발생기를 무기와 방패에 연결해서 탄약을 장전하고 위력을 높입니다.
		총기를 발사하면 %d%% 확률로 중화기 탄약을 하나 장전합니다.
		중화기를 발사하면 일반 탄약을 %d 발 장전합니다.
		방패 막기를 시전하면 중화기 탄약을 1 발 장전합니다.
		또한 총기와 중화기를 사용할 때 무기 피해가 %d%%, 물리력이 30 증가합니다.
		거기에 더해서 시전자의 총기와 중화기 공격은 아군에게 피해를 입히지 않고 통과하게 됩니다.]], "tformat")
t("Exoskeleton", "외골격", "talent name")
t("#STEEL_BLUE#(%d exoskeleton)#LAST#", "#STEEL_BLUE#(%d 외골격)#LAST#", "tformat")
t([[Current exoskeleton life: %d/%d
		...
		The armor's maximum life will increase with your Steampower.]], [[현재 외골격 내구도: %d/%d
		증기력으로 움직이고, 일반 방어구 위에 덧입는 강화 방어구 한 벌을 만들었습니다. 이 방어구의 내구도는 %d 이고, 받는 피해량의 50%% 를 대신 받습니다.
		강화 방어구는 매 턴마다 내구도를 5%% 씩 자가 복구합니다. 또한, 시전자가 증기를 사용할 때마다 소모된 증기량의 %d%% 만큼 복구합니다.
		강화 방어구의 내구도는 증기력에 비례하여 증가합니다.]], "tformat")
t("Hypervision Goggles", "고성능 시야 보안경", "talent name")
...
In addition, the goggles passively increase your stealth, invisibility and trap detection by %d.]], [[시야를 %d 턴 동안 강화하여, %d 칸 범위 내의 모든 적을 지형을 무시하고 감지할 수 있게 됩니다. 보안경이 활성화된 동안에는 적의 약점을 꿰뚫어 볼 수 있게 되어 저항 관통이 %d%% 증가합니다.
거기에 더해서 보안경은 지속 효과로 은신, 투명, 함정 탐지력을 %d 향상시킵니다.]], "tformat")
t("AED", "자동 심장 충격기", "talent name")
...
The healing and damage will increase with your Steampower.]], [[8 턴 동안 가동하는 긴급 구호 장비를 준비합니다.
자동 심장 충격기가 활성화된 동안 생명력이 0 이하로 내려가면, 심장 충격기가 전기 충격으로 시전자를 다시 소생시킵니다. 이 효과를 발동시킨 공격의 피해량을 무효화하고 생명력을 %d 회복시키며, 반경 %d 칸에 %0.2f 전기 피해를 가해 적들을 3 턴 동안 혼절시킵니다.
소생 효과가 발동하지 않았다면 재사용 대기시간이 15 턴 줄어듭니다.
회복량과 피해량은 증기력에 비례하여 증가합니다.]], "tformat", {1,3,2})

------------------------------------------------
section "tome-orcs/data/talents/steam/gunner-training.lua"

t("Steamgun Mastery", "총기 숙련", "talent name")
...
t([[You focus on managing your steamgun ammo for %d turns.
		...
		지속시간 동안 각종 사격은 탄환을 소모하지 않습니다.]], "tformat")
t("Static Shot", "방전 사격", "talent name")
t([[You fire a special, electrically charged shot with your steamgun(s) at a spot within range.
		...
		This talent does not use ammo.]], [[전기를 충전한 특별한 탄을 지정 위치에 쏩니다.
...
t([[You have learned to fire while moving.
		...
		When Strafe ends you may instantly reload between %d and %d ammo (based on the number of strafes you performed and your ammo capacity).]], [[움직이면서 사격하는 방법을 익혔습니다.
		한 번의 행동으로, 두 자루의 증기총을 쏘고 (100%% 무기 피해, 사거리 불이익 1 칸) 인접한 위치로 이동할 수 있습니다 (행동 불가 상태나, 속박 상태에서는 이동할 수 없습니다).
		이 기술은 재사용 대기 상태가 되기 전까지 최대 %d 번 사용할 수 있습니다. 이 기술을 사용할 때, 증기 공학 속도나 이동 속도 중 (이동 시에만 적용) 느린 쪽을 적용하여 사용합니다.
...
t([[You deliberately fire a missing shot at a target, startling it for 3 turns %s.
		...
		The next shot that hits the startled creature will deal %d%% more damage.]], [[탄을 일부러 빗나가게 쏘아 대상을 3 턴 동안 소극적으로 만듭니다 %s.
		대상이 정신 내성 판정에 실패하면 본능적으로 2 칸 물러서게 됩니다 %s.
		소극적인 대상에게 가하는 다음 번 사격의 피해량이 %d%% 증가합니다.]], "tformat")
...
t([[Using small engines to augment your reflexes you are able to automatically fire retaliatory shots at your foes doing %d%% weapon damage.
		...
		This can only happen once per turn and uses shots as normal.]], [[작은 엔진을 사용하여, 반사적으로 보복 사격을 가할 수 있을 정도로 반사 신경을 향상시킵니다. 보복 사격은 %d%% 무기 피해를 줍니다.
		보복 사격은 적의 근접 공격과 원거리 공격이 빗나가거나, 시전자가 회피했을 때 발동합니다.
		이 효과는 한 턴에 한 번만 일어나고, 탄환을 소모합니다.]], "tformat")
t("Trick Shot", "곡예 사격", "talent name")
t([[Your cunning and dexterity allow you to fire incredible trick shots that can hit multiple targets.
		...
		Your shot deals %d%% weapon damage on its first strike, but loses %d%% damage and %d(%d%%) accuracy with each bounce.]], [[뛰어난 교활함과 민첩함 덕분에 한 번에 여러 명을 공격할 수 있는 말도 안 되는 곡예 사격을 할 수 있게 됐습니다.
		정밀한 조준으로 탄환이 시야 내에 있는 적들이나 벽 사이를 튕겨다니게 합니다. 탄환은 가장 가까운 적에게로 튕겨나갑니다.
		도탄은 첫 대상을 기준으로 반경 5 칸 이내의 적에게 일어나고, 최대 %d 번 일어납니다 (탄환이 빗나가면 즉시 효과가 종료됩니다). 같은 적에게 두 번 튕기지는 않습니다.
		처음 대상에게는 %d%% 무기 피해를 가하지만, 도탄이 일어날수록 피해량이 %d%%, 정확도가 %d(%d%%) 낮아지게 됩니다.]], "tformat")

------------------------------------------------
section "tome-orcs/data/talents/steam/heavy-weapons.lua"

t("Heavy Weapons", "중화기", "talent name")
t([[You gain the ability to equip one of 3 heavy weapons listed below, temporarily granting you a special attack. Heavy weapons are significantly more powerful than a steamgun, but require heavy ammunition to fire. You can store up to %d ammunition at a time, and regenerate 1 every 3 turns while a heavy weapon is not equipped.
		...
		]], [[다음 세 가지 종류의 중화기 중 하나를 장착하고, 그에 해당하는 특수 공격을 가할 수 있게 됩니다. 중화기는 기존 총기보다 훨신 강력하지만 중화기 탄약이 필요합니다. 중화기 탄약은 최대 %d 발 소지할 수 있고, 중화기를 들고 있지 않을 때 3 턴마다 한 발씩 얻습니다.
		
		#AQUAMARINE#화염방사기#LAST#: 적에게 액체 화염을 뿜어내는 방화 도구입니다. 반경 5 칸 내의 모든 적에게 3 턴에 걸쳐 %d%% 화염 총기 피해를 줍니다. 화염방사기는 방어력을 무시하며, 반드시 명중합니다. 또한 명중 시 발생 효과는 증기총을 쏜 것과 동일하게 취급됩니다.
		#AQUAMARINE#충격 지팡이#LAST#: 근접 전투에서 사용할 수 있는 전기가 충전된 곤봉입니다. %d%% 전기 피해를 대상과 그 옆의 적들에게 가합니다. 피해를 받은 적은 가하는 피해량이 3 턴 동안 %d%% 줄어듭니다. 이 공격은 근접 공격으로 취급되지만, 탄환의 명중 시 발생 효과 역시 받습니다. 방패 장비 시, 충격 지팡이로 공격하면 방패로 추가 공격을 가하여 전기 속성으로 동일한 피해를 줍니다. 또한 장착한 총기의 사정거리 내의 적에게 돌진할 수 있습니다.
		#AQUAMARINE#화살탄 발사기#LAST#: 총열이 여러 개 달린 증기총입니다. 화학 물질이 담긴 화살탄을 발사합니다. 총을 두 번 발사하여 탄환당 %d%% 총기 피해를 산성 속성으로 주고, 한 발 명중할 때마다 증기를 %d 회복합니다.
		
		중화기로 가하는 피해는 현재 장착한 탄환에 비례합니다. 또한 무기 숙련 효과나 기타 다른 효과들에서 중화기는 총기로 취급됩니다.
		일반 총기로 사격 시 중화기를 즉시 장착 해제합니다.
		]], "tformat")
t("Flamethrower", "화염방사기", "talent name")
t("You require a steamgun for this talent.", "이 기술을 사용하기 위해서는 총기가 필요하다.", "logPlayer")
...
t([[You replace your steamgun and attack with an incendiary device that projects streams of liquid flame at your foes.
		...
		These attacks cannot miss and ignore armor.]], [[증기총 대신 적에게 액체 화염을 뿜어내는 방화 도구인 화염방사기를 들고 적을 공격합니다.
		
		5 칸 반경 내의 모든 적에게 3 턴에 걸쳐 %d%% 화염 총기 피해를 줍니다.

		화염방사기는 방어력을 무시하며, 반드시 명중합니다.]], "tformat")
t("Flame Jet", "화염 방사", "talent name")
t("You are disarmed.", "무장이 해제됐다.", "logPlayer")
t("You require heavy ammunition to fire your flamethrower.", "화염방사기를 사용하기 위해서는 중화기 탄환이 필요하다.", "logPlayer")
t("Fire a jet of flame, dealing %d%% weapon damage as fire over 3 turns.", "화염을 쏘아내 3 턴에 걸쳐 %d%% 무기 피해를 화염 속성으로 가합니다.", "tformat")
t("Shockstaff", "충격 지팡이", "talent name")
t("You require heavy ammunition to power your shockstaff.", "충격 지팡이를 사용하기 위해서는 중화기 탄환이 필요하다.", "logPlayer")
t([[You replace your steamgun and attack with a lightning-charged staff to engage in close combat.
		...
		You can charge up to your steamgun's range to make shockstaff attacks.]], [[증기총 대신 전기로 충전된 곤봉인 충격 지팡이를 들고 근접 전투를 벌입니다.
		
		%d%% 전기 피해를 대상과 그 옆의 적들에게 가합니다. 피해를 받은 적이 가하는 피해량은 3 턴 동안 %d%% 줄어듭니다. 이 공격은 근접 공격으로 취급되지만, 탄환의 명중 시 발생 효과 역시 받습니다. 방패 장비 시, 충격 지팡이로 공격하면 방패로 추가 공격을 가하여 전기 속성으로 동일한 피해를 줍니다.

		또한 장착한 총기의 사정거리 내의 적에게 돌진할 수 있습니다.]], "tformat")
t("Stormstrike", "폭풍의 일격", "talent name")
t([[Sweep your shockstaff, striking all enemies in a frontal arc for %d%% weapon damage as lightning and reducing their damage dealt by %d%% for 3 turns.
		...
		While active this replaces your normal melee attack.]], [[충격 지팡이를 넓게 휘둘러, 대상과 그 양 옆의 적에게 %d%% 무기 피해를 전기 속성으로 주고 3 턴 동안 대상이 가하는 피해량을 %d%% 감소시킵니다.
		방패 장착 시, 방패로 적을 가격합니다.
		충격 지팡이를 장착 시 이 기술이 일반 근접 공격을 대체합니다.]], "tformat")
t("Boltgun", "화살탄 발사기", "talent name")
t("You require heavy ammunition to fire your boltgun.", "화살탄 발사기를 쏘기 위해서는 중화기 탄환이 필요하다.", "logPlayer")
t([[You replace your steamgun and attack with a multi-barreled bolt launcher, firing deadly chemical-infused flechettes.
		
		Each attack fires twice for %d%% weapon damage as acid and generates %d steam per hit.]], [[증기총 대신 총열이 여러 개 달린 총기인 화살탄 발사기를 들고, 화학 물질이 담긴 화살탄을 쏩니다.
		
		총을 두 번 발사하여 탄환당 %d%% 총기 피해를 산성 속성으로 주고, 한 발 명중할 때마다 증기를 %d 회복합니다.]], "tformat")
t("Flechette Burst", "화살탄 발사", "talent name")
t("%s resists the disarm!", "%s 무장해제에 저항했다!", "logSeen", nil, {"가"})
t("Fire two chemical flechettes, dealing %d%% weapon damage as acid and generating %d steam per hit.", "화학 물질이 든 화살탄을 두 발 쏘아 %d%% 무기 피해를 산성 속성으로 가하고, 명중한 탄당 증기를 %d 회복합니다.", "tformat")
t("Heavy Weapon Expertise", "중화기 전문가", "talent name")
t("You require heavy ammunition and a heavy weapon to use this talent.", "이 기술을 쓰기 위해서는 중화기와 중화기 탄약이 필요하다.", "logPlayer")
t("%s resists the stunning blow!", "%s 기절의 일격에 저항했다!", "logSeen", nil, {"가"})
t("%s resists the stunning shock!", "%s 감전에도 불구하고 기절하지 않았다!", "logSeen", nil, {"가"})
...
The damage dealt by the fire wall and the chance to apply effects will increase with your Steampower.]], [[진보된 훈련을 통하여 보다 전문적인 기술을 익혔습니다. 현재 장착한 중화기에 따라 다른 효과를 내며, 중화기 탄환을 한 발 소모합니다.
...
t("Automated Defenses", "자동화된 방어", "talent name")
...
These attacks will not trigger Counterstrike.]], [[방패를 중화기 기술로 강화하여, 중화기를 장착하고 있을 때 방패 막기가 특정한 효과를 일으킵니다.
...
#AQUAMARINE#화살탄 발사기#LAST#: 방패에서 화살탄을 쏘아내 반경 7 칸 내의 모든 적에게 %d%% 방패 피해를 산성 속성으로 가합니다. 화살탄 %d 개가 6 턴 동안 각 대상에게 박혀 있게 됩니다. 화살탄이 박혀 있는 적이 근접/원거리 공격을 받으면 화살탄이 폭발하여, 이전에 가했던 방패 피해의 50%% 만큼 산성 피해를 받습니다.
이 공격들은 반격 효과를 발동시키지 않습니다.]], "tformat")
t("Safety Override", "안전 기준 무시", "talent name")
t("%s resists the stun!", "%s 기절에 저항했다!", "logSeen", nil, {"가"})
t("%s slams into something solid, emitting a pulse of stunning lightning!", "%s 단단한 것을 내려쳐, 기절의 전자기 파동을 방출시킨다!", "logSeen", nil, {"는"})
...
#AQUAMARINE#화염방사기#LAST#: 연료통을 폭파하여 반경 4 칸의 대폭발을 일으키고, 시전자는 반경 %d 칸 내의 선택한 위치로 날아갑니다. 폭발에 휘말린 적은 %0.2f 화염 피해를 받고, 화염방사기로 인한 화상 피해의 %d%% 만큼을 추가로 받습니다.
#AQUAMARINE#충격 지팡이#LAST#: 지팡이를 땅에 꽂아넣고 남아있는 모든 전력을 방출하여 %d%% 충격 지팡이 피해를 전기 속성으로 반경 %d 칸 내에 가합니다. 공격받은 적은 %d 칸 밀려나고, 벽에 부딪히면 전자기 파장을 방출해 반경 1 칸 내에 %0.2f 전기 피해를 가하고, 파장에 휘말린 적들을 5 턴 동안 기절시킵니다.
#AQUAMARINE#화살탄 발사기#LAST#: 화살탄 발사기를 과부하하여, %d%% 피해를 산성 속성으로 가하는 치명적인 화살탄을 단 한 발 쏘아 직선 상의 적을 꿰뚫습니다. 적들은 부정적인 물리, 마법, 정신 효과 하나마다 %d%% 피해를 추가로 받고 (최대 %d%% 까지), 모든 부정적인 효과의 지속시간이 %d 턴 연장됩니다.]], "tformat")
...
t([[Steam generator that permanently creates %0.1f steam per turn.
		...
		활성화하면 폭발적으로 가동되어 증기를 %d 회복합니다.]], "tformat")
...
t("Medical injector allows using therapeutics with %d%% efficiency and cooldown mod of %d%%.", "의료용 주사기는 연고를 %d%% 의 효율과 %d%% 변동된 재사용 대기시간으로 사용할 수 있게 해 줍니다.", "tformat")
t("efficiency %d%% / cooldown %d%%", "효율 %d%% / 대기 %d%%", "tformat")

------------------------------------------------
section "tome-orcs/data/talents/steam/magnetism.lua"

t("Static Shock", "정전기 충격", "talent name")
...
You now also use your Cunning in place of Strength when equipping shields as well as when calculating shield damage.]], [[방패 막기 기술을 사용하면 시전자와 그 하수인들에게 4 턴 동안 지속되는 전자기 보호막이 부여되어 모든 저항이 %d%% 상승합니다. 만약 적이 시전자나 그 하수인을 공격하면 전자기 보호막에서 전류가 방출되어 %d%% 방패 피해를 가합니다.
		이 효과는 같은 대상을 상대로는 한 턴에 한 번밖에 일어나지 않습니다. 또한 이 기술로 주는 피해는 반격 효과를 받지 않습니다.
또한 이제부터 힘 대신 교활을 이용하여 방패를 착용할 수 있습니다. 방패의 피해량을 계산할 때도 힘 대신 교활을 사용합니다.]], "tformat")
...
t([[You project a powerful blast of magnetic energy from your shield in radius %d around you. Enemies caught within are knocked back %d tiles and take %d%% shield damage as lightning, and any projectiles will be destroyed.
		While this talent is not on cooldown, you also project a magnetic field from your shield, reducing the speed of incoming projectiles by %d%% and your chance to be critically hit by %d%%.]], [[방패에서 강력한 자기장 폭발을 일으켜 반경 %d 칸 내의 적들을 공격합니다. 범위 내의 적은 %d 칸 밀려나고, %d%% 방패 피해를 전기 속성으로 받습니다. 또한 범위 내의 투사체는 전부 파괴됩니다.
		또한 이 기술이 재사용 대기 상태가 아닐 때, 방패에서 미약한 자기장이 방출되어 시전자를 향해 다가오는 투사체의 속도가 %d%%, 시전자의 치명타 피격 확률이 %d%% 감소합니다.]], "tformat")
...
The maximum damage you can absorb will increase with your Steampower.]], [[방패에 충격을 줄여주는 축전기를 장착합니다. 방패 막기 수치가 %d%% 증가하고, 방패로 막아내는 피해 전부를 전류로 변환하여 쌓아 둡니다 (최대 %d 까지 축적 가능).
이 기술을 활성화하면 쌓아 둔 모든 피해를 번개 화살로 방출하여, 첫 번째 대상에게 %d%% 방패 피해를 전기 속성으로 주고 근처의 적 %d 체에게 연쇄되어 축적된 수치만큼 전기 피해를 가합니다.
축적량이 최대치라면 번개 화살은 2 턴 동안 혼절시키고 %s 이 기술의 방패 공격이 무조건 치명타가 됩니다.
최대 피해 흡수량은 증기력에 비례하여 증가합니다.]], "tformat")
t("Lightning Web", "전기망", "talent name")
...
t([[Project a radius 3 electric field from your shield lasting %d turns. Enemies within this field will take an automatic shield strike for %d%% lightning damage each turn, while allies will gain flat damage reduction equal to %d%% (%d) of block value.
		All damage reduced by this effect will be stored for Capacitor Discharge.]], [[방패에서 반경 3 칸의 전기장을 펼칩니다. 전기장은 %d 턴 동안 유지되며, 내부의 적은 매 턴 %d%% 방패 피해를 전기 속성으로 받습니다. 전기장 내의 아군은 방패 막기 수치의 %d%% 만큼 고정 피해 감소 효과를 받게 됩니다 (고정 피해 감소 수치: %d).
		이 효과로 감소되는 피해량 역시 축전기에 쌓입니다.]], "tformat")

------------------------------------------------
section "tome-orcs/data/talents/steam/mecharachnid.lua"

t("disarmed", "무장 해제 상태", "_t")
t("no ammo", "탄환 부족", "_t")
...
t([[The mecharachnid self-destructs, destroying itself and generating a blast of fire in a radius of %d, doing %0.2f fire damage.
		This spell is only usable when the mecharachnid's master is dead.]], [[강철 거미가 자폭해, 반경 %d 칸의 폭발을 일으켜 %0.2f 화염 피해를 줍니다.
		강철 거미의 주인이 죽었을 때만 사용이 가능합니다.]], "tformat")
t("A heavily armored mechachnical spider, armed to the teeth with advanced weaponry.", "중무장한 강철 거미로, 이빨에 첨단 무기가 장착되어 있습니다.", "_t")
t("Your mecharachnid is out of sight; you cannot establish direct control.", "강철 거미가 시야를 벗어나서 직접 조종할 수 없다.", "logPlayer")
...
The mecharachnid has an inbuilt teleportation device that will recall it to you when combat ends if it is not nearby.]], [[강력한 강철 거미를 만들어 전투를 돕게 합니다. 강철 거미에게는 총기 두 자루와 탄환, 방어구를 장착할 수 있습니다.
강철 거미가 죽게 되면 이 기술을 활성화하여 최대 생명력의 %d%% 로 부활시킬 수 있습니다. 강철 거미는 전투가 끝나면 자동으로 최대 생명력까지 회복합니다.
강철 거미는 기술 레벨 %d 의 총기 숙련, 전투 정확도와 갑옷 숙련 기술을 가집니다. 강철 거미는 갑옷을 장비할 때 착용 요구 조건으로 힘 대신 민첩을 이용합니다.
강철 거미가 멀리 있을 때 전투가 끝나면, 내장형 순간이동 장치가 작동해 시전자 곁으로 돌아옵니다.]], "tformat")
t("Stormcoil Generator", "전자기 폭풍 생성기", "talent name")
t("You equip your mecharachnid with a stormcoil generator, a mechanical device that projects a powerful electrical field. On taking a hit greater than 15%% of its maximum life, the excess damage will be reduced by %d%% and converted into energy, giving your mecharachnid %d%% increased global speed for 2 turns.", "강철 거미에게 강력한 전자기장을 뿜어내는 전자기 폭풍 생성기를 장착합니다. 최대 생명력의 15%% 이상의 피해를 한 번에 받게 되면 초과된 피해량은 %d%% 감소되고, 동력으로 변환되어 강철 거미의 전체 속도가 2 턴 동안 %d%% 증가합니다.", "tformat")
t("Mecharachnid Chassis", "강철 거미 동체 변경", "talent name")
t("Assault", "맹공", "_t")
t("Armament", "폭격", "_t")
t("#LIGHT_RED#You must not be in combat to change the chassis.", "#LIGHT_RED#동체를 변경하기 위해서는 전투 상태가 아니어야 한다.", "logPlayer")
t("#LIGHT_RED#Your mecharachnid must not be in combat to change its chassis.", "#LIGHT_RED#강철 거미의 동체를 변경하기 위해서는 전투에서 벗어나야만 한다.", "logPlayer")
t("#LIGHT_RED#Your mecharachnid is already in chassis %s.", "#LIGHT_RED#강철 거미의 동체가 이미 '%s' 이다.", "logPlayer")
t("Mecharachnid chassis changed to: #GOLD#%s", "강철 거미 동체 변경: #GOLD#%s", "logPlayer")
t("You require your mecharachnid to be adjacent, and must be out of combat.", "당신은 전투 상태가 아니며, 강철 거미의 인근에 있어야 한다.", "logPlayer")
t([[You craft a new chassis for your mecharachnid, allowing you to tailor it to different situations. Each chassis grants the mecharachnid a new talent category, the ability to attach a weapon to their tail, as well as granting them %d class talent points to spend in a new category based off their chassis.
		...
		Tail weapons do not attack by default, and are instead used for special talents.]], [[강철 거미에 새로운 뼈대를 장착하여 다양한 상황에 유연하게 대처할 수 있게 합니다. 각 동체는 강철 거미에게 새로운 기술 계열을 제공합니다. 또한 꼬리 부분에 무기를 장착할 수 있게 되고, 직업 기술 점수를 %d 점 얻게 되어 동체가 제공하는 새로운 기술들에 투자할 수 있게 됩니다.

		전투 중이 아닐 때, 이 기술을 사용하여 동체를 바꿀 수 있습니다. (기본 동체: 맹공)
		- 맹공: 근접 전투와 방어에 치중한 중장갑 동체로, 증기톱 사용에 특화되어 있습니다.
		- 폭격: 원거리 전투에 치중한 중장갑 동체로, 추가 총기 사용에 특화되어 있습니다.

		꼬리에 장착한 무기는 일반 공격에 사용되지 않고, 특정 기술에만 사용됩니다.]], "tformat")
t("Mecharachnid Piloting", "강철 거미 탑승", "talent name")
t("You require your mecharachnid to be adjacent.", "강철 거미의 인근에 있어야 한다.", "logPlayer")
t("Leap into your mecharachnid, assuming direct control of it for %d turns. While piloting it, all damage dealt is increased by %d%%, resistances are increased by %d%%, and all of its talents cooldown twice as fast.", "강철 거미에게 뛰어들어 %d 턴 동안 직접 조종합니다. 강철 거미에 탑승하면 가하는 모든 피해가 %d%%, 모든 저항이 %d%% 증가하며 강철 거미가 가진 모든 기술의 재사용 대기시간이 2 배 더 빠르게 감소합니다.", "tformat")
t("steamtech", "증기 공학", "talent category")
t("armament", "폭격", "talent type")
t("Ranged combat mecharachnid abilities.", "강철 거미의 원거리 전투 기술입니다.", "_t")
t("assault", "맹공", "talent type")
t("Close combat mecharachnid abilities.", "강철 거미의 근접 전투 기술입니다.", "_t")
...
t("Your mecharachnid cannot do that currently.", "당신의 강철 거미는 현재 그것을 할 수 없다.", "logPlayer")
t("#Source# provokes #Target# to attack it.", "#Source2# #Target3# 도발했다!.", "logCombat")
t([[You rush to the target and strike with your tailsaw, dealing %d%% damage and taunting enemies within radius %d.
		You now also use your Dexterity in place of Strength when equipping Steamsaws as well as when calculating weapon damage, and have your Steamsaw damage increased by %d%% and Physical Power by %d.]], [[대상에게 돌진해 꼬리톱으로 공격합니다. %d%% 피해를 주고 반경 %d 칸 내의 모든 적을 도발합니다.
		또한 힘 대신 민첩을 이용하여 증기톱을 착용할 수 있습니다. 증기톱의 피해량을 계산할 때도 힘 대신 민첩을 사용합니다. 더해서 증기톱의 피해량이 %d%% 증가하고, 물리력이 %d 증가합니다.]], "tformat")
t("Defensive Protocol", "수비적 프로토콜", "talent name")
t("Enhancements to your mecharachnid combat skill increases your melee and ranged evasion by %d%%, and causes you to automatically strike adjacent enemies with your tailsaw for %d%% damage each turn.", "강철 거미의 전투 기술을 향상시켜 원거리, 근접 공격에 대한 피해 무효화 확률을 %d%% 증가시키고, 매 턴마다 인접한 적을 꼬리톱으로 공격해 %d%% 피해를 줍니다.", "tformat")
t("Pincer Strike", "집게발 타격", "talent name")
t("#Target# resists the pincer strike from #Source#!", "#Target2# #Source#의 집게발 타격에 저항했다!", "logCombat")
t("You strike the target with your tailsaw for %d%% damage. If this hits, you attempt to clamp them with your pincers for %d turns %s. This pins, reduces their attack, spell and mind speed by %d%%, and lets you make a free, unavoidable strike with your tailsaw against them each turn for %d%% damage. This ends if you move more than 1 tile from the target.", "대상을 꼬리톱으로 가격해 %d%% 피해를 줍니다. 명중하면 적을 집게로 조여 %d 턴 동안 속박시킵니다 %s. 공격, 시전, 사고 속도가 %d%% 감소하고, 매 턴마다 꼬리톱으로 턴 소모 없이 반드시 명중하는 공격을 가해 %d%% 피해를 줍니다. 대상에게서 1 칸 이상 벗어나게 되면 효과가 즉시 중단됩니다.", "tformat")
t("Automated Repair System", "자동 수리 시스템", "talent name")
t([[On falling below 0 life, you engage an automated repair mode. While in this mode you cannot act, but can survive below -%d life, heal for %0.1f life each turn and have all resistances increased by %d%%. This will last until you are destroyed or until you are fully healed.
		This effect has a cooldown.]], [[생명력이 0 이하로 떨어지게 되면 자동 수리 모드로 진입합니다. 이 상태에서는 움직일 수 없지만, 생명력이 -%d 에 도달할 때까지 파괴되지 않습니다. 또한 매 턴마다 생명력이 %0.1f 회복되고 모든 저항이 %d%% 상승합니다. 이 효과는 파괴되거나, 완전히 회복될 때까지 계속됩니다.
		이 효과는 재사용 대기시간이 존재합니다.]], "tformat")
t("Gauss Cannon", "가우스 캐논", "talent name")
t("You require a tail-mounted steamgun for this talent.", "이 기술을 사용하기 위해서는 꼬리에 장착한 총기가 필요하다.", "logPlayer")
t([[Fire a charged shot at the farthest target with your tail-mounted steamgun that pierces through your enemies, ignoring armor and dealing %d%% weapon damage as lightning.
		This takes no time to use.]], [[가장 멀리 떨어진 적에게 꼬리에 달린 총기로 적들을 관통하는 사격을 가합니다. 이 사격은 방어력을 무시하며, %d%% 무기 피해를 전기 속성으로 가합니다.
		이 기술은 턴을 소모하지 않습니다.]], "tformat")
t("Magnetic Accelerator", "자기장 가속 장치", "talent name")
t("You must have an empty space to leap to.", "도약하기 위해서는 빈 공간이 필요하다.", "logPlayer")
t([[Improved power output increases the speed of your projectiles by %d%%, critical damage by %d%%, and allows you to automatically reload each turn.
		In addition, you can instantly activate this talent to gain a sudden burst of speed, moving to a tile in range %d.]], [[출력을 높여 투사체 속도를 %d%%, 치명타 피해량을 %d%% 늘립니다. 또한 매 턴마다 탄환을 자동으로 장전합니다.
		추가로, 이 기술을 활성화하여 순간적으로 엄청난 속도를 낼 수 있습니다. 반경 %d 칸 내의 위치로 이동합니다.]], "tformat")
t("Haywire Missiles", "광란의 미사일", "talent name")
t("You require a steamgun for this talent.", "이 기술을 사용하기 위해서는 총기가 필요하다.", "logPlayer")
t("Fires a barrage of charged missiles from your tail-mounted steamgun at a radius %d area, dealing %d%% steamgun damage as lightning as well as dazing those within for 2 turns %s.", "꼬리총으로 반경 %d 칸의 지역에 충전된 미사일 세례를 퍼붓습니다. %d%% 총기 피해를 전기 속성으로 가하고, 지역 내의 적들을 2 턴 동안 혼절시킵니다 %s.", "tformat")
t("Advanced Targeting System", "첨단 조준 시스템", "talent name")
t([[Enhancements to your targeting systems give all ranged attacks a %d%% chance to trigger an immediate shot from your tail-mounted steamgun for 100%% damage as lightning.
		In addition, your physical and lightning resistance penetration is increased by %d%%.]], [[조준 시스템을 강화하여, 모든 원거리 공격이 %d%% 확률로 꼬리총을 함께 발사하여 100%% 총기 피해를 전기 속성으로 가합니다.
		추가로 물리와 전기 저항 관통이 %d%% 증가합니다.]], "tformat")
t("Tail Attachment", "꼬리 부착", "talent name")
t("%s mounts %s to its tail.", "%s %s 꼬리에 장착했다.", "logSeen", nil, {"는","를"})
t("Attach which item?", "어떤 장비를 장착하시겠습니까?", "_t")
t("Attach the chosen weapon to your tail.", "선택한 무기가 꼬리에 장착되었다.", "_t")

------------------------------------------------
section "tome-orcs/data/talents/steam/mechstar.lua"

t("Metalstar", "쇠붙이 별", "talent name")
t([[Quickly aggregate particles of metal around your mindstar and focus psionic energies into it.
		The metal explodes like shrapnel, knocking back (%d away) %s and dazing (%d duration) %s all foes in radius %d.]], [[조그마한 금속 입자들을 마석에 모으고, 초능력 에너지를 집중시킵니다.
		금속 입자는 유산탄처럼 폭발해, 반경 %d 칸 내의 적들을 %d 칸 밀치고 %s %d 턴 동안 혼절시킵니다 %s.]], "tformat", {5,1,2,3,4})
...
t([[When you fire your metalstar, your also establish a psionic bloodlink with the shrapnel still inside for %d turns %s.
		...
		This damage does not break daze and increases with your Steampower.]], [[쇠붙이 별을 발동할 때, 적의 몸에 박힌 파편과 %d 턴 동안 유지되는 초능력적 혈인을 맺습니다 %s.
		영향을 받은 적은 매 턴마다 %0.2f 물리 피해를 받고, 피해량의 절반만큼 시전자의 생명력이 회복됩니다 (피해를 받는 대상이 둘 이상이면 회복량은 반감됩니다).
		효과를 받는 적이 쇠붙이 별로 밀치는 거리의 2 배 이상 (현재 %d 칸) 멀리 떨어지게 되면 이 효과는 즉시 중단됩니다.
...
t([[Your bloodstar effect also burns part of your victim's flesh, dealing %0.2f fire damage.
		...
		This damage does not break daze and increases with your Steampower.]], [[선혈의 별 효과가 희생자의 살갗을 불살라 %0.2f 화염 피해를 가합니다.
		강렬한 화염은 게슈탈트를 통해 흡수 가능한 증기를 생성합니다. 매 턴 증기를 %d 회복합니다 (피해를 받는 대상이 둘 이상이면 두 번째부터 회복량이 66%%씩 줄어듭니다).
		이 피해는 혼절 상태인 적을 깨우지 않고, 증기력에 비례하여 증가합니다.]], "tformat")
t("Deathstar", "죽음의 별", "talent name")
t("When you use a shoot class talent to hit a creature affected by bloodstar an other shoot talent will have its current cooldown reduced by %d turns.", "선혈의 별 효과를 받고 있는 적에게 사격 기술을 명중시키면 다른 사격 기술 하나의 재사용 대기시간이 %d 턴 단축됩니다.", "tformat")

------------------------------------------------
section "tome-orcs/data/talents/steam/other.lua"

t("Medical Injector", "의료용 주사기", "talent name")
t("Medical Urgency Vest", "응급 의료지원 조끼", "talent name")
t("#LIGHT_BLUE#Medical Urgency Vest selected to be used first by salves.", "#LIGHT_BLUE#연고를 사용하면 응급 의료지원 조끼가 먼저 사용됩니다.", "saySimple")
t("This medical injector will now be used first if available when using medical salves.", "연고를 사용할 수 있을 때, 해당 주사기가 먼저 사용됩니다.", "logPlayer")
t("The medical urgency vest allows using therapeutics with %d%% efficiency and cooldown mod of %d%%.", "응급 의료지원 조끼는 연고를 %d%% 의 효율과 %d%% 변동된 재사용 대기시간으로 사용할 수 있게 해 줍니다.", "tformat")
...
t("The life support suit allows using therapeutics with %d%% efficiency and cooldown mod of %d%%.", "생명 유지복은 연고를 %d%% 의 효율과 %d%% 변동된 재사용 대기시간으로 사용할 수 있게 해 줍니다.", "tformat")
t("Create Tinker", "발명", "talent name")
t("Allows you to create tinkers.", "발명품을 만듭니다.", "_t")
...
t("An Automaton wielding a chosen weapon.", "선택한 무기를 들고 있는 로봇입니다.", "_t")
...
t([[Fires your ammo at an enemy in range %d for %d%% weapon damage.  If this tinker is made of voratun you will fire an additional shot.
			This shot is a ranged melee attack but will use the ranged procs of your ammo as well.]], [[반경 %d 칸 내의 적에게 시전자가 현재 장착한 탄환을 쏘아 %d%% 무기 피해를 가합니다. 이 발명품이 보라툰 재질이라면 한 발 더 쏩니다.
			이 사격은 원거리에서 가한 근접 공격으로 취급되지만, 탄환의 원거리 명중 시 일어나는 효과들을 그대로 적용합니다.]], "tformat")
t("Fatal Attractor", "치명적 인력 발생기", "talent name")
t("Not enough space to summon!", "소환할 공간이 부족하다.", "logPlayer")
t("fatal attractor", "치명적 인력 발생기", "_t")
t("A psionic contraption that reflects damage and forces things to attack it.", "초능력의 힘이 담긴 기계 장치로, 피해를 반사하고 공격을 강제합니다.", "_t")
t([[Quickly create a psionic-enhanced metal contraption that lures all your foes to it and reflects %d%% of the damage it takes to its attackers.
		...
		Damage, life, resists, and armor scale with your Steampower.]], [[빠르게 초능력으로 강화된 금속 장치를 설치해 모든 적을 끌어오고, 장치가 받은 피해량의 %d%% 를 공격자에게 반사합니다.
		기계 장치의 생명력은 %d 이며, 5 턴 동안 유지됩니다.
		피해량, 생명력, 속성 저항, 방어력은 증기력에 비례하여 증가합니다.]], "tformat")
t("Rocket Boots", "로켓 장화", "talent name")
t([[Activate the rocket boots, firing huge flames from your boots increasing your movement speed by %d%%.
		...
		#{italic}#Burninate them all!#{normal}#]], [[로켓 장화를 활성화시켜, 장화에서 거대한 불길을 내뿜습니다. 시전자의 이동 속도가 %d%% 증가합니다.
		이동할 때마다 4 턴 동안 유지되는 불길을 땅에 남겨 %0.2f 화염 피해를 줍니다.
		이동 외 다른 행동을 하면 효과는 즉시 중단됩니다.
		#{italic}#놈들에게 쑥대밭을 보여주자!#{normal}#]], "tformat")
t("Iron Grip", "무쇠 손아귀", "talent name")
t("%s resists the iron grip!", "%s 무쇠 손아귀에 저항했다!", "logSeen", nil, {"는"})
t([[Activate the pistons to crush your target for %d turns %s and dealing %d%% unarmed melee damage.
		...
		#{italic}#Crush their bones!#{normal}#]], [[피스톤을 작동시켜 대상을 으스러뜨립니다. 적을 %d 턴 동안 붙잡고 %s %d%% 맨손 근접 피해를 가합니다.
		붙잡힌 적은 이동할 수가 없어지고 방어력과 회피도가 %d 감소합니다.
		#{italic}#저들의 뼈를 으스러뜨리자!#{normal}#]], "tformat")
t("Spring Grapple", "용수철 바이스", "talent name")
t("%s resists the pin!", "%s 속박에 저항했다!", "logSeen", nil, {"가"})
t("Grab the target and pull them towards you, striking for %d%% unarmed melee damage, and if you hit, pinning them for %d turns %s.", "대상을 붙잡아 시전자에게로 끌고 옵니다. 이때 적을 가격해 %d%% 맨손 근접 피해를 가하고, 명중하면 %d 턴 동안 속박합니다 %s.", "tformat")
t("Toxic Cannister Launcher", "독가스 탄 발사기", "talent name")
t("toxic cannister", "독가스 통", "_t")
t("A smelly cannister.", "냄새나는 가스통입니다.", "_t")
t([[Launch a cannister filled with toxic gas at a location.
		...
		Damage and penetration are inherited from the creator.]], [[독가스로 채운 금속 용기를 해당 위치에 발사합니다.
		2 턴마다 가스통은 반경 3 칸의 독구름을 방출합니다.
		독가스는 %0.2f 자연 피해를 5 턴에 걸쳐 가합니다.
		가스통의 내구도는 %d 이고, 8 턴 동안 유지됩니다. 가스통의 지속시간이 다하거나 파괴되면 마지막으로 가스를 분사합니다.
		피해량, 내구도, 속성 저항, 방어력은 증기력에 비례하여 증가합니다.
		시전자의 피해 증가량과 속성 저항 관통 효과를 따릅니다.]], "tformat")
...
t([[Activate the armour's active defense system.
		...
		The effects increase with your Steampower.]], [[갑옷의 방어 시스템을 활성화합니다.
		갑옷에 전류를 흘려보내 에너지 공격을 일부 감쇄하고, 작은 증기 엔진들을 가동시켜 갑옷의 중요 부품으로 물리 피해를 일부 감쇄합니다.
		피격 시, 정신 피해를 제외하고 받는 피해량이 %d 감소합니다.
		추가로, 갑옷의 전력이 매 턴 50%% 확률로 누출되어 적들에게 방전됩니다. %0.2f - %0.2f 전기 피해를 반경 1 칸 내의 모든 적에게 가합니다.
		이 효과는 증기력에 비례하여 증가합니다.]], "tformat")
t("Viral Needlegun", "바이러스 바늘총", "talent name")
t([[You fire a cone of blighted needles, hitting everything in a frontal cone of radius %d for %0.2f physical damage.
		...
		The damage and disease effects increase with your Steampower.]], [[황폐성 물질이 묻은 바늘 다발을 발사하여 반경 %d 칸의 원뿔 범위 내의 모든 개체에게 %0.2f 물리 피해를 가합니다.
...
t("You shred pieces of sandwalls. Brrrmmm!.", "모래벽 조각을 분쇄한다. 부르르릉!", "_t")
t("Flamethrower", "화염방사기", "talent name")
t([[Throw a cone of flame with radius %d
		The damage will increase with your Steampower.]], [[반경 %d 칸의 원뿔 범위에 화염을 쏟아냅니다.
		피해량은 증기력에 비례하여 증가합니다.]], "tformat")
t("Mass Repair", "대규모 수리", "talent name")
t([[Throw a cone of healing with radius %d, healing other mechanical creatures (steam spiders) for %d.
		The healing will increase with your Steampower.]], [[반경 %d 칸의 원뿔 범위 내의 기계들 (증기 거미들) 의 생명력을 %d 회복시킵니다. 
		회복량은 증기력에 비례하여 증가합니다.]], "tformat")
t("Arcane Disruption Wave", "마법 방해 파동", "talent name")
...
t("Mind Crush", "정신 파쇄", "talent name")
...
t([[Shatters the mind of your victim, giving you full control over its actions for 6 turns.
		...
		.]], [[희생양의 정신을 산산조각 내어, 6 턴 동안 대상을 완벽하게 장악합니다.
		효과가 끝나면 당신의 정신이 희생양의 몸에서 빠져나가고, 대상의 몸은 붕괴되어 죽게 됩니다.
		이 효과는 희귀, 보스, 언데드에게 적용되지 않습니다.
		.]], "tformat")
t("Shocking Touch", "충격의 손길", "talent name")
t([[Touch a creature to release a nasty electrical charge into them, doing %0.2f lightning damage.
		...
		The damage increases with your Steampower.]], [[대상에게 끔찍한 전류를 흘려보내 %0.2f 전기 피해를 가합니다.
		이 발명품의 등급이 1 등급 이상이라면 전류가 최대 2 칸 밖의 적에게 연쇄됩니다.
		발명품의 등급과 동일한 수의 적에게 연쇄됩니다.
		피해량은 증기력에 비례하여 증가합니다.]], "tformat")
t("Flash Powder", "섬광 가루", "talent name")
t("%s resists the blinding light!", "%s 실명의 빛에 저항했다!", "logSeen", nil, {"는"})
t([[Throw a handful of dust that rapidly oxidises, releasing a blinding light.
		Creatures in a cone of radius %d are blinded for %d turns %s.]], [[빠르게 산화하며, 실명시키는 빛을 뿜어내는 가루를 한 줌 던집니다.
		반경 %d 칸의 원뿔 범위 내의 적을 %d 턴 동안 실명시킵니다 %s.]], "tformat")
...
t([[Throw a handful of dust that is very itchy to touch.
		Creatures in a cone of radius %d are itchy for %d turns %s, causing them to fail talents %d%% of the time.]], [[만지기만 해도 매우 간지러운 가루를 한 줌 던집니다.
		반경 %d 칸의 원뿔 범위 내의 적에게 %d 턴 동안 극심한 가려움증을 유발하여 %s %d%% 확률로 기술 시전에 실패하게 합니다.]], "tformat")
...
t([[Throw a grenade at your foes, dealing %0.2f physical damage in radius %d.
		Creatures hit will also be stunned for %d turns %s.]], [[적에게 수류탄을 던져 반경 %d 칸 범위에 %0.2f 물리 피해를 줍니다.
		폭발에 휘말린 적은 %d 턴 동안 기절합니다 %s.]], "tformat", {2,1,3,4})
...
t([[You activate hidden springs to project a saw towards your foes.
		...
		The damage increases with your Steampower.]], [[숨겨둔 용수철을 작동시켜 적에게 톱을 발사합니다.
		발사 궤도 상의 모든 적은 %0.2f 물리 피해를 받고, 출혈로 인해 해당 피해량의 절반을 5 턴에 걸쳐 받습니다.
		피해량은 증기력에 비례하여 증가합니다.]], "tformat")
t("Voltaic Bolt", "정전기 화살", "talent name")
t([[Fires a bolt of lightning, doing %0.2f lightning damage.
		The damage will increase with your Steampower.]], [[번개 화살을 날려 %0.2f 전기 피해를 가합니다.
		피해량은 증기력에 비례하여 증가합니다..]], "tformat")
t("Voltaic Sentry", "전류 보초", "talent name")
t("volatic sentry", "전류 파수병", "_t")
t("A strange device. Your hair stands on end when you approach.", "기묘한 기계입니다. 다가가면 머리카락이 곤두섭니다.", "_t")
t([[Place an electrically charged sentry device at a location.
		...
		Damage, life, resists, and armor scale with your Steampower.
		Damage and penetration are inherited from the creator.]], [[전기를 방출하는 파수병을 대상 위치에 설치합니다.
		매 턴, 파수병은 가까운 적에게 전류 화살을 쏩니다.
...
t([[You fire a special explosive shot with your steamgun(s) at a spot within range.
		...
		탄환이 목표에 도달하면 기본 총기 피해와 함께 반경 %d 칸의 폭발이 일어나 %0.2f 물리 피해를 줍니다.
		이 기술은 장착중인 탄환에 영향을 받지만, 탄약을 소모하지는 않습니다.]], "tformat")
...
t([[You fire a special explosive shot with your steamgun(s) at a spot within range.
		...
		This talent does not use ammo as it is the ammo.]], [[특수 탄환을 총기 사거리 내에 발사합니다.
		탄환이 목표에 도달하면 기본 총기 피해와 함께 반경 %d 칸의 폭발이 일어나고, 빛이 뿜어져 나와 해당 지역을 밝히고 %d 턴 동안 실명시킵니다 %s.
		이 기술은 장착중인 탄환에 영향을 받지만, 탄약을 소모하지는 않습니다.]], "tformat")
...
t([[You fire a special stake shot with your steamgun(s) at a target for %d%% physical weapon damage.
		...
		탄환의 무게로 인해 대상은 2 칸 밀려나고 %d 턴 동안 속박됩니다 %s.
		이 기술은 장착중인 탄환에 영향을 받지만, 탄약을 소모하지는 않습니다.]], "tformat")
...
t([[You fire a special steamsaw shot with your steamgun(s) at a target for %d%% physical weapon damage.
		...
		톱날은 적의 몸을 잘라내어 %d%% 물리 무기 피해를 5 턴에 걸쳐 가합니다.
		이 기술은 장착중인 탄환에 영향을 받지만, 탄약을 소모하지는 않습니다.]], "tformat")
...
t([[You fire a special hook shot with your steamgun(s) at a target creature or location.
		...
		적이나 아군에게 발사하면 시전자 쪽으로 %d 칸 끌고 옵니다.
		비어 있는 장소에 발사하면 시전자가 해당 방향으로 최대 %d 칸 끌려갑니다.
		이 기술은 장착중인 탄환에 영향을 받지만, 탄약을 소모하지는 않습니다.]], "tformat")
...
t([[You fire a special magnetic shot with your steamgun(s) at a target for normal weapon damage.
		...
		탄환은 대상을 %d 턴 동안 자기장으로 방해해 %s 방어도를 %d 감소시키고, 같은 수치만큼 피로도를 증가시킵니다.
		이 기술은 장착중인 탄환에 영향을 받지만, 탄약을 소모하지는 않습니다.
...
t([[You fire a special antimagic shot with your steamgun(s) at a target for 100%% normal weapon damage.
		...
		탄환은 대상에게 반마법의 힘을 해방해 %0.2f 마법 원천력 소각 피해를 줍니다.
		이 기술은 장착중인 탄환에 영향을 받지만, 탄약을 소모하지는 않습니다.
...
t([[You fire a special botanical shot with your steamgun(s) at a target for 100%% weapon damage as nature.
		...
		이 이끼는 거머리 같은 특성을 갖고 있기 때문에, 가한 피해의 %d%% 만큼 시전자의 생명력을 회복합니다.
		이 기술은 장착중인 탄환에 영향을 받지만, 탄약을 소모하지는 않습니다.
...
t([[You fire a special corrosive shot with your steamgun(s) at a target for %d%% weapon damage as acid.
		...
		This talent does not use ammo as it is the ammo.]], [[총기로 특수 부식 탄환을 발사해 대상에게 %d%% 무기 피해를 산성 속성으로 가합니다.
		탄환에서 흘러나온 산성 물질은 대상의 장비를 부식시켜 %s 정확도, 회피도, 방어력을 %d 감소시킵니다.
		이 기술은 장착중인 탄환에 영향을 받지만, 탄약을 소모하지는 않습니다.]], "tformat")
...
t([[You fire a special toxic shot with your steamgun(s) at a target for 100%% weapon damage as blight.
		...
		탄환은 중금속 조각들을 대상에게 방출하여 매 턴 %0.2f 황폐 피해를 주고 대상의 전체 속도를 %d 턴 동안 %d%% 감소시킵니다 %s.
		이 기술은 장착중인 탄환에 영향을 받지만, 탄약을 소모하지는 않습니다.
		맹독의 위력은 증기력에 비례하여 증가합니다.]], "tformat", {1,3,2,4})
...
t([[For %d turns, you lay down Grasping Moss where you walk or stand.
		...
		This moss is very thick and sticky causing all foes passing through it have their movement speed reduced by %d%% %s and have a %d%% chance to be pinned to the ground for 4 turns %s.
		The damage scales with your Steampower.]], [[%d 턴 동안, 시전자의 위치에 붙잡는 이끼를 생성합니다.
		이 이끼는 시전자가 움직이는 곳에 자동적으로 생성되고 %d 턴 동안 유지됩니다.
		매 턴 이끼는 이끼를 밟고 있는 적에게 %0.2f 자연 피해를 줍니다.
		이 이끼는 두껍고 끈적이기 때문에, 이끼의 위의 적은 이동 속도가 %d%% 감소하고 %s %d%% 확률로 4 턴 동안 속박됩니다 %s.
		피해량은 증기력에 비례하여 증가합니다.]], "tformat")
t("Arcane Dynamo", "비전 발전기", "talent name")
t([[Allows the use of Technomancy spells.
		...
		#{italic}#Metal Arcane Power!#{normal}#]], [[마도공학 주문을 사용할 수 있게 됩니다.
		마법의 증기를 모아둘 수 있게 되어, 마나를 10 소모할 때마다 증기를 %d 회복합니다.
...
t("Smith", "야금학", "talent name")
t([[Allows you to create smithed tinkers of level %d.
		You will learn a new schematic at level 1.
		Each other talent level, you have a 20%% chance to learn one more random schematic, if you have not gained it by level 5 you are guaranteed it (unless all are known).
		%s]], [[야금학 레벨 %d 을 요구하는 발명품을 만들 수 있게 됩니다.
		이 기술을 습득하면 새로운 도안을 하나 배웁니다.
		이 기술에 기술 점수를 투자할 때마다 20%% 확률로 무작위한 도안을 하나 배웁니다. 기술 레벨이 5 가 될 때까지 이 효과가 일어나지 않았다면 도안 하나를 100%% 확률로 배웁니다. (도안을 전부 배웠다면 무효)
		%s]], "tformat")
...
t([[Allows you to create mechanical tinkers of level %d.
		You will learn a new schematic at level 1.
		Each other talent level, you have a 20%% chance to learn one more random schematic, if you have not gained it by level 5 you are guaranteed it (unless all are known).
		%s]], [[기계학 레벨 %d 을 요구하는 발명품을 만들 수 있게 됩니다.
		이 기술을 습득하면 새로운 도안을 하나 배웁니다.
		이 기술에 기술 점수를 투자할 때마다 20%% 확률로 무작위한 도안을 하나 배웁니다. 기술 레벨이 5 가 될 때까지 이 효과가 일어나지 않았다면 도안 하나를 100%% 확률로 배웁니다. (도안을 전부 배웠다면 무효)
		%s]], "tformat")
...
t([[Allows you to create electrical tinkers of level %d.
		You will learn a new schematic at level 1.
		Each other talent level, you have a 20%% chance to learn one more random schematic, if you have not gained it by level 5 you are guaranteed it (unless all are known).
		%s]], [[전기학 레벨 %d 을 요구하는 발명품을 만들 수 있게 됩니다.
		이 기술을 습득하면 새로운 도안을 하나 배웁니다.
		이 기술에 기술 점수를 투자할 때마다 20%% 확률로 무작위한 도안을 하나 배웁니다. 기술 레벨이 5 가 될 때까지 이 효과가 일어나지 않았다면 도안 하나를 100%% 확률로 배웁니다. (도안을 전부 배웠다면 무효)
		%s]], "tformat")
t("Compact Steam Tank", "소형 증기 탱크", "talent name")
t("Increases the capacity of your steam tank by %d.", "최대 증기 보유량이 %d 증가합니다.", "tformat")
...
t([[Using psionic energies you overheat your shot, making it deal %d%% damage.
		If the shot hits a wet foe it will vaporize, removing the wet effect and dealing %0.2f fire damage in a radius 4.]], [[초능력 에너지로 탄환을 과열시키고 사격하여 %d%% 피해를 가합니다.
		젖음 상태의 적을 대상으로 사용하면 순식간에 증발시켜 젖음 효과를 제거하고 반경 4 칸에 %0.2f 화염 피해를 줍니다.]], "tformat")
t("Blunt Shot", "둔탁한 사격", "talent name")
t("Fire a relatively low-powered shot at a foe doing %d%% weapon damage, if it hits a cone-shaped shockwave of radius 4 emanates from the impact, stunning it and all creatures caught inside for %d turns %s.", "비교적 약한 위력의 탄환을 발사하여 %d%% 무기 피해를 가합니다. 공격이 명중하면 반경 4 칸 원뿔 범위에 충격파가 일어나, 대상과 해당 범위 내의 모든 개체를 %d 턴 동안 기절시킵니다 %s.", "tformat")
t("Vacuum Shot", "진공 사격", "talent name")
t([[Attach a psionic steam device to a shot doing %d%% weapon damage.
		When it hits a foe the device activates, violently sucking all the air nearby, pulling in all creatures in radius %d %s.]], [[초능력 증기 장치를 탄환에 부착하고 발사하여 %d%% 무기 피해를 줍니다.
		공격이 명중하면 장치가 기동해, 주변의 모든 공기를 빨아들여 반경 %d 칸 내의 모든 개체를 중심으로 끌어당깁니다 %s.]], "tformat")
...
t([[Hits the target on the arms with one rotating saw doing %d%% damage and trying to maim it for %d turns %s.
		...
		#{italic}#Cutting your foes has never been so simple!#{normal}#]], [[회전하는 증기톱으로 적의 팔을 공격해 %d%% 피해를 가하고, %d 턴 동안 사지 손상을 일으킵니다 %s.
		사지 손상이 일어난 적은 가하는 피해량이 %d%% 감소합니다.
		#{italic}#네 녀석들을 써는 건 실로 간단하군!#{normal}#]], "tformat")
...
t([[You "gently" slam your saws into the wounds of a creature, dealing %d%% weapon damage and deepening the wounds.
		...
		#{italic}#The marvels of technology, now at the service of true butchery!#{normal}#]], [[대상의 상처를 증기톱으로 "부드럽게" 쳐서 %d%% 무기 피해를 주고 상처를 악화시킵니다.
		모든 출혈 효과의 지속시간이 %d 턴 연장되고, 피해량이 %d%% 증가합니다. 이 효과는 각 출혈 효과마다 한 번씩만 발동합니다.
		출혈이 연장되면 피가 뿜어져 나와 대상의 뒤쪽 4칸 원뿔 범위 내의 모든 개체에게 %0.2f 물리 피해를 줍니다.
		효과와 피해량은 증기력에 비례하여 증가합니다.
		#{italic}#경이로운 기술이 이제 진정한 도살을 돕는다!#{normal}#]], "tformat")
...
t([[You try to sever the spine of your foe, reducing its global speed by %d%% for 4 turns and dealing %d%% weapon damage.
		...
		#{italic}#Break them, grind them, mow them down!#{normal}#]], [[적의 척추를 부숴 4 턴 동안 전체 속도를 %d%% 감소시키고 %d%% 무기 피해를 가합니다.
		이 강력한 일격은 대상의 물리 효과를 최대 %d 개까지 제거합니다 %s.
		기술 레벨 3 부터, %d 개의 물리적, 마법적 유지기까지 같이 제거합니다.
		#{italic}#놈들을 부숴버리고, 베어버리고, 갈아버리자!#{normal}#]], "tformat")
t("Goresplosion", "피폭발", "talent name")
t([[When you kill a foe you place small explosives with shrapnels inside its body, making it explode in radius %d.
		...
		#{italic}#Use the finest of wartech now: shrapnels. For blood and mayhem!#{normal}#]], [[적을 살해하면 적의 시체가 반경 %d 칸에 피와 살의 파편 폭발을 일으킵니다.
		폭발에 휘말린 적은 출혈로 인해 매 턴 %0.2f 피해를 6 턴 동안 받습니다 %s. 또한 파편은 성대 혹은 그에 준하는 기관에 피해를 입혀 %d 턴 동안 침묵시킵니다 %s.
...
t("All this metalworking has improved you.", "오랜 대장일로 육체를 단련합니다.", "_t")
...
t("Harness the power of fire.", "불의 힘을 다룹니다.", "_t")
t("gunner training", "사수 훈련", "talent type")
t("Use steam powered guns to rain bullets of death on your foes!  (Learning these talents allow you to fire two steamguns at once.)", "총기를 이용하여 적들에게 죽음의 총알 비를 내립니다! (이 계열의 기술을 배우면, 두 자루의 총기를 한 번에 발사할 수 있게 됩니다.)", "_t")
t("gunslinging", "총잡이", "talent type")
t("Use advanced marksmanship to confound and overwhelm your foes!  (Learning these talents allow you to fire two steamguns at once.)", "진보된 사격술로 적을 물리치고 압도합니다. (이 계열의 기술을 배우면, 두 자루의 총기를 한 번에 발사할 수 있게 됩니다.)", "_t")
t("bullets mastery", "탄환 숙련", "talent type")
t("Use various kinds of technology to temporarily enhance your bullets.  (Learning these talents allow you to fire two steamguns at once.)", "다양한 공학 기술로 일시적으로 탄환을 강화합니다. (이 계열의 기술을 배우면, 두 자루의 총기를 한 번에 발사할 수 있게 됩니다.)", "_t")
...
t("Incredible feats of slipperiness!", "믿기지가 않는 도망 기술들입니다!", "_t")
...
t("Use the power of electricity to supercharge your shield.", "전력을 사용하여 방패를 강화합니다.", "_t")
...
t("This talent is required for the following tinkers (you still need to learn/find the schematics):", "이 기술은 다음 발명품에 필요합니다 (설계도를 배우거나, 찾아야 합니다.):", "_t")
...
t([[Using psionic energies you temporarily alter your blood, turning it into molten iron.
		...
		]], [[초능력을 써서 일시적으로 혈액을 뜨거운 쇳물로 바꿉니다.
		지속되는 동안 시전자에게 근접 공격을 가한 적은 %0.2f 화염 피해를 받습니다. 시전자의 모든 저항은 %d%% 증가하고, 새로 받는 부정적인 효과들의 지속시간이 %d%% 감소합니다.
		피해량은 증기력에 비례하여 증가합니다.
		]], "tformat")
...
t([[Melding psionics with steamtech you create 5 mind drones at your sides that fly towards your target.
		...
		Disrupted creatures have %d%% chances to fail to use talents and suffer a -%d%% reduction to fear and sleep immunity.]], [[초능력과 증기 공학을 이용해 정신 드론을 5 개 만들어내고 대상에게 날립니다.
		정신 드론이 무언가와 접촉하면, 드론은 곧바로 두개골에 구멍을 파고 들어가 6 턴 동안 생각을 방해합니다 %s.
		생각을 방해받는 개체는 %d%% 확률로 기술 사용에 실패하고, 공포와 수면 저항이 %d%% 감소합니다.]], "tformat")
t("Psionic Mirror", "염동 거울", "talent name")
t([[You cleanse your mind of %d mental debuffs.
		Cleansed effects will be randomly sent to closeby foes in range 5 %s.]], [[정신을 맑게 하여 부정적 정신 효과를 %d 개 제거합니다.
		제거된 효과들은 반경 5 칸 내의 무작위한 적들에게 넘어갑니다 %s.]], "tformat")
...
The stat bonus as well as the damage and healing dealt by Flame and Medic Turrets will increase with your Steampower.]], [[전투에서 시전자를 돕는 고정된 구조물인 포탑을 설치할 수 있게 됩니다. 포탑은 10 턴 동안 유지되며 20 턴의 재사용 대기시간을 갖고 있고, 포탑 설치 후 다른 포탑을 설치하는 것은 5 턴 동안 재사용 대기 상태로 만듭니다.
이 기술에 기술 점수를 투자하면 새로운 포탑의 도면을 배우게 됩니다.

기술 점수 1 점: 근처의 무작위한 적에게 %d%% 총기 피해를 가하는 총기 포탑을 설치할 수 있게 됩니다. 총기 포탑의 사격은 아군을 맞히지 않습니다.
기술 점수 3 점: 반경 3 칸의 원뿔 범위에 화염 피해를 주는 화염 포탑을 설치할 수 있게 됩니다. 화염 포탑은 추가 방어력 %d 과 모든 피해 저항 30%% 를 얻습니다.
기술 점수 4 점: 아군에게 회복 안개를 내뿜어 생명력을 %d 회복시키고, 새로 걸린 부정적인 효과의 지속시간을 %d%% 줄여주는 의료 포탑을 설치할 수 있게 됩니다.

이 기술은 모든 포탑의 민첩, 체격, 교활을 %d 늘려줍니다.

모든 포탑은 시전자 레벨의 절반에 해당하는 방어력을 추가로 얻습니다. 또한 포탑은 모든 부정적 효과에 면역이며, 시전자의 피해 증가량, 저항 관통, 증기력, 물리력, 정확도를 따릅니다.
...
t("An automated turret equipped with a steamgun.", "증기총이 장착된 자동 포탑입니다.", "_t")
t("Turret", "포탑", "_t")
t("Deploy a turret mounted with a steamgun that fires at foes within range for %d%% steamgun damage. The turret gains +%d Dexterity, Constitution and Cunning and %0.2f Steamgun Mastery.", "범위 내의 적에게 %d%% 총기 피해를 가하는 포탑을 설치합니다. 포탑은 민첩, 체격, 교활을 %d 만큼 추가로 가지며, %0.2f 레벨의 총기 숙련을 가집니다.", "tformat")
...
t("Gain a second steamgun that deals %d%% damage.", "%d%% 피해를 가하는 두 번째 총열을 장착합니다.", "tformat")
t("Flame Turret", "화염 포탑", "talent name")
t("flame turret", "화염 포탑", "_t")
t("An automated turret equiped with a flamethrower.", "화염방사기가 장착된 자동 포탑입니다.", "_t")
t("Deploy a turret mounted with a flamethrower, scorching nearby targets. The turret gains +%d Dexterity, Constitution and Cunning.", "근처의 적을 불사르는 화염방사기가 장착된 자동 포탑을 설치합니다. 포탑은 민첩, 체격, 교활을 %d 만큼 추가로 가집니다.", "tformat")
t("Flamethrower", "화염방사기", "talent name")
...
t([[Project a radius %d vortex of superheated air, dealing %0.2f fire damage and pulling targets towards you.
		The damage will increase with your Steampower.]], [[반경 %d 칸의 과열된 소용돌이를 만들어내 %0.2f 화염 피해를 주고, 적들을 시전자에게로 끌고 옵니다.
		피해량은 증기력에 비례하여 증가합니다.]], "tformat")
t("Medic Turret", "의료 포탑", "talent name")
t("medic turret", "의료 포탑", "_t")
t("An automated turret emitting a healing mist.", "회복 안개를 내뿜는 자동 포탑입니다.", "_t")
...
t([[Send a surge of power into all turrets in sight, extending their duration by %d turns and granting them a charged shield absorbing %d damage for 10 turns. While the shield holds, each turn the turret will project a bolt of lightning dealing %0.2f lightning damage to a random enemy in radius 6, with a 25%% chance to daze %s.
		The effects will increase with your Steampower.]], [[시야 내의 모든 포탑에 쇄도하는 힘을 불어넣습니다. 모든 포탑의 지속시간이 %d 턴 늘어나고, 10 턴 동안 %d 피해를 흡수하는 전하 보호막이 포탑에 생성됩니다. 보호막이 유지되는 동안 매 턴마다 포탑이 반경 6 칸 내의 무작위한 적에게 %0.2f 전기 피해를 가하고, 25%% 확률로 혼절을 일으키는 %s 번개 화살을 날립니다.
		이 효과는 증기력에 비례하여 증가합니다.]], "tformat")
...
t([[Upgrade the target turret, granting it %d%% increased maximum life and enhanced abilities based on type:
		...
		Medic: Increases healing on affected targets by %d%%, and has a %d%% chance to cleanse a negative effect each turn.]], [[지정한 포탑을 업그레이드하여 최대 생명력을 %d%% 늘리고, 포탑의 종류에 따라 강화 기술을 부여합니다:
		총기: %d%% 피해를 가하는 두 번째 총열을 장착합니다. 또한 3 턴마다 로켓을 발사해 반경 2 칸에 %d%% 총기 피해를 가합니다.
		화염: 피해량이 %d%%, 사거리가 %d 증가합니다. 매 3 턴마다 과열된 공기 소용돌이를 만들어내 반경 %d 칸 내의 적들을 포탑으로 끌고 오고 일반 화염방사기 피해를 줍니다.
		의료: 회복량을 %d%% 늘리고, 매 턴 %d%% 확률로 부정적인 효과를 제거합니다.]], "tformat")
t("Hunker Down", "전선 지원", "talent name")
t("guardian turret", "수호 포탑", "_t")
t("An advanced turret equipped with dual steamguns.", "이중 총열이 장착된 첨단 포탑입니다.", "_t")
t([[Deploy a defensive emplacement around you, summoning 2 guardian turrets in adjacent tiles for %d turns. Guardian turrets redirect %d%% of all damage taken by other adjacent allies (other than fellow guardian turrets) to themselves, and each is armed with a powerful turret capable of firing piercing bullets.
			Guardian Turrets gain %0.2f ranks in Steamgun Mastery based on your Hunker Down talent level.]], [[주변에 전선을 만들어, 인근에 %d 턴 동안 유지되는 수호 포탑을 2 개 세웁니다. 수호 포탑은 인접한 아군이 받는 피해의 %d%% 를 대신 받습니다 (다른 수호 포탑이 받는 피해는 대신 받지 않습니다). 포탑은 강력한 관통탄으로 무장하고 있습니다.
			수호 포탑은 %0.2f 레벨의 총기 숙련을 갖고 있고, 이는 전선 지원 기술 레벨에 비례하여 증가합니다.]], "tformat")
t("Gauss Cannon", "가우스 캐논", "talent name")
t("Fire your twin-linked gauss cannons, dealing 100%% steamgun damage as lightning in a piercing beam that bypasses all armor. This does not harm friendly targets.", "2연장 가우스 캐논을 발사해 100%% 총기 피해를 전기 속성으로 줍니다. 이 공격은 방어력을 무시하며, 사선 내의 모든 적을 관통합니다. 이 공격은 아군에게 영향을 주지 않습니다.", "tformat")

------------------------------------------------
section "tome-orcs/data/talents/uber/const.lua"
...
t("Spell damage done to it ripples in radius 4 doing 130% arcane damage.", "드론에게 가해진 주문 피해의 130% 비전 피해를 입히는 반경 4 칸의 폭발을 일으킵니다.", "_t")
t("Arcane Amplification Drone", "비전 증폭 드론", "talent name")
t("Have gained the #{italic}#Tales of the Spellblaze#{normal}# achievement with this or any previous character for the current difficulty & permadeath settings.", "지금 이 캐릭터나, 과거에 어떤 캐릭터로든, 현재 난이도와 영구적 죽음 설정으로 #{italic}#마법폭발 이야기#{normal}# 업적을 달성했을 것.", "_t")
t("Not enough space to summon!", "소환할 공간이 부족하다.", "logPlayer")
...
t("Earned the achievement 'Size Matters' on this character.", "이 캐릭터로 '크기는 상관 있다' 업적을 달성했을 것.", "_t")
...
------------------------------------------------
section "tome-orcs/data/timed_effects/floor.lua"
...
t("The target is surrounded by a magical steam shield, absorbing %d/%d damage and burning attackers for %d fire damage before it crumbles.", "마법적인 증기 방어막에 둘러싸임: 흡수량 %d/%d / 피격 시 공격자는 %d 화염 피해를 받음.", "tformat")
...
t("#Target# is no longer cursed.", "#Target#의 저주가 끝났다.", "_t")
...
t("#Target# wanders around!", "#Target1# 주위를 서성였다!", "_t")
t("+Confused", "+혼란", "_t")
...
t("TO THE MOUNTAINS!", "산으로 후퇴하라!!", "_t")
...
t("Engaged in automated repairs, preventing any action but increasing life regen by %d, all resistances by %d%% and preventing death until falling below -%d life.", "자동 수리 상태에 돌입함: 행동 불가 / 내구도 재생 +%d / 모든 저항 +%d%% 내구도가 -%d 에 도달할 때까지 파괴되지 않음.", "tformat")
...
t("Bullet Mastery: Supercharged", "탄환 숙련: 관통탄", "_t")
t("Bullets shot are supercharged:  They can pass through multiple targets and have %d additional armour penetration.", "탄환이 강화됨: 다수의 대상 관통 /방어력 관통 +%d", "tformat")
...
t("Fight to the brink of death, can not die before going under -%d life (but life under 0 is not shown) and increases all resistances by %d%%.", "죽음 직전까지 싸움: 생명력이 -%d 에 도달할 때까지 죽지 않음 / 모든 저항 +%d%%. (0 이하의 생명력은 보여지지 않음)", "tformat")
...
t("+Smoke Cover", "+연기 은폐", "_t")
t("#Target# is no longer hiding in smoke.", "#Target3# 덮고 있던 연기가 사라졌다.", "_t")
t("-Smoke Cover", "-연기 은폐", "_t")
t("Magnetised", "자성을 띰", "_t")
t("The target has been magnetised, reducing defense by %d and increasing fatigue by %d.", "자성을 띠게 됨: 회피도 -%d / 피로도 +%d.", "tformat")
t("#Target# is magnetised.", "#Target2#자성을 띈다.", "_t")
t("+Magnetised", "+자력을 띰", "_t")
...
t("You lay moss where you walk.", "걸을 때마다, 이끼가 자리잡습니다.", "tformat")
t("+Moss", "+이끼", "_t")
t("-Moss", "-이끼", "_t")
t("Stimulus", "자극제", "_t")
...
t("#Target# is suffering and fails to concentrate on dealing damage.", "#Target2# 고통으로 인해 제대로 된 공격을 가하지 못한다.", "_t")
t("#Target# is suffering less.", "#Target#의 고통이 가셨다.", "_t")
t("acid", "산성", "effect subtype")
t("Acid Burn", "산성 화상", "_t")
t("The target has been splashed with acid, taking %0.2f acid damage per turn.", "산성 물질에 덮임: 매 턴마다 산성 피해 %0.2f.", "tformat")
...
t("-Static Shield", "-정전기 보호막", "_t")
t("Lightning Web", "전기망", "_t")
t("The target is surrounded by a crackling web of lightning, reducing all damage taken by %d.", "전기로 탁탁거리는 그물에 덮여 있음: 피격 시 받는 피해 -%d.", "tformat")
t("#LIGHT_BLUE#(%d lightning web)#LAST#", "#LIGHT_BLUE#(%d 전기망)#LAST#", "tformat")
t("Incendiary Grenade", "소이 수류탄", "_t")
...
t("+AED", "+심소생", "_t")
t("#Target#'s AED deactivates.", "#Target#의 자동 심장 충격기가 비활성화되었다.", "_t")
t("-AED", "-심소생", "_t")
t("%s's AED triggers!", "%s의 자동 심장 충격기가 발동했다!", "logSeen")
t("Burning Phosphorus", "소이 화상", "_t")
t("The target is covered in burning chemicals, taking %0.2f fire damage each turn. Subsequent shots deal %0.2f fire damage, and if they fall below 25%% life they have a %d%% chance to panic.", "불타는 화학 물질에 뒤덮임: %0.2f 화염 피해를 매 턴 받음 / 후속 사격이 %0.2f 화염 피해를 입히고, 생명력이 25%% 이하로 떨어질 시, %d%% 확률로 공황에 빠짐.", "tformat")
...
t("The target is surrounded by a toxic cloud or radius %d. Enemies within will suffer %d%% talent failure, %d%% reduced healing, and take %0.2f additional acid damage from melee and ranged attacks.", "반경 %d 칸의 독기 구름에 덮여 있음: %d%% 확률로 기술 시전에 실패 / 회복 효율 -%d%% / 근접, 원거리 공격에 %0.2f 산성 피해를 추가로 받음.", "tformat")
...
t("Hovering in place, gaining %d%% evasion, %d%% movement speed and launching a powerful rocket barrage each turn.", "공중에 떠다님: 피격 시, %d%% 확률로 피해 무효화 / 이동 속도 +%d%% / 매 턴 강력한 로켓 세례를 가할 수 있음.", "tformat")
...
t("Allows your weapon to spray caustic acid on hit, reducing armor.", "명중 시 방어력을 감소시키는 부식성 산성 물질을 무기에서 뿜을 수 있게 됩니다.", "_t")
t("Brain Cap", "두뇌 차폐막", "_t")
t("By mounting a brain in a jar in a stralite frame this marvel will increases your mental resistances and allow you to emit a powerful magic disrupting wave.", "스트랄라이트로 제작된 틀 안에 두뇌가 담긴 통을 장착합니다. 이 경이로운 발명품은 정신 저항을 향상시키고, 강력한 마법 방해 파장을 내뿜을 수 있게 합니다.", "_t")
t("Brain Flare", "두뇌 신호기", "_t")
t("By mounting a brain in a jar in a stralite frame this marvel will increases your mental resistances and to invade your foe's minds, taking control.", "스트랄라이트로 제작된 틀 안에 두뇌가 담긴 통을 장착합니다. 이 경이로운 발명품은 정신 저항을 향상시키고, 적의 정신에 침투해, 적을 조종할 수 있게 합니다.", "_t")
...
t("Make the invisible visible.", "보이지 않는 것을 보이게 합니다.", "_t")

------------------------------------------------
section "tome-orcs/data/tinkers/electricity.lua"

t("Lightning Coil", "전기 코일", "_t")
t("Lightning coils can be attached to melee weapons to generate a short range beam of electricity on melee crits.", "전기 코일을 근접 무기에 장착하면 근접 치명타 시 짧은 전기 광선을 쏘아냅니다.", "_t")
t("Mana Coil", "마나 코일", "_t")
t("Mana coils can be attached to staves to improve mana regeneration and cast a lightning spell on spell hits.", "마나 코일을 지팡이에 장착하면 마나 재생이 향상되고, 주문 명중 시 번개 주문을 시전합니다.", "_t")
t("sapphire", "사파이어", "_t")
t("Arcane Dynamo", "비전 발전기", "_t")
t("Arcane Dynamos build a bridge between arcane forces and steamtech, regenerating steam supplies when casting spells and allowing the use of Technomancy.", "비전 발전기는 마법의 힘과 증기 공학을 잇는 발명품입니다. 주문을 사용할 때마다 증기를 회복시키며, 마도공학 주문을 사용할 수 있게 합니다.", "_t")
t("amethyst", "자수정", "_t")
...
t("Fortify your shield with electricity and prepare to unleash GALVANIC RETRIBUTION against your attackers!", "방패를 전기로 강화하고, 공격자에게 전열 보복기를 해방할 준비를 하세요!", "_t")
t("Shocking Edge", "충격의 칼날", "_t")
t("Attaching a capacitor to your weapon in just the right way is a great way to shock your enemies.", "무기에 축전기를 장착해, 올바르고, 좋은 방법으로 적들에게 전기 충격을 가해보세요.", "_t")
t("Steamsaw: Stormcutter", "증기톱: 폭풍절단기", "_t")
t("The pinnacle of steamsaws technology. Every one of your hits will unleash the power of the storm onto your foes, chaining between them and stunning them!", "증기톱 기술의 정점입니다. 모든 공격에 폭풍의 힘이 담겨, 해방된 폭풍이 적들 사이로 연쇄되고 기절시킵니다!", "_t")
t("shocking edge", "충격의 칼날", "_t")
t("fire opal", "화염 오팔", "_t")
t("pearl", "진주", "_t")
t("diamond", "다이아몬드", "_t")
...
t("Steamgun", "총기", "_t")
t("Dismantle any one sling, add some amazing steampower to it and make a powerful steamgun to fire a bullet hell at your foes!", "투석구를 분해하고, 놀라운 증기의 힘을 불어넣어, 적들에게 총알 지옥을 보여주는 강력한 증기총을 만들어냅니다!", "_t")
...
t("A special reservoir seeps liquid fire onto the weapon, adding fire damage and setting the ground on fire when you hit.", "특수 탱크를 무기에 장착해, 화염 속성 피해를 추가하고 땅바닥에 불길을 일으킵니다.", "_t")
t("Thunder Grenade", "천둥 수류탄", "_t")
t("Small radius, but stuns quite well.", "범위는 좁지만 기절 효과는 뛰어납니다.", "_t")
t("Steamgun: Payload", "총기: 폭발력", "_t")
t("The pinnacle of steamguns technology. Critical strikes with this gun will feel like a massive explosion of flames! And it actually will be one!", "증기 총기 기술의 정점으로, 이 총기로 가하는 모든 치명타는 거대한 화염 폭발을 일으키는 것 같은데요? 아! 실제로 폭발이 일어나네요!", "_t")
...
t("A special shot that slices 'n' dices.", "대상을 갈아 토막내는 특수 탄환입니다.", "_t")
...
t("A special shot that releases acid on impact.", "충격을 받으면 산성액이 터져나오는 특수 탄환입니다.", "_t")
...
t("Attach small steam rocket to your boots, granting faster movement and leaving a trail of fire to burn those foolish enough to follow you.", "장화에 작은 증기 로켓을 장착해, 빠른 이동 속도를 얻고 뒤쫓아오는 멍청이들을 불태울 화염의 궤적을 남깁니다.", "_t")
t("Hand Cannon", "핸드 캐논", "_t")
t("Allows you to fire your equipped shot or arrow ammo via your gloves.", "장착한 화살이나 투석구 탄환을 장갑을 통해 발사할 수 있게 됩니다.", "_t")
t("Fatal Attractor", "치명적 인력 발생기", "_t")
...
t("Steamsaw", "증기톱", "_t")
t("Dismantle any one handed sword/axe/mace, add some amazing steampower to it and make a powerful steamsaw to shred your foes to pieces!", "한손검/도끼/둔기를 분해하고, 놀라운 증기의 힘을 불어넣어, 적들을 조각낼 수 있는 강력한 증기톱을 만들어냅니다!", "_t")
t("a one handed sword/axe/mace (not unique, without a special damage type)", "한손검/도끼/둔기를 (유니크 아이템이 아니고, 특별한 속성이 아닐 것)", "_t")
t("Convert which weapon?", "어떤 무기를 변환할까요?", "_t")
t("Converted %s into %s", "%s %s 변환됨", "log", nil, {"가","로"})
t("Focus Lens", "집중 렌즈", "_t")
t("A simple contraption consisting of a gem and some metal to enhance your sight, detection and infravision! At tier 4 it even allows you to fight while blinded. #{italic}#Amazing!#{normal}#", "보석과 약간의 금속으로 이루어진 작은 기계로, 시야, 감지력, 적외선 시야를 향상시킵니다! 4 등급 이상일 경우, 실명 상태에서의 불이익을 제거합니다. #{italic}#놀라워요!#{normal}#", "_t")
t("citrine", "시트린", "_t")
...
t("Blight is not dirty to a Tinker, it is useful! By combining blighted materials with a simple mechanical gun, you can fire a low damaging attack that infects foes with terrible diseases.", "바이러스는 발명가에게는 더러운 녀석이 아니죠, 꽤 쓸만합니다! 황폐를 퍼뜨리는 물질들과 간단한 기계 총의 결합으로, 적들에게 끔찍한 질병을 퍼뜨리는 조그마한 바늘 공격을 발사할 수 있습니다.", "_t")
t("Razor Edge", "면도날", "_t")
t("Properly working and tempering a metal can make it harder than normal, and hold a sharper edge.", "제대로 된 야금 기술과 담금질은 금속을 원래보다 더 단단하게 만들수 있고, 날카롭게 날을 세울 수 있습니다.", "_t")
t("Armour Reinforcement", "방어구 보강", "_t")
t("Want more defense? Wear more armour!", "좀 더 튼튼해지고 싶다구요? 방어구를 더 껴입으면 됩니다!", "_t")
...
t("Just what you need to support your back when lifting heavy things; like armour, weapons or Yetis.", "갑옷이나 무기, 예티 같이 무거운 것을 들어올릴 때에 등을 지지해줄 친구입니다!", "_t")
t("Grounding Strap", "접지 노끈", "_t")
t("Keeping yourself grounded is very important, especially around lightning mages.  Increases lightning and stun resistance.", "접지는 매우 중요합니다, 특히 전기 마법사 주변에 있을 때는요.  전기 저항력과 기절 면역력이 증가합니다.", "_t")
...
To be used with the medical injector implant.]], [[일정 시간 동안 몸을 강철과 같이 단단하게 만들어주는 연고입니다. 생명력이 0 이하여도 생존할 수 있게 되고, 모든 저항을 증가시킵니다.
연고를 사용하려면 의료용 주사기가 필요합니다.]], "_t")
t("Frost Salve", "서리 연고", "_t")
...
t("diamond", "다이아몬드", "_t")
t("bloodstone", "혈석", "_t")
t("Second Skin", "두 번째 피부", "_t")
t("Not only does it help seal wounds, protecting you from bleeding and enhancing your healing, it also protects from armour chafe!", "상처 봉합뿐만 아니라, 출혈도 막아주고 회복 효율까지 높여주네요! 이뿐만이 아닙니다! 갑옷에 쓸린 상처까지 막아줍니다!", "_t")
...
t("Moss Tread", "이끼 장화", "_t")
t("Where you walk nature grows! Well moss. Sticky moss.", "당신이 걸으면 자연이 자라납니다! 아, 이끼네요, 끈적거리는 이끼.", "_t")
t("Fungal Web", "곰팡이 망", "_t")
t("This mesh of fungal threads absorbs nutrients for salves to provide you with added healing!", "균사로 이루어진 망사로, 연고의 영양분을 흡수하여 추가적인 회복 효과를 제공합니다!", "_t")
...
------------------------------------------------
section "tome-orcs/data/wda/orcs.lua"
...
------------------------------------------------
section "tome-orcs/data/zones/cave-hatred/zone.lua"
...
------------------------------------------------
section "tome-orcs/data/zones/dominion-port/zone.lua"
...
이 차원문은 마즈'에이알의 마지막 희망 근처로 통하는 것으로 보입니다.]], "_t")
t("#VIOLET#You enter the swirling portal and in the blink of an eye you set foot on the outskirts of Last Hope, with no trace of the portal...", "#VIOLET#당신은 소용돌이치는 차원문으로 들어갔고 눈 깜박할 새에 마지막 희망의 교외에 착지했습니다. 차원문은 흔적조차 보이지 않습니다...", "_t")
t("wall", "벽", "entity type")
...
------------------------------------------------
section "tome-orcs/data/zones/gates-of-morning/objects.lua"
...
t("Impenetrable Plates", "뚫리지 않는 편안함", "entity name")
t("Quality Leather", "끝내주는 가죽갑", "entity name")
t("Arcane Cloth", "신비한 옷가게", "entity name")
t("Swordmaster", "소드마스터", "entity name")
t("Night Affairs", "밤손님", "entity name")
t("Orc Cutters", "오크 절단기", "entity name")
t("Mauling for Brutes", "머리통을 깨자", "entity name")
t("Bows and Slings", "활과 투석구", "entity name")
t("Sook's Arcane Goodness", "수크네 신비한 물건가게", "entity name")
t("Sarah's Herbal Infusions", "세라네 약초 주입물", "entity name")
t("Sook's Runes and other Harmless Contraptions", "수크네 룬과 잡동사니들", "entity name")
t("Zemekkys Home", "제메키스의 집", "entity name")
...
------------------------------------------------
section "tome-orcs/data/zones/gem/zone.lua"
...
------------------------------------------------
section "tome-orcs/data/zones/internment-camp/grids.lua"
...
------------------------------------------------
section "tome-orcs/data/zones/internment-camp/zone.lua"
...
t("Freedom! Let's rally to Kruk Pride!", "자유다! 크룩 긍지로 가자!", "_t")
t("Mindwall", "마인드월", "_t")
...
------------------------------------------------
section "tome-orcs/data/zones/lost-city/zone.lua"

t("Ruins of a lost city", "잃어버린 도시의 폐허", "_t")

------------------------------------------------
section "tome-orcs/data/zones/palace-fumes/grids.lua"
...
------------------------------------------------
section "tome-orcs/data/zones/palace-fumes/zone.lua"

t("Palace of Fumes", "연기의 궁전", "_t")

------------------------------------------------
section "tome-orcs/data/zones/pocket-time/grids.lua"
...
t("steam-enhanced leather coat", "증기력 가죽 코트", "_t")
t("A simple leather armour of excellent facture that has been craftily enhanced with hidden miniature steam engines to enhance reflexes and provide safety features.", "훌륭한 기능을 갖춘 단순한 가죽 갑옷입니다. 초소형 증기기관들을 내장하여 반응 능력을 강화하고 안전을 확보해 줍니다.", "_t")
t("When you take a hit of more than 10% of your total life the suit's motors activate fo the next turn, displacing you before any blow could hit you.", "착용자가 최대 생명력의 10%를 넘는 피해를 받으면, 다음 턴에 슈트의 전동기가 활성화되어 착용자가 공격을 맞기 직전에 옆 칸으로 비켜 서게 해 줍니다.", "_t")
t("Brilliant Auto-loading Orc Expeller", "끝내주는 자동 장전식 오크 퇴치기", "entity name")
t("expensive gun", "값비싼 총", "_t")
t("A finely crafted gun, designed specifically to kill orcs. And giants somehow!", "오크를 죽이기 위해 특별히 고안된 고품질 총입니다. 뭐 어쨌건 거인도 죽일 수 있습니다!", "_t")
...
t("Ruined Cave", "폐허가 된 동굴", "_t")
t("This cave looks very solid and stable. You can probably leave items here for later.", "이 동굴은 매우 튼튼하고 안정되어 보입니다. 나중에 필요할 수도 있는 물건들은 여기 잠시 놔 두고 가도 될 것 같습니다.", "_t")

------------------------------------------------
section "tome-orcs/data/zones/slumbering-caves/npcs.lua"

t("Amakthel's Hand", "아마크텔의 손", "entity name")
t("god", "신", "entity type")
...
But there it is, half alive, half dead but you can feel his thoughts in your head, there is no mistake: #{bold}#The Dead God is here!#{normal}#]], [[이런 것이 존재할 것이라고는 상상조차 못했습니다. 이런 걸 마주하게 되는 것 또한, 단연코 상상조차 못한 일입니다. 하지만 지금 눈 앞에 있는 것은, 확실히 아마크텔 그 자체의 조각입니다.
신화에서 말하는 쉐르'툴에게 살해당한 신이라는 것은, 그저 신화에 불과하다고 생각했습니다.
하지만 그게 지금 여기에 있고, 반쯤만 살아있는 상태이지만, 당신은 머릿속에서 그의 생각을 느낄 수 있습니다. 틀림없습니다,
#{bold}#죽은 신이 여기에 있습니다!#{normal}#]], "_t")
t("Amakthel's Mouth", "아마크텔의 입", "entity name")
t("#PURPLE#%s shouts: 'YOU DO NOT GET AWAY!'", "#PURPLE#%s 소리쳤다: '도망칠 순 없다!!'", "saySimple", nil, {"가"})
t("#PURPLE#%s shouts: 'YOU DO NOT GET AWAY!'", "#PURPLE#%s 소리쳤다: '도망칠 순 없다!!'", "log", nil, {"가"})
t("Amakthel's Eye", "아마크텔의 눈", "entity name")
t("spiked tentacle", "가시 촉수", "entity name")
t("A huge tentacle, ready to crush you with its many spikes.", "거대한 촉수로, 수많은 가시로 당신을 으깨려 하고 있습니다.", "_t")
t("oozing tentacle", "점액을 흘리는 촉수", "entity name")
...
------------------------------------------------
section "tome-orcs/data/zones/slumbering-caves/objects.lua"
...
그대는 이제 그분의 태양의 조각과 함께하게 되었도다. 그것을 내리신 분을 잊지 말지니. 그렇지 않으면 그분을 저버린 가엾은 천치들과 운명을 같이 하리라.#{normal}#"]], "_t")
t("When worn, gives you an additional prodigy point.", "착용 시, 특수 기술 점수를 1점 추가로 얻습니다.", "_t")
t("#GOLD#The light of the Amulet envelops you, then subsides. You feel stronger. (+1 Prodigy Points)", "#GOLD#목걸이의 빛이 당신을 휘감았고, 곧 진정되었다. 더 강해진 느낌이 든다. (특수 기술 점수 +1점)", "logPlayer")
t("#GOLD#The light of the Amulet envelops you, then subsides. You feel stronger. (+1 Prodigy Points)", "#GOLD#목걸이의 빛이 당신을 휘감았고, 곧 진정되었다. 더 강해진 느낌이 든다. (특수 기술 점수 +1점)", "saySimple")

------------------------------------------------
section "tome-orcs/data/zones/slumbering-caves/zone.lua"

t("The Slumbering Caves", "깊이 잠든 동굴", "_t")
t("The Slumbering Caves (%d)", "깊이 잠든 동굴 (%d)", "tformat")
t("Amakthel's Prison", "아마크텔의 감옥", "_t")
t("Fall", "추락", "_t")
t("The end of the staircase was trapped, you fell for a long time, luckily not breaking anything. But you have no way back now...", "계단의 끝에 함정이 있었습니다. 당신은 한참을 추락했고, 운좋게 다치진 않았습니다. 하지만 이제 돌아갈 길이 없습니다...", "_t")

------------------------------------------------
section "tome-orcs/data/zones/steam-quarry/grids.lua"

t("giant steam valve", "거대 증기 밸브", "entity name")
t("#PURPLE#You kick and destroy the valve!", "#PURPLE#밸브를 발로 차서 파괴했다!", "log")

------------------------------------------------
section "tome-orcs/data/zones/steam-quarry/npcs.lua"

t("Automated Defense System", "자동 방어 시스템", "entity name")
t("This heavily armored mecharachnid looks extremely dangerous and well equipped to defend the quarry.", "극히 위험해 보이는 중무장 강철 거미입니다. 채굴장을 방어하기 위해 장비들을 든든하게 착용했습니다.", "_t")

------------------------------------------------
section "tome-orcs/data/zones/steam-quarry/objects.lua"

t("a very old journal", "굉장히 오래된 일지", "entity name")
t("A journal.", "일지입니다.", "_t")
t("schematic: Stormcutter", "설계도: 폭풍절단기", "entity name")

------------------------------------------------
section "tome-orcs/data/zones/steam-quarry/zone.lua"

t("Steam Quarry", "증기 채굴장", "_t")
...
t("void", "공허", "entity type")
t("void", "공허", "entity subtype")
t("bottom of the mountain", "산의 땅", "entity name")
t("floor", "바닥", "entity type")
t("rocks", "바위", "entity subtype")
t("rocks", "바위", "entity name")
t("way into a strange cave", "이상한 동굴로 가는 길", "entity name")
t("stairs to the previous level", "이전 구역으로 가는 계단", "entity name")
t("stairs to the cavern", "동굴로 통하는 계탄", "entity name")
t("pillar of the sun", "태양의 기둥", "entity name")
t("pillar of the moons", "달의 기둥", "entity name")

------------------------------------------------
section "tome-orcs/data/zones/sunwall-observatory/npcs.lua"

t("elf", "엘프", "entity subtype")
t("Star Gazer", "천체관측사", "entity name")
t("This astromancer radiates the power of all celestial bodies. You can discern a distinct elven shape under the hood and robes.", "천상의 힘을 내뿜고 있는 점성술사입니다. 후드와 로브에 가려져 있는 엘프의 모습을 알아볼 수 있습니다.", "_t")
t("Astral-Infused Yeti", "우주의 힘이 깃든 예티", "entity name")
t("You wonder how this yeti can have wandered so far from its native habitat in the Clork Peninsula. You also wonder what happened to it that produced the celestial energies-wielding creature you angrily marching towards you.", "원래 클로크 반도에 사는 예티가 어쩌다가 이런 곳까지 오게 됐는지 궁금합니다. 또 지금 화가 나서 뛰어오고 있는 녀석이 어쩌다가 천상의 에너지를 휘두르게 됐는지도 궁금합니다.", "_t")
...
t("a journal", "일지", "entity name")
t("A journal.", "일지입니다.", "_t")
t("Cap of the Undisturbed Mind", "고요한 정신의 모자", "entity name")
t("red cap", "붉은 모자", "_t")
...
With it you can spend your time stargazing without fear.]], [[이 모자엔 여전히 살아 있는 뇌 조직이 심어져 있습니다. 공허의 공포들을 바라볼 때 받을 수 있는 정신적인 충격을 방지하기 위해서입니다.
이걸 쓰면 큰 문제 없이 천체를 관측할 수 있습니다.]], "_t")
t("Allows you to resist the most terrible assaults on your mind.", "흉악한 정신공격들에 저항할 수 있게 해 줍니다.", "_t")
t("flesh", "살점", "entity type")
t("muscle", "근육", "entity subtype")
t("Yeti's Muscle Tissue (Astral)", "예티의 근육 조직 (우주)", "entity name")
t("flesh", "살점", "_t")
t("Muscle tissue, extracted from a powerful yeti. Somewhere, somebody or something is bound to be interested!", "강력한 예티에게서 뜯어낸 근조직입니다. 어딘가의 누군가, 또는 무엇인가는 분명히 이것에 관심을 보일 것입니다!", "_t")
t("You cannot bring yourself to drop the %s", "%s 차마 버릴 수가 없었다", "logPlayer", nil, {"를"})

------------------------------------------------
section "tome-orcs/data/zones/sunwall-observatory/zone.lua"

t("Sunwall Observatory", "태양의 장벽 관측소", "_t")
t("Path into the mountain", "산으로 가는 길", "_t")
t("Caverns below the Observatory", "관측소 아래의 동굴", "_t")
...
t("human", "인간", "entity subtype")
t("Outpost Leader John", "전초기지 대장 존", "entity name")
t("This warrior's armor glows with a bright golden light. He wields an ornate sword and shield, and marches towards you with confidence.", "황금빛으로 눈부시게 빛나는 갑옷을 입은 전사입니다. 화려하게 장식된 검과 방패를 들고 당신을 향해 위풍당당하게 전진하고 있습니다.", "_t")
t("humanoid", "인간형", "entity type")
t("orc", "오크", "entity subtype")
t("orc retaliator", "오크 복수자", "entity name")
t("A stern-looking orc, armed to the teeth.", "중무장을 하고 단호한 표정을 짓고 있는 오크입니다.", "_t")
t("orc gunslinger", "오크 총잡이", "entity name")
t("A nasty looking orc armed with double steamguns.", "양손에 증기총을 두 자루 들고 있는 험악한 오크입니다.", "_t")
...
t("Sunwall Outpost", "태양의 장벽 전초기지", "_t")
t("Reinforcements!", "지원군!", "_t")
t("An %s has managed to join forces with you!", "%s 한 명이 간신히 당신과 합류했습니다!", "tformat")

------------------------------------------------
section "tome-orcs/data/zones/tinker-master/grids.lua"
...
t("construct", "구조체", "entity type")
t("mechanical", "기계학", "entity subtype")
t("Ancient Automated Teacher", "고대의 학습 장치", "entity name")
t("An ancient archive of knowledge! It seems to have some kind of vocal interface.", "고대 지식의 보고입니다! 음성 인터페이스라는 것이 달려 있는 모양입니다.", "_t")

------------------------------------------------
section "tome-orcs/data/zones/tinker-master/zone.lua"

t("Ancient Cave", "고대의 동굴", "_t")

------------------------------------------------
section "tome-orcs/data/zones/town-kruk/grids.lua"

t("floor", "바닥", "entity type")
t("grass", "잔디", "entity subtype")
t("exit to the worldmap", "세계 지도로의 출구", "entity name")
t("Coward!", "겁쟁이!", "_t")
t("You are not coward enough to leave your home unprotected!", "당신은 집을 위험한 채로 버려두고 떠날 정도의 겁쟁이가 아닙니다!", "_t")
t("floor", "바닥", "entity subtype")
t("old road", "오래된 길", "entity name")
t("wooden barricade", "나무 바리케이드", "entity name")
t("wall", "벽", "entity type")
...
t("tunnel weakness", "터널의 취약점", "entity name")
...
t("humanoid", "인간형", "entity type")
t("orc", "오크", "entity subtype")
t("orc guard", "오크 경비병", "entity name")
t("A stern-looking guard, he will not let you disturb the town.", "엄격한 얼굴을 한 경비병입니다. 당신이 마을을 어지럽히는 걸 용납하지 않을 것입니다.", "_t")
t("orc gunslinger", "오크 총잡이", "entity name")
t("A nasty looking orc armed with double steamguns.", "양손에 증기총을 두 자루 들고 있는 험악한 오크입니다.", "_t")
t("Commander Fralor", "지휘관 프랄로르", "entity name")
t("This heavily armored steam giant carries a huge battleaxe, swinging it menacingly towards you.", "중무장을 하고 있는 증기 거인으로, 거대한 전투도끼를 들고 맹렬하게 휘두릅니다.", "_t")
t("Metash the Maulotaur", "마울로타우르스 메타쉬", "entity name")
t("This big undead minotaur is carrying a nasty looking hammer, imbued with lightning.", "무시무시한 망치를 들고 있는, 커다란 언데드 미노타우르스입니다. 망치에서 번개가 튀고 있습니다.", "_t")

------------------------------------------------
section "tome-orcs/data/zones/town-kruk/objects.lua"

t("The Shunned Kruk", "미움받는 크룩 긍지", "entity name")
t("A history lesson.", "역사 공부가 됩니다.", "_t")
t("Yeti Mind Controller", "예티 정신 조작기", "entity name")
t("This device seems to be designed to 'hack' the mind of a wild yeti to make it able to be used as a weapon of war.", "이 장치는 야생 예티의 정신을 '해킹' 하여 전쟁 무기로 써먹을 수 있도록 고안된 것 같습니다.", "_t")
t("hack the mind of a weakened yeti", "약해진 예티의 정신을 '해킹' 한다", "_t")
t("#CRIMSON#Impossible to to control.", "#CRIMSON#조작할 수 없다.", "logPlayer")
t("#CRIMSON#Impossible to to control.", "#CRIMSON#조작할 수 없다.", "saySimple")
t("#CRIMSON#The yeti is not hurt enough to control.", "#CRIMSON#예티가 충분히 약해지지 않았다.", "logPlayer")
t("#CRIMSON#The yeti is not hurt enough to control.", "#CRIMSON#예티가 충분히 약해지지 않았다.", "saySimple")
t("#AQUAMARINE#You overtake the yeti's mind and order it to report to Kruk Pride.", "#AQUAMARINE#예티의 정신을 덮쳐 크룩 긍지로 가도록 명령했다.", "logPlayer")
t("#AQUAMARINE#You overtake the yeti's mind and order it to report to Kruk Pride.", "#AQUAMARINE#예티의 정신을 덮쳐 크룩 긍지로 가도록 명령했다.", "saySimple")
...
t("Tinkers Store", "발명용품점", "entity name")
t("Library", "도서관", "entity name")

------------------------------------------------
section "tome-orcs/data/zones/town-kruk/zone.lua"
...
t("paper scrap", "종잇조각", "entity name")
t("A paper scrap.", "종잇조각입니다.", "_t")
t("schematic: Hands of Creation", "설계도: 창조의 손", "entity name")

------------------------------------------------
section "tome-orcs/data/zones/ureslak-host/zone.lua"

t("Ureslak's Host", "우르슬락의 둥지", "_t")

------------------------------------------------
section "tome-orcs/data/zones/vaporous-emporium/grids.lua"

t("merchant stall", "상점 가판대", "entity name")

------------------------------------------------
section "tome-orcs/data/zones/vaporous-emporium/npcs.lua"

t("giant", "거인", "entity type")
t("steam", "증기", "entity subtype")
t("An unarmed steam giant.", "비무장 상태의 증기 거인입니다.", "_t")
t("Guards!", "경비병!", "_t")
t("Help!", "도와줘요!", "_t")
...
t("This heavily armored steam giant carries a gun in each hand. The gun in his right hand is ornate and well worn.", "중무장을 하고 양손에 총을 들고 있는 증기 거인입니다. 오른손의 총은 화려하게 장식되어 있고, 다소 오래된 물건 같습니다.", "_t")

------------------------------------------------
section "tome-orcs/data/zones/vaporous-emporium/objects.lua"

t("poster", "포스터", "entity name")
t("An advertisement poster.", "광고 포스터입니다.", "_t")

------------------------------------------------
section "tome-orcs/data/zones/vaporous-emporium/zone.lua"

t("Vaporous Emporium", "증기 상업지구", "_t")

------------------------------------------------
section "tome-orcs/data/zones/wilderness-add/grids.lua"

t("bridge to the mainland", "본토로 가는 다리", "entity name")
...
t("Way into old ruins in the Erúan desert", "에류안 사막의 오래된 폐허로 가는 길", "entity name")
t("Entrance to the Dominion Port", "자치령 항구의 입구", "entity name")
t("Destroyed Dominion Port", "파괴된 자치령 항구", "entity name")
t("Entrance to a Ritch Hive", "릿치 군락의 입구", "entity name")
t("Path to a peak leading to the Sunwall Observatory", "태양의 장벽 관측소가 있는 봉우리로 가는 길", "entity name")
t("Entrance to the Pride's Internment Camp", "오크 긍지 수용소의 입구", "entity name")
...
t("a crude mural painting", "대충 그려진 벽화", "entity name")

------------------------------------------------
section "tome-orcs/data/zones/yeti-caves/npcs.lua"

t("immature ice ant", "성장 중인 얼음 개미", "_t")
t("An oversized white ant. It seems not yet fully developed.", "지나치게 커다란 하얀색 개미입니다. 아직도 다 큰게 아닌 것 같습니다.", "_t")
t("Yeti Patriarch", "예티 족장", "entity name")
t("This yeti towers over its comrades. You see a cunning in its eyes unmatched by the others.", "다른 동족들보다 훨씬 더 큰 예티입니다. 눈동자는 교활함을 품고 있어 예티스럽지가 않습니다.", "_t")
...
t("flesh", "살점", "entity type")
t("muscle", "근육", "entity subtype")
t("Yeti's Muscle Tissue (Patriarch)", "예티 근육 조직 (족장)", "entity name")
t("flesh", "살점", "_t")
t("Muscle tissue, extracted from a powerful yeti. Somewhere, somebody or something is bound to be interested!", "강력한 예티에게서 뜯어낸 근조직입니다. 어딘가의 누군가, 또는 무엇인가는 분명히 이것에 관심을 보일 것입니다!", "_t")
t("You cannot bring yourself to drop the %s", "%s 차마 버릴 수가 없었다", "logPlayer", nil, {"를"})

------------------------------------------------
section "tome-orcs/data/zones/yeti-caves/zone.lua"

t("Yetis Cave", "예티 동굴", "_t")

------------------------------------------------
section "tome-orcs/init.lua"

t("Embers of Rage", "분노의 잉걸불", "init.lua long_name")
t([[Play as an orc of the Kruk Pride, located on an island near Var'Eyal.
Learn to master steam technology, battle the terrible Atmos Tribe and ensure dominion of Var'Eyal for your race.]], [[바르'에이알 옆에 위치한 섬의 크룩 긍지 오크로 플레이합니다.
증기 공학을 배우고, 끔찍한 아트모스 부족과 싸우고, 또 바르'에이알 내에서의 당신 종족의 지배권을 확고히 하십시오.]], "init.lua description")

------------------------------------------------
section "tome-orcs/overload/data/calendar_orc.lua"

t("Remembrance", "추모", "calendar orc")
t("Retaking", "재탈환", "calendar orc")
t("Revenge", "복수", "calendar orc")
t("Pain", "고통", "calendar orc")
t("Dearth", "결핍", "calendar orc")
t("Loss", "상실", "calendar orc")
t("Destruction", "파괴", "calendar orc")
t("Renewal", "재개", "calendar orc")

------------------------------------------------
section "tome-orcs/overload/data/texts/intro-orc-whitehooves.lua"
...
------------------------------------------------
section "tome-orcs/overload/data/texts/intro-orc-yeti.lua"
...
------------------------------------------------
section "tome-orcs/overload/data/texts/intro-orc.lua"
...
------------------------------------------------
section "tome-orcs/overload/data/texts/unlock-orcs_campaign_all_classes.lua"
...
------------------------------------------------
section "tome-orcs/overload/data/texts/unlock-orcs_campaign_mage.lua"
...
------------------------------------------------
section "tome-orcs/overload/data/texts/unlock-orcs_campaign_rogue.lua"
...
------------------------------------------------
section "tome-orcs/overload/data/texts/unlock-orcs_tinker_eyal.lua"
...
섬멸자는 화염방사기나 충격 지팡이, 화살탄 발사기 같은 중화기를 만들어내 사용하는 발명가들이며, 발명 지식으로 보다 진보된 전쟁 병기들을 만들어내기도 합니다.
직업 특징:#YELLOW#
- 중화기의 힘을 맛보여 준다.
...
t("Created tinker: %s", "만들어낸 발명품: %s", "log")
t("Created tinker: %s", "만들어낸 발명품: %s", "saySimple")
t("Learnt new tinker schematic: #LIGHT_GREEN#%s", "새로운 발명품의 설계도를 배움: #LIGHT_GREEN#%s", "log")
...
t("#PURPLE#Automated Reflex System activated!", "#PURPLE#자동 반사작용 시스템이 활성화됐다!", "saySimple")
...
------------------------------------------------
section "tome-orcs/superload/mod/dialogs/Birther.lua"
...
------------------------------------------------
section "tome-orcs/superload/mod/dialogs/LevelupDialog.lua"
