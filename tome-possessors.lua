...
t("#CRIMSON#Your body died! You quickly return to your normal one but the shock is terrible!", "#CRIMSON#육체가 죽었습니다! 신속하게 원래 육체로 돌아왔지만, 그 충격은 실로 끔찍합니다!", "say")
...
t("Destroy the most damage copy or all?", "가장 많은 피해를 받은 육체를 파괴하겠습니까, 아니면 육체 전부를 파괴하겠습니까?", "_t")
